...
<Info>
  Alternatively, the SDK can be initialized manually. If you require this approach, please refer to the guide on [Framework Initialization](https://developers.moengage.com/hc/en-us/articles/11650953391636-Framework-Initialization).
</Info>
...
<Accordion title="Android Configuration">
  ...
  |              | `com_moengage_core_data_center`                       | Integer  | Default: `1`. For more info, refer [Data Center values](https://dashboard.mintlify.com/moengage/moengage/editor/SDK-docs?file=untitled-page.mdx#h_01KBCZFV92YVXMQ8KYY9YKMGX0). |
...
<Accordion title="iOS Configurations">
  ...
  |              | `DataCenter`                         | Integer          | Specifies the Data Center value. This is a Mandatory field. The default value is _1_. For more info, refer to [Data Center values](https://dashboard.mintlify.com/moengage/moengage/editor/SDK-docs?file=untitled-page.mdx#h_01KBCZFV92YVXMQ8KYY9YKMGX0). |
