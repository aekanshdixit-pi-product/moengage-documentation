...
For example, if the dashboard URL starts with [https://dashboard-01.moengage.com](https://dashboard-01.moengage.com), your current version of Web SDK is 2, and workspace_id is XXXXXXXXXXXXXXXX,  then the prefetch and initiation code would be:
...
For example, if the dashboard URL starts with [https://dashboard-01.moengage.com](https://dashboard-01.moengage.com), your current version of Web SDK is 2, and workspace_id is XXXXXXXXXXXXXXXX,  then the whole code will look like:
...
For example, if the dashboard URL starts with [https://dashboard-01.moengage.com](https://dashboard-01.moengage.com), and workspace_id is XXXXXXXXXXXXXXXX,  then the prefetch and initiation code would be:
...
![Screenshot 2024-06-03 at 3.39.42 PM.png](/guide-media/01HZGSP62J0FA33WN76ZSNC89B)
...
![Screenshot 2024-06-03 at 3.41.14 PM.png](/guide-media/01HZGSS6EH8XRRCC4F0PFJVK7T)
