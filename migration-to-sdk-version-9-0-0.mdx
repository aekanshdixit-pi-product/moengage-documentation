...
For information on the new initialization methods, refer to this [link](https://developers.moengage.com/hc/en-us/articles/4403905438228-SDK-initialisation).
...
For information on the new DataCenter value, refer to this [link](https://developers.moengage.com/hc/en-us/articles/4403910162452-Data-Center).
...
For information on the new DataCenter value, refer to this [document](https://developers.moengage.com/hc/en-us/articles/4403910297620-Install-Update-differentiation).
...
For information on tracking user attributes methods, refer to this [document](https://developers.moengage.com/hc/en-us/articles/4403922636308-Tracking-events).
...
For more details, refer to the [InApp Native developer documentation](https://developers.moengage.com/hc/en-us/articles/4404155127828-In-App-Nativ).
...
For more details, refer to [Real-Time Triggers.](https://developers.moengage.com/hc/en-us/articles/4404012829204-Real-Time-Triggers)
...
For more info on the Geofence feature, refer to our documentation [here.](https://developers.moengage.com/hc/en-us/articles/4404022268308-Location-triggered)
...
For more information on the Geofence feature, refer to this [document.](https://developers.moengage.com/hc/en-us/articles/4403961980308-Actionable-Notifications)