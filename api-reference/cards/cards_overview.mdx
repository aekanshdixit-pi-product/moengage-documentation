...
<AccordionGroup>
  ...
  <Accordion title="Can I delete cards for a specific platform only?" icon="sparkles">
    es, you can specify the `platforms` array in the request body (e.g., `[&quot;android&quot;]`) to delete the cards only from those specific platforms. If omitted, it deletes from all associated platforms. 
  </Accordion>
</AccordionGroup>
