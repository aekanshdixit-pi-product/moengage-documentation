...
- File Import Status
- Import Details API
- [Import File Run History API](https://moengage.mintlify.app/api-reference/file-import/import-file-run-history)
...
![alt text](/Screenshot2025-11-24at3.27.23PM\(2\).png)
