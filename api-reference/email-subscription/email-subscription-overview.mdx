...
- [Bulk Resubscribe Users](https://moengage.mintlify.app/api-reference/resubscribe/bulk-resubscribe-users) - Resubscribe users and optionally update ESP suppression lists.
- [Update User Email Opt-in Preferences](https://moengage.mintlify.app/api-reference/opt-in-management/update-user-email-opt-in-preferences) - Update overall opt-in status and category-specific preferences.
