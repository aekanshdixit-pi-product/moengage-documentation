...
- [Create Push Template](https://moengage.mintlify.app/api-reference/templates/create-push-template)
- [Update Push Template](https://moengage.mintlify.app/api-reference/templates/update-push-template)
- [Search for Push Templates](https://moengage.mintlify.app/api-reference/templates/search-for-push-templates)
...
<Note>
  ...
  **Group Key Guidelines:**
  ...
  MoEngage automatically modifies the group_key to ensure it does not exceed the 45-character limit. Non-Latin scripts, special characters, and spaces are removed to restrict the key composition to ASCII characters exclusively.
</Note>
