...
description: "Create and manage Push and Email campaigns programmatically using the MoEngage Campaigns API."
---

## Overview

The MoEngage Campaigns API allows you to create and manage Push and Email campaigns programmatically. Use these endpoints to automate campaign creation, update existing campaigns, control campaign status, and retrieve campaign details.
...
- [Create Campaign](https://moengage.mintlify.app/api-reference/create-campaigns/create-campaign)
- [Update Campaign](https://moengage.mintlify.app/api-reference/update-campaigns/update-campaign)
- [Change Campaign Status](https://moengage.mintlify.app/api-reference/update-campaigns/change-campaign-status)
- [Search Campaigns](https://moengage.mintlify.app/api-reference/get-campaign-details/search-campaigns)
- [Get Campaign Meta](https://moengage.mintlify.app/api-reference/get-campaign-details/get-campaign-meta)
- [Get Child Campaigns](https://moengage.mintlify.app/api-reference/get-campaign-details/get-child-campaigns)
- [Test Campaign](https://moengage.mintlify.app/api-reference/test-campaigns/test-campaign)
- [Personalized Preview](https://moengage.mintlify.app/api-reference/test-campaigns/personalized-preview)
...
| DEVICE_TRIGGERED         | ✓            | ✗     |
| LOCATION_TRIGGERED       | ✓            | ✗     |
| BROADCAST_LIVE_ACTIVITY  | ✓ (iOS only) | ✗     |
...
<Note>
  **Request ID Guidelines:**
  ...
  - After a successful campaign creation, do not reuse the same `request_id` for **1 hour** (Push) or **1 day** (Email).
  - If campaign creation fails, you can immediately retry with the same `request_id`.

  **Update Restrictions:**

  - You can only update campaigns created via the API, not campaigns created through the MoEngage Dashboard.
  - Campaigns in the **Stopped** or **Archived** state cannot be updated.
</Note>
