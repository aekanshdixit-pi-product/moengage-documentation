...
- [Update Email Template API](https://moengage.mintlify.app/api-reference/email-templates/update-email-template): Updates an email template specified by its Template ID.
