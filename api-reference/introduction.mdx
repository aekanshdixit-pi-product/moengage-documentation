...
<CardGroup cols={2}>
  <Card title="Data" icon="database" href="/api-reference/overview-data">
    Create and update users, track events, manage devices, and import data in bulk.
  </Card>
  <Card title="Campaigns" icon="paper-plane" href="/api-reference/post-campaigns">
    Create and manage Push and Email campaigns programmatically.
  </Card>
  <Card title="Push" icon="bell" href="/api-reference/post-transactionsendpush">
    Send transactional and targeted push notifications to Android, iOS, and Web.
  </Card>
  <Card title="Inform" icon="message" href="/api-reference/post-alertssend">
    Send transactional alerts across SMS, Email, and Push channels.
  </Card>
  <Card title="Catalog" icon="box" href="/api-reference/post-catalog">
    Manage product catalogs for recommendations and personalization.
  </Card>
  <Card title="Cards" icon="rectangle-history" href="/api-reference/post-cardsfetch">
    Fetch and manage App Inbox cards for users.
  </Card>
  <Card title="Custom Segments" icon="users" href="/api-reference/post-v2-custom-segments-file-segment">
    Create and manage file-based and filter-based user segments.
  </Card>
  <Card title="Business Events" icon="calendar-check" href="/api-reference/post-business_event">
