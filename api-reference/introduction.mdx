...
<CardGroup cols={2}>
  <Card title="Data" icon="database" href="https://moengage.mintlify.app/api-reference/data/data-overview">
    Create and update users, track events, manage devices, and import data in bulk.
  </Card>
  <Card title="Campaigns" icon="paper-plane" href="https://moengage.mintlify.app/api-reference/campaigns/campaigns-overview">
    Create and manage Push and Email campaigns programmatically.
  </Card>
  <Card title="Push" icon="bell" href="https://moengage.mintlify.app/api-reference/push/push-overview">
    Send transactional and targeted push notifications to Android, iOS, and Web.
  </Card>
  <Card title="Inform" icon="message" href="https://moengage.mintlify.app/api-reference/inform/inform-overview">
    Send transactional alerts across SMS, Email, and Push channels.
  </Card>
  <Card title="Catalog" icon="box" href="https://moengage.mintlify.app/api-reference/catalog/catalog-overview">
    Manage product catalogs for recommendations and personalization.
  </Card>
  <Card title="Cards" icon="rectangle-history" href="https://moengage.mintlify.app/api-reference/cards/cards-overview">
    Fetch and manage App Inbox cards for users.
  </Card>
  <Card title="Custom Segments" icon="users" href="https://moengage.mintlify.app/api-reference/custom-segments/custom-segments-overview">
    Create and manage file-based and filter-based user segments.
  </Card>
  <Card title="Business Events" icon="calendar-check" href="https://moengage.mintlify.app/api-reference/business-events/business-events-overview">
