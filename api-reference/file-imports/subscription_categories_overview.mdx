...
- [Update Subscription Preferences](https://moengage.mintlify.app/api-reference/subscription-preferences/update-subscription-preferences): Updates the subscription category preferences information for a specific user who navigates to the custom landing page from the email notification sent to them and updates their preferences.
