...
- [Create SMS Template](https://moengage.mintlify.app/api-reference/sms-templates/create-sms-template)
- [Search SMS Template](https://moengage.mintlify.app/api-reference/sms-templates/search-sms-templates)
- [Update SMS Template](https://moengage.mintlify.app/api-reference/sms-templates/update-sms-template)
