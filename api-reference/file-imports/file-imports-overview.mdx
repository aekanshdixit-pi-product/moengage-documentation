---
title: "File Imports API"
description: "Fetch the processing status at both the import and file levels using the MoEngage File Imports API."
---

## Overview

The File Imports API helps in proactively tracking the status of the Imports and the Files in an import without navigating to the MoEngage dashboard.
...
| Endpoint                     | Limit                                       |
| :--------------------------- | :------------------------------------------ |
| **Trigger File Imports**     | The rate limit is 100 RPM and 360k per day. |
| **Import Details**           | The rate limit is 50 requests per minute.   |
| **Import File Run History ** | The rate limit is 100 RPM and 360k per day. |
