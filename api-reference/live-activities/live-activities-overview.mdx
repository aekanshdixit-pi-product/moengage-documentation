...
- [**Start Broadcast Live Activity**](/api-reference/live-activities/start): Initiates the shared activity and sends the initial content to the target audience.
- [**Update Broadcast Live Activity**](/api-reference/live-activities/update): Pushes unified updates (e.g., score changes) to all subscribed devices.
- [**End Broadcast Live Activity**](/api-reference/live-activities/end): Terminates the activity session across all devices.
