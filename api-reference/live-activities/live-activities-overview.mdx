...
- [**Start Broadcast Live Activity**](https://moengage.mintlify.app/api-reference/live-activities/start-broadcast-live-activity): Initiates the shared activity and sends the initial content to the target audience.
- [**Update Broadcast Live Activity**](https://moengage.mintlify.app/api-reference/live-activities/update-broadcast-live-activity): Pushes unified updates (e.g., score changes) to all subscribed devices.
- [**End Broadcast Live Activity**](https://moengage.mintlify.app/api-reference/live-activities/end-broadcast-live-activity): Terminates the activity session across all devices.
