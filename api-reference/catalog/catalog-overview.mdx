...
- [Create a New Catalog](https://moengage.mintlify.app/api-reference/catalog/create-a-new-catalog)
- [Add Catalog Attributes](https://moengage.mintlify.app/api-reference/catalog/add-catalog-attributes)
- [Ingest Items into the Catalog](https://moengage.mintlify.app/api-reference/items/ingest-items-into-the-catalog)
- [Update Existing Items](https://moengage.mintlify.app/api-reference/items/update-existing-items-in-a-catalog)
- [Delete Existing Items](https://moengage.mintlify.app/api-reference/items/delete-existing-items)
