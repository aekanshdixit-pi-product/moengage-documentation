...
- [Get Campaign Stats](https://moengage.mintlify.app/api-reference/stats/get-campaign-stats) - Retrieve real-time performance metrics (clicks, impressions, conversions) at a platform level.
- [Download Campaign Report](https://moengage.mintlify.app/api-reference/campaign-reports/download-campaign-report) - Directly download campaign data files for specified date ranges.
...
Test your integration and verify your signature logic using our Postman collection. [View Postman Collection →](https://www.postman.com/moengage-dev/workspace/api-docs/)