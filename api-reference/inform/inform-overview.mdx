...
- [Inform API](https://moengage-shilpa-2.mintlify.app/api-reference/transactional-alerts/send-transactional-alert)
...
<AccordionGroup>
  <Accordion title="What is the rate limit?" icon="sparkles">
