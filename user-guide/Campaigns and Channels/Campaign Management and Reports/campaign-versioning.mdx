...
sidebarTitle: "Campaign Versioning"
---
...
3. On the Campaign analytics and info page, click **Edit**.  
   ...
   You can also click the ellipsis icon ( <img alt="ellipsis 1.png"  src="/images/moengage_15cbb5.png"  /> ) under the **Actions** column for the preferred campaign, and then click **Edit**.  
...
6. On the **Publish changes** dialog box,
   ...
   3. Click **Publish**.  
       <img alt="publish 2.png" src="/images/moengage_79300c.png" /> After publishing, the older version is retired.
...
2. On the Campaign analytics and info page, click the **History** ( <img alt="Image 09-10-24 at 2.22 PM.jpeg"  src="/images/moengage_aba478.png"  /> ) icon to analyze existing versions of the campaign. On the Version History page, you can view updates made in individual versions.  
...
You can manage campaign versions by clicking the ellipsis icon ( <img alt="ellipsis 1.png"  src="/images/moengage_15cbb5.png"  /> ) under the **Actions** column for the required campaign on the All campaigns page. The following actions are available to manage versions:
