...
sidebarTitle: "Notifications in iOS 15"
---
...
Within the notification summary, iOS 15.0 contains on-device intelligence to order the summary as per the user’s interactions with the apps. More frequently used apps will be provided higher priority. <img alt="image1.jpg" src="/images/moengage_1a75ec.png" />
