...
sidebarTitle: "Android Push Heads-Up Notifications"
---
...
Heads-up notifications are triggered when the priority of the [push notification channel](https://help.moengage.com/hc/en-us/articles/115005277246-Push-Notification-Channels#h_01HM5JGNG5ZS12BP288C8M8E6G) is set to *High*. For more information on the notification channel on Android, see [here](https://developer.android.com/develop/ui/views/notifications#Heads-up).
...
- [Reposting method (Default method)](#h_01JMKXT2S4GE9PS904K9KQS1YG)
- [Direct posting method](#h_01JMKXVYJ8S59Q7CRGX22WCPYB)
...
To configure this method, refer [here](https://developers.moengage.com/hc/en-us/articles/35577194112020-Heads-Up-Notification#h_01JP1ZFGGGYBBQ3AX09W35RE66).
...
- If you have set up *High* priority channels and want better visibility in the heads-up area, use the Direct posting method. Ensure that media assets comply with size guidelines for optimal visibility. For more information, see [here](https://help.moengage.com/hc/en-us/articles/4415622460948).
