...
sidebarTitle: "Notification Actions"
---
...
| iOS\*\* | iOS 8 and above | SDK Version 2.2 and above | [Check about our latest SDK](https://developers.moengage.com/hc/en-us/articles/4403900743828-SDK-Integration) |
...
**8)** **Custom Action**(for Android only): Helps perform the app functions like Add to Cart or Play a song etc. directly from the notification. [Check here](https://developers.moengage.com/hc/en-us/articles/4403449633428-Advanced-Push-Configuration#custom-action-on-action-button-click-0-6) on how to integrate them into your apps.
...
For more information, refer to [Notifications in iOS 15.0](https://help.moengage.com/hc/en-us/articles/4408901929492).