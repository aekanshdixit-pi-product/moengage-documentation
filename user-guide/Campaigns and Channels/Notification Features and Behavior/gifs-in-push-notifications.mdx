...
sidebarTitle: "GIFs in Push Notifications"
---
...
1. In the second step of [push campaign creation](https://help.moengage.com/hc/en-us/articles/206541583), **Content**, select the **Basic Notification** template.
...
Only .gif file format is supported.
   ...
   3. In the [Test Campaigns](https://help.moengage.com/hc/en-us/articles/206541583-Create-Push-Campaigns#01FX49HAY2M8VWZ99RKT89JN63) section, you can test your push campaigns to preview the output based on the device.
...
1. In the second step of [push campaign creation](https://help.moengage.com/hc/en-us/articles/206541583), **Content**, select the **Basic Notification** or the **Stylized Basic Notification** template.
...
Only the .gif file format is supported.
   ...
   4. In the [Test Campaigns](https://help.moengage.com/hc/en-us/articles/206541583-Create-Push-Campaigns#01FX49HAY2M8VWZ99RKT89JN63) section, you can test your push campaigns to preview the output based on the device.
