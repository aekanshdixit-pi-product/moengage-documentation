...
sidebarTitle: "Push Notification Sounds"
---
...
For example, a notification with a time-sensitive interruption level might still play a sound even if the user has Do Not Disturb enabled, because it is deemed important enough to break through those settings. For more information, refer to [Notifications in iOS 15](https://help.moengage.com/hc/en-us/articles/4408901929492).