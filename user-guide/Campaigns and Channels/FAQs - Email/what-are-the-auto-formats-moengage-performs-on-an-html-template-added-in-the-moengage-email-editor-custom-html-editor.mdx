...
sidebarTitle: "What are the auto-formats MoEngage performs on an HTML template added in the MoEngage email editor (Custom HTML Editor)?"
---

## Auto-Formats Independent of the Auto-format HTML Code Toggle

MoEngage automatically applies the following edits to your HTML code in the [custom HTML editor](https://help.moengage.com/hc/en-us/articles/360058752732), regardless of the **Auto-format on HTML code** toggle in the **General Settings** of Email.
...
MoEngage performs the following edits only if you enable the **Auto-format HTML code** toggle in the **General Settings** of Email. For more information, refer to [Configure Email Channel](https://help.moengage.com/hc/en-us/articles/360059172811-Configure-Email-Channel#h_01J1SMEHGAQF9NAPCA2X7QVTCX).
