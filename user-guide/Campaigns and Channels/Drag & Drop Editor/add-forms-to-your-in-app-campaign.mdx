...
3. In the **Create form** pop-up, enter the following details:
   ...
   - **User property**: Select a user attribute to update with the value that users enter in the form. The user property updates only after users submit the form.<img alt="enter form details.gif" src="/images/moengage_9b9c2c.png" />   
   <Info>
...
3. Use the high-level filters, such as **Date Range**, **Attribution Type**, and **Platform**, to refine the campaign data. For more information, refer to [Analyze In-App Campaign](https://help.moengage.com/hc/en-us/articles/360052454472-Analyze-In-App-Campaign#01H816QGH2EBZ122F64RJNX4N7).  
