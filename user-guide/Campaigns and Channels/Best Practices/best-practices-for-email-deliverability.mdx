...
sidebarTitle: "Best Practices for Email Deliverability"
---
...
- Ensure your email setup is correct and compliant.  
  ...
  - [Test email set up](https://help.moengage.com/hc/en-us/articles/25306820413844-Test-the-Email-Settings).
- Collect audience data accurately.  
  ...
  - Do not send marketing/promotions to users if they have not explicitly signed up.
    - Review [user collection](https://help.moengage.com/hc/en-us/articles/28134607532308) best practices.
- Align email frequency with user engagement levels.  
  ...
  - Use [Frequency capping](https://help.moengage.com/hc/en-us/sections/15747914883732-Delivery-Controls) to limit the emails sent per user per day/week.
...
- Make sure you are **warmed up** to send the intended volume.
  - Review [warm-up](https://help.moengage.com/hc/en-us/articles/28137939779604) best practices.
- Throttle emails using the correct [RPM](https://help.moengage.com/hc/en-us/articles/15916160319764-Throttling).  
  Sending too quickly without warming up your volume can lead to delivery issues. For more information, refer to [RPM recommendations](https://help.moengage.com/hc/en-us/articles/28168151932052).
...
- - Deferrals: Internet Service Providers (ISPs) may rate limit your sends.  
  ...
  - Low opens or clicks
    ...
    - Pause and monitor.
- In case of domain reputation issues, refer to [Issues with Domain Reputation and Preventive Measures](https://help.moengage.com/hc/en-us/articles/27964316877716-Domain-Reputation-Issues-and-Preventive-Measures).