...
sidebarTitle: "OSM Templates (HTML Editor)"
---
...
<img alt="Screenshot of background color options in MoEngage platform." src="/images/moengage_53b799.png" />
...
<img alt="Screenshot of the Code View button in MoEngage." src="/images/moengage_b700d7.png" />
...
<img alt="Screenshot showing Lead Gen template selection." src="/images/moengage_e1655c.png" />

1. Configure your On-site Messaging campaign. For details, see [Create On-site Messaging Campaigns](https://help.moengage.com/hc/en-us/articles/14111506452372).
...
<img alt="Screenshot showing how to map input widget to user attributes." src="/images/moengage_15304f.png" />

1. To hide an input field, select the input widget and choose to hide it.

<img alt="Screenshot showing how to hide an input widget." src="/images/moengage_3dc32f.png" />
...
<img alt="Screenshot of captured Lead Gen data in a user profile." src="/images/moengage_3f8c8d.png" />
...
<img alt="Screenshot showing MOE_RESPONSE_SUBMITTED event in user profile." src="/images/moengage_ab5513.png" />
...
The **SMS Sign-Up** template in MoEngage On-site Messaging allows you to collect consent from users for SMS notifications. For more information about North America compliance, see [SMS for North America Region](https://help.moengage.com/hc/en-us/articles/7252470147092).
...
Before you begin, be aware of SMS compliance for the North American region. For details, see [SMS Regulations in the US](https://help.moengage.com/hc/en-us/articles/6182412748436).

### Create an SMS Sign-Up Campaign

1. During On-site Messaging campaign creation, select an **SMS Sign-Up** template.

<img alt="Screenshot showing SMS Sign-Up template selection." src="/images/moengage_52149a.png" />
...
<img alt="Animated GIF showing SMS Sign-up Fullscreen template on web." src="/images/moengage_d9419e.png" />

<img alt="Animated GIF showing SMS Sign-up Popup template on web." src="/images/moengage_b3ae2d.png" />
...
| body | Add the Opt-In keyword. For details about keywords, see [Configure Subscription & Keywords](https://help.moengage.com/hc/en-us/articles/7455097552788). |

<img alt="Animated GIF showing SMS Sign-up Fullscreen template on mobile." src="/images/moengage_9fc9f1.png" />

<img alt="Animated GIF showing SMS Sign-up Popup template on mobile." src="/images/moengage_f9f31a.png" />
...
<img alt="Screenshot of captured SMS Sign-Up data in user profile." src="/images/moengage_5c4466.png" />