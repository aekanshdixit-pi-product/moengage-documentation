...
sidebarTitle: "Test Email Campaign"
---
...
<Tip>
Before proceeding, make sure you have completed Step 1: **Target Users** and Step 2: **Content** in the [Create Email Campaign](https://help.moengage.com/hc/en-us/articles/360059171891) journey.
</Tip>
...
- [Locale and variations](#h_01KCGAS29HFA8VQ8Z604D54SAT)
- [Send via](#h_01KCGASZFA9328ATNX5TX6K15R)
- [Use sample data from the personalized preview](#h_01KCGAV6F54JV5QNWXJFW42XTH)
- [Test email](#h_01KCGAVVRB6M88WCN0VPFRYBWZ)
...
- **Mobile Number**: This option allows you to send personalized test emails to the existing users by entering their mobile numbers. Entering the mobile numbers fetches the associated user profile and sends the test to their registered email address.  
  <Info>
If [PII (Personally Identifiable Information) tokenized sending](https://help.moengage.com/hc/en-us/articles/9111881294996) is enabled, the following identification methods for registered users are not available:
...
| This error occurs when the \<body\> container is missing or empty. | Ensure you have opening and closing body tags wrapping your actual email content.  This error is displayed only if the [VIB (View in Browser) feature](https://help.moengage.com/hc/en-us/articles/39018811022100) is enabled. |