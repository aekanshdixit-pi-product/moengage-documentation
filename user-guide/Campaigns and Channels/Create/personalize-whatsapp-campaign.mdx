...
sidebarTitle: "Personalize WhatsApp Campaign"
---

[Personalization](https://help.moengage.com/hc/en-us/articles/30926654573972-Overview) makes your marketing messages feel more relevant to users. By tailoring your WhatsApp campaigns, you can build a stronger connection with your audience and improve how well your messages are received.
...
1. In the campaign creation process, navigate to [Step 2: Content](https://help.moengage.com/hc/en-us/articles/4411175043220-Create-a-WhatsApp-Campaign#01FX49HAY2M8VWZ99RKT89JN63).
...
<img alt="WhatsAppPersonlization.gif" src="/images/moengage_f6def8.png" />

In the **WhatsApp Personalization** editor, you can perform the following:

- [Data Personalization](#h_01HEADS5DNFWC71BC215FQ5XK6)
- [Personalize using Content blocks](#h_01HEADS5DPNJTMXTAT1KNZ76CQ)
- [Personalize using Auxillary data](#personalization_using_aux_data)

# Data Personalization

You can [personalize your messages](https://help.moengage.com/hc/en-us/articles/30926654573972-Overview) using user attributes, Product Sets (Recommendations), and Content APIs. To insert personalization into a message field, type @. The personalization menu opens, as shown in the following image:

<img alt="Screenshot 2025-09-08 at 4.36.24 PM.png"  src="/images/moengage_86260a.png"  />
...
Recommendations (Product sets) help you communicate real-time and contextual product recommendations to customers. For more information, refer to [Recommendations](https://help.moengage.com/hc/en-us/sections/16277704408468-Personalize-campaign-with-recommendations).
...
<img alt="WA_ContentCreation.png" src="/images/moengage_6b5913.png" />
...
```
{% if ProductSet.product\_recommendations%}
...
For more information about JINJA, refer to [MoEngage Templating Language](https://help.moengage.com/hc/en-us/articles/115002757783-MoEngage-Templating-Language-JINJA-).
...
4. Click **Done**.  
    <img alt="Screenshot 2025-09-08 at 5.22.32 PM.png"  src="/images/moengage_cf5656.png"  />
...
5. Turn on the **Insert only the content of the content block** toggle to disconnect the content from the existing content block, and any future updates to the content block will not be reflected in the campaign. This step is optional.  For more information, refer to [Content Blocks](https://help.moengage.com/hc/en-us/articles/4414768369172).
...
6. Click **Done**. The Auxiliary Data JINJA will get added to the field or the editor.  
    <img alt="Screenshot 2025-09-08 at 4.49.05 PM.png"  src="/images/moengage_af2977.png"  />
...
The Personalization Preview feature enables you to tailor content effectively, ensuring it meets the needs of your target audience. For more information, refer to [Personalized Preview](https://help.moengage.com/hc/en-us/articles/30958544839828).

<img alt="WA_PersoanlizedPreview.png" src="/images/moengage_cbaa12.png" />
