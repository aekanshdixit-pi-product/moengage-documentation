...
sidebarTitle: "Personalize Email Content"
---
...
Before starting with personalization, ensure you have [configured Email Settings](https://help.moengage.com/hc/en-us/articles/360059172811) and read about [how to create email campaigns](https://help.moengage.com/hc/en-us/articles/206184606-Creating-Email-Campaigns).
...
- [Personalized Images](https://help.moengage.com/hc/en-us/articles/360058752932#personalizing-images-0-3) for Cart Abandonment, Search Drop-offs, and so on
- [Personalized URLs](https://help.moengage.com/hc/en-us/articles/360058752932#personalizing-urls-0-4) to increase conversions by redirecting the user to the right link

<Info>
When you create a personalization condition or logic for *Email* campaigns using the *Custom HTML Editor,* it appears as a chip. To know more about Chip Actions, refer [here](https://help.moengage.com/hc/en-us/articles/39719238781716-Dynamic-Content-Personalization#h_01JMKXT2S4GE9PS904K9KQS1YH).
</Info>
...
<img alt="Personlization.png" src="/images/moengage_c017fb.png" />

On selecting the attribute, you will be prompted to select the Fallback mechanism for this user attribute.

<Warning>
When Fallback Mechanism is unavailable through the MoEngage UI, you can define  the fallback using [Jinja](https://help.moengage.com/hc/en-us/articles/115002757783-MoEngage-Templating-Language-JINJA-#working-with-default-values-0-1).
...
The fallback mechanism is useful when personalization fails due to the attribute not being present for the user or the non-resolution of the specific user attribute.  
 <img alt="Screenshot 2024-09-18 at 2.47.17 PM.png"  src="/images/moengage_df9134.png"  />
...
- Select the "Cart Abandonment" template in the "Content" section or use your own email template.  
   <img alt="ComposeEmail.png"  src="/images/moengage_7ccc40.png"   />
...
- Click the Dynamic Content inside the template. The **Add** button in the content tab that lets you personalize the image.  
   <img alt="DragDropEditor_DynamicContent.png"  src="/images/moengage_ac44f4.png"  />
- Click **Add** and the following screen is displayed.  
   <img alt="Email_PersonalizeImages.png"  src="/images/moengage_fffd0a.png"  />
...
1. Click the **Custom HTML Editor** in Step 2 of the campaign creation and choose the **Edit/Paste HTML Template** option. The following screen is displayed.  
    <img alt="Screenshot 2024-09-11 at 5.17.02 PM.png" src="/images/moengage_9bb2c9.png"  />
2. Click **Image personalization** on the top pane. The following screen is displayed.  
    <img alt="Email_ImagePersonalization.png"  src="/images/moengage_75dc09.png"   />
...
4. You can select a fallback mechanism. This is applicable if the attribute is not correctly resolved or there is no image present at the URL after resolving the attribute. You can enter a fallback image (this will be shown if personalization fails) or decide not to send the email if the image is not personalized.  
    <img alt="FallbackDetails_ImagePersonalization.png"  src="/images/moengage_fb1ba6.png"   />
...
6. Cick  the  <img alt="AddPersonalizedImage_Icon.png"  src="/images/moengage_a5d332.png"   />  icon in the custom HTML editor to insert the personalized image.  
    <img alt="Screenshot 2024-09-11 at 5.37.14 PM.png" src="/images/moengage_3a6aa0.png"  />   
...
1. Select the image and click **Replace**.  
    <img alt="" src="https://help.moengage.com/hc/en-us/article_attachments/207982123/Screen_Shot_2016-09-28_at_3.53.35_PM.png"  />
2. Enter the personalized URL under the **Image personalization** tab and click **Replace**.  
    <img alt="" src="https://help.moengage.com/hc/en-us/article_attachments/207981066/Screen_Shot_2016-09-28_at_3.41.47_PM.png"  />

### Insert a New Image in the Template

1. Click **Insert Image** in the top bar of the editor.  
    <img alt="Screenshot 2024-09-18 at 2.29.01 PM.png"  src="/images/moengage_110d47.png"   />
...
1. Click **Link personalization** as shown below:  
    <img alt="Screenshot 2024-09-11 at 5.40.42 PM.png" src="/images/moengage_d1d786.png" />   
     
    <img alt="" src="https://help.moengage.com/hc/en-us/article_attachments/207981506/Screen_Shot_2016-09-28_at_4.14.20_PM.png"  />
...
3. In the following **Email Personalization** dialog box that appears, choose the attribute and click **Done**.  
    <img alt="2024-09-11_17-54-36.gif" src="/images/moengage_bd0b9d.png" />
4. You can then copy this link and paste it wherever required, into the HTML code.  
    <img alt="Screenshot 2024-09-11 at 5.44.17 PM.png" src="/images/moengage_d351e2.png" />
