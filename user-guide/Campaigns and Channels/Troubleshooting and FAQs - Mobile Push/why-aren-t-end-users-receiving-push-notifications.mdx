...
sidebarTitle: "Why Aren't End Users Receiving Push Notifications?"
---
...
- [User Activity](#activity): This theme explores the correlation between a user's recent app activity and their likelihood of receiving notifications.
- [User Device](#device): This theme examines the correlation between a user's device model and notification deliverability.
