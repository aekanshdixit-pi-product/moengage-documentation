...
sidebarTitle: "How to Avoid Common Push Notification Issues on iOS Devices Using Flutter, Objective-C, and MoEngage-iOS-SDK (Versions 7.x.x , 8.x.x, 9.x.x)?"
---
...
2. **Disable MoEngage Proxy**:
   - Add MoEngageAppDelegateProxyEnabled key in info.plist with the value Boolean = false/NO <img alt="boolean.png" src="/images/moengage_6550ce.png" />
