...
sidebarTitle: "How to Avoid Common Push Notification Issues on iOS Devices Using Native iOS, Objective-C, and MoEngage-iOS-SDK (Versions 7.x.x , 8.x.x, 9.x.x)?"
---
...
4. **Disable MoEngage Proxy**:
   - Add MoEngageAppDelegateProxyEnabled key in info.plist with the value Boolean = False/NO <img alt="boolean.png" src="/images/moengage_3e6d66.png" />
