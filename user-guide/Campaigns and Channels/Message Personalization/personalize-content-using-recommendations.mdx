...
sidebarTitle: "Personalize Content Using Recommendations"
---
...
Custom HTML Editor Drag and Drop Editor
...
5. In the **Template Editor**section, type *@* to select the required product set and write the Jinja code to fetch the list of product set attributes and send the product set in the communication based on user preferences.  
    <img alt="personalization@jinjaproductset.gif" src="/images/moengage_9e504f.png" />
6. Click **Preview**.  
    <img alt="Screenshot 2024-11-25 at 2.24.05 PM (1).png"  src="/images/moengage_832cab.png"  />
...
1. While creating content, on the **Drag and drop editor** tab, hover over the required template and then click **Choose** to open the editor.  
    <img alt="DRAGANDDROP1.gif" src="/images/moengage_a64254.png" />
...
3. On the **ADD PRODUCT SET ROW**dialog box, in **Select product set** list, click the defined product set and click **Create**.  
    <img alt="DRAGANDROP2.gif" src="/images/moengage_d438a2.png" />
4. Expand the **Row layout** accordion and click the required row layout.  
    <img alt="DRAGANDDROP3.png" src="/images/moengage_5d6c2e.png" />
5. Expand the **Product Block Layout**  accordion and click the required product block layout.  
    <img alt="DRAGANDDROP4.png" src="/images/moengage_733d7a.png" />
6. Expand the **Information Mapper** accordion and define the information mapper.  
    <img alt="DRAGANDROP5.png" src="/images/moengage_766408.png" />
7. Click **Create**.
8. Drag and drop the defined product sets on the template.  
    <img alt="DRAGANDDROP7.gif"  src="/images/moengage_8d33cc.png"  />
9. Select **Preview.  
    <img alt="image (16).png" src="/images/moengage_60ed0f.png" />**
...
- [Personalizing Email campaigns using Recommendations](https://help.moengage.com/hc/en-us/articles/17598910966804-Using-Recommendations-in-Email)
- [Personalizing Push campaigns using Recommendations](https://help.moengage.com/hc/en-us/articles/17602388253844-Using-Recommendations-in-Push)
- [Personalizing On-Site Messaging campaigns using Recommendations](https://help.moengage.com/hc/en-us/articles/29111435499796-Using-Recommendations-in-On-site-Messaging)