...
1. 1. On the sidebar menu in MoEngage, hover over the Engage menu item <img alt="Screenshot 2025-06-04 at 4.32.53 PM.png"  src="/images/moengage_d55b34.png"  /> . The **Engage** menu appears.
   2. Click **+ New Campaign**.  
       <img alt="1.png"  src="/images/moengage_0f34bc.png"  />   
   ...
   3. On the **New Campaign** dialog box, under **Outbound**, click **WhatsApp**.  
       <img alt="whatsapp.png"  src="/images/moengage_0f8126.png"  />
...
<img alt="3.png" src="/images/moengage_c34f6b.png" />

# Steps to Create a WhatsApp Campaign

The following are the steps to create a WhatsApp campaign:

1. [Target users](https://help.moengage.com/hc/en-us/articles/4411175043220#h_01F9H2RCZ3V3374C9E9Y7QZXEF): Define the target audience for the campaign.
2. [Content](https://help.moengage.com/hc/en-us/articles/4411175043220#01FX49HAY2M8VWZ99RKT89JN63): Define the content of the campaign to be sent.
3. [Schedule and Goals](https://help.moengage.com/hc/en-us/articles/4411175043220#h_01F9H4PZTNT3CRXZM3SFXYR99C): Define the campaign's delivery schedule and goals.
...
<img alt="all users.png"  src="/images/moengage_93082c.png"  />
...
<img alt="6.png" src="/images/moengage_c3981c.png" />
...
<img alt="7.png" src="/images/moengage_4cbef8.png" />
...
<img alt="5.png" src="/images/moengage_7aa6f4.png" />
...
<img alt="8.png" src="/images/moengage_2ecf7f.png" />
...
- **Send campaign to the users ignoring Opt-in preference**: Select this option to send campaigns to users who have opted in for receiving WhatsApp campaigns. For more information, refer to [Prerequisites](https://help.moengage.com/hc/en-us/articles/4411171362452).
...
<img alt="exclude users.png" src="/images/moengage_df1608.png" />
...
<img alt="image (2).png"  src="/images/moengage_cec903.png"  />
...
|  |  |
| --- | --- |
| In the **Enable control groups** section, turn the **Global control group** toggle on to not send the campaign to all the users in the control group.  For more information, refer to [Global Control Group](https://help.moengage.com/hc/en-us/articles/360052305312). | <img alt="ControlGroups.png"  src="/images/moengage_52df6e.png"  /> |
...
<img alt="Screen_Shot_2022-08-03_at_3.34.11_PM.png"  src="/images/moengage_790caa.png"  />
...
<img alt="TestCampaigns.png" src="/images/moengage_e42b8a.png" />
...
- [Delivery Schedule](https://help.moengage.com/hc/en-us/articles/4411175043220#h_01F9H84424V8J9W1X10MJBMSZR): Choose when the campaign should be delivered to your users and the periodicity of delivery.
- [Conversion Goals](https://help.moengage.com/hc/en-us/articles/4411175043220#01GN9507KJVE9R0GF3V761ZJRM): Choose the conversion goals and revenue metrics to be tracked for the campaign.
- [Delivery Controls](https://help.moengage.com/hc/en-us/articles/4411175043220#01FXMSYQ4W0E8MH1DADE6GBCJ3): Choose the advanced delivery control options such as throttling, frequency capping, and expiration settings for the notification.
...
<img alt="OneTime_SendASAP.png" src="/images/moengage_b67b0a.png" />
...
<img alt="at specific date and time.png" src="/images/moengage_927c16.png" />
...
<img alt="periodic connector campain.png" src="/images/moengage_dc48bd.png" />
...
<img alt="DT_ActiveContinously.png" src="/images/moengage_9d2f6d.png" />
...
*<img alt="ConVErsionGoals.png" src="/images/moengage_0b93ec.png" />*
...
|  |  |
| --- | --- |
| With MoEngage, you can track the revenue generated by your campaigns. For example, you can track the revenue generated by your product after sending a communication. To track revenue performance, enable the **Revenue performance** toggle for the conversion goal for which you want to track the revenue.  In the example here, to track revenue for *orderSuccessful* events, you must enable the **Revenue performance** toggle. | <img alt="TrackingRevenuePerformance.png" src="/images/moengage_0c9518.png" /> |

|  |  |
| --- | --- |
| After choosing the goal, you can select the numeric attribute that captures the order's total monetary value. In this example, *cartValue* contains the total order value. You can choose the currency in which your monetary value is being reported. | <img alt="RevenuePerformance.png" src="/images/moengage_a3b2f5.png" /> |

|  |  |
| --- | --- |
| **Set Attribution window**: You can set an attribution window (a time period or window that is calculated since the user has received/clicked the campaign, for which you want to attribute the conversion goals to a specific campaign.) The default duration is set for 36 hours while the maximum attribution window can be set up to 10 days. In the example below, the attribution window is set to 5 hours. | **<img alt="attributionwindow5hrs.png"  src="/images/moengage_b1886d.png"  />** |
