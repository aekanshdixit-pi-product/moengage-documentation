...
- [Publish a test campaign to yourself](https://help.moengage.com/hc/en-us/articles/25306820413844#h_01HTWMMAYG6CXV7ZB9Y3YDDC91)
- [Compliance check](https://help.moengage.com/hc/en-us/articles/25306820413844#h_01HSW8TF3QPCRSAP7QDVDV171P)
- [SSL-branded links verification](https://help.moengage.com/hc/en-us/articles/25306820413844#h_01HW7VAE3T8MVH7Y0WVGG03TYP)
- [Test the unsubscribe link](https://help.moengage.com/hc/en-us/articles/25306820413844#h_01JP7ERE671H8DFH8V5R3VJP2Z)
- [Stats validation](https://help.moengage.com/hc/en-us/articles/25306820413844#h_01HSW9GTY5SRWZH6CBF1HYY4Y2)

## Publish a Test Campaign to Yourself

To perform any test (such as authentication test, Unsubscribe Link test, stats validation) to verify email settings, you must publish a test email campaign to yourself first. To send a test email campaign to yourself, perform the following steps:

1. On the sidebar menu in MoEngage, hover over the **Segment** menu item <img alt="Screenshot 2025-06-16 at 3.25.14 PM.png"  src="/images/moengage_7b35b3.png"  /> . The **Segment** menu appears.
2. Click **User Imports**.  
    <img alt="user imports nw.png"  src="/images/moengage_93f42e.png"  />
3. On the User imports page, click **Import users**.
4. Upload a CSV file with your email address.
   ...
   - You must select **Anonymous users** under **Select user type** while uploading a CSV file. For more information, refer to [Import User Data](https://help.moengage.com/hc/en-us/articles/19192630201620).  
      <img alt="anonymous user.png" src="/images/moengage_4f5a81.png" />
   - Under **Map columns**, you must map the **Email** column with the existing profile attribute **Email (Standard)**.  
      <img alt="map email.png" src="/images/moengage_cc2671.png" />
5. Create a custom segment and save it as **test\_email\_settings**. For more information, refer to [Custom Segments](https://help.moengage.com/hc/en-us/articles/206528613).
6. Create a test email campaign and send it to the custom segment created above. For more information, refer to [Create Email Campaign](https://help.moengage.com/hc/en-us/articles/360059171891).
...
To publish a test campaign yourself, refer to the above [section](https://help.moengage.com/hc/en-us/articles/25306820413844#h_01HTWMMAYG6CXV7ZB9Y3YDDC91).
...
<img alt="Auth 1.png" src="/images/moengage_178c5c.png" />
...
<img alt="Link Branding.png" src="/images/moengage_523650.png" />
...
- If you have used the replacement tags, the unsubscribe link must be within the email body. Otherwise, it will be outside the email body as shown in the following image:  
   <img alt="Screenshot 2024-06-19 at 16.14.54.png" src="/images/moengage_cc7ef4.png" />
...
- Go back to the MoEngage UI and verify if:
  - Unsubscribe is tracked in the [stats](https://help.moengage.com/hc/en-us/articles/25306820413844#h_01HSW9GTY5SRWZH6CBF1HYY4Y2).
...
<img alt="campign.png" src="/images/moengage_46d9cf.png" />
