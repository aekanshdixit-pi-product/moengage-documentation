...
sidebarTitle: "HTML In-App Templates"
---
...
- Use HTML templates for showing pop-ups inside your mobile apps. This will unlock features like surveys, lead gen, spin the wheel, and so on with In-App campaigns. Sample templates are available [here](https://help.moengage.com/hc/en-us/articles/4405363290004-Sample-HTML-In-app-templates).
...
<img alt="ContentCreation_InAppCampaigns.png" src="/images/moengage_ed8a39.png" />
...
1. [Survey Templates](#h_01HHKG3XB2EV39KWZM4012DN6W)
2. [Popup-Promotional](#h_01HHKG3822GEQXXT7GCBPTS7KF)
3. [FullScreen- Lead Gen](#h_01HHKG3822HRXFTBD9Y61G6Z1H)
4. [FullScreen- Carousel](#h_01HHKG3822JTBQYSB6Y5RHNDN0)
5. [Gamification Templates - Spin the Wheel and Scratch Card](https://help.moengage.com/hc/en-us/articles/14835890022804-Gamification-templates-)
...
1. [Popup Survey Template](#01HHPFTVGWMPRYSF8TWE0AX1E3)
2. [Survey Popup and Emoji](#h_01HHPFWQYKGC9YXTR12TE38N6P)
3. [Survey popup- Radio buttons with emoji](#h_01HHPFYEDB5VKHCWN663NQ7C5A)
4. [Survey popup - Multi Screen](#h_01HHPG0QGJ23460X768W1PHDBH)
5. [Survey popup - NPS Slider](#h_01HHPG2TFT9F6K0YZQFD82JXKR)

<img alt="Screenshot 2023-12-15 at 12.17.06 PM.png" src="/images/moengage_f8055b.png" />
...
<img alt="Popup-Survey_portrait.png"  src="/images/moengage_e1062d.png"  />

The HTML code for this template is pre-populated in the 'Code View' section of content creation as shown below.

<img alt="Popup_Survey.png" src="/images/moengage_9811d9.png" />
...
<img alt="PopupSurvey_TrackEvent.png" src="/images/moengage_95e0c0.png" />
...
```
onclick="moengage.trackClick(); moengage.trackEvent('MOE\_RESPONSE\_SUBMITTED',{survey\_response: document.querySelector('input[name=customRadio]:checked').value},{},{},false,true);
```
...
<img alt="DataTracking.png" src="/images/moengage_6a9264.png" />
...
<img alt="Screenshot 2023-12-15 at 12.55.53 PM.png"  src="/images/moengage_f50cbf.png"  />

The HTML code for this template is pre-populated in the 'Code View' section of content creation as shown below.

<img alt="Screenshot 2023-12-15 at 12.57.22 PM.png" src="/images/moengage_10c34d.png" />
...
<img alt="Screenshot 2023-12-15 at 1.09.32 PM.png" src="/images/moengage_8379ef.png" />
...
<img alt="Screenshot 2023-12-15 at 1.19.04 PM.png" src="/images/moengage_75f7d5.png" />

**Step 3: Change the text box heading**

You can change the heading of the text box from line number 37 to 41.

<img alt="Screenshot 2023-12-15 at 2.37.12 PM.png" src="/images/moengage_6b409f.png" />

**Step 4: Data tracking**

Clicks and data tracking have been added by default to the existing templates. If you add more buttons, make sure to add click tracking. To know more about tracking, refer to [this document.](https://developers.moengage.com/hc/en-us/articles/4409590417684-JavaScript-Bridge-for-HTML-In-Apps)
...
<img alt="Screenshot 2023-12-15 at 3.01.32 PM.png" src="/images/moengage_c7d857.png" />
...
<img alt="Screenshot 2023-12-15 at 3.05.47 PM.png"  src="/images/moengage_50cc03.png"  />
...
<img alt="Screenshot 2023-12-15 at 3.05.57 PM.png" src="/images/moengage_2f67f2.png" />
...
<img alt="Screenshot 2023-12-15 at 3.10.37 PM.png" src="/images/moengage_66bb31.png" />

**Step 2: Change the heading**

You can change the heading of the pop-up from line number 40.

<img alt="Screenshot 2023-12-15 at 3.06.16 PM.png" src="/images/moengage_a508f5.png" />
...
<img alt="Screenshot 2023-12-15 at 3.06.54 PM.png" src="/images/moengage_f937f5.png" />
...
<img alt="ezgif.com-video-to-gif-converted.gif"  src="/images/moengage_5f82cb.png"  />

You can modify each screen separately through the template's HTML code.

<img alt="Screenshot 2023-12-15 at 3.20.53 PM.png" src="/images/moengage_ae9374.png" />
...
<img alt="Screenshot 2023-12-15 at 3.24.51 PM.png" src="/images/moengage_936bcc.png" />
...
<img alt="Screenshot 2023-12-15 at 3.27.01 PM.png" src="/images/moengage_fbc67c.png" />
...
<img alt="Screenshot 2023-12-15 at 3.29.35 PM.png"  src="/images/moengage_6f45ea.png"  />

The HTML code for this template is pre-populated in the 'Code View' section of content creation as shown below. You can modify it according to your use case.

<img alt="Screenshot 2023-12-15 at 3.29.44 PM.png" src="/images/moengage_8689cf.png" />
...
<img alt="Screenshot 2023-12-15 at 3.33.09 PM.png" src="/images/moengage_4c806e.png" />

**Step 2: Change the heading**

You can change the heading of the pop-up from line number 36.

**<img alt="Screenshot 2023-12-15 at 3.35.54 PM.png" src="/images/moengage_8fb082.png" />**
...
<img alt="Screenshot 2023-12-15 at 3.34.24 PM.png" src="/images/moengage_f87d1d.png" />
...
<img alt="Popup-Promotional.png"  src="/images/moengage_80f19f.png"  />

The HTML code for this template is pre-populated in the 'Code View' section of content creation as shown below.

<img alt="Ppup_PromoCode_View.png" src="/images/moengage_c02e3c.png" />
...
<img alt="Ppup_PromoCode_View_JSBRidge.png" src="/images/moengage_cfb529.png" />
...
<img alt="LeadGenTemplate.png"  src="/images/moengage_d981c5.png"  />

The HTML code for this template is pre-populated in the 'Code View' section of content creation as shown below.

<img alt="LeadGenTemplate_PreviewCodeView.png" src="/images/moengage_219fbc.png" />
...
<img alt="LeadGen_CodeView.png" src="/images/moengage_b4c0ec.png" />
...
<img alt="Carousel.png"  src="/images/moengage_66a317.png"  />

The HTML code for this template is pre-populated in the 'Code View' section of content creation as shown below.

<img alt="CarouselTemplate.png" src="/images/moengage_621941.png" />
...
<img alt="Carousel_CodeView.png" src="/images/moengage_c92b30.png" />
...
<img alt="TmpltSettings.png"  src="/images/moengage_d51e4e.png"  />
...
- Use the [Sample HTML Templates](https://help.moengage.com/hc/en-us/articles/4405363290004-Sample-HTML-In-app-templates) provided by MoEngage. You can either directly download and upload them on MoEngage or edit them as required. These sample templates also act as references when you want to go about building your own HTML templates from scratch.
...
- For background images provided inside the HTML template as described in the image, MoEngage will not pre-fetch the URLs as these URLs are inside the template styles. **Please do not use uploaded asset URLs for the background images.** For such cases, an absolute URL is required which MoEngage SDK will download and render on runtime. For all other images, we pre-fetch the images so that when the In-app message is rendered, there is no buffer.  
   <img alt="Screen_Shot_2021-09-06_at_1.08.44_PM.png"  src="/images/moengage_df5641.png"  />
...
1. [Self-Handled](https://help.moengage.com/hc/en-us/articles/360051330591)
2. [Zip Upload](#h_01GDW5YGA7NEXWQ8SR4FBWTBX9)
3. [Custom HTML Upload](#h_01FDBP2R9GM50225ZF5ASFPXM0)

## <img alt="Custom_template_editor.png" src="/images/moengage_ae6e00.png" /> ZIP File Upload
...
Once you choose this option, a pop-up will open up where you can upload your template ZIP file   
 <img alt="Screen_Shot_2021-09-03_at_10.29.12_AM.png" src="/images/moengage_9116d5.png" />
...
When you select this option from the template selection screen of In-App campaign creation, you can directly paste your template's HTML on the MoEngage dashboard and upload assets as required. If you select this option, then you will be redirected to the code view editor, where you can paste the HTML code of your template.  
 ...
 <img alt="Screen_Shot_2021-08-31_at_10.30.19_AM.png" src="/images/moengage_d5a532.png" />
...
While creating an In-app campaign on MoEngage, you may see up to 3 different warnings as shown below -  
 <img alt="Screen_Shot_2021-09-01_at_5.05.33_PM.png" src="/images/moengage_703d37.png" />   
...
- [Product Sets](https://help.moengage.com/hc/en-us/articles/17456587985428-Catalogs)
...
<img alt="HTMLInApp.gif" src="/images/moengage_d81def.png" />
...
<img alt="Screen_Shot_2021-09-01_at_3.39.53_PM.png" src="/images/moengage_391333.png" />
...
<img alt="Screen_Shot_2021-09-01_at_3.39.43_PM.png" src="/images/moengage_5b7a0c.png" />

# Sample Templates

The sample HTML templates are available in this [article](https://help.moengage.com/hc/en-us/articles/4405363290004-Sample-HTML-In-app-templates).
...
<img alt="DeviceOrientation.png" src="/images/moengage_28ede9.png" />
...
<img alt="DeviceTypes.png" src="/images/moengage_f7f161.png" />
...
2. Above the preview of the template, click on "Copy HTML" to copy the HTML code of the selected template.   
    <img alt="Copy_HTML.png" src="/images/moengage_aa13a3.png" />
3. As a next step, click on the kebab menu to change the template.  
    <img alt="Change_template.png" src="/images/moengage_ad20e9.png" />
4. Select "Custom HTML Upload" from the Custom template editor tab  
    <img alt="Select_custom_HTML.png" src="/images/moengage_d0bedb.png" />
...
- Implementing click tracking will be necessary in this case, as it will not be included by default in the copied code. Read how to do it [here](https://developers.moengage.com/hc/en-us/articles/4409590417684-JavaScript-Bridge-for-HTML-In-Apps#track-event-0-13).
- No actions configured in the native template will be copied here automatically. They will have to be implemented at your end from scratch. For example, [here](https://developers.moengage.com/hc/en-us/articles/4409590417684-JavaScript-Bridge-for-HTML-In-Apps#navigation-actions-0-2) is how you can add code to navigate to another screen.
- You will also need to implement the close button. [Here](https://developers.moengage.com/hc/en-us/articles/4409590417684-JavaScript-Bridge-for-HTML-In-Apps#track-dismiss-0-15) is how you can do it.
...
3. Ensure to follow the guidelines mentioned in the window before uploading. Upload the file from your computer and click **Done**.  
    <img alt="2025-03-19_16-24-18 (1).gif" src="/images/moengage_02bb3f.png" />
4. Copy the font URL. To do so, click the **View uploaded** button and click **Copy URL** as shown below.  
    <img alt="Screenshot 2025-03-19 at 4.26.28 PM.png"  src="/images/moengage_948f81.png"  />
5. Add the following style within the HTML code. Use the copied font URL in the @font-face section.  
   ...
   @font-face {  src: url('assets/17423800370465841\_gy3/Pacifico.ttf'); }
   h1 {
   "Screenshot 2025-03-19 at 4.32.54 PM.png" src="/images/moengage_87e14f.png" />