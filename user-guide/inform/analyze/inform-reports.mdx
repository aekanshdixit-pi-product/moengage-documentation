...
description: "Generate aggregated performance reports for transactional alerts in MoEngage Inform. Download CSV data or automate scheduled reporting."
---
...
- [Step 1: Select alerts](/user-guide/inform/analyze/inform-reports#step-1-select-alerts)
- [Step 2: Report format and content](/user-guide/inform/analyze/inform-reports#step-2-report-format-and-content)
- [Step 3: Scheduling and delivery](/user-guide/inform/analyze/inform-reports#step-3-scheduling-and-delivery)
...
2. **Teams**: If your organization has teams enabled, select a team in the drop-down list. For more information, refer to [Teams in MoEngage](/user-guide/settings/account/team-management/teams-in-moengage).
...
2. In the **Send report** **to** section, configure when your report is delivered using the following options:
   ...
   - **Rest API**: Select this option to extract the report using the [Campaign Report API](/api/campaign-reports/download-campaign-report) of MoEngage.
3. Click **Create**.
