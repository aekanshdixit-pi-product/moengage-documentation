...
<Accordion title="How can we segment the number of messages sent through Inform?">
  ...
  2. Select **User behavior** and choose the relevant channel event (e.g., `Email Sent`, `SMS Sent`, `Notification Sent iOS, Notification Sent Andriod`, or `WhatsApp Message Sent`).
