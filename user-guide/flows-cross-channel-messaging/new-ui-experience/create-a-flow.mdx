...
4. From the resulting pop up, use one of the following options to create a flow:
   - [Using a flow template](https://help.moengage.com/hc/en-us/articles/26100424636436#h_01HZRZ46M06N20P0TVS7CPN6QF) or
   - [Start from scratch](https://help.moengage.com/hc/en-us/articles/26100424636436#01H812S21FJ8B8BGWW6P2DG9BE)
...
5. After the structure of your flow is ready, you can click **Save** to save it as a draft. To publish the flow, your next action depends on your account's settings:
   - - If the Campaign Approval workflow is disabled, you can publish the flow directly.
     ...
     - If the Campaign Approval workflow is enabled and you only have the **Create & Manage** permission, you must submit the flow for approval. For more information, refer [here](https://help.moengage.com/hc/en-us/articles/26100424636436#h_01K0E4E6XW2QY4X7HVPQMGJA1W).
...
1. [Details and goals](https://help.moengage.com/hc/en-us/articles/26100424636436#h_01HWK15KM97Q81E3AGRN9E1XB6): Define the goal of the flow and add the required details.
2. [When will users enter the flow](https://help.moengage.com/hc/en-us/articles/26100424636436#h_01HY96AJ7AZ39EWA7E6C6PD3B1): Define when the users will enter the flow.
3. [Who will enter the flow](https://help.moengage.com/hc/en-us/articles/26100424636436#h_01HWK1D8AFVM5D2B8363KM786T): Define the audience of the flow.
...
OR  
Click **Previous** to navigate to the [Details and Goals](https://help.moengage.com/hc/en-us/articles/26100424636436#h_01HWK15KM97Q81E3AGRN9E1XB6)step.
...
3. You must select the users who would review and approve your flow.
   1. In the **Start typing to filter approvers** box, search for the users (Admins or Managers) from the team you selected in the [Details and Goals](https://help.moengage.com/hc/en-us/articles/26100424636436#h_01HWK15KM97Q81E3AGRN9E1XB6) step.
...
- After making the requested changes, MoEngage can resubmit the flow by following the approval process. For more information, refer [here](https://help.moengage.com/hc/en-us/articles/26100424636436#h_01K0E4E6XW2QY4X7HVPQMGJA1W).
</Info>
