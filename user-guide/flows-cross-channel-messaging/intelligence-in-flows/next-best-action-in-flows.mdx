...
sidebarTitle: "Next Best Action in Flows"
---

The Next Best Action (NBA) option in Flows is powered by insights on user behavior gathered by Merlin AI, the machine learning module of MoEngage. NBA lets marketers engage with each user on their preferred channel at the best time to deliver the campaign for that user. For more information, refer to [Most Preferred Channel (MPC)](https://help.moengage.com/hc/en-us/articles/4414961372436) and [Best Time to Send (BTS)](https://help.moengage.com/hc/en-us/articles/4410529561108).
