...
1. 1. 1. Navigate to the All Flows Page.
      ...
      4. In the *Search user entry* search bar, select the user identifier - ID or MoEngageID in the dropdown. For more information, refer to [User Identifiers](/user-guide/data/user-data/anonymous-to-registered-user-merge).
