...
To identify the unique users who have converted, you can query for Has Executed Flow Trip Conversion with Flow ID as the attribute in segmentation. For more information, refer to [Conversion Attribution in Flows](/user-guide/campaigns-and-channels/campaign-management-and-reports/conversion-and-attribution). 
