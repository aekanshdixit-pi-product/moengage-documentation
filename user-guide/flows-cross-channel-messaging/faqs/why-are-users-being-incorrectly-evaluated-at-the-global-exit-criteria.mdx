...
description: "Resolve issues where users are incorrectly evaluated at global exit criteria in MoEngage Flows due to trigger events matching the exit conditions."
---
