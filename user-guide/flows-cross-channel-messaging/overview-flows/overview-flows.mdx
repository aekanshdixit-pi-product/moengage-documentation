...
This type of Flow listens to users' actions across different platforms and allows them to enter the flow provided they match the [Audience Definition](#h_01GENT331S7Q5QP4DJJ90RP2YM). Some of the common use cases are:
