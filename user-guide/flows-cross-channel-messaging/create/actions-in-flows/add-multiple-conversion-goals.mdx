...
description: "Set up to five conversion goals in MoEngage Flows to track intermediate steps, auxiliary events, and revenue generated from cross-channel campaigns."
---
...
Revenue Tracking is optional and non-mandatory. You can click on the Revenue performance to disable it. When the Revenue performance toggle is enabled, the Revenue and Revenue Boost metrics can be tracked from the **Stats section** as shown in the screenshot below. For information about these metrics, click [here](/user-guide/flows-cross-channel-messaging/analyze-flows/analyze-a-flow).
