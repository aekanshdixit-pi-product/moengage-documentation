...
<Tabs>
  ...
  <Tab title="RCS">
    ...
    <img alt="add rcs to flows.gif" src="/images/moengage_0ab44a.png" />
    ...
    - **Action conditions:**
      ...
      - RCS clicked 
      <img alt="rcs metrics.png" src="/images/moengage_010dcd.png" />
  ...
  <img alt="RCS failure breakdown.png" src="/images/moengage_0dda38.png" />
...
1. To copy a branch, hover over the branch to be copied and click on the copy icon  <img alt="CopyIcon.png" src="/images/moengage_ee5e85.png" /> as shown below.
   ...
   When you click on the copy icon, the following message is displayed in the lower right corner of the canvas.
   ![Copy and paste 2.png](/images/moengage_339839.png)
...
<Info>
  ...
  4. You can paste a branch that has a GoTo stage only above an exit stage.
     ![copy and paste error 2.png](/images/moengage_c89e0a.png)
</Info>
