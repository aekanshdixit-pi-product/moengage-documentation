...
The Next Best Action (NBA) option in Flows is powered by insights on user behavior gathered by Merlin AI, the machine learning module of MoEngage. NBA lets marketers engage with each user on their preferred channel at the best time to deliver the campaign for that user. For more information, refer to [Most Preferred Channel (MPC)](/user-guide/intelligence/most-preferred-channel/most-preferred-channel) and [Best Time to Send (BTS)](/user-guide/intelligence/timing/best-time-to-send).
...
<img alt="NBA_Illustration_.png"  src="/images/moengage_1f5aa4.png"  />
...
1. 1. 1. Select NBA from the stages in the Flow.
...
<img alt="NBA.png"  src="/images/moengage_a95614.png"  />
...
1. 1. 1. Number of users who have Entered and Exited
...
<img alt="NBA_Stats.png"  src="/images/moengage_424a19.png"  />
