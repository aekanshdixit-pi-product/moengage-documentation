...
2. Maximizing Engagement\
   ...
   The engagement score for the branch is 100 times the number of branch trips that have fetched a click from at least one of the action campaigns(BTC) \+ one-tenth the number of branch trips that have only fetched email opens(BTO) divided by the Total Branch Trips. **Engagement Score** **= ((BTC\+ 1/10(BTO))/Total Branch Trips)\*100**
   <Info>
