...
description: "Control user movement in MoEngage Flows with wait stages and force move options. Configure specific time frames, slots, or rolling durations for steps."
---

Flow Controls enable the marketers to control the user movement inside the Flow. Following are the flow controls:

- [Wait for/till](#wait-for/till)
- [Go to](#go-to)
...
1. Click on the plus icon and do one of the following to add the 'Wait for/till' control.
   ...
   2. Search for "Wait for/till" in the search bar & select the resulting option.
      ![Screenshot 2024-09-26 at 10.59.51 PM.png](/images/moengage_7aa6a5.png)
   3. Click **Control Flow** card in the **All stages** tab and then click **Wait for/till**.
      ![WaitStage Addition\_Category.gif](/images/moengage_19b794.png)
      <Info>
        ...
        ![image.png](/images/moengage_67c2b1.png)
      </Info>
...
<Tabs>
  <Tab title="Wait for a specific duration">
    ### Duration
    ...
    ![WaitTillDuration.png](/images/moengage_eabc8a.png)
  ...
  <Tab title="Wait for a time slot">
    ...
    **Any Day**
    ...
    ![Any\_Day.png](/images/moengage_2c1129.png)
    ...
    **Weekdays**
    ...
    ![Weekdays.png](/images/moengage_4046a5.png)
    ...
    **Weekends**
    ...
    ![Weekends.png](/images/moengage_be6100.png)
    ...
    **Day of Week**
    ...
    ![WaitTill\_TimeSlot\_DaysOfWeek.png](/images/moengage_890c06.png)
    ...
    **Specific Day(s)**
    ...
    ![WaitTill\_TimeSlot\_SpecificDays.png](/images/moengage_3360cc.png)
  ...
  <Tab title="Wait till a particular date and time">
    ...
    **Next day**
    ...
    ![WaitTill\_DateTime\_NextDay.png](/images/moengage_6bc63b.png)
    ...
    **Next `<day of the week>`**
    ...
    ![WaitTill\_DateTime\_NextDayofWeek.png](/images/moengage_bb900a.png)
    ...
    **Specific date**
    ...
    ![WaitTill\_DateTime\_SpecificDate.png](/images/moengage_317cf7.png)
...
1. Click the plus icon and do one of the following to add the Go to stage:
   ...
   2. Search for "Goto" in the search bar & select the resulting option.
      ![Screenshot 2024-09-26 at 11.03.49 PM.png](/images/moengage_ee0993.png)
   3. Click the **Control Flow** card in the **All stages** tab and then click **Goto**.
      ![GoTo Addition\_Category.gif](/images/moengage_902375.png)
      <Info>
        The five frequently used stages are displayed under the **Frequently Used** section on the **All stages** tab. The list of available stages changes dynamically based on your workspace. Click the required stage to add it to the flow.
        ![image.png](/images/moengage_67c2b1.png)
      </Info>
...
4. Search and select the destination stage on the Goto page.
   ![Screenshot\_2022-07-30\_at\_10.52.11\_PM.png](/images/moengage_368b5a.png)
