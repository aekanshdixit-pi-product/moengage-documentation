...
3. From the resulting pop up, use one of the following options to create a flow:
   - [Using Merlin AI Flows Assist](#Using-Merlin-AI-Flows-Assist) or
...
<Tabs>
  ...
  <Tab title="Reviewer">
    ...
    3. On the flow canvas page, click **Approve and Publish** on the right side. <img src="/images/moengage_f03d38.png" /> The **Approve & publish** flow pop-up window appears.
    4. In the **Add yours comment here** **(optional)** box, add the comments for the creator.
    ...
    6. On the flow canvas page,select the **Actions** button on the right side.
    7. In the **Actions** list, select **Reject**. <img src="/images/moengage_f2de7a.png" /> The **Reject the flow** pop-up window appears.
    8. In the **Add your comments here** box, you must add comments that explain why the creator needs to make edits.
    9. Click **Reject flow**. <img src="/images/moengage_53a6a9.png" /> After you reject the flow, the creator and other approvers receive an email notification with your comments.
