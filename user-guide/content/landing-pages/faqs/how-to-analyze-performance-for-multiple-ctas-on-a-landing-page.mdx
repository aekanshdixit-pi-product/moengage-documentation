...
For more information on Behavior Analysis, refer [here](/user-guide/analyze/analytics/behavior/behavior-analysis). You can analyze different *widget\_id* values to compare the performance of various buttons.
