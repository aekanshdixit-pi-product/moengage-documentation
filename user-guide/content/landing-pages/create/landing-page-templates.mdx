...
After you load the template of your choice, you can customize elements like text fields, style the images, embed links to the buttons, and capture user attributes. For more information on customizing these elements, refer to the [Landing Page Editor](/user-guide/content/landing-pages/create/landing-page-editor).