...
description: "Step-by-step guide to creating a landing page in MoEngage — define the page name and tags, design your content, then publish it for campaigns."
---
...
- **Add elements**: You can add elements to the template by clicking the <img alt="AddElement_Icon.png"  src="/images/moengage_86451e.png" style={{ display: 'inline-block'}} /> icon in the editor's left pane.
- **Add or edit styling options**: Click the <img alt="Options.png"  src="/images/moengage_31dddb.png" style={{ display: 'inline-block'}}  /> icon at the upper-right corner of an element to add the desired styling. For more information, refer to [Landing Page Editor](/user-guide/content/landing-pages/create/landing-page-editor).
- **Change the template**: To change to a different template, click the ellipsis <img alt="ellipsis.png"  src="/images/moengage_9bf49e.png" style={{ display: 'inline-block'}}  /> icon,  
...
- **Change the platform view**: Click the <img alt="PreviewOptions.png"  src="/images/moengage_039e34.png" style={{ display: 'inline-block'}}  /> icon on the left panel to preview the template. You have the following platform options:
...
3. Click the ellipsis icon ( <img alt="ellipsis.png"  src="/images/moengage_9bf49e.png" style={{ display: 'inline-block'}} /> ) next to any of your custom domains to mark it as default or delete it.
...
3. You can also **Edit**, **Duplicate**, or **Archive** the page. You can find these options by clicking the ellipses <img alt="Actions Button.png"  src="/images/moengage_1ad6a4.png" style={{ display: 'inline-block'}} /> in the last column of any created landing page. Note that opening an archived page displays a 404 message.  
