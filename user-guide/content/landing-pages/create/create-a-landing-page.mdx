...
- **Add or edit styling options**: Click the <img alt="Options.png"  src="/images/moengage_31dddb.png"  /> icon at the upper-right corner of an element to add the desired styling. For more information, refer to [Landing Page Editor](/user-guide/content/landing-pages/create/landing-page-editor).
