...
2. On the Add Coupons dialog box, attach a coupon file. Upload the CSV file containing coupons from your system. Your CSV file must have a header with _Coupon Code_. You can also [download a sample file](/images/moengage_b9a670.png) to see the format. /
