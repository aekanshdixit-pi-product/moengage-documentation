...
11. You can also deliver a test campaign to ensure end-to-end delivery before scheduling it for all users. <img src="/images/moengage_fedf4b.png" />
12. After the content setup with the coupon list is complete, click **Next** to move to step 3 of campaign setup, _Schedule and Goals_.
