...
## ![Screenshot 2025-06-17 at 12.42.57 PM.png](/images/moengage_0ce5b8.png)

## Create Catalog

To create an item catalog, follow these steps:

1. On the sidebar menu in MoEngage, hover over the **Content** menu item <img alt="content icon.png" src="/images/moengage_1da6a1.png" /> . The **Content** menu appears.
2. Click **Catalogs**.
   ![](/images/moengage_f8db06.png)
...
4. In the **Catalog name** box, type a name for the catalog.
   ![Screenshot 2025-06-17 at 12.40.42 PM.png](/images/moengage_7b3bf3.png)
5. Click **Submit**.
...
1. On the sidebar menu in MoEngage, hover over the **Content** menu item <img alt="Screenshot 2025-06-17 at 12.26.32 PM.png" src="/images/moengage_e053c0.png" /> . The **Content** menu appears.
2. Click **Catalogs**.
   ![3322.png](/images/moengage_502ea4.png)
   The Catalogs page appears.
3. Click the ellipsis icon for the desired catalog and then click **Add feed**.
   ![Screenshot 2025-06-17 at 12.48.12 PM.png](/images/moengage_512c31.png)
4. Choose one of the following feed upload options:
   1. **Manual upload:** To manually upload a CSV file, select the **Manual upload** option. Select the CSV file containing your item listings.
      ![](/images/moengage_bb4c98.png)
   2. **URL upload:** To sync your catalog file, define the file source URL of your catalog. MoEngage supports CSV, TSV, and XML files with any HTTP, HTTPS, FTP, and SFTP connection URL. You can choose from daily, weekly, or hourly sync options to keep your item information up-to-date in MoEngage. <img src="/images/moengage_0f48c1.png" />
...
2. Enter the search term associated with the unique ID, title, or description of the item you are trying to locate in the search field.
...
![Screenshot 2024-05-22 at 5.22.41 PM.png](/images/moengage_58b91c.png)
...
2. Click **Catalogs**.
   ![3322.png](/images/moengage_502ea4.png)
   The Catalogs page appears.
3. Click the specific catalog you wish to configure update alerts for.
4. On the catalog page, click **Manage alerts** in the top section. The Catalog update alerts pop-up window appears.
5. In the **Email address** field, set up the desired email addresses to subscribe for the update alerts. Please ensure to press Enter after adding each email address. You can configure a maximum of 50 email addresses.
   ![](/images/moengage_d4e0e0.png)
6. Under **Notify on**, mark the checkboxes corresponding to the desired alerts type based on the preference.
...
<Accordion title="Can we use Google Sheets to update Feeds?">
  ...
  3. Add the Google sheet with the URL params as **export?format=csv.** For example [https://docs.google.com/spreadsheets/d/Google\\\_Sheet\\\_ID/\*\*export?format=csv](https://docs.google.com/spreadsheets/d/Google\_Sheet\_ID/**export?format=csv)\*\*
</Accordion>
