...
| --- | --- | --- |
| <span style={{color: "purple"}}>**U1**</span> | <span style={{color: "green"}}>**P1**</span> | 2023-07-23 11:24:02.112 |
| <span style={{color: "purple"}}>**U1**</span> | <span style={{color: "orange"}}>**P2**</span> | 2023-07-24 12:20:05.096 |
| <span style={{color: "purple"}}>**U1**</span> | <span style={{color: "cyan"}}>**P3**</span> | 2023-08-12 04:34:34.234 |
| <span style={{color: "pink"}}>**U2**</span> | <span style={{color: "green"}}>**P1**</span> | 2023-07-05 12:30:00.090 |
| <span style={{color: "pink"}}>**U2**</span> | <span style={{color: "orange"}}>**P2**</span> | 2023-08-02 14:45:45.010 |
| <span style={{color: "teal"}}>**U3**</span> | <span style={{color: "green"}}>**P1**</span> | 2023-08-25 15:52.12.020 |
| <span style={{color: "red"}}>**U4**</span> | <span style={{color: "gold"}}>**P4**</span> | 2023-08-24 05:52.12.020 |
| <span style={{color: "red"}}>**U4**</span> | <span style={{color: "green"}}>**P1**</span> | 2023-06-24 03:25.12.020 |
| <span style={{color: "red"}}>**U4**</span> | <span style={{color: "orange"}}>**P2**</span> | 2023-07-09 06:37.25.100 |
| <span style={{color: "red"}}>**U4**</span> | <span style={{color: "deepskyblue"}}>**P5**</span> | 2023-08-04 09:35.14.080 |
| <span style={{color: "red"}}>**U4**</span> | <span style={{color: "green"}}>**P1**</span> | 2023-06-24 01:25.12.456 |
| <span style={{color: "blue"}}>**U5**</span> | <span style={{color: "orange"}}>**P2**</span> | 2023-07-14 04:15.22.030 |
| <span style={{color: "blue"}}>**U5**</span> | <span style={{color: "gold"}}>**P4**</span> | 2023-08-04 10:25.12.120 |

This can be transformed to an item-item matrix based on no of users who interacted with the items, as following:

| | <span style={{color: "green"}}>**P1**</span> | <span style={{color: "orange"}}>**P2**</span> | <span style={{color: "cyan"}}>**P3**</span> | <span style={{color: "gold"}}>**P4**</span> | <span style={{color: "deepskyblue"}}>**P5**</span> |
| --- | --- | --- | --- | --- | --- |
| <span style={{color: "green"}}>**P1**</span> | <span style={{color: "gray"}}>5</span> | 4 | 1 | 2 | 1 |
| <span style={{color: "orange"}}>**P2**</span> | 4 | <span style={{color: "gray"}}>4</span> | 1 | 2 | 1 |
| <span style={{color: "cyan"}}>**P3**</span> | 1 | 1 | <span style={{color: "gray"}}>1</span> | 0 | 0 |
| <span style={{color: "gold"}}>**P4**</span> | 2 | 2 | 0 | <span style={{color: "gray"}}>2</span> | 1 |
| <span style={{color: "deepskyblue"}}>**P5**</span> | 1 | 1 | 0 | 1 | <span style={{color: "gray"}}>1</span> |
...
| --- | --- |
| <span style={{color: "green"}}>**P1**</span> | <span style={{color: "orange"}}>**P2**</span>, <span style={{color: "gold"}}>**P4**</span>, <span style={{color: "cyan"}}>**P3**</span>, <span style={{color: "deepskyblue"}}>**P5**</span> |
| <span style={{color: "orange"}}>**P2**</span> | <span style={{color: "green"}}>**P1**</span>, <span style={{color: "gold"}}>**P4**</span>, <span style={{color: "cyan"}}>**P3**</span>, <span style={{color: "deepskyblue"}}>**P5**</span> |
| <span style={{color: "cyan"}}>**P3**</span> | <span style={{color: "green"}}>**P1**</span>, <span style={{color: "orange"}}>**P2**</span> |
| <span style={{color: "gold"}}>**P4**</span> | <span style={{color: "green"}}>**P1**</span>, <span style={{color: "orange"}}>**P2**</span>, <span style={{color: "deepskyblue"}}>**P5**</span> |
| <span style={{color: "deepskyblue"}}>**P5**</span> | <span style={{color: "green"}}>**P1**</span>, <span style={{color: "orange"}}>**P2**</span>, <span style={{color: "gold"}}>**P4**</span> |
