...
A/B testing is an experimental setup of comparing multiple variations of a landing page against each other by sending it to a set percentage of randomly chosen groups of users. This helps you to know which landing page performs better to drive your engagement metrics. You can create and test multiple variations of an entire landing page and distribute traffic among them to identify the best-performing version. For more information, refer [here](/user-guide/intelligence/ab-testing/what-is-ab-or-multivariate-testing/manual-multivariate-experiment).
