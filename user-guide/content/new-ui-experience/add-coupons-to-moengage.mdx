...
2. On the Add Coupons dialog box, attach a coupon file. Upload the CSV file containing coupons from your system. Your CSV file must have a header with *Coupon Code*. You can also [download a sample file](https://cdn.moengage.com/static-files/Sample_Coupon_File.csv) to see the format.
