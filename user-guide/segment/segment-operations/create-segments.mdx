...
<Tip>
  For advanced techniques such as nesting segment blocks within each other, aggregation operations, and object data type filtering, refer to the [Refine and Combine](/user-guide/segment/advanced-concepts/segment-nesting) section.
</Tip>
