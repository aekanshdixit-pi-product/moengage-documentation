...
<Tip>
Before you start with segmentation, do ensure that MoEngage SDK integration and Event tracking is completed for your app/website. [More details on integration in our documentation](/developer-guide).
</Tip>
