...
2. Click on **Create Segments**.\
   ...
   ![Access_affinity.gif](/images/moengage_c86caf.png)
...
4. From the drop-down list, select one of the following affinity filters:
   1. Predominantly\
      For more information, refer to [Predominantly](/User Guide/#Predominantly).
   2. Minimum of\
   ...
   4. Least no. of times\
      For more information, refer to [Top users or Bottom users](#Top Users and Bottom Users).
1. Select the attributes used with the affinity filter.
2. Click **Show Count** to show the count of users in the affinity segment.
...
![Predo_Multi.png](/images/moengage_9fd385.png)
...
![Prod_Filter.png](/images/moengage_fd8b59.png)
...
![Min_Multi.png](/images/moengage_9fddc4.png)
...
![Min_Filter.png](/images/moengage_51aea8.png)
...
![Top_Filt.png](/images/moengage_26893f.png)
