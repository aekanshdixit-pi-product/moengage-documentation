...
description: "Understand why event and user counts may differ between your data warehouse exports and the MoEngage dashboard due to event time vs server time."
---
...
<Info>
MoEngage Analytics works on unique users, whereas Exports contain raw data for all exported events. For more information, read [Analyze the Volume of Data Exports](/user-guide/data/exports/events/analyze-the-volume-of-data-exports).
</Info>
