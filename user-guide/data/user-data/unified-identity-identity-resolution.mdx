...
- Event payload: Identifiers set up in the workspace must be mentioned within the _user\_identifiers_ parameter, as shown in the below example where _moe\_mobile_ is one of the identifiers in the workspace: JSON
  ```json
  "user_identifiers":{
