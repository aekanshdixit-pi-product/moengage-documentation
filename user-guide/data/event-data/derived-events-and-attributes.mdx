...
<Info>
- Some MoEngage-tracked events or system events (e.g., App/Site opened) have device information tracked as [event attributes](/user-guide/data/event-data/derived-events-and-attributes). Such event attributes are available for analysis and segmentation.
