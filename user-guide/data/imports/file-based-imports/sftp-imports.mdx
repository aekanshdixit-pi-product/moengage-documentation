...
4. Click the **SFTP tile** and click **Continue**.
   ![SFTP\_IMports.png](/images/moengage_345d66.png)
...
In the above example, "App/Site Opened" is the Display Name of the chosen event and its Event Name is `MOE\_APP\_OPENED`, so the file names should begin with `MOE\_APP\_OPENED\_`. Refer to the [Naming Conventions](/user-guide/data/imports/overview/overview-imports) section for more information.
