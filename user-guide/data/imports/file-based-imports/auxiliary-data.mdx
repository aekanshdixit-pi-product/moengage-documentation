...
- **Save as custom segment** - This option lets you create a custom segment from the user base in the imported file. To save a custom segment:
  ...
  - Map the column that contains the user ID to facilitate custom segment creation. This column would be the ID field in the user profile of the users in MoEngage. For more information, refer to [ID in MoEngage](/user-guide/data/user-data/anonymous-to-registered-user-merge).
- **Update user profile attributes** - This option lets you update the Auxiliary data in the User Profiles of the respective users in MoEngage. To update user profile attributes:
  ...
  - Map the column that contains the user ID so that the user can be identified in MoEngage. This column would be the ID field in the user profile of the users in MoEngage. For more information, refer to [ID in MoEngage](/user-guide/data/user-data/anonymous-to-registered-user-merge).
