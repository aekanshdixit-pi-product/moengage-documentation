...
| **Is your file encrypted?** | MoEngage supports importing encrypted files. We currently support **PGP Encryption.** For more information, refer to  [How Does MoEngage Handle PGP Encryption?](https://help.moengage.com/hc/en-us/articles/21864536245396)(Link). <br />If you are importing encrypted files, select the checkbox. |
