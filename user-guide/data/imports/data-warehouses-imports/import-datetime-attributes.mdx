...
1. On the left navigation menu in the MoEngage dashboard, click **Segments**, and then click **[User Imports](/user-guide/data/imports/file-based-imports/import-user-data-using-csv)**.
