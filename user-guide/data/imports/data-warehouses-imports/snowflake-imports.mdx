...
<Accordion title="User Imports">
  <Tabs>
    <Tab title="Registered Users">
      ...
      | Updated at | MoEngage will use this column to determine which rows have been added/updated since the last sync. You need to ensure that this timestamp (date \+ time) is in UTC Timezone. The column type for this should be `TIMESTAMP\_NTZ`. <br />   For the full list of supported datetime formats, refer to this [section](/user-guide/data/imports/overview/overview-imports). |
    </Tab>
