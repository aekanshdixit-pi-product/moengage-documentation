...
5. Enter the following details:
   ...
   | **Table name** | Optional | Enter the name for the export table. If left blank, MoEngage creates a name for you with the prefix _moe\_events_.  **Note:** To avoid errors, allow MoEngage to automatically create this table. |
