...
The _PII masking_ feature enables organizations to protect sensitive information by masking personally identifiable information (PII) fields in campaign previews. This ensures that PII data, such as user and event attributes, are not exposed on the UI, aligning with privacy standards.
