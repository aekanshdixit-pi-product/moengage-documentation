...
* **Bring Your Own Key (BYOK):** Provides direct control over the master encryption key using your own AWS KMS. For more information, refer to [Bring Your Own Key (BYOK) for PII Data Encryption](#).
