...
description: "Store PII within specific regions using MoEngage dedicated data centers. Meet data residency and localization requirements for privacy compliance."
---
...
A PII DC is a specialized, physically isolated DC designed to store and process Personally Identifiable Information (PII) within a specific geographical region. This ensures that your customers' sensitive data remains within their country's borders, which helps you comply with local data residency and privacy regulations. PII DCs come into play only when there is no main DC already present in your region. For the main DCs list, please refer to this [article](/user-guide/data/key-concepts/data-centers-in-moengage).
...
For more information on working with the Bulk Import API, refer to the [Bulk Import](https://www.moengage.com/docs/api/bulk/bulk-import-users-and-events) API documentation.
