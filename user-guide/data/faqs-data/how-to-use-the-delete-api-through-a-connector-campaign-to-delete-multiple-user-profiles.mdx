...
description: "Delete multiple user profiles in MoEngage without developer help. Use the Delete API via a connector campaign with a custom user segment to bulk remove."
---
