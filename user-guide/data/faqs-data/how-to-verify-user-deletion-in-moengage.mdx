...
description: "Verify that a user profile was successfully deleted from MoEngage after calling the Delete User API. Check segmentation search and API status responses."
---
