...
| **Max number of array elements** | 100 is the maximum limit supported for the number of array elements in an Array of objects. <br /> `"product":[` <br /> `{` <br /> `"item-id": 123,` <br /> `"item-type": "books",` <br /> `"item-cost": 100,` <br /> `"item-currency": "USD"` <br /> `},` <br /> `{` <br /> `"item-id": 323,` <br /> `"item-type": "apparel",` <br /> `"item-cost": 90,` <br /> `"item-currency": "USD"` <br /> `},` <br /> `{` <br /> `"item-id": 523,` <br /> `"item-type": "food",` <br /> `"item-cost": 200,` <br /> `"item-currency": "USD"` <br /> `}` <br /> `]` The example above has three array elements. |
