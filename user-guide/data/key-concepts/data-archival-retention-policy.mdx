...
| **Anonymous (Guest) users**       | Users who: <br /> - Have an ID as an identifier, but do not have an Email ID and do not have a Mobile Number <br /> - Do not have an ID as an identifier, do not have an Email ID, and do not have a Mobile Number | **Activity:** <br /> - First Seen is \> 60 days <br /> - Does not have any custom/standard event tracked for last 60 days <br /> **Reachability:** <br /> - Not reachable on any of (Email, Push, SMS) <br /> **Campaign engagement:** <br /> - Not interacted with campaigns for the last 60 days |
