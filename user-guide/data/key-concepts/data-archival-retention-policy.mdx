...
2. **Anonymous Users** - To keep your workspace lean and focused on high-intent audiences, Anonymous profiles are archived after a shorter period of inactivity. Anonymous users are the users who either:<ul><li>Have an ID as an identifier, but do not have an Email ID, and do not have a Mobile Number</li><li>Do not have an ID as an identifier, do not have an Email ID, and do not have a Mobile Number</li></ul>
