...
sidebarTitle: "Best Time to Send"
---
...
- - [Create Push](https://help.moengage.com/hc/en-us/articles/206541583)
  - [Create Marketing Email](https://help.moengage.com/hc/en-us/articles/360059171891)
  - [Create SMS](https://help.moengage.com/hc/en-us/articles/41158071867924)
  - [Create MMS](https://help.moengage.com/hc/en-us/articles/38959417030292)
...
| Of 100 users, the users whose BTS is available: **75** | Number of users whose best time is within the BTS window (6:58 PM to 9:58 PM): **50**   |  |  | | --- | --- | | **25** users have the best time as 7 PM | The campaign will be sent at 7 PM | | **15** users have the best time as 8 PM | The campaign will be sent at 8 PM | | **10** users have the best time as 9 PM | The campaign will be sent at 9 PM | |
| Number of users whose best time lies **outside** the BTS window (6:58 PM to 9:58 PM): **25**  Depending on the option you choose under "If user’s best time is outside this time window"  - If you choose "Send message at start time or end time", let us assume   |  |  | | --- | --- | | 15 users have the best time before 7 PM | The campaign will be sent at 6:58 PM (start time) | | 10 users have the best time after 10 PM | The campaign will be sent at 9:58 PM (end time) |      - If you choose "Do not send message" then these 25 users will not be targeted |
...
The logic involves calculating the number of messages received by each user on each outbound channel (Push, SMS, or Email) and applying decay to prioritize recent messages. The total messages received by each user and the engagement metrics are summed up. Based on the engagement rate calculated for each channel at user level over the past 60 days of data, the channel with the highest engagement rate is identified and assigned as their most preferred channel.
