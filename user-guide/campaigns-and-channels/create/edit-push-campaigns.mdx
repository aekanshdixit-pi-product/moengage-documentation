...
sidebarTitle: "Edit Push Campaigns"
---
...
*<img alt="Screenshot_2020-08-04_at_1.00.17_PM.png" src="/images/moengage_2a9bed.png/Screenshot_2020-08-04_at_1.00.17_PM.png" />*
...
<img alt="ETPushCamp_Pause.png" src="/images/moengage_a67623.png/ETPushCamp_Pause.png" />
...
<img alt="ETPushCamp_Resume.png" src="/images/moengage_fd1739.png/ETPushCamp_Resume.png" />
...
1. Process the queued triggers and send them the campaign
   ...
   - To identify the delay in sending the campaign from the expected time as per the campaign schedule, we have added the "was queued" attribute to the Campaign Sent event to reflect that the delay in sending was due to the trigger being queued as the campaign was paused.  
    <img alt="Screenshot_2020-08-13_at_1.26.24_PM.png" src="/images/moengage_444f8f.png/Screenshot_2020-08-13_at_1.26.24_PM.png" />
...
|  |  |
| --- | --- |
| check\_circle | **Takeaway**  `Trigger Purged` event is generated when the notification is **finally** not sent to the user. It can happen in 2 cases:  (a)  after the paused campaign is resumed with the option to purge the queued triggers  (b) the trigger has been in the queued state for more than the queuing period (max 24 hours), and the campaign has yet to be resumed. |

<img alt="mceclip0.png" src="/images/moengage_3f8879.png/mceclip0.png" />

<Info>
1. Marketers **cannot** edit segmentation filters/types, IF/AND events and trigger delay options, add/remove variations, send type, conversion goal, and attribution window.
2. To edit the fields that are not allowed, pause the existing campaign, duplicate it, make the required changes, and then make it live.
3. If you feel we have missed anything here or you are unable to edit the fields as mentioned here, write to us at [support@moengage.com](mailto:support@moengage.com)
</Info>