...
sidebarTitle: "Key-Value Pairs in In-App Campaigns"
---
...
1. In the **Content** section of your In-App Message campaign, select a widget from the **Preview** area.
   ...
   <img alt="2024-12-13_10-58-15 (1).gif" src="/images/moengage_c5ad55.png" />
2. Scroll down to the **Actions** section. Click **+ Action**.

   <img alt="2024-12-13_11-01-57 (1).gif" src="/images/moengage_b98e5f.png" />
3. Select an action from the **Custom** list.
4. Click **+ New KV pair** to add a key-value pair to this action.

   <img alt="2024-12-13_11-04-06 (1).gif" src="/images/moengage_72547c.png" />
...
- Key: `email`, Value: `{{UserAttribute['u\_em']}}`
...
- Key: `campaignId`, Value: `promo\_2024`
...
- [Analyze In-App Campaign](https://help.moengage.com/hc/en-us/articles/360052454472-Analyze-In-app-Campaigns)