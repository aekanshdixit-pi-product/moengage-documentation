...
<Tip>
Ensure you have a fundamental understanding of MoEngage Cards before learning how to create one by reading the article [Overview - Cards](https://help.moengage.com/hc/en-us/articles/20091877135764-Overview-Cards).
</Tip>
...
1. Navigate to the MoEngage Dashboard sidebar **\>** click **+ Create new \> Campaign \>** **Inbound** **\>** click **Cards**.  
   OR  
   Navigate to the MoEngage Dashboard sidebar and select **Engage \> Campaigns** **\>** click **+ Create campaign** **\>** **Inbound** **\>** click **Cards**.  
    <img alt="navigate.gif" src="/images/moengage_c0347d.png" />
2. Enter the Campaign Name to manage and identify the campaign. The campaign name must have at least five characters, and the limit is 256.
3. Select campaign tags from the dropdown. You can select a maximum of five tags. For more information, refer to [Campaign Tags](https://help.moengage.com/hc/en-us/articles/360058057412-Campaign-Tags).
4. Check the boxes of the platform that you want to target:
   - **Android**
   - **iOS**
   - **Web**
   - **TV (Early Access)**
...
5. Based on how you want the campaign to be triggered, you can select one of the following criteria:

   One Time Event Triggered Periodic

   A **One Time** Card Campaign enables you to send the Card to a specific user segment only once as soon as possible or at a scheduled date and time.  <img alt="card one time.png" src="/images/moengage_458acc.png" />   
   You can check the **Allow Future Qualifiers** box if you want users to access the Cards after the scheduled time. For example, if the Card was scheduled to go live at 10 am on a particular day, users who visit your application at 11 am or anytime after the scheduled time will also be eligible for the Card. For more information, see [Allow Future Qualifiers](#Allow-Future-Qualifiers).
   ...
   <img alt="card on event trigger.png" src="/images/moengage_cbf13c.png" />
   ...
   <img alt="card trigger condition.png"  src="/images/moengage_9f1fa8.png"  />

   **Periodic** Campaigns help you target a specific user segment recurrently. For example, you can send a Card to encourage users to update your application once every month. <img alt="card periodic.png" src="/images/moengage_502a44.png" />
...
6. Select **All users** in the **Select Audience** section to send the campaign to all the app users.  
    <img alt="all users.png" src="/images/moengage_de491f.png" />   
   ...
   Filter by User Property Filter by User Behavior Filter by User Affinity Filter by Custom Segment
   ...
   1.  Click the **User property** tab and then select the desired attribute in the drop-down list.  
    <img alt="UserProperty.png" src="/images/moengage_c9d916.png" />
   ...
   <img alt="UserBehavior.png" src="/images/moengage_2f8d9b.png" />
   ...
   6.  Click the **+ Aggregation** button to add the aggregation functionality. For more information, refer to [Aggregation Operations](https://help.moengage.com/hc/en-us/articles/9722166234004).
   ...
   <img alt="UserAffinity.png" src="/images/moengage_d0a165.png" />
   ...
   <img alt="CustomSegment.png" src="/images/moengage_6e9d13.png" />
   ...
   <img alt="filters connector campaign.png" src="/images/moengage_565f18.png" />
...
<img alt="image (2).png" src="/images/moengage_e492ef.png" />
...
1. Click the dropdown and select your Card category.  
    <img alt="mceclip2.png" src="/images/moengage_3c9163.png" />
...
2. Click the dropdown and select the required template.  
    <img alt="TemplateType.png"  src="/images/moengage_8c0e0c.png"  />   
...
3. Manage the look and feel of your Card by configuring the various components of the Card as follows:
   - **Select background color**  
     ...
     <img alt="Cards_Msg_BGColor.png"  src="/images/moengage_86d81f.png"  />
   - **Header**
     ...
     - You can also use emojis in all the text fields.  
        <img alt="mceclip21.png"  src="/images/moengage_815f93.png"  />
   - **Message**  
     ...
     - The text limit for the Message is 115 characters. Depending on the width of the device, you can add up to three lines of text. On larger devices, more text will be visible, while on smaller ones, less text.  
        <img alt="mceclip22.png"  src="/images/moengage_05aca9.png"   />
...
- - **Card Action** (**Tap on Card would**)  
    ...
    | iOS |
    | Web | **Redirect URL** - This option takes the user to the URL when they tap on the car  <img alt="TapOnCard_Web.png"  src="/images/moengage_6061bf.png"  /> |
  - **CTA**You can also include calls to action (CTA) text on your Cards, which, when clicked, will direct the users to a particular website or link.  
    ...
    | **Platform** | **Actions** |
    | --- | --- |
    | Android | - **Navigate to a screen** - This option redirects the user to a specified screen (selected from the drop-down). Optionally, multiple Key-Value pairs can be added to take the user to specific parts of the page with relevant results. For instance, if you wish to offer discounts on Apple iPhone 11 Yellow, you need to specify the screen name as `<product purchase screen>` and send the key-value pairs (brand, Apple), (Model, iPhone 11), (Color, Yellow) so that you can display results relevant to the Card campaign. - **Deep-link** - This option takes the user to a deep-linked URL inside the app. - **Rich landing** - This option takes the user to a mobile-optimized rich landing page (Web or Mobile Web)    <Info>
You can use key-value pairs to add additional information to the deep linking or Rich landing URLs.
</Info> |
    | iOS | - **Navigate to a screen**: Redirects the user to a specified screen (selected from the dropdown). Optionally, add Key-Value pairs to navigate to specific parts of the page with relevant results. - **Deep-link**: Takes the user to a deep-linked URL inside the app. - **Rich landing**: Takes the user to a mobile-optimized rich landing page (Web or Mobile Web) |
    | Web | **Redirect URL** - This option takes the user to the URL when they tap on the car  <img alt="TapOnCard_Web.png"  src="/images/moengage_6061bf.png"  /> |
    ...
    You can test the output of your newly created Card campaign by selecting a custom attribute and its value for a test user as follows:
        ...
        <img alt="test campaign.png"  src="/images/moengage_24f46b.png"  />
    ...
    **Basic Card Template**
        ...
        <img alt="CreateView.png" src="/images/moengage_08d77b.png" />

        <img alt="AndroidPreview.png"  src="/images/moengage_173c94.png"  />

        <img alt="iOSPreview.png"  src="/images/moengage_17becd.png"  />

        <img alt="WebPreview_1.png"  src="/images/moengage_5cf9c2.png"  />

        **Illustration Card Template**

        Before Test Android iOS Web

        <img alt="Preview_IC.png" src="/images/moengage_1e06a5.png" />

        <img alt="Android_IC.png"  src="/images/moengage_fb606b.png"  />

        <img alt="iOS_IC.png"  src="/images/moengage_c0216e.png"  />

        <img alt="WebPreview_IC.png"  src="/images/moengage_6ef2db.png"  />

        You can also Click the **See in web browser** to preview the Card in the browser window as shown below:

        <img alt="see in web browser.png"  src="/images/moengage_a6a4b0.png"  />
        ...
        **Expected Result**:
        ...
        <img alt="DesktopPreview.png" src="/images/moengage_e67eb9.png" />
...
1. Under the **Send Campaign** section, select one of the following options to deliver the Card to your users:
   - **As soon as possible**
   - **At a specific date and time**The delivery process behaves differently for different trigger criteria implied on the Card as follows:
     ...
     As soon as possible At specific date and time
          ...
          <img alt="1.png" src="/images/moengage_dc0839.png" />
          ...
          <img alt="2.png" src="/images/moengage_89fe9c.png" />
     ...
     Choose this option to send the campaign periodically on a specified date and time and end it on a specific date and time. The following fields are available in this section:
          ...
          <img alt="3.png" src="/images/moengage_d1fc5f.png" />
     ...
     Choose this option to engage the right users (through segmentation) at the right time (through event triggering). The **Active continuously** option is selected by default under **Send campaign** and the following fields are available in this section:
          ...
          <img alt="5.png" src="/images/moengage_679586.png" />
     2. Under the **Display Controls** section, manage your Card display by configuring the following conditions:  

        Card Expiry The Period to Display the Card Maximum Time to Show the Card Pin Card to the top
        ...
        <img alt="mceclip28.png"  src="/images/moengage_efa191.png"  />
     ...
     The default value for Card expiry is 30 days after the Card is delivered to the user's Inbox.
        ...
        <img alt="mceclip29.png"  src="/images/moengage_8d4be4.png"  />
        ...
        <img alt="mceclip30.png"  src="/images/moengage_a6e770.png"  />
     ...
     This is an optional field. If no value is set, the Card will remain active until the expiry time.
        ...
        If you want a particular Card to get maximum user attention, then you can use the pin Card option. Select the **Pin Card to the top** option as follows:  
         <img alt="mceclip34.png" src="/images/moengage_27f25b.png" />
        ...
        <img alt="mceclip31.png"  src="/images/moengage_5e9e59.png"  />
     3. Enable the **Conversion Goal** toggle to set your conversion goals for your Card campaign.  
        ...
        *<img alt="mceclip35.png"  src="/images/moengage_2f4c4f.png"  />*   
        You can add attributes by clicking **+ New attribute**associated with the event to specify your conversion goals. In this case, *prod\_name* is the event attribute/property with the value *iPhone* which means that your application will log the users who have purchased the product with name iPhone on your application.
        ...
        We also allow you to set an attribution window which is the duration for which you want to attribute the conversion goals to a specific campaign. This duration is calculated from the time at which the user received the campaign. By default, it is set for 36 hours but you can set it to any duration lesser than 36 hours.
         ...
         <img alt="mceclip36.png"  src="/images/moengage_0a168b.png"  />   
        <Info>
...
- [Edit campaign and Show/Hide Cards](https://help.moengage.com/hc/en-us/articles/360047934612-Edit-campaign-and-Show-Hide-Cards#h_01HGDDCNGXM957G77GA6V6CE7R)
- [Analyze Card Campaign](https://help.moengage.com/hc/en-us/articles/360045424772-Analyze-Card-Campaign)