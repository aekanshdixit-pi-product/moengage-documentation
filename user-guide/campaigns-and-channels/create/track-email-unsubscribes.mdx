...
sidebarTitle: "Track Email Unsubscribes"
---
...
6. You can add the unsubscribe URL shown below to the **Unsubscribe Page URL** field. In this case, the user automatically gets unsubscribed.   
   ...
   "X" here denotes your [data center](https://help.moengage.com/hc/en-us/articles/360057030512).
...
<Info>
Each customer is hosted on a different data center. You can find your data center number (value of "X" in the Unsubscribe page URL) by checking the data center and API endpoint mapping page [here](https://help.moengage.com/hc/en-us/articles/360057030512).
...
- To include the unsubscribe link in your custom landing page, add the following HTML code in the HTML template of your email body:
  ...
  You can also [add the HTML code](https://help.moengage.com/hc/en-us/articles/360059171931) in the WYSIWYG editor. You can customize the code to align with your email template as shown in the below example.  

  ```ruby
  Want to change how you receive these emails?
  You can  __PROTECTED_13__ 
  ```
...
If a user clicks on the unsubscribe link, the service provider will manage the request. Pass this data back to MoEngage using the [Data API](https://developers.moengage.com/hc/en-us/articles/4413167462804-Track-User#h_01HRVRKZJPZ298Y83PX8V5GTWK) to update the corresponding user profile in the MoEngage dashboard.
...
Pass this data back to MoEngage using the [Data API](https://developers.moengage.com/hc/en-us/articles/4413167462804-Track-User#h_01HRVRKZJPZ298Y83PX8V5GTWK) to update the corresponding user profile in the MoEngage dashboard.

# Preference Management

If you wish to provide an option to categorically subscribe to certain kinds of email communications or select the frequency of email communications, use the [subscription categories](https://help.moengage.com/hc/en-us/articles/11053939178004-Configure-Subscription-Categories) offered by MoEngage. It is still recommended to configure the option to unsubscribe from all emails at the end of the preference management page.