...
| Nudges | A **Nudge** template is a non-intrusive message that lets users continue interacting with your app. Nudges can appear embedded in the app or at the top or bottom of the screen. Use these templates to deliver new information or promotional alerts.  **Prerequisites:** Nudges require additional SDK integration. For more information, refer [here](https://developers.moengage.com/hc/en-us/articles/4404155127828-In-App-Nativ#h_01H9MNK9J0F907RQY7TDWATFVB).  **Important:** Do not select the **On custom event** trigger criteria when creating nudges, as nudges do not work with event triggers.  To ensure in-app nudges are visible within the iOS app interface, turn on the **iOS Safe Area** toggle in the **Template Settings** section during content creation for the iOS platform, as shown in the following image:  <img alt="Screenshot showing iOS Safe Area setting"  src="/images/moengage_99a9ee.png"  /> |
...
To use GIFs in Android In-App native templates, ensure you complete the required integration steps outlined in the [Android In-App NATIV SDK documentation](https://developers.moengage.com/hc/en-us/articles/4403652537492-In-App-NATIV#gif-in-apps-0-7). The iOS platform supports GIFs by default.
...
<img alt="Screenshot showing options to set a template background image." src="/images/moengage_9594e4.png" />
...
<img alt="Screenshot showing options to set background color for a template." src="/images/moengage_5fc819.png" />
...
<Info>
Nudges are supported from InApp iOS SDK version 4.15.00 and InApp Android SDK version 7.0.0. For more information, refer to [In-App Nativ Nudges](https://developers.moengage.com/hc/en-us/articles/4403652537492-In-App-NATIV#h_01H907MZECEFCHJ2EWKZ5MHQA8).
</Info>
...
3. Fill in the following fields in the template editor to create your Nudge. As you make changes, a preview of the template displays.
   ...
   - **Buttons**
     ...
     | **+ Actions** | Click **+Action** to add a custom action. Select the action from the **Custom** dropdown list. The default action closes the nudge. For more information, refer to [Custom Actions](https://help.moengage.com/hc/en-us/articles/206184196#01FVHNN0NBZ3B86STC2CB6M6KZ). |
     ...
     <img alt="GIF showing customization of nudge template elements." src="/images/moengage_dcac37.png" />
4. Preview the template.
5. Test your campaign. For more information, refer to [Test In-App Campaigns](https://help.moengage.com/hc/en-us/articles/360047789092-Testing-In-App-Campaign#how-does-it-work--0-1).
...
3. Fill in the following fields in the template editor to create your campaign. As you make changes, a preview of the template displays.
   - **Template Settings**
     ...
     | **Template Background Image** | Select one of the following to add a background to the nudge:  - **Upload Image**: Upload an image from your computer. - **Image URL**: Add a URL from which the background image should be retrieved. - **Background Color**: Add a background color. |
     | **Animation** | **Entry Animation** | Select the animation for the nudge's entry (when the nudge first appears to the user) from the dropdown list. |
     | **Exit Animation** | Select the animation for the nudge's exit (when the nudge is dismissed or removed) from the dropdown list. |
...
4. Preview the template.
5. Test your campaign. For more information, refer to [Test In-App Campaigns](https://help.moengage.com/hc/en-us/articles/24411201041940).
6. Schedule your campaign in **Step 3**, and then publish it.
...
The SMS Sign-Up template allows you to request consent from your users to receive SMS notifications. For more information on compliance for the North America region, refer to [SMS for North America Region](https://help.moengage.com/hc/en-us/articles/7252470147092).
...
<img alt="Screenshot showing SMS Sign-Up template options." src="/images/moengage_44c043.png" />
...
4. Configure the button to receive consent.
   ...
   <img alt="Screenshot showing SMS Sign-Up template with image." src="/images/moengage_5620bb.png" />

| Field | Description |
| --- | --- |
| **Mobile Number** | Provide the mobile number used to receive consent and subscribe for notifications. |
| **Message** | Add the Opt-In keyword. For more information about keywords, refer to [Configure Subscription & Keywords](https://help.moengage.com/hc/en-us/articles/7455097552788). |
...
4. Configure the button to receive consent.
   ...
   <img alt="Screenshot showing SMS Sign-Up template without image." src="/images/moengage_27ee0e.png" />
...
<img alt="GIF showing how to personalize content using the @ symbol." src="/images/moengage_68d946.png" />
...
Configure accessibility features for your in-app messages in MoEngage to make them accessible to all users. For a comprehensive understanding of accessibility principles, refer to [Accessible Campaigns in MoEngage](https://help.moengage.com/hc/en-us/articles/20358934549140).
...
- **Using the drag-and-drop editor:** When you add an **Image** or **GIF** element to your In-App campaign, type a clear and concise description in the **Alt Text** box.
  ...
  <img alt="Screenshot showing Alt Text box for an image in the drag-and-drop editor." src="/images/moengage_39cd65.png" />
- **For native In-App templates:** In a native template, such as **Popup—Image, Text, and Button**, type alt text for images in the **Accessibility Text** box.
  ...
  <img alt="Screenshot showing Accessibility Text box for an image in a native template." src="/images/moengage_01563f.png" />
...
- **Describe your images:** Ensure your alt text accurately describes the image's content and purpose. If the image contains important text, include this in the alt text. For tips on writing effective alt text, refer to [Accessible Campaigns in MoEngage](https://help.moengage.com/hc/en-us/articles/20358934549140).
...
- **Video controls:** Add **Accessibility Text** to video controls such as **Play**, **Pause**, **Mute**, and **Unmute** buttons. This ensures all users, including those using assistive technology, can easily understand them.
  ...
  <img alt="Screenshot showing Accessibility Text field for video controls." src="/images/moengage_1805e7.png" />
...
- **Custom HTML In-App messages:** If you design in-app messages using custom HTML, ensure all interactive elements (buttons, links) are large enough for easy tapping. For general guidelines on touch target sizes, refer to [Accessible Campaigns in MoEngage](https://help.moengage.com/hc/en-us/articles/20358934549140).
