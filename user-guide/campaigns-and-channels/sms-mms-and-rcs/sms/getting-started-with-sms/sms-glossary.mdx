...
An SMS sent from the brand to the user is termed a Mobile Terminated (MT) message, as it's a message that finally reaches the user's mobile. The image below represents how the message travels from the brand to the end user's handset. <br/>
<img alt="Screenshot_2022-07-28_at_12.40.58_PM.png" src="/images/moengage_b436aa.png" /> 
**Receiving SMS - MO (Mobile Originated)**

An SMS sent from the user to the brand is termed a Mobile Originated (MO) message, as it's a message that originates from the user's mobile. The image below represents how the message travels from the user's handset to the brand.<br/> 

<img alt="Screenshot_2022-07-28_at_12.49.10_PM.png" src="/images/moengage_be90df.png" />