...
- **Preview a template**: You can preview a template by hovering over it and clicking the preview icon that appears, as shown below.
...
![Variations_Added.png](/images/moengage_bba759.png)

You can specify the user distribution for each variation by clicking **User Distribution**, available at the top right corner. For more information, refer to [A/B Testing](/user-guide/settings/account/security/overview).
