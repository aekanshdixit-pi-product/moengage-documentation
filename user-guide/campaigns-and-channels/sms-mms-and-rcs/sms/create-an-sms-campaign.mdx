...
1. Click **\+ Create new**, and then click **Campaign**. The Campaign page is displayed.
   ...
   ![SMS 1.png](/images/moengage_d3af90.png)
   ...
   ![SMS 2.png](/images/moengage_79baba.png)
...
<Tabs>
  <Tab title="All Users">
    Select this filter option to send the campaign to all app users. When you use this option, you cannot add multiple filters.<br/>
...
![6.png](/images/moengage_f2768c.png)
...
If teams are enabled for your account, you will be able to see the custom segments created by your team. The segmentation criteria specified for the team for which you are creating the campaign will get appended to the segmentation filters with an AND condition. For example, if the segmentation criteria for your team is the set of \_users whose last known city is Los Angeles_and you have selected _users who've purchased a product within the last 3 days_ as the target audience for your campaign, your target audience would be _users who have purchased a product within the last 3 days and whose last known city is Los Angeles_. For more information, refer to [Teams in MoEngage](/user-guide/settings/account/team-management/teams-in-moengage).
...
1. Select a blank template. The Content tab is displayed.
   ...
   ![ContentCreation_SMS.png](/images/moengage_5b31d8.png)
2. From the **SMS sender** list, select the SMS connector (service provider). In the case of connectors that come under DLT regulations, such as ICS, GupShup, and Kaleyra, it is mandatory to display the **Template ID** information as shown below. For more information on DLT regulations, click [here](/user-guide/campaigns-and-channels/sms-mms-and-rcs/compliance-and-deliverability/dlt-impact-on-sms).
   ...
   ![268368DA-C881-4A7A-9908-4E28D48A3861_1_201_a.jpeg](/images/moengage_4f7b07.png)
3. In the **Message** field, enter the content that is displayed in the SMS.

   ![Message.png](/images/moengage_8d9f10.png)
4. To personalize your message, enter @ in the **Message** field. The **SMS Personalization** pop-up window is displayed. For more information, refer to [Personalization](/user-guide/settings/account/security/overview).
   ...
   ![6A582B4B-1963-4498-A2E2-1692B129AD94_1_201_a.jpeg](/images/moengage_1d6adb.png)
5. In case the attribute chosen is not available for the user or there is some failure in displaying the attribute, we can select a fallback option as shown above. Select **No Fallback** if there is no alternative to the failed attribute. You can choose not to send the SMS or replace the failed attribute with a text of our choice using the **Replace text** option.\
   ...
   ![mceclip1.png](/images/moengage_2e6348.png)
...
- **Preview a template**: You can preview a template by hovering over it and clicking the <img alt="PreviewIcon__1_.png" src="/images/moengage_851e37.png" /> icon that appears, as shown below.
  ...
  ![PreviewCustomSMSTemplate.gif](/images/moengage_5295fd.png)
...
1. Special characters such as apostrophes and commas are not supported in shortened links.
2. Multiple JINJA operations are not supported in links that are to be shortened. For example, using a Content API link in a Product or vice versa (in a link that is to be shortened) is not supported.
...
<Accordion title="Tracking Revenue Performance (Optional)">
  ...
  |                                                                                                                                                                                                                                                        |                                                                        |
  | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
  | After choosing the goal, you can select the numeric attribute that captures the order's total monetary value. In this example, _cartValue_ contains the total order value. You can choose the currency in which your monetary value is being reported. | <img alt="RevenuePerformance.png" src="/images/moengage_3e07e1.png" /> |
