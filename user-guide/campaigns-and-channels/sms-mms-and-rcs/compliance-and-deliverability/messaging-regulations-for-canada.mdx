...
description: "Learn about Canada's Anti-Spam Legislation (CASL) and how it applies to SMS, MMS, and RCS marketing campaigns sent to Canadian recipients."
---
...
Fines for violating CASL can be up to 10 million per violation for businesses. Both individuals and businesses (including their directors, officers, and other agents) can be liable for violations of CASL.
...
- Send between 9 a.m. and 8 p.m. in the recipients’ local time (for SMS, MMS, RCS, and direct messages); use [Do Not Disturb for flows](/user-guide/flows-cross-channel-messaging/create/configure-flows/frequency-capping-fc-and-do-not-disturb-dnd-for-flows) to automatically prevent sending SMS, MMS, and RCS messages outside of these times
...
- Do not overload recipients with too many messages; for instance, use [Frequency Capping](/user-guide/settings/channels/delivery-controls/frequency-capping) to limit how often someone can receive messages via a certain channel
