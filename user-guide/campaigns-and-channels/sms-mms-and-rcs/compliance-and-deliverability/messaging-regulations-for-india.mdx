...
|         |                                                                                                                                                                            |
| ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| warning | **Critical**  As per the regulations, it is mandatory to register **HEADER (Sender ID) and TEMPLATES** with **All operators** to avoid rejections from the cross-operator. |