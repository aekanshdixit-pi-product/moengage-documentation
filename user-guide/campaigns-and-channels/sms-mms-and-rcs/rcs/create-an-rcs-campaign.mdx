...
1. Click **\+ Create new**, and then click **Campaign**. The Campaign page is displayed.
   ...
   ![Screenshot 2025-08-25 at 3.05.28 PM.png](/images/moengage_1dee8c.png)
   ...
   ![RCS11.png](/images/moengage_39bbe4.png)
...
- A global control group is a list of users who will not receive any of the marketing campaigns. Turn the **Global control group** toggle on to not send the campaign to all the users in the control group.
- Campaign Control Group is created by combining the user base that qualifies for the campaign. Turn the **Campaign control group** toggle on to not send the particular campaign to the control group.   For more information, refer to [Control Group](/user-guide/campaigns-and-channels/getting-started/introduction/control-groups).
...
5. Select the **Use SMS as Fallback** checkbox to ensure message delivery. MoEngage first attempts to send the message as an RCS message, and if the recipient's device or network does not support it, the message is automatically delivered via SMS. Enter the following details for your fallback SMS.
   ...
   ![Screenshot 2025-09-15 at 4.32.50 PM.png](/images/moengage_e81d0d.png)
   ...
   3. In the **Message** field, type the content to be displayed in the SMS.
      ...
      - If you selected a custom template for fallback SMS, the template will be loaded into the UI with all the field details. For more information, refer to [Create Content using Custom Templates](/user-guide/campaigns-and-channels/sms-mms-and-rcs/sms/create-an-sms-campaign#create-content-using-custom-template:~:text=Create%20Content%20Using%20Custom%20Template).
...
3. Click the edit icon adjacent to the **Personalized Preview type**. You are taken to the Personalized preview page.\
   ...
   ![RCS 8 (1).png](/images/moengage_2ea031.png)
...
<Accordion title="One Time">
  ...
  ![OneTime_SendASAP.png](/images/moengage_ed5105.png)
  ...
  ![OneTime_FixedTime.png](/images/moengage_5c2b9b.png)
</Accordion>
...
<Accordion title="Periodic">
  ...
  - **Periodic** - the periodicity of the campaign. You can choose from three options: Daily, Weekly, and Monthly, from the radio buttons available to the left of the screen.
    ...
    ![Periodic_AtFixedTime.gif](/images/moengage_9d42e6.png)
  ...
  - **Periodic** - the periodicity of the campaign. You can choose from three options: Daily, Weekly, and Monthly, from the radio buttons available to the left of the screen.
    ...
    ![Periodic_SendinUserTZ.gif](/images/moengage_933279.png)
  - **Ends** - the date on which the campaign will end. The following options are available:
    - - **Never** - the campaign will be scheduled to run daily.
      - **On** - the campaign will end on the end date specified in the **End Date** field.
      - **After** - the campaign will end after the number of occurrences specified in the **occurrences** field.
  ...
  - **Periodic** - the periodicity of the campaign. You can choose from three options: Daily, Weekly, and Monthly, from the radio buttons available to the left of the screen.
    ...
    ![Periodic_Sherpa.gif](/images/moengage_5bb1e3.png)
  - **Ends** - the date on which the campaign will end. The following options are available:
    - - **Never** - the campaign will be scheduled to run daily.
      - **On** - the campaign will end on the end date specified in the **End Date** field.
      - **After** - the campaign will end after the number of occurrences specified in the **occurrences** field.
...
<Accordion title="Event Triggered">
  ...
  **When will event triggered campaigns be sent?**
  ...
  ![DT_ActiveContinously.png](/images/moengage_599a3e.png)
</Accordion>
...
<Accordion title="Tracking Revenue Performance (Optional)">
  |                                                                                                                                                                                                                                                                                                                                                                                                                                         |                                                                                |
  | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
  | With MoEngage, you can track the revenue generated by your campaigns. For example, you can track the revenue generated by your product after sending a communication. To track revenue performance, enable the **Revenue performance** toggle for the conversion goal for which you want to track the revenue.  In the example here, to track revenue for _orderSuccessful_ events, you must enable the **Revenue performance** toggle. | <img alt="TrackingRevenuePerformance.png" src="/images/moengage_0ff26b.png" /> |

  |                                                                                                                                                                                                                                                        |                                                                        |
  | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
  | After choosing the goal, you can select the numeric attribute that captures the order's total monetary value. In this example, _cartValue_ contains the total order value. You can choose the currency in which your monetary value is being reported. | <img alt="RevenuePerformance.png" src="/images/moengage_fde042.png" /> |
  ...
  **Throttling**
  ...
  ![del control.png](/images/moengage_98d487.png)
