...
description: "Find answers to frequently asked questions about RCS campaigns in MoEngage, covering setup, delivery, troubleshooting, and rich messaging tips."
---
...
- MoEngage setup: Once your CPaaS vendor has successfully created and registered your RCS Agent, the setup within the MoEngage platform is straightforward. For more information, refer to [Configure your RCS sender](/user-guide/campaigns-and-channels/sms-mms-and-rcs/rcs/getting-started-with-rcs/configure-an-rcs-sender).
- Message delivery
