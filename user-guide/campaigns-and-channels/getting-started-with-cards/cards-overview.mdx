...
<img alt="MoENgageCards.png"  src="/images/moengage_e159c3.png"  />                         <img alt="self handled.png"  src="/images/moengage_21663e.png"  />
...
To learn more, see [Push Notifications](https://developers.moengage.com/hc/en-us/articles/4403943988756-Push-Notifications).
</Info>
...
MoEngage provides a customizable and integrative App Inbox and takes care of the delivery, display, and management of the Card for users using your application on different platforms ([Android](https://developers.moengage.com/hc/en-us/articles/4403794226452-Cards#h_01H9080Q2EH6XJM7GKYH2GYKZC), [iOS](https://developers.moengage.com/hc/en-us/articles/4404058438676-Cards-in-iOS), and [Web](https://developers.moengage.com/hc/en-us/articles/9526886582292-Cards)). You can use one of the following methods to deliver the Cards to your users on your application:

Cards Inbox Self-handled Cards with SDK (Client Side) Self-handled Cards with Fetch API (Server Side)
...
|  |  |
| --- | --- |
| **Integration Effort** | Low  Requires basic integration and setting UI customization values. |
| **Cards UI** | Styling Options are available to change the Inbox (Feed) UI to set custom Fonts, theme colors, and labels to fit brand guidelines along with Basic and Illustration Cards template.  <img alt="MoENgageCards.png"  src="/images/moengage_e159c3.png"  /> |
...
| **Platforms Supported** | [Android Native](https://developers.moengage.com/hc/en-us/articles/4403794226452-Cards#h_01H9080Q2EZ23H04PKFC08Q6XQ), [iOS Native](https://developers.moengage.com/hc/en-us/articles/4404058438676-Cards-in-iOS#01H8K730YZAH5X40G1RBWCT7G7), [Web Native](https://developers.moengage.com/hc/en-us/articles/9526886582292-Cards#ui-customizations-0-6). |
...
|  |  |
| --- | --- |
| **Integration Effort** | High  Requires building custom UI and Parsing cards payload to populate UI. |
| **Cards UI** | Custom UI  <img  src="/images/moengage_ad0565.png"   /> |
| **Tracking Analytics** | SDK functions are available to track deliveries, impressions, clicks, and deletes. |
| **Ideal for** | Teams who are looking to:   - Create their custom Inbox (Feed) UI. - Create app widgets, banners, and content carousels in line with app content. |
| **Platforms Supported** | [Android Native](https://developers.moengage.com/hc/en-us/articles/4703794844820-Self-Handled-Cards), [iOS Native,](https://developers.moengage.com/hc/en-us/articles/4766926755348-Self-Handled-Cards) [Web Native,](https://developers.moengage.com/hc/en-us/articles/9611294586772-Self-Handled-Cards) [React Native,](https://developers.moengage.com/hc/en-us/articles/18392458870676-Self-Handled-Cards)[Flutter](https://developers.moengage.com/hc/en-us/articles/17392019021844-Self-Handled-Cards). |
...
| **Ideal for** | Teams who are looking to:   - Create their custom Inbox (Feed) UI. - Create app widgets, banners, and content carousels in line with app content. - Send cards payload to external systems. |
...
1. [Create a Card Campaign](https://help.moengage.com/hc/en-us/articles/360045074752-Create-a-Card-Campaign)
2. [Analyze Card Campaign](https://help.moengage.com/hc/en-us/articles/360045424772-Campaign-Info-and-Analytics)
3. [Guide for Implementing Self-handled Cards - carousel banners on app home screen](https://help.moengage.com/hc/en-us/articles/25760529945108-Banner-Carousel-Implementation-for-Android-iOS-using-Self-handled-Cards)
4. [Guide for Trigger Card Deletion through Custom Connector Campaigns](https://help.moengage.com/hc/en-us/articles/25405534788244-Trigger-Card-Deletion-through-Custom-Connector-Campaigns)
