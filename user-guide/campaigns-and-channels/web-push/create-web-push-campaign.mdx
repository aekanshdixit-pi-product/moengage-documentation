...
1. On the sidebar menu in MoEngage, hover over the **Engage** icon <img alt="Screenshot 2025-06-04 at 4.32.53 PM.png"  src="/images/moengage_d88941.png"  /> . The **Engage** menu appears.
2. Click **+ New Campaign**.  
    <img alt="1.png"  src="/images/moengage_1e1113.png"  />   
...
3. On the **New Campaign** dialog box, under **Outbound**, click **Push**.  
    <img alt="2.png"  src="/images/moengage_d17cdc.png"  />
...
|  |  |
| --- | --- |
| For business event-triggered campaigns, you can select the business event to be mapped to the campaign using the *Select business event* dropdown. The dropdown contains all the business events created in your MoEngage account. | <img alt="BusinessEvent.png" src="/images/moengage_7c29b1.png" /> |
...
<img alt="AllUsers_Segmentation.png" src="/images/moengage_026a58.png" />
...
<img alt="UserProperty.png" src="/images/moengage_79723f.png" />
...
<img alt="UserBehavior.png" src="/images/moengage_c190c2.png" />
...
<img alt="UserAffinity.png" src="/images/moengage_32befe.png" />
...
<img alt="CustomSegment.png" src="/images/moengage_512db2.png" />
...
<img alt="OtherFilterOptions.png" src="/images/moengage_cf8602.png" />
...
The various parts of a web push campaign are:  
 <img src="/images/moengage_1f2167.png" />
...
<img src="/images/moengage_854767.png" />
...
<img alt="Screenshot 2022-09-20 at 12.59.39 PM.png" src="/images/moengage_1e550b.png" />
...
**Icon Image**: This is the icon displayed in the push message. You can either select the default icon (present in Web Push settings) or upload a new image.   
 <img src="/images/moengage_a04e18.png" />
...
<img alt="TestCampaign (1).png" src="/images/moengage_b9b680.png" />
...
<img alt="OneTime_SendASAP.png" src="/images/moengage_97f5cb.png" />
...
<img alt="OneTime_FixedTime.png" src="/images/moengage_f43612.png" />
...
- **Periodic** - the periodicity of the campaign. You can choose from three options: Daily, Weekly, and Monthly, from the radio buttons available to the left of the screen.
  ...
  <img alt="Periodic_AtFixedTime.gif" src="/images/moengage_5b30ab.png" />
...
- **Periodic** - the periodicity of the campaign. You can choose from three options: Daily, Weekly, and Monthly, from the radio buttons available to the left of the screen.
  ...
  <img alt="Periodic_SendinUserTZ.gif" src="/images/moengage_87d543.png" />
- **Ends** - the date on which the campaign will end. The following options are available:
  - - **Never** - the campaign will be scheduled to run daily.
    - **On** - the campaign will end on the end date specified in the *End Date* field.
    - **After** - the campaign will end after the number of occurrences specified in the *occurrences* field.
...
- **Periodic** - the periodicity of the campaign. You can choose from three options: Daily, Weekly, and Monthly, from the radio buttons available to the left of the screen.
  ...
  <img alt="Periodic_Sherpa.gif" src="/images/moengage_be0205.png" />
- **Ends** - the date on which the campaign will end. The following options are available:
  - - **Never** - the campaign will be scheduled to run daily.
    - **On** - the campaign will end on the end date specified in the *End Date* field.
    - **After** - the campaign will end after the number of occurrences specified in the *occurrences* field.
...
<img alt="DT_ActiveContinously.png" src="/images/moengage_f2fd77.png" />
...
*<img alt="ConVErsionGoals.png" src="/images/moengage_985966.png" />*
...
|  |  |
| --- | --- |
| - **Ignore frequency capping** - Enable this toggle to ignore the frequency capping settings. For more information, refer to [Frequency Capping](https://help.moengage.com/hc/en-us/articles/15919660670356-Frequency-Capping). - **Ignore global minimum delay** - Enable this toggle to ignore the settings for the minimum delay set for Push notifications. - **Request Limit** - We support a maximum throughput of 250K requests per minute. If multiple campaigns are running in parallel, then we might not be able to support throughput for all the campaigns and campaigns might be delayed | <img src="/images/moengage_8893d5.png" /> |

This section contains the following options:

|  |  |
| --- | --- |
| - **Ignore frequency capping** - Enable this toggle to ignore the frequency capping settings. For more information, refer to [Frequency Capping](https://help.moengage.com/hc/en-us/articles/15919660670356). - **Ignore global minimum delay** - Enable this toggle to ignore the settings for the minimum delay set for Push notifications. - **Request Limit** - We support a maximum throughput of 250K requests per minute. If multiple campaigns are running in parallel, then we might not be able to support throughput for all the campaigns and campaigns might be delayed. | <img src="/images/moengage_8893d5.png" /> |
...
|  |  |
| --- | --- |
| **Expiration Settings** - let you specify an expiry value for the push notification. To set the push expiry value, enter a value in the **Expire notifications after**field. | <img src="/images/moengage_23fedb.png" /> |
