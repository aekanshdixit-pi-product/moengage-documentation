...
sidebarTitle: "Subscription Management and Keywords"
---

# Subscription Management - Overview

SMS Subscription Management enables customers to opt-in or opt-out of receiving SMS notifications. MoEngage complies with the United States SMS regulations. For more information on the regulations, refer to [SMS Regulations in the US](https://help.moengage.com/hc/en-us/articles/6182412748436).
...
For more information on adding keywords and keyword categories, refer to [Keyword Management.](https://help.moengage.com/hc/en-us/articles/7455097552788)
...
- User Import/Update feature that MoEngage provides under Segment-\>Import Users on MoEngage Dashboard. The attribute that needs to be updated is **SMS Subscription Status.** Read more about it [here.](https://help.moengage.com/hc/en-us/articles/19192630201620-Import-User-Data-Using-CSV)
- User Update APIs to send it directly from your Apps or Backend systems to MoEngage. The attribute you should update via API is moe\_sms\_subscription. Click [here](https://developers.moengage.com/hc/en-us/articles/4413167462804) for the API documentation.
...
In-App templates can be used to nudge mobile app users to sign-up for SMS; click [here](https://help.moengage.com/hc/en-us/articles/360045818091-Pre-built-In-App-Templates#sms-sign-up-template-0-14) for more information. On-Site Messaging Templates can be used to convert website visitors to SMS subscribers; click [here](https://help.moengage.com/hc/en-us/articles/360056534732-OSM-Templates-Old-Editor-#sms-sign-up-template-0-9) for more information.
...
For more information, refer to [Create SMS Campaign](https://help.moengage.com/hc/en-us/articles/41158071867924-Create-an-SMS-Campaign).
...
SMS Subscription Management settings overrule the Preference Management settings for SMS.  For more information, refer to [Preference Management for SMS](https://help.moengage.com/hc/en-us/articles/4408413593492-Overview#sms-general-settings-0-6).
...
You can view the status of users who have subscribed or have not subscribed to the SMS notifications under 'Reachability' in the User Profile. For more information on user profiles, refer to [User Profile](https://help.moengage.com/hc/en-us/articles/360044285511).
