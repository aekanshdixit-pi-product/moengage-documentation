...
sidebarTitle: "How to Avoid Common Push Notification Issues on iOS Devices Using React-Native, Swift, and MoEngage-iOS-SDK (Versions 7.x.x , 8.x.x, 9.x.x)?"
---
...
4. **Disable MoEngage Proxy**:
   - Add MoEngageAppDelegateProxyEnabled key in info.plist with the value Boolean = False/NO <img alt="boolean.png" src="/images/moengage_80ebe5.png" />
