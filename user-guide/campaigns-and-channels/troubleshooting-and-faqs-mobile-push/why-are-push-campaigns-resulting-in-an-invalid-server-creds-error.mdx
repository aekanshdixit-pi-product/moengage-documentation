...
sidebarTitle: "Why Are Push Campaigns Resulting in an INVALID_SERVER_CREDS Error?"
---
...
<img  src="/images/moengage_ea004e.png"  />
...
- Verify the **Private key file (Recommended)** on the MoEngage dashboard.
  ...
  - If you already have a private key on the Service Accounts page, you need not generate a new one. <img  src="/images/moengage_77d443.png"  />   
    <Info>
