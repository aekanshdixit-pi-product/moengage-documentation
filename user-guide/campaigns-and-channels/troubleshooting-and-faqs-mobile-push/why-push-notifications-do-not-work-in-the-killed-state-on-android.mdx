...
sidebarTitle: "Why Push Notifications Do Not Work in the Killed State on Android?"
---
...
- The most common reason is that the SDK is not initialized correctly. For more details, refer to the [SDK Initialization](https://developers.moengage.com/hc/en-us/articles/4401984811796-SDK-Initialization) documentation.
