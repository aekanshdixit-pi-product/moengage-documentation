...
sidebarTitle: "Why is the no. of emails sent lower than user segment count?"
---
...
1. 1. 1. **Segment Count** - Total number of users that belong to the segment of the campaign
      ...
      5. **After FC Removal** - Number of users obtained after removing emails that have crossed Frequency Capping as defined in the [FC Settings](https://help.moengage.com/hc/en-us/articles/15919660670356).
