...
sidebarTitle: "Connector Campaign Analytics"
---

<Info>
1. All the metrics are calculated and displayed in the App's Timezone.
2. We've revamped our Analytics and Info UI. For more information, refer to [Connector Analytics and Info](https://help.moengage.com/hc/en-us/articles/16651082488340).
</Info>
...
**Personalization Failed** occurs when one or more of event/user attributes used in request are not found for the specific user. For more information, refer to [Common Personalization Errors and FAQs](https://help.moengage.com/hc/en-us/articles/30958502449300). 
...
You can also see **Success Rate and Conversion Rate**percentage on All Campaigns page against a connector campaign. <img alt="" src="https://help.moengage.com/hc/en-us/article_attachments/211190823/Screen_Shot_2016-11-28_at_11.57.40_AM.png" />