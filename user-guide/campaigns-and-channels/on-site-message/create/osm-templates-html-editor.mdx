...
1. Configure your On-site Messaging campaign. For details, see [Create On-site Messaging Campaigns](/user-guide/campaigns-and-channels/on-site-message/create/create-osm-campaign).
