...
description: "Fix click tracking issues in MoEngage On-site Messaging campaigns by adding explicit tracking code to embedded redirection URLs in text elements."
---
