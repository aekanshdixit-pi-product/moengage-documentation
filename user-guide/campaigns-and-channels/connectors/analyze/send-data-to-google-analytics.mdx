...
| --- | --- |
| `api_secret` | **Required.**<br />An `API Secret` that is generated through the Google Analytics UI. An API Secret that is generated through the Google Analytics UI.  To create a new secret, navigate in the Google Analytics UI to:  Admin \> Data Streams \> choose your stream \> Measurement Protocol \> Create |
