...
description: "Localize MoEngage campaign messages across languages and regions using locales to boost user engagement, conversion rates, and customer loyalty."
---
...
![ScreenRecording2025-03-13at2.02.15PM-ezgif.com-video-to-gif-converter.gif](/images/moengage_f898fc.png)
...
Your administrator can add a new locale from settings. For more information, see [Locales](/user-guide/settings/advanced-settings/locales).
...
1. In **Step 2 (Content)** of campaign creation, in the upper-right corner, click **\+ Locale**.
   ...
   ![CreateLocale_Campaign.png](/images/moengage_40bbb4.png)
2. Click **\+ New Locale**.

   <img
     alt="Screenshot 2025-03-26 at 12.08.11 PM.png"
     src="/images/moengage_028cfb.png"
     style={{ width:"48%" }}
   />
3. On the **Add new locale** dialog box, enter the following details:
   ...
   | User property | Define the criteria for the locale. For example, to target users in the US who speak English, you can add _English_ as the locale language and define the _Last Known Country_ as the _US_.                                                                           |
   | \+ Filter     | Use a single attribute or a combination of attributes (AND or OR) to further define a locale.                                                                                                                                                                         |
   | Exclude Users | Select this check box and define filter criteria for users to be excluded from the campaign. For example, select it when you want to create a locale for _English Speakers in the US,_ but specifically want to exclude users who have opted out of marketing emails. |

   ![NewLocale.png](/images/moengage_72e143.png)
4. Click **Add**.
...
After you configure your locales, you can use them in your campaign messages. Follow these steps:
 ...
 5. From the list, select a locale to send messages and then click **Add**.
    ...
    <img
      alt="mceclip0.png"
      src="/images/moengage_11eda8.png"
      style={{ width:"52%" }}
    />
 ...
 6. After you add a locale, the **Choose content for new added locales** dialog box appears.
    ...
    <img
      src="/images/moengage_9974cd.png"
      style={{ width:"58%" }}
    />
 ...
 9. After you add a locale, it appears in a new tab. The selected tab is highlighted in blue. You can switch between different localized messages by clicking the tabs.
    ...
    ![Screenshot 2025-04-22 at 4.11.28 PM.png](/images/moengage_9df4fc.png)
...
12. To view users who received or clicked notifications from a specific locale in a campaign, check the segmentation with queries as shown in the following image:

    <Frame>
      ![Segments Localization](/images/Segments_Localization.png)
    </Frame>
...
MoEngage provides locale performance statistics at the campaign level. For more information, see [here](/user-guide/campaigns-and-channels/mobile-push/analyze/push-analytics-and-info#locale-and-variation-performance).
