...
- [SMS](https://help.moengage.com/hc/en-us/articles/41158071867924)
- [MMS](https://help.moengage.com/hc/en-us/articles/38959417030292-Create-an-MMS-Campaign)
- [RCS](https://help.moengage.com/hc/en-us/articles/38566548392084)
...
1. On the sidebar menu in MoEngage, hover over the **Engage** icon <img alt="Screenshot 2025-06-04 at 4.32.53 PM.png"  src="/images/moengage_cf0d0a.png"  /> . The **Engage** menu appears.
2. Click **+ New Campaign**.  
    <img alt="1.png"  src="/images/moengage_365483.png"  />   
...
<img src="/images/moengage_69fb04.png" />
</Info>
...
If the user has executed the *Added to Cart* event AND has not executed the *Product Purchased* event in the past 30 days from the *Added to Cart* event, then trigger the message. <img src="/images/moengage_9da9b3.png" />

## Configure Triggers with a Trigger Event Property

With event triggers, you can trigger the message for specified values of the *event attribute* in your *IF* event. For instance, you want to remind users who have booked a flight 2 hours before the flight time. You must create a trigger on the *Flight Booked* event using the event property *flight\_time* and set the notification to be sent 2 hours before the flight time.

To create a trigger:

In the **IF user** section, in the **Has Executed** list, click the *flight booked* event as shown below:

<img src="/images/moengage_8f4282.png" />
...
Define your target audience by selecting the **User property, User behavior,** or any of the following options as shown below. <img src="/images/moengage_c57e61.png" />
...
When creating campaigns, if the attributes in the target audience contain multiple data types, it is highly recommended to pin the data type in the data management page. Otherwise, the number of users who receive the communication could be inconsistent.  
 ...
 <img alt="Screenshot 2025-02-18 at 5.35.16 PM.png"  src="/images/moengage_f09085.png"  />
