...
sidebarTitle: "Jinja Templating Language"
---
...
To insert variables, enclose them in double braces. For example, to insert the user attribute labeled *F**irstName*:
...
For example, *U**serAttributes* is a collection of all attributes belonging to the current user. If you want to insert the value of the attribute *F**irstName*, use the following code:
...
<img alt="5d92aaf1-31be-4708-ba15-6695728879c7.png" src="/images/moengage_5965d8.png" />
...
<img alt="Screenshot 2024-11-07 at 6.38.09 PM.png" src="/images/moengage_65bc1a.png" />
...
<img alt="image (4).png" src="/images/moengage_b66539.png" />
...
<img alt="image (5).png" src="/images/moengage_4bffa4.png" />
...
\> *Usage*{{'14/10/2020'|dateFormatter('%m/%d/%Y')}}
...
> ```
\>   
\> *Usage*{{ "2012-01-19 17:21:00 CST" |dateTimeFormatter(tzOffset=-330)}}  
...
\> *Usage (where 6ABC89W3XY9W is secret key)*{{UserEmail|convertToSHA256('6ABC89P3FXYW')}}  
\>   
\> *Example*  
