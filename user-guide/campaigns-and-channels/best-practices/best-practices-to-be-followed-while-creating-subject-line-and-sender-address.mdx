...
sidebarTitle: "Best Practices to be Followed While Creating Subject Line and Sender address"
---
...
- For specific use cases, such as a policy change, you can also use the following *From name* formats, particularly if the email is signed with a person’s name:  
  ...
  - JohnDoe from Brand  
     <img alt="Screenshot 2024-04-17 at 19.39.23.png"  src="/images/moengage_e105ba.png"  />