...
sidebarTitle: "Configure Sendgrid Email Settings"
---
...
All of the following details are case-sensitive.
   ...
   | SMTP Password | Enter the password. This is the [API key created above](#h_01HTWCNVZD743JXH18AN831FZV). |
   | WebApi Key | Enter the key. This is the [API key created above](#h_01HTWCNVZD743JXH18AN831FZV). |
4. Configure **Unsubscribe Settings** based on your requirements. For more information, refer to [Track Email Unsubscribes](https://help.moengage.com/hc/en-us/articles/360059172811-Configure-Email-Channel#h_01J1SPPGFCPX2CW998XQQR205R).
5. Configure the **List unsubscribe email** settings based on your requirements. For more information, refer to [List Unsubscribe Email](https://help.moengage.com/hc/en-us/articles/24713268455060).
...
2. Use the below API to configure event webhook:  
   ...
   --header 'Authorization: Bearer API\_KEY\_GENERATE\_ABOVE' \
   --data '{
   ...
   1. Enter the API key obtained from the above [Create API Keys from SendGrid](#h_01HTWCNVZD743JXH18AN831FZV) section by replacing `API\_KEY\_GENERATE\_ABOVE` in the API.
...
For more information, refer to [Test the Email Settings](https://help.moengage.com/hc/en-us/articles/25306820413844).

# Next Steps

After your SendGrid sender is configured, you can proceed to create and send your email campaigns in MoEngage. For more information, refer to [Create Email Campaign](https://help.moengage.com/hc/en-us/articles/360059171891).