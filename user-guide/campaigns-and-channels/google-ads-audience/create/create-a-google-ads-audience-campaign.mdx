...
<Tabs>
  ...
  <Tab title="Filter by User Behavior">
    ...
    6. Click **\+ Nested Filter** to add a filter for nested AND or OR conditions. (This step is optional). For more information, see [Create Segments](https://moengage.com/docs/user-guide/segment/segment-operations/create-segments).

    ![8.png](/images/moengage_75f077.png)
  </Tab>
  <Tab title="Filter by User Affinity">
    This option targets groups of users based on a user performing an action with a specific attribute value. For more information, see [User Affinity](https://moengage.com/docs/user-guide/segment/segment-operations/create-segments). Click **User Affinity**, and do the following:
