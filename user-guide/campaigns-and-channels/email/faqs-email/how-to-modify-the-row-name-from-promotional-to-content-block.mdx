...
description: "Fix the row naming issue in MoEngage email templates where body modules appear as Promotional instead of Content Block in the Bee editor setup."
---
