...
description: "Fix ZIP upload failures in MoEngage HTML email templates by checking file size limits, naming rules, supported image formats, and folder paths."
---
