...
description: "Fix encryption or decryption failure errors in MoEngage email campaigns by passing email data in the correct encrypted format for PII protection."
---
