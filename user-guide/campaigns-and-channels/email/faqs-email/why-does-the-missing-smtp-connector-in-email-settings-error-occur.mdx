...
description: "Resolve the missing SMTP connector error when creating MoEngage email campaigns by properly configuring an email connector in channel settings."
---
