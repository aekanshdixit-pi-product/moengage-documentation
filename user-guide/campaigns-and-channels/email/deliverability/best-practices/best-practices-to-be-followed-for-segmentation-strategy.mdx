...
description: "Build a dynamic email segmentation strategy based on user engagement activity, tailored send frequency, and evolving audience performance metrics."
---
...
- [Sunset](/user-guide/campaigns-and-channels/email/getting-started-with-email/email-glossary#email-sunsetting) the inactive users. You can contact the sunset users through other channels and stop sending emails to them. They may be inactive because of the following reasons:
