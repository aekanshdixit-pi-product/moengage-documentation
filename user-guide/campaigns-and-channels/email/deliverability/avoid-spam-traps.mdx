...
- Suppress hard bounce immediately. Ensure these remain suppressed even when migrating to a different vendor. To know how to suppress hard bounce, refer [here](/user-guide/campaigns-and-channels/email/deliverability/email-delivery-rates).
