...
description: "Understand what affects your email delivery rate, from hard bounces and invalid addresses to list quality issues, and how to improve deliverability."
---
...
- **Use the [Best time to send (BTS)](/user-guide/ai-and-intelligence/timing/best-time-to-send) strategy for higher volume campaigns:** Using the BTS strategy is helpful, especially when sending high volumes infrequently. This helps optimize email delivery by increasing the chances of timely and successful email delivery, thus reducing the potential for deferrals.
