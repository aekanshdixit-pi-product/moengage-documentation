...
<Info>
- You can view the bounce error code under the *Email soft bounced* event, which is tracked under the attribute named *reason*. For a particular user, you can view this information within the **User Profile**> **Activity info** tab.  
   <img alt="Screenshot 2025-05-09 at 13.14.54.png" src="/images/moengage_587af0.png" />
- To obtain the consolidated list of error descriptions, navigate to **Analyze** > **Behaviour,** then configure the **Events & filters** as shown in the following image:  
   <img alt="Screenshot 2025-05-09 at 13.17.23.png"  src="/images/moengage_e9e51f.png"  />
