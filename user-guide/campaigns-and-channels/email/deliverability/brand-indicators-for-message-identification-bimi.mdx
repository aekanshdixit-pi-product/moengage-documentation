...
[BIMI](https://bimigroup.org/) is an emerging technology that is built on top of the [DMARC](/user-guide/campaigns-and-channels/email/getting-started-with-email/email-glossary).
