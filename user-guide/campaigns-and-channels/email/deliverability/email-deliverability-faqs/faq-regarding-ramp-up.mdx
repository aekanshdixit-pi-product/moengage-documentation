...
No, refer to the [here](/user-guide/campaigns-and-channels/email/getting-started-with-email/email-warm-up) to view the differences.
...
- Create [smaller segments](/user-guide/segment/segment-operations/create-segments) based on the daily prescribed volume.
...
Additionally, you should use [BTS](/user-guide/intelligence/timing/best-time-to-send) to send high-volume email campaigns throughout the day.