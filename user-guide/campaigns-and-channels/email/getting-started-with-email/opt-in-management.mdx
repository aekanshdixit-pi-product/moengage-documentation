...
<Tabs>
  ...
  <Tab title="New User">
      ...
      **Perform the following steps to update the opt-in status of new users:**
      ...
      3. **Create a Connector campaign**: This helps update the opt-in status of users submitting preferences in the created landing page by making an API call to the [Email Optin Management API](/user-guide/campaigns-and-channels/email/getting-started-with-email/opt-in-management#inform-is-not-enabled-and-landing-page-is-enabled) of MoEngage. Make sure to follow the points below while creating a connector campaign:
         1. Select the delivery type as **Event Triggered**.
