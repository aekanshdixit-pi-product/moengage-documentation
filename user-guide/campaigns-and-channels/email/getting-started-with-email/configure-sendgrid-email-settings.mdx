...
4. Configure **Unsubscribe Settings** based on your requirements. For more information, refer to [Track Email Unsubscribes](/user-guide/campaigns-and-channels/email/getting-started-with-email/configure-email-channel).
