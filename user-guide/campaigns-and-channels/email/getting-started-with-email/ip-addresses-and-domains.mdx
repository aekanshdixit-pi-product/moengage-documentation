...
description: "Understand IP reputation and domain setup for email marketing in MoEngage. Improve deliverability and avoid spam filters with proper configuration."
---

# IP Addresses

Your business's IP address is essential in email marketing. If your system requires IP whitelisting, refer [here](/user-guide/settings/account/security/ip-whitelisting-in-moengage).
...
| --- | --- | --- | --- |
| A | NA | < 10K/day | <ul> <li>One sub-domain for one-time, periodic, event-triggered ,and Flow campaigns </li><li> One sub-domain for transactional campaigns</li></ul> |
| B | 1/month or less | NA | <ul> <li> One sub-domain for one-time, periodic, event-triggered, and Flow campaigns </li><li> One sub-domain for transactional campaigns </li></ul> |
| C | 4/month or more | > 100K/day | <ul> <li> One sub-domain for one-time and periodic campaigns </li><li>One sub-domain for event-triggered and Flow campaigns </li><li> One sub-domain for transactional campaigns </li></ul> | 