...
<Tabs>
  ...
  <Tab title="CSV upload approach">
    ...
    5. In the **Import name** box, enter a unique name to the import.
    6. Under **Select user type**, select **Registered users**.
    7. Under **Select file**, click **upload from the computer** to upload the CSV file.
    8. Under **File preview**, click **Preview** **file**.
    9. Click **Next**. <img src="/images/moengage_8ecdb9.png" alt="Screenshot 2024-09-28 at 12.06.02 AM.png" />
    10. Check if the **User Identifier** field is mapped correctly. If not, select the column name that has the user identifier. <img src="/images/moengage_96214c.png" alt="Screenshot 2024-09-28 at 12.06.56 AM.png" />
    11. Map the column with unsubscribe status to the _Unsubscribe_ user attribute. <img src="/images/moengage_59b85a.png" alt="Screenshot 2024-09-28 at 12.08.07 AM.png" />
    12. Click **Next** and then click **Schedule Import**. <img src="/images/moengage_7286da.png" alt="Screenshot 2024-09-28 at 12.08.48 AM.png" /> After the file is processed, the status will be emailed to you. You can see the same on the User imports page.
    13. After the unsubscribe values are updated, MoEngage will drop these users as part of any future campaigns.
