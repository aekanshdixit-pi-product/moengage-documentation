...
- If self-serve for email onboarding is not enabled for your workspace, you can manage the suppression as described [here](/user-guide/campaigns-and-channels/email/getting-started-with-email/self-service-for-email-onboarding#manage-email-suppression). 
...
<AccordionGroup>
  ...
  <Accordion title="How can I audit changes made in Suppression Management?">
    To ensure complete traceability, all modifications are automatically recorded in your [Audit Logs](/user-guide/settings/account/audit-logs/audit-logs).
  </Accordion>
</AccordionGroup>  