...
description: "Enhance your MoEngage email campaigns with animated GIFs. Boost visual appeal, increase engagement, and convey emotions more effectively in emails."
---
...
2. Consider the following methods while adding GIFs to your emails:
   ...
   - **GIF Drag and Drop**: You can source GIFs from platforms like Giphy and conveniently search them on MoEngage GIFs after dragging and dropping. <img src="/images/moengage_66ffc7.png" alt="GIF from GIPHY.gif" />
   
   - **Image block usage**: Alternatively, you can utilize the image block and provide the GIF's URL for insertion.
  
   <img src="/images/moengage_95b606.png" alt="2025-03-12_14-31-20.gif" />
...
After the email content is created, you can navigate to [Step 3: Schedule and Goals](/user-guide/campaigns-and-channels/email/create/create-an-email-campaign) of the email creation journey.