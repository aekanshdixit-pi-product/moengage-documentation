...
Before starting with personalization, ensure you have [configured Email Settings](/user-guide/campaigns-and-channels/email/getting-started-with-email/configure-email-channel) and read about [how to create email campaigns](/hc/en-us/articles/206184606-Creating-Email-Campaigns/user-guide/campaigns-and-channels/email/create/create-an-email-campaign).
...
- [Personalized Images](/user-guide/campaigns-and-channels/email/create/personalize-email-content) for Cart Abandonment, Search Drop-offs, and so on
- [Personalized URLs](/user-guide/campaigns-and-channels/email/create/personalize-email-content) to increase conversions by redirecting the user to the right link

<Info>
When you create a personalization condition or logic for *Email* campaigns using the *Custom HTML Editor,* it appears as a chip. To know more about Chip Actions, refer [here](/user-guide/campaigns-and-channels/getting-started/message-personalization/dynamic-content-personalization).
</Info>
...
In business event-triggered Email campaigns, you can use the attribute of the business event that is mapped to the campaign to personalize the campaign. For more information, refer to [Personalize Business Event Triggered Campaigns](/user-guide/settings/account/security/overview).
