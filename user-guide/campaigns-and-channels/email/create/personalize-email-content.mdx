...
Before starting with personalization, ensure you have [configured Email Settings](/user-guide/campaigns-and-channels/email/getting-started-with-email/configure-email-channel) and read about [how to create email campaigns](https://help.moengage.com/hc/en-us/articles/206184606-Creating-Email-Campaigns).
