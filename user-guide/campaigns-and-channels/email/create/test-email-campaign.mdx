...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>Create a profile with this identifier. To add a profile, follow the steps mentioned <a href="/user-guide/data/imports/file-based-imports/import-user-data-using-csv" target="_blank" rel="noopener noreferrer">here</a>.</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        To have the test email sent to the chosen identifier, update the values of Hard bounce attributes to False. To do the same, follow the steps mentioned <a href="/user-guide/data/imports/file-based-imports/import-user-data-using-csv" target="_blank" rel="noopener noreferrer">here</a>.
      </td>
    </tr>
    <tr>
      <td>
