...
4. In the Edit row slide-out panel, you can:
   * Modify the row **Name**.
   * Reassign the row to a different **Category**. Alternatively, you can create a new category directly from this field and reassign the row to it simultaneously.
...
If they attempt to click or edit inside the locked row, the editor will display a toast notification: 
