...
<Tabs>
  <Tab title="If Content Block feature is enabled ">
    <Note>
  ...
  <Tab title="If Content Block feature is not enabled">
...
* **Default Categories:** Every workspace includes three default categories that cannot be modified: Header, Footer, and Promotional.
...
### Create a New Category
    <img alt="save_a_new_category.gif" src="/images/save_a_new_category.gif" width="400" />
...
MoEngage allows you to edit and delete your saved rows directly from the Drag & Drop (D&D) Editor. Any modifications you save happen in real-time and apply at the workspace level, making the updated design immediately available for all team members.
  <img alt="edit_delete_row.png" src="/images/edit_delete_row.png" width="400" />
### Edit a Row
...
Row locking permissions are governed by role access settings managed in the MoEngage **Content** permissions section:
* **Admin and Manager:** Granted Lock / Unlock Row capabilities by default.
* **Developer, Analyst, and Marketer:** Do not have lock/unlock capabilities by default.
* **Custom Roles:** Can be manually granted lock/unlock privileges. Granting a custom role the **Lock/Unlock Row** capability automatically forces the inheritance of **View**, **Create**, and **Manage & Publish** permissions for rows.
...
When a user without lock/unlock permissions (such as a Marketer) interacts with a locked row:
* They can drag, drop, and rearrange the row into their email design template.
* They cannot edit, change properties, or modify the content inside the row.

If they attempt to click or edit inside the locked row, the editor will display a toast notification: ``This module is locked by your team. Only members with "Lock/Unlock" permission can edit it. Contact your Manager or Admin to request edits.``
