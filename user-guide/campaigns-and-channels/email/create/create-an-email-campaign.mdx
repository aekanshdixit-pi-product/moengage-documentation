...
<Accordion title="Event Triggered Campaigns">
  ...
  <Info>
    If [_Portfolio_](https://help.moengage.com/hc/en-us/articles/40394603054100) is enabled for your workspace, you can create advanced event-triggered campaigns that are initiated by user actions in one project (brand) to send a message from another project (brand).
  </Info>
</Accordion>
