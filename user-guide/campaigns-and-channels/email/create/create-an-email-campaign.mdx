...
<Accordion title="Test Campaign (optional)">
  Test campaigns are a crucial step for quality assurance before campaign launch. They allow you to proactively validate the email's layout, confirm personalization accuracy across different user segments, and check all links and media. For more information, refer to Test Email Campaign.
</Accordion>
