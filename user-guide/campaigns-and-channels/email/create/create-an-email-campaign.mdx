...
|  |  |
| --- | --- |
| In the **Control groups** section:   - Turn the **Global control group** toggle on to not send the campaign to all the users in the control group - Turn the **Campaign control group** toggle on to not send the particular campaign to the control group.   For more information, refer to [Control Group](/user-guide/campaigns-and-channels/getting-started/introduction/control-groups). | <br /><img alt="mceclip10.png" src="/images/moengage_2d75fd.png" style={{ display:"inline" }} /> |
