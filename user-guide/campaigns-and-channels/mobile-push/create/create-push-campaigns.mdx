...
|  |  |
| --- | --- |
| - - **Team** -If your organization has teams enabled, select the Team in the dropdown. For more information, refer to [Teams in MoEngage](/user-guide/settings/account/team-management/teams-in-moengage).   - **Campaign name** - Type the name of the campaign to manage and identify the campaign.  The campaign name must have at least five characters, and the limit is 256.   - **Campaign tags** - Select campaign tags from the drop-down list.  You can select up to 5 tags. For more information, refer to [Campaign Tags](/user-guide/campaigns-and-channels/getting-started/introduction/campaign-tags). | <img alt="Push_CampaignDetails (1).png"  src="/images/moengage_9b0b2b.png"  /> |
...
<Info>
If *[Portfolio](/user-guide/settings/account/portfolio/portfolio)* is enabled for your workspace, you can create advanced event-triggered campaigns that are initiated by user actions in one project (brand) to send a message from another project (brand).
</Info>
...
|  |  |
| --- | --- |
| **Android** - Select this option to send campaigns only to Android devices. When this is selected, you get the following option: *Send this campaign using Push Amp+*. [Push Amp+ and Delivery Impact](/user-guide/campaigns-and-channels/mobile-push/analyze/push-amplification-plus-and-delivery-impact). | <img alt="android1.png"  src="/images/moengage_4e4d7b.png"  /> |
...
| **Web** - Select this option to send a Web Push campaign. This option is available only for One Time and Periodic Push campaigns. For more information, refer to [Web Push Campaigns.](/user-guide/campaigns-and-channels/web-push/create/create-web-push-campaign) | <img alt="web1.png"  src="/images/moengage_66948c.png"  /> |
...
| - **Enable message queuing**- Enable this toggle to automatically queue messages that are blocked by Frequency Capping or Minimum Delay. For more information, refer to [Message Queuing](/user-guide/settings/channels/delivery-controls/message-queuing).  **Note:** The [*Message Queueing*](/user-guide/settings/channels/delivery-controls/message-queuing) feature is an Early Access feature. To enable it for your account, contact your MoEngage Customer Success Manager (CSM) or the Support team. | <img alt="createpush.png" src="/images/moengage_5fb384.png" /> |
...
|  |  |
| --- | --- |
| **Last Active device** - Select the **Last Active device** checkbox to send this push campaign only to the latest active device of the target user. For more information, refer to [Primary Device Per User](/user-guide/campaigns-and-channels/mobile-push/notification-features-and-behavior/primary-device-per-user). | <img alt="createcampaign.png" src="/images/moengage_82414c.png" /> |
