...
3. **Engagement Metrics**- Two engagement metrics are tracked for your push campaigns, and they are shown below.
   ...
   | Click through Rate | The percentage ratio of total clicks for push notifications successfully sent.
   **Note**: This metric is available only when Total occurrences are chosen in the dropdown at the beginning of the Campaign Performance Stats section.  Click through rate = ((Total clicks) / (Total Impressions)) \* 100 |
...
<img src="/images/moengage_7f3abe.png" alt="Push_Locale.png" />
...
<img alt="GroupByVariation.png" src="/images/moengage_63d6d1.png" />
