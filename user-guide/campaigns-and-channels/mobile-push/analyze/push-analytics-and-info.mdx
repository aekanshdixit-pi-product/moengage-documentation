...
BTS campaigns use MoEngage's Merlin AI to estimate the best time to deliver a push campaign to a specific user based on their past engagement trends. For more information, refer to [BTS](/user-guide/intelligence/timing/best-time-to-send).
