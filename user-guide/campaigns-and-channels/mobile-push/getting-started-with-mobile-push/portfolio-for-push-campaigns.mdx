...
2. For the first rule, use the project drop-down list to select p_roject A\_ and set the condition "_Has Executed Made Purchase_." This finds your valuable customers.
...
|            |            | Device D | Reachable and opt-in status unknown (old SDK) |                                                   |                                         |
...
- **User 2:** This user is considered_Reachable\_ at the portfolio level.\
