...
| **Implementation** | Use the following implementation:  **Use case-based**: This is a trigger-based [two-step opt-in campaign](/user-guide/campaigns-and-channels/mobile-push/notification-features-and-behavior/android-push-permission-and-reachability). For example, you could set up an in-app campaign that is triggered on certain events such as the “Checkout complete” event, Thank-you screen, Upcoming events screen, and “Subscribed to program”. You can select the event trigger based on the event of your choice and add the segmentation criteria as All users. |
