...
<img src="/images/moengage_f50712.png"alt="Flight tracking" style={{ display: 'inline-block', width:"41%" }}/><img src="/images/moengage_652ba0.png" style={{display: 'inline-block', width:"34%" }}/><img src="/images/moengage_ecf8b6.png"style={{ display: 'inline-block',width:"41%" }}/>


![Flight\_tracking\_\_1\_-removebg-preview.png](/images/moengage_f50712.png)

![Games-LA.png](/images/moengage_652ba0.png)

![News-sensex (1).png](/images/moengage_ecf8b6.png)
...
<Tip>
  ...
  - Your app developers must implement the client-side logic to:
    - Enable Broadcast Live Activity token tracking. For more info, refer [here](https://developers.moengage.com/hc/en-us/articles/38663370787732-Broadcast-Live-Activity#h_01JYE038NZ63D3MAWVBYR63JFQ).
    - Define the Live Activity widgets' UI and their unique attributes-type within your app. This identifier is essential for MoEngage to target the correct widget with updates. For more info, refer [here](https://developers.moengage.com/hc/en-us/articles/38663370787732-Broadcast-Live-Activity#h_01JYE038NZ63D3MAWVBYR63JFQ).
</Tip>
...
![image.png](/images/moengage_83394c.png)
...
1. **Enable Live Activity Token Tracking**:\
   App developers are required to [enable the tracking of Push-to-Start (PTS) tokens](https://developers.moengage.com/hc/en-us/articles/38663370787732-Broadcast-Live-Activity#h_01JYE038NZ63D3MAWVBYR63JFQ). These tokens are fundamental for initiating a Live Activity through an API request.
...
- For SDK integration guides and updates on Live Activity support, refer to the [MoEngage SDK Documentation](https://developers.moengage.com/hc/en-us/articles/38663370787732-Broadcast-Live-Activity#h_01JYE038NZ63D3MAWVBYR63JFQ).
- For API guides, refer to the [Broadcast Live Activties API documents](https://developers.moengage.com/hc/en-us/sections/38536882991380-Broadcast-Live-Activities).
