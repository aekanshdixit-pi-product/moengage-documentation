...
2. Under the **Rich media** section:  
   ...
   3. In the [Test Campaigns](/user-guide/campaigns-and-channels/mobile-push/create/create-push-campaigns#test-campaigns) section, you can test your push campaigns to preview the output based on the device.
