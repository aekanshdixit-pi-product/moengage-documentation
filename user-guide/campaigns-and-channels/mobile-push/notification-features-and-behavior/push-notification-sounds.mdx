...
The importance declared in **Manage notification channel** is shown next to each channel in the campaign picker, so you can see at a glance whether a channel plays a sound: **Urgent** and **High** play a sound, while **Medium**, **Low**, and **None** are silent. This label is informational. The actual sound and vibration behavior is determined by what your developers configured for the channel in the app code. For more information, refer to [Android Push Notification Channels](/user-guide/campaigns-and-channels/mobile-push/notification-features-and-behavior/android-push-notification-channels).
