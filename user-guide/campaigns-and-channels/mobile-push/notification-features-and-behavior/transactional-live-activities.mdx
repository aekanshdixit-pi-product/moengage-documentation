...
4. Toggle the setting on or off.
   ![image.png](/images/moengage_7687c7.png)
...
- **Update (Real-Time Status)**\
  ...
  _Note:_ Even if the end user started an activity locally via the app, only you or your developer can update it via the API once the token is synced.\
