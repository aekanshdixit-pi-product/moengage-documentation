...
3. On the Campaign analytics and info page, click **Edit**.  
   ...
   You can also click the ellipsis icon <Icon icon="ellipsis-stroke-vertical" size={32} /> under the **Actions** column for the preferred campaign, and then click **Edit**.  
...
You can manage campaign versions by clicking the ellipsis icon <Icon icon="ellipsis-stroke-vertical" size={32} /> under the **Actions** column for the required campaign on the All campaigns page. The following actions are available to manage versions:
