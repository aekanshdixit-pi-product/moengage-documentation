...
description: "Configure file paths and naming conventions for MoEngage message archival exports to S3 or SFTP, with customizable attributes and directory structures."
---
...
<Tabs>
  <Tab title="S3 Bucket Archival">
    ...
    <Tabs>
      <Tab title="One-Time Campaign">
        ...
        | --- | --- |
        | Email | File Path:  `<bucket_name>/{{db_name}}/{{date}}/email/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{time}}_email.eml` |
        | SMS | File Path:  `<bucket_name>/{{db_name}}/{{date}}/sms/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{time}}_sms.json` |
        | Push - Android | File Path:  `<bucket_name>/{{db_name}}/{{date}}/push/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{time}}_push_android.json` |
        | Push - iOS | File Path:  `<bucket_name>/{{db_name}}/{{date}}/push/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{time}}_push_ios.json` |
        | Push - Web | File Path:  `<bucket_name>/{{db_name}}/{{date}}/push/<file>` |
      ...
      <Tab title="Event-Triggered and Business Event Triggered Campaign">
        ...
        | --- | --- |
        | Email | File Path:  `<bucket_name>/{{db_name}}/{{date}}/email/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{moe_event_id}}_{{time}}_email.eml` |
        | SMS | File Path:  `<bucket_name>/{{db_name}}/{{date}}/sms/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{moe_event_id}}_{{time}}_sms.json` |
        | Push - Android | File Path:  `<bucket_name>/{{db_name}}/{{date}}/push/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{moe_event_id}}_{{time}}_push_android.json` |
        | Push - iOS | File Path:  `<bucket_name>/{{db_name}}/{{date}}/push/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{moe_event_id}}_{{time}}_push_ios.json` |
        | Push - Web | File Path:  `<bucket_name>/{{db_name}}/{{date}}/push/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{moe_event_id}}_{{time}}_push_web.json` |
      </Tab>
      <Tab title="Inform Alert">
        | Channel and Platform | File Path and File Naming Convention |
        | --- | --- |
        | Email | File Path:  `<bucket_name>/{{db_name}}/{{date}}/email/<file>` |
        |  | File Name:  `{{id}}_{{alert_ID}}_{{moe_transaction_id}}_{{time}}_email.eml` |
        | SMS | File Path:  `<bucket_name>/{{db_name}}/{{date}}/sms/<file>` |
        |  | File Name:  `{{id}}_{{alert_ID}}_{{moe_transaction_id}}_{{time}}_sms.json` |
        | Push - Android | File Path:  `<bucket_name>/{{db_name}}/{{date}}/push/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{moe_transaction_id}}_{{time}}_push_android.json` |
        | Push - iOS | File Path:  `<bucket_name>/{{db_name}}/{{date}}/push/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{moe_transaction_id}}_{{time}}_push_ios.json` |
        | Push - Web | File Path:  `<bucket_name>/{{db_name}}/{{date}}/push/<file>` |
        |  | File Name:  `{{id}}_{{cid}}_{{moe_transaction_id}}_{{time}}_push_web.json` |
      </Tab>
    </Tabs>
  ...
  <Tab title="SFTP Server Archival">
    ...
    MoEngage automatically appends your workspace name (db\_name) and the date to create the final directory structure: `your_configured_base_path/{db_name}/{YYYY-MM-DD}/`
    ...
    **ZIP File Naming Convention:** `[workspace_name]_[date]_[hour]_[chunk_number].zip`
    ...
    | --- | --- |
    | `workspace_name` | The name of your MoEngage workspace (e.g., `checkfcsgain`). |
    | `date` | The date of the export in YYYY-MM-DD format. |
    | `hour` | The hour of the day (00-23) during which the export was generated. |
    | `chunk_number` | A sequential number starting from 1. If the total hourly data is under 200 MB, the chunk number will be 1. |
    ...
    <Info>
      ...
      - `checkfcsgain_2025-07-14_06_1.zip`
      - `checkfcsgain_2025-07-14_06_2.zip`
    ...
    **Inside the Archive: The Data File**
    ...
    Each JSON object represents a single archived message and begins with the `"message_content"` key.
