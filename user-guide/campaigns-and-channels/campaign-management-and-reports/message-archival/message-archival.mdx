...
<Info>
  The _View sent message_ option is exclusively available for messages archived to a MoEngage or client-owned S3 bucket, and not for those archived to an SFTP server.
</Info>
...
- Message copies are available under the _Email Sent,_ _SMS Sent, Notification Received Android, Notification Sent iOS, and Notification Received Web_ events.
...
6. When creating your own policy, specify a **Policy Name** of your choice and enter the following code into the **Policy Document** section. Be sure to replace the **INSERTSID** with your SID, **INSERTPOLICYID** with your policy ID, and **INSERTBUCKETNAME** with your bucket name.
   <Tabs>
     <Tab title="DC-01, DC-02, DC-03, and DC-04">
       <CodeGroup>
       ```json Code wrap
       {
           "Version": "2012-10-17",
