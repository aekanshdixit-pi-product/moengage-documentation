...
description: "In MoEngage email stats, unsubscribed counts display only total values. Separate total and unique breakdowns apply only to opens, clicks, and conversions."
---
