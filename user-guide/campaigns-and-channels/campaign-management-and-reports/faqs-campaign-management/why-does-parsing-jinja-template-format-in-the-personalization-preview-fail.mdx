...
description: "Resolve the Jinja template parsing error in MoEngage personalization preview. Usually caused by string operators on integers or incorrect quote usage."
---
