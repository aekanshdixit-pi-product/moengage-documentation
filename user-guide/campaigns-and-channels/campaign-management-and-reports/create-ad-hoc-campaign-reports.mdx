...
1. On the All campaigns page in the MoEngage UI, click **Export** in the upper-right side.
   ![AllCampaigns.png](/images/moengage_62da25.png)
...
2. On the Campaign reports page, click the **\+ New** **report** button in the upper-right corner.
   ![Screenshot 2025-11-09 at 9.05.34 AM.png](/images/moengage_d273a8.png)
...
5. In the **Campaigns** section, select campaigns to include in the report. You have two options:
   ...
   - **Select campaigns manually**: Choose specific campaigns to include. Use the campaign search and sorting options to find the campaigns you need.
     ![CampaignReports\_SelectCampManually.png](/images/moengage_2696ba.png)
...
2. Select a **Delivery Mode**. You can receive reports via email or extract them using APIs. For more information, see [Campaign Report API](https://www.moengage.com/docs/api/campaign-reports/download-campaign-report).
   ![Screenshot\_2021-02-10\_at\_10.08.49\_AM.png](/images/moengage_430ae4.png)
