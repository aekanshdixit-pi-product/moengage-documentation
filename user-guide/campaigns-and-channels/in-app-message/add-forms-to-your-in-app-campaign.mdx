...
sidebarTitle: "Add Forms to your In-app Campaign"
---
...
<Tip>
Ensure that you're present in Step 2 of creating content for your In-app campaign. For more information, refer to [Create In-App Campaign](https://help.moengage.com/hc/en-us/articles/206184196-Create-In-App-Campaign#01FVHNN0N9R62973S6E0JXJWJ8).
</Tip>
...
1. On the **Content** page, select one of the pre-built **Drag and drop** form templates, or create one from scratch. In this article, you will create a new registration form from scratch. Click the **Start with a blank canvas** button.
   ...
   <img alt="new form template.gif" src="/images/moengage_9ffb8a.png" />

   <Info>
Your dashboard includes the following pre-built form templates:  
 <img alt="prebuilt templates.png" src="/images/moengage_7cd020.png" />
</Info>
2. Drag the **Form** element to the desired position in the template. Then, click **Edit Form**.  
    <img alt="drag form new.gif" src="/images/moengage_09bb53.png" />
3. In the **Create form** pop-up, enter the following details:
   ...
   - **User property**: Select a user attribute to update with the value that users enter in the form. The user property updates only after users submit the form.<img alt="enter form details.gif" src="/images/moengage_2c229b.png" />   
   <Info>
...
5. Configure the appearance of the form elements in the **Content Properties** section.  
    <img alt="form format.png"  src="/images/moengage_44c4cc.png"  />
...
1. On the sidebar menu in MoEngage, hover over the **Engage** menu item <img alt="Screenshot 2025-06-04 at 4.32.53 PM.png"  src="/images/moengage_82bd34.png"  /> . The **Engage** menu appears.
2. Click **All Campaigns**.  
    <img alt="Screenshot 2025-06-17 at 4.09.44 PM.png"  src="/images/moengage_876dea.png"  />
3. From the **All Campaigns** page, select the campaign that includes the form.  
    <img alt="choose campaign.gif" src="/images/moengage_9be51c.png" />
4. Use the high-level filters, such as **Date Range**, **Attribution Type**, and **Platform**, to refine the campaign data. For more information, refer to [Analyze In-App Campaign](https://help.moengage.com/hc/en-us/articles/360052454472-Analyze-In-App-Campaign#01H816QGH2EBZ122F64RJNX4N7).  
    <img alt="global filters.png" src="/images/moengage_508d6c.png" />
5. Scroll down to the **Form Inputs** section on the **Analytics** page.  
    <img alt="scroll to form inputs.gif" src="/images/moengage_91d4d9.png" />   
   <Info>
...
6. You can view the following details:
   ...
   - **Total Rows**: Shows the total number of users who submitted a response. You can filter these users by:
     ...
     - **Name**
     - **Email**  
        **<img alt="form input filter attributes.png"  src="/images/moengage_d5d7e7.png"  />** 

       The response for each user attribute appears in the adjacent column. For example, if you select **User ID** from the list, the analytics page displays the user ID "x1z2y3" and their corresponding response "xyz@gmail.com". If you select **Name** or **Email**, the analytics displays the name or email of the users and their responses.<Info>
...
7. You can also download the CSV file that contains the user responses.  
    <img alt="download csv file form inputs.gif" src="/images/moengage_7c3dd3.png" />   
   <Warning>
...
You can upload a custom image for the close button. Then, add the *close-btn* class, as shown in the following screenshot:  
 <img alt="Screenshot 2024-09-11 at 12.25.39 PM.png" src="/images/moengage_94b849.png" />
