...
description: "Set up automatic dark and light mode switching for custom HTML in-app templates using CSS media queries and prefers-color-scheme in MoEngage."
---
