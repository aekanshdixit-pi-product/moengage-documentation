...
- Use HTML templates for showing pop-ups inside your mobile apps. This unlocks features like surveys, lead gen, spin the wheel, and more with In-App campaigns.
...
1. [Survey Templates](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#survey-templates)
2. [Popup-Promotional](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#popup-promotional-template)
3. [FullScreen- Lead Gen](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#fullscreen-lead-gen-templates)
4. [FullScreen- Carousel](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#full-screen-carousel)
5. [Gamification Templates - Spin the Wheel and Scratch Card](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-gamification-templates)
...
1. [Popup Survey Template](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#popup-survey-template)
2. [Survey Popup and Emoji](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#survey-popup-emoji-and-text-box)
3. [Survey popup- Radio buttons with emoji](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#survey-popup-radio-buttons-with-emoji)
4. [Survey popup - Multi Screen](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#survey-popup-multi-screen)
5. [Survey popup - NPS Slider](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#survey-popup-nps-slider)
...
- Use the [downloadable starter templates](#downloadable-starter-templates) provided by MoEngage. Download and upload them on MoEngage, or edit them as needed. These starter templates also act as references when you build your own HTML templates from scratch.
...
2. [Zip Upload](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#zip-file-upload)
3. [Custom HTML Upload](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates#custom-html-upload)
...
Use these starter templates as a reference when building your own HTML In-App campaigns. Download the template, edit it as needed, and upload it through the **Custom HTML Upload** option.

| Template | Use case | Download |
| --- | --- | --- |
| Carousel | Show multiple products, services, or offers with automatic scrolling. | [Download](/images/moengage_0a33e4.png) |
| Survey | Collect user interest, feedback, or opinions. | [Download](/images/moengage_204ac5.png) |
| Lead Generation | Capture email addresses, mobile numbers, or other user details. | [Download](/images/moengage_f0218b.png) |
| Promotional | Promote ongoing offers and best-selling products or services. | [Download](/images/moengage_a3ec73.png) |
| Spin the Wheel | Display an interactive gamified pop-up where users spin a wheel to claim a prize. | Refer to [HTML gamification templates](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-gamification-templates). |
| Scratch Card | Present a scratch card pop-up that users scratch to reveal a prize. | Refer to [HTML gamification templates](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-gamification-templates). |
