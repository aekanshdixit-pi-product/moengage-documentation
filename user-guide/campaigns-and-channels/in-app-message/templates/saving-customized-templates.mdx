...
description: "Save customized MoEngage in-app templates for reuse in future campaigns. Modify default templates and access saved versions from the templates section."
---
