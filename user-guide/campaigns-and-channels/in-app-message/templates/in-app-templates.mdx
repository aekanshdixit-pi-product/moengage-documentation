...
3. Fill in the following fields in the template editor to create your Nudge. As you make changes, a preview of the template displays.
   ...
   - **Buttons**
     ...
     | **+ Actions** | Click **+Action** to add a custom action. Select the action from the **Custom** dropdown list. The default action closes the nudge. For more information, refer to [Custom Actions](/user-guide/campaigns-and-channels/in-app-message/create/create-in-app-campaign). |
