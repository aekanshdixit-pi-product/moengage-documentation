...
4. **Copy Coupon Code**: This action allows you to add a Coupon code to a content block. When the user clicks on the content block, the coupon code will get copied in their keyboard. You can also add some personalization to this attribute.
   ![](/images/moengage_5e9f49.png)
5. **Call**: You can now call a user as soon as they click on on the content block you assigned this attribute to. Enter the _Mobile No._ to do so.
   ![](/images/moengage_22518b.png)
6. **SMS**: You can send a message to the user as soon as they click on your message. Enter the _Mobile No_. and the _Message_ content to send your SMS.
   ![](/images/moengage_b8b8eb.png)
...
2. Add a new row element and drag and drop the image element as shown below.
   ![2025-03-25\_17-38-51 (1).gif](/images/moengage_899dc9.png)
3. Click the image element and enter the URL for your image in the **Url** field as shown below.
   ![2025-03-25\_17-43-41 (1).gif](/images/moengage_5edddd.png)
4. Adjust the image according to your needs.
   ![2025-03-25\_17-46-39 (1).gif](/images/moengage_c64de3.png)
5. Under the **ATTRIBUTES** section, click **Add new attribute**.
6. Select _class_ and set it as _close-btn_.
   ![2025-03-25\_18-03-32 (1).gif](/images/moengage_ebe001.png)