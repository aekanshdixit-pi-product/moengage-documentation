...
description: "How self-handled in-app messages work in React Native with MoEngage, including single and multiple invocation callback handling and event order."
---
