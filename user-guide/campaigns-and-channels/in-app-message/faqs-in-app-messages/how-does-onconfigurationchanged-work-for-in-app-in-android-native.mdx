...
1. Open the [Handling Configuration](https://www.moengage.com/docs/developer-guide/android-sdk/in-app-messages/in-app-nativ) link, change, and override the code in your activity or fragment.
