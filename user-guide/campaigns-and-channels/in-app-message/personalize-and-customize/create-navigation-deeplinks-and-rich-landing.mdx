...
description: "Configure navigation actions, deep links, and rich landing pages in MoEngage in-app messages to guide users to specific screens or external content."
---
...
<Tip>
  Ensure that you are at Step 2 of creating an In-App campaign. For more information, see [Create In-App Campaign](/user-guide/campaigns-and-channels/in-app-message/create/create-in-app-campaign).
</Tip>
...
2. Scroll down to the **Actions** section, and then click **\+ Actions**.
   ![action.png](/images/moengage_919f24.png)
3. From the dropdown list, select **Navigation**.
   ![click navigation.png](/images/moengage_6249b5.png)
...
5. Select the target screen or enter the target URL.
   ![urls.gif](/images/moengage_a4b9c4.png)
6. Click **Next**.

## Understand Navigation Options

<Tabs>
  <Tab title="Navigate to Screen">
    ...
    ![navigate to screen.gif](/images/moengage_ec2a51.png)
  </Tab>
  <Tab title="Deep Link">
    ...
    ![deeplink.gif](/images/moengage_0d98e3.png)
    ...
    <Info>
    For detailed implementation steps and callback methods required to handle deep links in native (Android, iOS) and hybrid frameworks (for example, Flutter), refer to the [MoEngage Developer Documentation for In-App NATIV](/developer-guide/react-native-sdk/in-app-messages/inapp-nativ).
    </Info>
  </Tab>
  <Tab title="Rich Landing">
    ...
    ![richlanding.gif](/images/moengage_d619f6.png)
