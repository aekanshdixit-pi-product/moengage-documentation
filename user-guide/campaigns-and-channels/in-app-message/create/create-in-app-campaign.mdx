...
#### Run a campaign on TV

To deliver an In-App campaign on a TV app, select **TV** in **Target platforms** and choose the **TV OS Type** where the campaign should run. You must select at least one OS type.

<img src="/images/moengage_0910cd.png" alt="TV OS Type selection during campaign creation." />
...
When you select TV, the template selector in **Step 2** displays only TV templates. The In-App NATIV editor includes a **View in TV preview** button to show how the campaign appears on a TV screen. TV interfaces use a focus state instead of touch — use the **Focused** sub-section in the editor to set the **Font size**, **Font color**, and **Button color** that apply when a button is in focus on the remote. Action items only work on buttons in TV templates; actions added to other widgets are ignored.
...
- **Zip upload**: For more information, refer to [Zip Upload Templates](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates).
- **Custom HTML upload**: For more information, refer to [HTML In-App Templates](/user-guide/campaigns-and-channels/in-app-message/templates/html/html-in-app-templates).
...
3. Click **\+ Locales** to add a locale. You can add a maximum of 10 locales for a single campaign.\
   For more information, refer to [Using Locales](/user-guide/campaigns-and-channels/in-app-message/personalize-and-customize/using-locales-in-in-app-messages).
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                For more information, refer to <a href="/user-guide/campaigns-and-channels/in-app-message/personalize-and-customize/key-value-pairs-in-in-app-campaigns">Key-Value Pairs in In-App Campaigns</a>.
              </td>
            </tr>
            <tr>
              <td>Dismiss</td>
...
<Accordion title="Test Campaign (optional)">
  ...
  For more information about testing campaigns, refer to [Testing In-App Campaign](/user-guide/campaigns-and-channels/in-app-message/create/test-your-in-app-campaign).
</Accordion>
