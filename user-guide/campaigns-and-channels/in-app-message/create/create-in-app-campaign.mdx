...
|  |  |
| --- | --- |
| In the **Control group** section:   - Turn the **Global control group** toggle on to not send the campaign to all users in the control group. - Turn the **Campaign control group** toggle on to not send the particular campaign to the control group.   For more information, refer to [Control Group](/user-guide/campaigns-and-channels/getting-started/introduction/control-groups). | <img alt="control group.png" src="/images/moengage_4f8241.png" /> |
...
- **Ignore frequency capping**: Enable this toggle to ignore the frequency capping limit for this In-App campaign. For more information, refer to [Frequency Capping](/user-guide/settings/channels/delivery-controls/frequency-capping).  
