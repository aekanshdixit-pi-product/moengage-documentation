...
|  |  |
| --- | --- |
| In the **Control group** section: <ul><li>Turn the **Global control group** toggle on to not send the campaign to all users in the control group.</li><li>Turn the **Campaign control group** toggle on to not send the particular campaign to the control group.</li></ul> For more information, refer to [Control Group](/user-guide/campaigns-and-channels/getting-started/introduction/control-groups). | <img alt="control group.png" src="/images/moengage_4f8241.png" /> |
