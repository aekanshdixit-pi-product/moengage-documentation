...
![Screen\_Shot\_2022-08-03\_at\_4.25.30\_PM.png](/images/moengage_58ccc4.png)
...
![Screen\_Shot\_2022-08-04\_at\_1.03.43\_PM.png](/images/moengage_5bdf84.png)

| Statistics | Description |
| --- | --- |
| Conversions | Unique users who have executed primary conversion goal events within the [attributionwindow](/user-guide/settings/advanced-settings/campaign-attribution-settings) from the time the user received the WhatsApp message. |
| Conversion Events | Conversion events are the total number of primary conversion goal events within the [attributionwindow](/user-guide/settings/advanced-settings/campaign-attribution-settings) (configurable) from the time the user received the WhatsApp message. |
