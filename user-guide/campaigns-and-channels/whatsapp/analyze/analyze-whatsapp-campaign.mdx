...
| Statistics | Description |
| --- | --- |
| Conversions | Unique users who have executed primary conversion goal events within the [attributionwindow](/user-guide/settings/advanced-settings/campaign-attribution-settings#attribution-window) from the time the user received the WhatsApp message. |
| Conversion Events | Conversion events are the total number of primary conversion goal events within the [attributionwindow](/user-guide/settings/advanced-settings/campaign-attribution-settings#attribution-window) (configurable) from the time the user received the WhatsApp message. |
...
![CampaignDeliveryStats.png](/images/moengage_4f7ded.png)
...
![Screenshot 2023-09-28 at 2.00.50 PM.png](/images/moengage_64a39b.png)
