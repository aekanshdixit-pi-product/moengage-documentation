...
| Statistics | Description |
| --- | --- |
| Conversions | Unique users who have executed primary conversion goal events within the [attribution](/user-guide/settings/advanced-settings/campaign-attribution-settings) [window](/user-guide/settings/advanced-settings/campaign-attribution-settings) from the time the user received the WhatsApp message. |
| Conversion Events | Conversion events are the total number of primary conversion goal events within the [attribution](/user-guide/settings/advanced-settings/campaign-attribution-settings)[window](/user-guide/settings/advanced-settings/campaign-attribution-settings) (configurable) from the time the user received the WhatsApp message. |
