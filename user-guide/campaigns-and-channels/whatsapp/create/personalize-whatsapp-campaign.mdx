...
1. The first placeholder is used for personalization and is fetched using the _firstname_ user attribute.
...
4. Click **Done**.
   ![Screenshot 2025-09-08 at 5.22.32 PM.png](/images/moengage_cf5656.png)
...
6. Click **Done**. The Auxiliary Data JINJA will get added to the field or the editor.
   ![Screenshot 2025-09-08 at 4.49.05 PM.png](/images/moengage_af2977.png)
