...
description: "Add dynamic personalization to your MoEngage WhatsApp campaigns using user attributes, event data, and business events for more relevant messaging."
---
