...
description: "Fix auto-duplicated cards in periodic campaigns by adjusting the card expiry setting under Display Controls to prevent overlapping child campaigns."
---
