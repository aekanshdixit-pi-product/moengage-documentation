...
description: "Card sent counts are lower than push notifications because card delivery requires users to open the app. Understand this key difference in MoEngage."
---
