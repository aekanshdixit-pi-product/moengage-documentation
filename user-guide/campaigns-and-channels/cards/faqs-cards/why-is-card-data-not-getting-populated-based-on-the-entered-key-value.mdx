...
description: "Fix card data not populating by correctly configuring the Navigate to screen option with the proper link and key-value pairs in Card Action settings."
---
