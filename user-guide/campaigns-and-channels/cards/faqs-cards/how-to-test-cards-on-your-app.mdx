...
description: "Test MoEngage Cards on your app by understanding when the SDK syncs card data from the server, including triggers like app open and session start."
---
