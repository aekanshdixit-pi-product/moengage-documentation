...
<Info>
  - The MoEngage Cards Inbox is different from the MoEngage Push Notification Center. Although both serve as inboxes for content delivery, the delivery points may not be located in the same place.
  - Cards are displayed within the **Cards Inbox**, while Push notifications appear in the **Notification Inbox**. To learn more, see [Push Notifications](https://developers.moengage.com/hc/en-us/articles/4403943988756-Push-Notifications).
</Info>
...
3. [Guide for Implementing Self-handled Cards - carousel banners on app home screen](/user-guide/use-cases/cards/how-to-add-carousel-banners-on-app-home-page)
4. [Guide for Trigger Card Deletion through Custom Connector Campaigns](/user-guide/use-cases/cards/trigger-card-deletion-through-custom-connector-campaigns)
