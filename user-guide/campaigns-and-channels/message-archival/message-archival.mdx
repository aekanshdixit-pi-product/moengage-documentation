...
- **Customer experience**: Your customers may be contacting your support touch-points, enquiring about a message they have received. To serve these customers better, you need to empower your teams with information on all transactional and/or promotional messages sent to customers. Your customer service teams can then respond to a customer query and/or complaint by reviewing the personalized message sent to the customer.
  ...
  Combining this with the message sent/delivery events (using MoEngage [S3 Exports](https://help.moengage.com/hc/en-us/articles/8098260902548-S3-Exports) or [Streams](https://developers.moengage.com/hc/en-us/articles/4952761690644-MoEngage-Streams)) can give your teams a 360-degree view of messages received or those that remained undelivered because of various reasons such as the Email box being full or mobile number being unavailable and so on. This 360-degree view of communication sent by you (brand) to your customers helps customer service teams get a holistic context, thereby reducing the turnaround time (TAT) and the cost to serve and, more importantly, improving the overall customer experience.
...
<Info>
The *View sent message* option is exclusively available for messages archived to a MoEngage or client-owned S3 bucket, and not for those archived to an SFTP server.
</Info>
...
<img alt="2023-06-05_15-17-10" src="/images/moengage_4e08ec.png" />

To view a copy of the SMS  message sent to a customer:

1. Navigate to the User Profile of the user.
2. Click on the **Activity Info** tab.
3. Look for the SMS  sent to the customer under the *SMS Sent* event associated with the campaign.
4. Click **View sent message** to view the communication sent to the customer.
...
- If the SMS Connector is Sinch, the **View sent message** option is also available for the *SMS Delivered* event.

<img alt="SMS_Archival (1).gif" src="/images/moengage_4282f6.png" />

To view the copy of the Push notification sent to a customer:

1. Navigate to the User Profile of the user.
2. Click the **Activity Info** tab.
3. Look for the Push notification sent to the customer under the *Notification Received Android,* or *Notification Received iOS,* or *Notification Received Web* event (based on the platform) associated with the campaign.
4. Click **View sent message** to view the communication sent to the customer.
...
<img alt="Push_ViewCopy (1).gif" src="/images/moengage_d4900e.png" />

<Info>
Message Archival is not supported in MoEngage when PII Tokenized Sending is enabled. PII Tokenized Sending allows you to engage with your customers without storing their PII within the MoEngage platform. For more information, refer to [PII Tokenized Sending](https://help.moengage.com/hc/en-us/articles/9111881294996).
</Info>
...
2. You also need to provide the ARN URL for your bucket. For more information, refer to [Set Up the ARN URL](#01HVRHFK7KHQR1P92402B4K06E).
...
- File path and naming convention, refer to [File Path and Naming Convention](https://help.moengage.com/hc/en-us/articles/29635308841876).
- File contents, refer to [File Contents](https://help.moengage.com/hc/en-us/articles/30019566082836).
...
6. When creating your own policy, specify a **Policy Name** of your choice and enter the following code into the **Policy Document** section. Be sure to replace the **INSERTSID** with your SID, **INSERTPOLICYID** with your policy ID, and **INSERTBUCKETNAME** with your bucket name.  
   ...
   "Principal": {
   "AWS": [
   "arn:aws:iam::612427630422:role/campaigns\_archival\_s3\_export-role-e1qw8ulf",
   ...
   "Principal": {
   "AWS": [
   "arn:aws:iam::163129101105:role/campaigns\_archival\_s3\_export-role-e1qw8ulf",
