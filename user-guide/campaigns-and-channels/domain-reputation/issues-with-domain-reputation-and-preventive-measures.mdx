...
sidebarTitle: "Issues with Domain Reputation and  Preventive Measures"
---
...
- Pause all one-time email campaigns from the affected domain for 3 days and then:
  - Utilize this period to find out the [reason for the reputation drop](https://help.moengage.com/hc/en-us/articles/28171165667604-Checklist-to-Review-Email-Performance) and plan accordingly to [resolve it](https://help.moengage.com/hc/en-us/articles/28328820827284-Improve-the-Email-Performance).
...
- Add a [frequency capping (FC)](https://help.moengage.com/hc/en-us/articles/15919660670356-Frequency-Capping) of one email to a user in 1 day.
- Ensure to send at least one campaign per week. While sending it, follow the points below:
  ...
  - Use a [Request Per Minute (RPM)](https://help.moengage.com/hc/en-us/articles/28168151932052) of 1000.
...
- Pause all one-time email campaigns from the affected domain for 10 days and then:
  ...
  - Continue sending event-triggered campaigns unless you encounter problems related to the performance or delivery of such campaigns.
- Add a [frequency capping (FC)](https://help.moengage.com/hc/en-us/articles/15919660670356-Frequency-Capping) of 1 email to a user in 3 days or less.
...
- Utilize this period to find out the [reason for the reputation drop](https://help.moengage.com/hc/en-us/articles/28171165667604-Checklist-to-Review-Email-Performance) and plan accordingly to [resolve it](https://help.moengage.com/hc/en-us/articles/28328820827284-Improve-the-Email-Performance).
- Add a [frequency capping (FC)](https://help.moengage.com/hc/en-us/articles/15919660670356-Frequency-Capping) of one email to a user in 7 days.
...
- Resume event-triggered campaigns. Create [event-based triggered](https://help.moengage.com/hc/en-us/articles/360058752652) or [life-cycle campaign use cases](https://help.moengage.com/hc/en-us/sections/28900638182676-Customer-Lifecycle-Campaigns). While creating them, use content personalization and reduce one-time campaigns.