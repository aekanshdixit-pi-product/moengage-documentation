...
sidebarTitle: "Data Management Alerts"
---

<Info>
- Data Management Alerts feature is only available if you have Alert Management enabled for your workspace.
- Note that only roles with permission to create custom alerts can view and edit alerts. For more information, refer to [Access Roles](https://help.moengage.com/hc/en-us/articles/210855743).
</Info>
...
- Monitor the event and user attribute usage proactively, thereby complying with your workspace's [Data Tracking Policies](https://help.moengage.com/hc/en-us/articles/360037314991). When you set up usage alerts, you are notified based on your event and user attribute usage.
...
1. In the **Data Management** dashboard, click <img alt="bell.png"  src="/images/moengage_af0750.png"  />   on the **Unique events used** or **Unique user attributes used** card.  
    <img alt="DM alerts 1.png" src="/images/moengage_b4bb6e.png" />
2. In the **Create alert - Event usage** dialog box, enter the following details:  
    <img alt="DM alerts 2.png"  src="/images/moengage_97861d.png"  />   
   ...
   2. In the **Alert condition** section, create a condition for receiving alerts. When the data usage meets this condition, an alert is received.  
      1. In the **Send alerts when** list, select the type of usage for which you want to create an alert. The type of usage can be **Event usage**, **User attribute usage**. By default, **Event usage** is auto-populated.
      ...
      3. Select the usage limit above which you want to receive the alert.
         ...
         2. When you select **User attribute usage**, by default, **255** is auto-populated because your default limit is 256. Any value greater than 255 means you have reached user attribute usage limit. However, a system alert is configured by default when you reach 100 percent of your user attribute usage limit.  
            <Info>
...
3. Click **Save Alert**.
4. After saving, to manage the created alerts, click **Manage alerts** at the upper-right corner of the screen. For more information, refer to [Manage alerts](https://help.moengage.com/hc/en-us/articles/19094494054036).

<Info>
You can also create the usage alert using the **Create Alert** option on the **Alert Management** page. While creating, make sure to select the **Create Alerts On** as **Events and User Attribute Usage**. For more information, refer to [Create Alert](https://help.moengage.com/hc/en-us/articles/19094285198484-Create-Alert).
</Info>
...
1. In the **Data Management** dashboard, click <img alt="bell.png"  src="/images/moengage_af0750.png"  /> on the **Event volume (All events)** or **Event volume (Custom events)** card.  
    <img alt="DM alerts 3.png" src="/images/moengage_53e954.png" />
2. In the **Create alert - Event volume** dialog box, enter the following details:  
    <img alt="DM alerts 4.png" src="/images/moengage_189371.png" />   
   1. In the **General details** section, enter the following details:
      1. **Alert name**: Type a name for your usage alert for easy identification.
      2. **Send alert via**: By default, you can send alerts through **Email.** This field is auto-populated.
   2. In the **Alert condition** section, in the **Events** list, select the type of event for which you want to create an alert. Following are the types of events in the list:  
       <img alt="Screenshot 2024-12-10 at 3.27.48 PM.png" src="/images/moengage_3c446e.png" />   
   ...
   3. In the **Send alerts when event volume for the selected event(s)** section, create a condition for receiving alerts. When the event volume meets this condition, an alert is received.  
      1. **Select operator** from the list.  The following operators are supported:
         - **Is greater than**: Allows you to set an alert when the event volume is greater than the entered value. After selecting this operator, select the following values:  
            <img alt="duration 1.png" src="/images/moengage_4bd237.png" />   
         ...
         - **Is less than:** Allows you to set an alert when the event volume is less than the entered value. After selecting this operator, select the following values:  
            <img alt="duration 2.png" src="/images/moengage_575d50.png" />   
         ...
         - **Increases by:** Allows you to set an alert when the event volume increases by a specified percentage compared to the average event volume of specified previous days. After selecting this operator, select the following values:  
            <img alt="Screenshot 2024-12-09 at 8.52.24 PM.png" src="/images/moengage_f053eb.png" />   
         ...
         - **Decreases by:** Allows you to set an alert when the event volume decreases by a specified percentage compared to the average event volume of specified previous days. After selecting this operator, select the following values:  
            <img alt="Screenshot 2024-12-09 at 8.53.49 PM.png" src="/images/moengage_b00fa7.png" />   
...
<Info>
You can also create the event volume alert using the **Create Alert** option in **Alert Management** page. While creating, make sure to select the **Create Alerts On** as **Events Volume**. For more information, refer to [Create Alert](https://help.moengage.com/hc/en-us/articles/19094285198484-Create-Alert).
</Info>
...
1. In the **Data Management** dashboard, click <img alt="bell.png"  src="/images/moengage_af0750.png"  /> on the **Web user volume (30-day)** or **Mobile user volume (30-day)** card.  
    <img alt="dm alerts 7.png" src="/images/moengage_bce98c.png" />
2. In the **Create alert - User volume** dialog box, enter the following details:  
    <img alt="dm alerts 8.png" src="/images/moengage_e9e690.png" />   
...
<Info>
You can also create the user volume alert using the **Create Alert** option on the **Alert Management** page. While creating, make sure to select the **Create Alerts On** as **Active Users Volume**. For more information, refer to [Create Alert](https://help.moengage.com/hc/en-us/articles/19094285198484-Create-Alert).
</Info>