...
sidebarTitle: "SDK Authentication"
---
...
The following image shows the SDK Authentication dashboard:  
 <img  src="/images/moengage_a14e89.png"  />
...
2. On the **Security** page, select the **SDK Authentication** tab.  
    <img  src="/images/moengage_deec7f.png"  />

## Permissions to access

| Capability | Permission Required | Description |
| --- | --- | --- |
| Manage Settings | An Admin role or a custom role with Setup & manage permission for **Security Settings**.  **Note*:*** The **Login Settings** component is now renamed to **Security Settings**. | Grants complete administrative access. The user can add/delete public keys and change the enforcement mode (**Disabled (Default)** or **Required (Recommended**). |
...
2. Type a descriptive name in the **Enter description (optional)** box to help you identify the key.  
    <img  src="/images/moengage_d9a6e1.png"  />
...
2. Click **Confirm** to apply your configuration.  
    <img  src="/images/moengage_51aa21.png"  />   
