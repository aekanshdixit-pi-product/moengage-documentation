...
For more information about team management, refer to [Teams in MoEngage](https://help.moengage.com/hc/en-us/articles/360028586211)*.*
...
| All Segments  RFM Segments  Warehouse Segments  Seg AI  Sync Segments | View | Yes | Yes | Yes | Yes | Yes |
| Create and manage | Yes | Yes | Yes | Yes | Yes |
...
| Create, manage and publish | Yes | Yes | If [approval flow](https://help.moengage.com/hc/en-us/articles/360021206931-Campaign-Approval-Workflow-) is enabled - No  If [approval flow](https://help.moengage.com/hc/en-us/articles/360021206931-Campaign-Approval-Workflow-) is disabled - Yes | No | No |
...
| Teams [(know more)](https://help.moengage.com/hc/en-us/articles/360028586211-Teams-in-MoEngage#creation-of-a-new-team-0-0) | View | Yes | Yes | Yes | No | No |
...
1. Navigate to **Settings \> Account \> Team management \> Roles**.|  
    <img alt="Roles_RevampedUI.png" src="/images/moengage_5b43b3.png" />
...
| Create and manage | Can create new campaigns, and edit/update existing campaigns; but cannot publish the campaign.  If you are using [campaign approval flow](https://help.moengage.com/hc/en-us/articles/360021206931-Campaign-Approval-Workflow-) - the user with the permission can only send the campaign for approval. |
| Create, manage, and publish | Can create new campaigns, edit/update existing campaigns, and also publish the campaign.  If you are using [campaign approval flow](https://help.moengage.com/hc/en-us/articles/360021206931-Campaign-Approval-Workflow-) - the user with the permission can approve/reject the campaign. |
...
| App configuration | View | - Can view general, API, Analytics, and Control group settings - **Data Management:** Can view the data management dashboard and download reports - **Identity Resolution:** Can view the identity resolution dashboard - **Tag Management:** Can view tags |
| Setup and manage | - Can configure and update App settings - **Data Management:**Can perform actions on the data management dashboard (for example, block/hide events) - **Identity Resolution:** Can perform actions on the identity resolution dashboard (for example, add identifiers, change merge settings, pause identifiers) - **Tag Management:**Can create/edit tags |
| App Marketplace | Create and manage | Can create & edit the integrations. |
| Channel configuration | View | - Can view channel settings - **PII Masking & Encryption:** Can view masked attributes |
| Setup and manage | - Can configure and update channel settings - **PII Masking & Encryption:**Can mask attributes |
...
| Teams [(know more)](https://help.moengage.com/hc/en-us/articles/360028586211-Teams-in-MoEngage#creation-of-a-new-team-0-0) | View | Can view all teams and their members |
