...
sidebarTitle: "Teams in MoEngage"
---
...
2. Click  **+ Create Team**. The **Create Team** screen is displayed.  
    <img alt="CreateTea_RevampedUI.png" src="/images/moengage_bd2a9a.png" />
...
4. Click **Create**. You get a success message upon successful creation, as shown in the following image.
   ...
   <img alt="Teams_SuccessMsg.png"  src="/images/moengage_23efbe.png"  />
...
3. Click the ellipsis beside the **Description**.  
    <img alt="EditTeams_RevampedUI.png" src="/images/moengage_22f6e8.png" />
...
Users can be part of multiple teams but will have permissions for the same role across all the teams that they are part of. Each team can have users with all the possible roles. For more information about different access roles, refer to [Different Access Roles](https://help.moengage.com/hc/en-us/articles/210855743-Understand-different-Access-Roles).
...
3. Click **+ Add Team Member(s)**.  
    <img alt="AddTeamMember_RevampedUI.png" src="/images/moengage_fc9f9c.png" />
4. Select the relevant users you want to add from the **Email** drop-down.

   <img src="/images/moengage_784427.png"  />
5. Click **Add**.
...
3. Click on the vertical ellipsis icon next to the user you want to remove.
   ...
   <img alt="Teams_RemoveMember.png" src="/images/moengage_76f2fb.png" />
...
<img alt="CreateCampaign_FromSegment.png" src="/images/moengage_c1c17b.png" />
...
<img alt="AllCampaigns (3).png" src="/images/moengage_78ff19.png" />
