...
1. On the left navigation menu in the MoEngage UI, click **Settings** \> **Account** \> **Portfolio**.  
    <img alt="portfolio1.gif"  src="/images/moengage_7bd2a0.png"  />
2. On the **Portfolio** page, click **+ Add Project**.  
    <img alt="portfolio2.png"  src="/images/moengage_bd96b5.png"  />
3. On the **Add a new Project**window, enter the following values:  
   ...
   | Project Icon | This field specifies the icon to represent the project. It is optional. For correct visibility on MoEngage, ensure to upload an image with a minimum resolution of 72x72 pixels. Supported file types are:  - PNG - GIF - WebP - ICO - CUR - BMP |
   | Type of Business | This field specifies the business model for the configured project. It is mandatory. The available options are:  - Offline / Storefront - Online |
   | Platform(s) | This field specifies the platform(s) for the configured project. It is mandatory and is visible only when the **Type of Business** field value is set to *Online*. Supported platforms are:  - Android - iOS - Web **Note**: The initial platform selection is for representation and initial setup. It does not lock the project to that platform; you can add and configure settings for other platforms later. |
4. Click **Save**.  
   You can now see the project details on the **Portfolio**page.  
    <img alt="snnnnaaaappp.png"  src="/images/moengage_4333c6.png"  />
...
<img alt="ProjectIDimg.png"  src="/images/moengage_e07cb7.png"  />
...
- **Last Updated By**: Displays the date and the user who last modified the project. Project modification permissions are based on the app configuration level. For more information, see [Permission Levels](https://help.moengage.com/hc/en-us/articles/210855743).
...
2. Click the Ellipsis ( <img alt="ellipses.png"  src="/images/moengage_aad2d6.png"  /> ) icon against the preferred entry, and then click **Edit**.
3. On the **Add a New Project**window, make the required changes.
4. Click **Save**.

<img alt="Edit Project.gif"  src="/images/moengage_297a2c.png"  />
...
- **Portfolio and project-specific attributes**: MoEngage enables project-level tracking of custom, standard user attributes, and events.
  ...
  - Standard and custom events are tracked at the project level.  
    To understand user attributes tracked at the project and portfolio level, refer to [Derived User Attributes Behaviour](https://help.moengage.com/hc/en-us/articles/40358246598804-Portfolio-Data-Ingestion-and-Management#h_01K2Y9G8XBK25TXB8EAN0TY8X2).
...
For more information, refer to [Portfolio: Data Ingestion and Management](https://help.moengage.com/hc/en-us/articles/40358246598804-Portfolio-Data-Ingestion-and-Management)
...
For more information, refer to [Segmentation in a Multi-Project Portfolio](https://help.moengage.com/hc/en-us/articles/40431846748820-Segmentation-in-a-Multi-Project-Portfolio).
...
For more information, refer to [Portfolio for Push Campaigns](https://help.moengage.com/hc/en-us/articles/40898390943252).
...
For more information, refer to [Portfolio for In-app Campaigns](https://help.moengage.com/hc/en-us/articles/45812961878804-Portfolio-for-In-app-Campaigns).
...
For more information, refer to [Portfolio for OSM Campaigns](https://help.moengage.com/hc/en-us/articles/45813021455508-Portfolio-for-On-site-Messaging).
...
<Info>
The *Portfolio* feature is not supported for campaigns created via the Push API, Campaigns API, or those using dynamic conditions.
</Info>
...
For more information on the channel-specific support matrix of the *Portfolio* feature, refer to [Supported Features by Channel](#h_01K4B1C2D3E4F5G6H7J8K9L0M1).
...
- While the global capping controls the overall volume, *tag-based frequency capping* allows for more granular, project-specific control.  
...
For more information, refer to [Frequency Capping](https://help.moengage.com/hc/en-us/articles/15919660670356).
...
- **\*Not Supported**: The dashboard does not provide portfolio UI elements for these channels.
  - To use cross-project segmentation, you can:  
    ...
    - Create the segment using the project-level user attribute, and for event-based segmentation, select the *project name* event attribute specifying the project's name as the value.
  - You can use cross-project event triggers by selecting the *project name* event attribute, specifying the project's name as the value.
</Info>
...
- [Portfolio: Data Ingestion and Management](https://help.moengage.com/hc/en-us/articles/40358246598804-Portfolio-Data-Ingestion-and-Management)
- [Segmentation in a Multi-Project Portfolio](https://help.moengage.com/hc/en-us/articles/40431846748820-Segmentation-in-a-Multi-Project-Portfolio)
- [Portfolio for Push Campaigns](https://help.moengage.com/hc/en-us/articles/40898390943252)
- [Portfolio for In-app Campaigns](https://help.moengage.com/hc/en-us/articles/45812961878804-Portfolio-for-In-app-Campaigns#h_01KG71A8F63AB9E8DNRZZ1PDP5)
- [Portfolio for OSM Campaigns](https://help.moengage.com/hc/en-us/articles/45813021455508-Portfolio-for-On-site-Messaging)
- [Create an Event-Triggered Campaign](https://help.moengage.com/hc/en-us/articles/360058752652)