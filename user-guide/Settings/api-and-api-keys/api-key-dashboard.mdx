...
sidebarTitle: "API Key Dashboard"
---
...
2. Click **+ Create new key**.  
    <img alt="create new key.png" src="/images/moengage_a5e237.png" />
3. In the **Create new key** page, enter the following details:
   ...
   2. In the **Select APIs for access** check box list, select the APIs you want to access using this key.  
       <img alt="Screenshot 2024-09-25 at 12.41.17 PM.png"  src="/images/moengage_685ea1.png"  />
...
The **API Access** is **Full** if all listed APIs can be accessed using this key; otherwise, it is **Partial**.
    ...
    **<img alt="Active api keys list.png" src="/images/moengage_632dcf.png" />**
5. Click **View archived keys** to view the list of archived keys.
6. On the **API Keys** page**,** clicking **<img alt="333.png"  src="/images/moengage_b6aff6.png"  />**for each API key displays the following options:  
    <img alt="multi key.png" src="/images/moengage_b6852d.png" />   
...
<img alt="Screenshot 2024-11-13 at 5.44.37 PM (1).png" src="/images/moengage_620fc6.png" />
...
- Click <img alt="filter icon.png"  src="/images/moengage_4f4db1.png"  />   to filter audit logs based on **Team(s)**, **Action**, **Actor**, and **Date time Range**.
