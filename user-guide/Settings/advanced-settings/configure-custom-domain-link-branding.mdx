...
sidebarTitle: "Configure Custom Domain (Link Branding)"
---
...
3. After verification, you get a message stating that the custom domain is verified, as shown below.  
    <img alt="SMS Custom Domain (1).gif" src="/images/moengage_2c2ad5.png" />
...
8. After successfully verified and saved, your custom domain is listed under the **Custom domain** screen with a **Verified** tag against that custom domain.  
    <img alt="2025-02-06_17-42-07.gif" src="/images/moengage_143b37.png" />
9. Click the ellipsis icon ( <img alt="ellipsis.png"  src="/images/moengage_0ba4d3.png"  /> ) against any of your custom domains to mark it as **Default** or **Delete**.
   ...
   - If you have configured multiple default link branding domains and delete one, any active campaign that uses the deleted link branding domain falls back to the new default link branding domain.  
     For more information on how to use a link branding domain while creating an email campaign, refer to [Create an Email Campaign](https://help.moengage.com/hc/en-us/articles/360059171891).

If you want to configure a deep linking domain for your brand, MoEngage recommends its Deep linking feature. For more information, refer to [Configure a Deep Linking Domain](https://help.moengage.com/hc/en-us/articles/34173133994516).
...
<img alt="CustomDomain (1).png" src="/images/moengage_f01a79.png" />

<img alt="CustomDomain_WA.png" src="/images/moengage_410f50.png" />
