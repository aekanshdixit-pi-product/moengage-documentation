...
| --- | --- |
| Push | All **Note**: For *One-Time*, *Periodic,* and *Business event-triggered* campaigns, the DND can be configured only when the [Message Queuing](https://help.moengage.com/hc/en-us/articles/41888436184340) feature is enabled. |
...
These DND Settings are applicable to the campaigns created inside a MoEngage Flow as well. Read more about how it works [here](https://help.moengage.com/hc/en-us/articles/360000127483).