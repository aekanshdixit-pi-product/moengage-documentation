...
sidebarTitle: "Campaign Audience Limit"
---
...
| - Push - Email - SMS - WhatsApp - Cards - Connectors | One time | Yes | No | No |
| Periodic | Yes | No | Yes |
| Event Triggered | Yes | Yes | No |
| - Push - Email - SMS | Business Event Triggered | Yes | Yes | Yes |
| - In-app - On-site messaging | One Time (Continuously Active in duration) | Yes | Yes | No |
| Periodic (Periodically Active) | Yes | Yes | No |
| - Push | Location-triggered | Yes | Yes | No |
