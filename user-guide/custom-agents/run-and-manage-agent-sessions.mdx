...
- **From the Agent Builder:** While creating a Draft or editing a Live agent, click **Test agent** to start a trial run. This session will be explicitly tagged as **Test** in the agent's history.
