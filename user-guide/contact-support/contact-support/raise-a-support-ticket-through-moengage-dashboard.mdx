...
sidebarTitle: "Raise a Support Ticket Through MoEngage Dashboard"
---
...
1. Go to your Moengage Dashboard. The login page is displayed.
   ...
   <img border="5" src="/images/moengage_13e35a.png"  />
2. Log in to the dashboard using your credentials.
   <Info>
If you are unable to log in, you can create a support ticket from the login page. For more information, refer to [Raise a Support Ticket from the MoEngage Login Page](https://help.moengage.com/hc/en-us/articles/28298317432724).
</Info>
   ...
   4. Click **Login**. After your login is successful, you are in the MoEngage dashboard.
      ...
      <img alt="Dashboard_SS.png" src="/images/moengage_7e68bd.png" />
3. In the top right corner of the screen, click **Need help** and then click **Support**.  
    <img src="/images/moengage_4d0e24.png"  />   
...
4. Enter the following details:
   ...
   5. In the **Priority** drop-down list, select the priority of the issue. For more information on priorities, refer to [Support Issue Types and Priority](https://help.moengage.com/hc/en-us/articles/4402656152468).
   ...
   7. In the **Attachments** section, click **Add file** to attach a file relevant to the issue. You can also drag and drop the file you want to attach to the ticket.  
       <img src="/images/moengage_c6a6fc.png"  />
5. Click **Submit**.
...
For more information, read [Introducing AIRA](https://help.moengage.com/hc/en-us/articles/32664799340564-Introducing-AIRA#h_01JE5EH13XKMFZ91GPDSMF2MWC).
</Info>