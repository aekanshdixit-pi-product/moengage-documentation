...
description: "Send real-time order status updates to customers via email using MoEngage Inform, with payload setup and template configuration for dispatch alerts."
---
...
For more information, refer to [Inform](/user-guide/inform/overview/overview-inform) and [Inform API](https://developers.moengage.com/hc/en-us/articles/10699624590868-Inform-API).
</Tip>
