...
1. [Create an RFM segment](#Create-an-RFM-Segment)
...
![card emi.png](/images/moengage_5da7df.png)
...
7. In the **Target audience** section, select our saved custom segment, _RFM-segment_ that we created in the [Step 1: Create an RFM segment](#Create-an-RFM-Segment) by searching for the same. <img alt="RFMusecase7.png" src="/images/moengage_1d2cb0.png" />
