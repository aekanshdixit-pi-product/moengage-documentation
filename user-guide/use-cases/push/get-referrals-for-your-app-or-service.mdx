...
We will achieve the use case by [creating a Push campaign](#Create-a-Push-Campaign) to get referrals for your app or service.

# Expected Result

Users receive a push notification on their phones to refer their friends:

![Screenshot 2024-02-06 at 4.57.34 PM.png](/images/moengage_479f17.png)
...
3. Under **Outbound**, click **Push** \> **Periodic**.
   ![jdsjhsbd.png](/images/moengage_9a1191.png)
...
4. Enter the following details:
   ...
   3. **Campaign tags**: Select the required campaign tags.
      ![1.png](/images/moengage_76824e.png)
...
3. Change the deliverability settings based on your requirements. For more information, refer to [Create Push Campaigns](/user-guide/campaigns-and-channels/mobile-push/create/create-push-campaigns).
   ![Screenshot 2024-02-06 at 5.03.13 PM.png](/images/moengage_2f6363.png)
4. Click **Publish**.
