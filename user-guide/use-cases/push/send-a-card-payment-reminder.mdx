...
We will achieve this use case by [creating a Push campaign](#Create-a-Push-Campaign) to remind users about pending credit card payments 5 days before the due date.

# Expected Result

Users receive a push notification about their credit card payment on their phones:

![card payment reminder.png](/images/moengage_7eb92f.png)
...
3. Under **Outbound**, click **Push** \> **Event Triggered**.
   ![pushlessgoooo.png](/images/moengage_ba5c3c.png)
...
4. Define your campaign with a name and tags. Enter the following details:
   ...
   - **Campaign tags**: Select the required campaign tags.
     ![usecase1.png](/images/moengage_367a69.png)
...
7. In the **THEN trigger the message** section, define the **With Delay** option to send a reminder to the user 5 days before the due date. This is the maximum time the user will be evaluated to fulfill the conditions from when the first condition is met.\
   ...
   ![usecase77.png](/images/moengage_b719cf.png)
...
9. In the **Target Platforms** section, select **Android**.
   ![usecase3.png](/images/moengage_a2eeb2.png)
...
1. Select the template that you would like to use. For example, select **Basic notification**.
   ![usecase4.png](/images/moengage_0f8ab7.png)
...
3. Add personalization to the message using information such as the user's name, bill amount, or credit card name. Such personalization makes the message more contextual for users with multiple cards. To do the same:
   ...
   2. On the **Push Personalization** dialog box, find your event attributes, such as bill amount, credit card name, or user attributes, such as name.
      ![7.png](/images/moengage_b308f9.png)
   3. Click **Done**.\
      ...
      ![8.png](/images/moengage_7c7b52.png)
      Whenever MoEngage tries to send a message, it makes sure to check the name of the user, credit card name, and amount from the _Bill generated_ event and replace those instead of `{{UserAttribute['Name']}}`, `{{EventAttribute['Credit card name']}}`, `{{EventAttribute['amount']}}` respectively.
4. Use the deep link option to take the users to the bill payment page in your app.
   ...
   2. In the **Take user to a specific screen** list, select the respective screen.
      ![usecase5.png](/images/moengage_1ddfa5.png)
...
1. Define when to start and end this campaign and the conversion goal based on your requirements.
   ![10.png](/images/moengage_100801.png)
2. Change the deliverability settings based on your requirements. For more information, refer to [Create Push Campaigns](/user-guide/campaigns-and-channels/mobile-push/create/create-push-campaigns).
   ![11.png](/images/moengage_27d8e6.png)
3. Click **Publish**.
