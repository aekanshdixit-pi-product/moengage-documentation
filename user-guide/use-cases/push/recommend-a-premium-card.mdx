...
sidebarTitle: "Recommend a Premium Card"
---
...
1. [Create RFM segments](#h_01HTEVNKF3987F75DA0K7YKDNH)
...
<img alt="UC-39.png"  src="/images/moengage_b90ce5.png"  />
...
- The Push channel must be configured. For more information, refer to [Configure App Push](https://help.moengage.com/hc/en-us/articles/7689492811796-Configure-App-Push).
...
The RFM (Recency, Frequency, and Monetary) model provides auto-segmentation and buckets users into categories such as *Loyal*, *Promising*, and *At Risk* based on their behavior. You can use these auto segments in different ways such as user analysis, churn analysis, and to target users effectively. To learn more about RFM Segments, refer to [RFM Segments](https://help.moengage.com/hc/en-us/articles/360037365132).
...
4. In the **Monetary Even**t list, select *Credit Card used* and select **Revenue Attribute** as *Amount*. <img alt="image-20240121-065824.png" src="/images/moengage_088209.png" />
...
9. On the Engage Users dialog box, select **Custom Segment**.  
    <img alt="image-20240121-071650.png" src="/images/moengage_e28133.png" />
...
3. Under **Outbound**, select **Push** \> **Periodic**.  
    <img alt="push periodic.png"  src="/images/moengage_72ec36.png"  />   
   You are taken to the first step, **Target users**, of defining your campaign.
4. Enter the following details:
   - **Team**: Select a team if your organization has teams enabled for your account. For more information, refer to [Teams in MoEngage](https://help.moengage.com/hc/en-us/articles/360028586211). For example, *Demo Account - E-commerce*.
   ...
   - **Campaign tags**: Select the required campaign tags.  
      <img alt="3.png"  src="/images/moengage_b80b28.png"  />
5. Under **Target audience**, select our saved custom segment [created above](#h_01HTEVNKF3987F75DA0K7YKDNH) by searching for the same. <img alt="image-20240121-072539.png" src="/images/moengage_c1c6c6.png" />
6. Under **Target Platforms**, select **Android**.   
    <img alt="4.png" src="/images/moengage_2b6534.png" />
...
2. Enter the required content for the campaign. We can enter the content manually or generate it using Merlin AI. For more information, refer to [Generate Push Messages with Merlin AI](https://help.moengage.com/hc/en-us/articles/19486880189332).  <img alt="image-20240121-072900 (1).png" src="/images/moengage_4c539b.png" />
...
5. On the **Add new locale** dialog box, enter a name to the locale and select the attribute that has this information from the drop-down list. In this example, select *CommonExpense*. <img alt="image-20240121-091958.png" src="/images/moengage_d0c21a.png" />
...
1. In the **Send campaign** section, define when you want to start and end your Push campaign.  
    <img alt="5.png" src="/images/moengage_06ac40.png" />
...
3. Define **Delivery controls** and **Advanced** settings based on your requirements. For more information, refer to [Create Push Campaigns](https://help.moengage.com/hc/en-us/articles/206541583).  
    <img alt="6.png" src="/images/moengage_8196fa.png" />
4. Click **Publish**.
