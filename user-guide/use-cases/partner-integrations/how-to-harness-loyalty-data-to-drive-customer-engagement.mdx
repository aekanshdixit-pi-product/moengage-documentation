...
sidebarTitle: "How to Harness Loyalty Data to Drive Customer Engagement"
---
...
| Any other in-house tool | With some development effort, you can write a script to send these details to [MoEngage Data APIs](https://developers.moengage.com/hc/en-us/articles/4404674776724-Overview). The loyalty data can then be directly used to create segment or run personalised campaigns. |
| Microsoft Excel or CSV files | If you are not using a well connected tool and do not want to spend effort in building direct API connections, you can also [import loyalty data](https://help.moengage.com/hc/en-us/articles/12246167449236) into MoEngage as simple CSV files. |
