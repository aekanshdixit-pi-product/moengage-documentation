...
1. [Create a Countdown Timer](#Create-a-Countdown-Timer)
2. [Generate HTML Code for the Timer](#Generate-HTML-Code-for-the-Timer)
3. [Embed HTML in Your MoEngage Email Template](#Embed-HTML-in-Your-MoEngage-Email-Template)
...
4. Add the copied code to your email in MoEngage as described in [Step 3: Embed HTML in Your MoEngage Email Template](#Embed-HTML-in-Your-MoEngage-Email-Template).
