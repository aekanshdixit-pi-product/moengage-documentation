...
description: "Increase event attendance by adding calendar invites to your email campaigns. Use calendar links or ICS files to help users save event dates."
---
...
3. Add an icon for the invite link to the email template. In our example, the icon is named *ADD TO CALENDAR*. For more information, refer to [Add icons to the email template](/user-guide/campaigns-and-channels/email/create/create-content-with-the-drag-and-drop-editor).
