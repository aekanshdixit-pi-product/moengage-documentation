...
1. [Create a Calendar Invite](#Create-a-Calendar-Invite)
2. [Add a Calendar Invite to the Email Campaign](#Add-a-Calendar-Invite-to-the-Email-Campaign)
...
<Tabs>
  ...
  Perform the following steps to upload the ICS file as an attachment to the email:
    ...
    6. In Step 3 of the campaign creation, add the information about the campaign's delivery schedule and configure the delivery controls.
    7. Publish the campaign. The user receives a [preview of the invite](#Expected-Results) in their inbox.
  </Tab>
</Tabs>
