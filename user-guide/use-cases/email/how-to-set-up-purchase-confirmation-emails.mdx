...
sidebarTitle: "How to Set Up Purchase Confirmation Emails"
---
...
<img alt="7.png"  src="/images/moengage_5e882c.png"  />
</Tip>
...
2. Under **Outbound**, select **Email** \> **Event Triggered**.  
    <img alt="13.png"  src="/images/moengage_9c01f2.png"  />   
   You are taken to the first step "Target users" of defining your campaign
3. Enter the following details:
   - **Team**: Select a team if your organization has teams enabled for your account. For example, select "Demo Account - E-commerce". For more information, refer to [Teams in MoEngage](https://help.moengage.com/hc/en-us/articles/360028586211).
   ...
   - **User attribute with email address**: Select "Email (Standard)".  
      <img alt="5.png" src="/images/moengage_8e29a7.png" />
...
4. Personalize the message by including information such as the user's name. This makes the message more contextual and helps users feel more connected. To do this, enter “@”. The Push Personalization pop-up will be displayed, allowing you to select information from the event or user's properties.  
    <img alt="weather 8.png" src="/images/moengage_7f84b9.png" />
5. Configure the following details:  
   ...
   <img alt="8.png"  src="/images/moengage_6884d0.png"  />
   ...
   <img alt="9.png"  src="/images/moengage_63230f.png"  />
   ...
   - These variables can then be used to call for the values in the email body.  
      <img alt="10.png"  src="/images/moengage_4cac93.png"  />
...
In the absence of the previous check, there will be a personalisation error whenever the user buys only one product.
   ...
   3. In the **Dynamic Url** field, enter the JINJA attribute.  
       <img alt="11.png"  src="/images/moengage_859a38.png"  />
   ...
   3. Enter the JINJA attribute.  
       <img alt="12.png"  src="/images/moengage_176b60.png"  /><Warning>
...
2. Change the deliverability settings based on your requirements. For more information, refer to [Create Email Campaigns](https://help.moengage.com/hc/en-us/articles/360059171891-Create-an-Email-Campaign).
3. Click **Publish**.
...
After the campaign is live, you can track its performance from the [campaign analytics and info page](https://help.moengage.com/hc/en-us/articles/16242513761556).