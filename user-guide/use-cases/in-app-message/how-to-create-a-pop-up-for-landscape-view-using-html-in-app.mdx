...
sidebarTitle: "How to Create a Pop-Up for Landscape View Using HTML In-App"
---
...
<img alt="Screenshot 2024-08-05 at 2.43.56 AM.png"  src="/images/moengage_bede70.png"  />
...
2. Under **Inbound**, click **In-app**.  
    <img alt="In-app.png" src="/images/moengage_f89375.png" />   
...
5. In the **Trigger Criteria** section, select **On app open**.  
    <img alt="image-20240121-050504.png" src="/images/moengage_5ae947.png" />
...
1. 1. Select the template you want to show the user. You can select any HTML In-app message template to design the pop-up. For this use case, we will select the **Popup—Promotional** template. You can customize it on the **Template Settings** page.  
       <img alt="Screenshot 2024-08-05 at 2.20.35 AM.png"  src="/images/moengage_0187bd.png"  />
   2. Design the pop-up message by performing the following steps:
      - - **Update the title**: "Introducing Brand Kit!"
          - **Style**: Use a bold and attractive font to grab attention.  
             <img alt="Screenshot 2024-08-05 at 2.28.45 AM.png" src="/images/moengage_728def.png" />
        - **Include a Description**: Provide a brief overview of what the feature does and how it benefits the user.
          ...
          - **Style**: Ensure the text is concise and easy to read.  
             <img alt="Screenshot 2024-08-05 at 2.29.48 AM.png" src="/images/moengage_000fc5.png" />
        ...
        - **View the template in both landscape and portrait mode**: Click **View portrait and landscape** to view the pop-up in landscape view.  
           <img alt="Screenshot 2024-08-05 at 2.47.25 AM.png" src="/images/moengage_18c1c2.png" />
...
4. In the **Delivery Controls** section, define the controls based on your requirements. For more information, refer to [Create In-app Campaign](https://help.moengage.com/hc/en-us/articles/206184196).  <img alt="image-20240121-054810.png" src="/images/moengage_28c47b.png" />
5. Click **Publish**.
