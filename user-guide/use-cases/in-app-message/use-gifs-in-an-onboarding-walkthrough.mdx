...
1. [Identify the key onboarding steps and create GIFs](#Identify-the-Key-Onboarding-Steps-and-Create-GIFs)
2. [Create an In-app Messaging campaign](#Create-an-In-App-Messaging-Campaign)
...
![ScreenRecording2024-07-26at6.24.45PM-ezgif.com-video-to-gif-converter.gif](/images/moengage_10deaf.png)
...
2. **Create Informative GIFs**: Create a series of short, looping GIFs that effectively demonstrate each key feature or action. Ensure that the GIFs are visually captivating and easy to understand. For instance, include GIFs that include the essential steps that you identified previously. For example, inform new users about your products, explain how to apply discount codes, and guide users to the beauty news section. The following is a sample GIF:
   ![onboarding-walkthrough.gif](/images/moengage_e62be6.png)
...
3. Under **Inbound**, click **In-app**.
   ![Screenshot 2025-05-12 at 10.27.15 AM.png](/images/moengage_5a40c1.png)
...
5. In the **Target Platforms** section, select **Android** and **iOS**.
   ![target platforms.png](/images/moengage_208696.png)
6. In the **Trigger Criteria** section, click the **On app open** card. This will ensure that the In-app message is displayed to the users during onboarding when the app is opened.
   ![trigger criteria.png](/images/moengage_b697e9.png)
7. In the **Select trigger time** section, select **After Delay** and set the trigger time for the In-app message to appear after 2 seconds of opening the app.
   ![trigger time.png](/images/moengage_594ec3.png)
8. In the **Target audience** section:
   ...
   2. On the **User behaviour** tab, segment the audience to target only those users who have newly installed the app in the last three days.
      ![target audience.png](/images/moengage_182c3e.png)
...
2. Select the **Nudge - Image, text & button** template.
   ![Screenshot 2025-03-17 at 12.02.32 PM.png](/images/moengage_863c06.png)
3. Upload the created GIFs in the template in the **Image** section.
   ![Screenshot 2025-03-17 at 12.06.08 PM.png](/images/moengage_294540.png)
...
5. Add navigation to the button so that when the user clicks it, they are redirected to the info page.
   ![2025-03-17\_12-09-50 (1).gif](/images/moengage_658166.png)
...
7. Before publishing the campaign, test the In-app messages under the **Preview in-app section**. With this, you can ensure that GIFs and text display correctly on different devices and screen sizes.
   ![testing.png](/images/moengage_b78b2b.png)
