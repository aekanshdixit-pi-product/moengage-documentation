...
sidebarTitle: "How to Show Offers to Customer Without Being Intrusive (Using Nudge)"
---
...
<img alt="Screenshot 2024-07-28 at 12.46.54 AM.png"  src="/images/moengage_33c55c.png"  />
...
2. Under **Inbound**, click **In-app**.  
    <img alt="In-app.png" src="/images/moengage_71ed44.png" />   
...
5. In the **Trigger Criteria** section, select **On app open**.   
    <img alt="image-20240727-190720.png" src="/images/moengage_47b278.png" />
6. In the **Select trigger time** section, set the trigger to display the nudge with a 2-second delay after the user opens the app.  
    <img alt="2 sec.png" src="/images/moengage_f5490b.png" />
7. In the **Target audience** section, we will target this pop-up for users who have opened the app at least 10 times in the last 7 days.  
    <img alt="7 days.png" src="/images/moengage_61c1be.png" />
...
1. Select the template you want to show the user. From the template listing page, select the nudge message template option.  
    <img alt="image-20240727-190828.png" src="/images/moengage_039265.png" />
2. Design the Nudge Message:
   ...
   - Add personalization by typing @ in the text widget. Select the User attribute **First Name**.  
      <img alt="Screenshot 2024-07-28 at 12.39.39 AM.png" src="/images/moengage_d7bbb1.png" />   
      <img alt="image-20240727-191324.png" src="/images/moengage_4cb710.png" />
...
2. In the **Conversion Goals** section, add conversion goals that you would like to track.  
    <img alt="Screenshot 2024-07-26 at 7.00.51 PM.png" src="/images/moengage_8db976.png" />
...
4. In the **Delivery Controls** section, define the controls based on your requirements. For more information, refer to [Create In-App Campaign](https://help.moengage.com/hc/en-us/articles/206184196). Ensure the nudge is shown a maximum of three times per user to avoid annoyance.  
    <img alt="Screenshot 2024-07-28 at 3.00.35 PM.png" src="/images/moengage_a7a3c0.png" />
5. Click **Publish**.
