...
description: "Deploy multi-step in-app surveys targeting users who viewed offers but did not convert, helping you collect feedback and improve experiences."
---
...
2. Configure the survey steps:  
   ...
   - **Page 6: Thank you screen**
     ...
     These pages are already defined in the multi-page survey template. You can also change them according to your use case. For more information on configuring this HTML template, refer [here](/user-guide/campaigns-and-channels/in-app-message/templates/html-in-app-templates).  
