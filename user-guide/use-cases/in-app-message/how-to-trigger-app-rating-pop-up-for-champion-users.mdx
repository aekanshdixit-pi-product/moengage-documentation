...
![Screenshot 2024-07-26 at 7.07.19 PM.png](/images/moengage_479664.png)
...
2. Under **Inbound**, click **In-app**.
   ![In-app.png](/images/moengage_0bdd66.png)
...
5. In the **Trigger Criteria** section, select **On Custom event**. The trigger for the app rating request will be the action of adding a product to the cart.
   ![Screenshot 2024-07-26 at 6.51.15 PM.png](/images/moengage_7a5d28.png)
...
7. In the **Target audience** section, select **Filter users by** to specifically target only those users who have added products to their cart at least 15 times in the last month.
   ![4 audience.png](/images/moengage_bc405e.png)
...
1. Select the template you want to show the user. To design the pop-up, you can select any In-app message template. For this use case, we want to trigger this message non-intrusively, so we will choose the **Nudge- Rating** template. You can customize it on the **Template Settings** page.
   ![Screenshot 2024-07-26 at 6.53.21 PM.png](/images/moengage_41481a.png)
...
3. Add conditional actions:
   - You can also add conditional actions. For example, if the rating is less than 3, navigate the user to the support screen so that they can raise their query.
     ![Screenshot 2024-07-26 at 6.59.48 PM.png](/images/moengage_90a063.png)
...
2. In the **Conversion Goals** section, add the conversion goal to the rating done.
   ![Screenshot 2024-07-26 at 7.00.51 PM.png](/images/moengage_b202c1.png)
