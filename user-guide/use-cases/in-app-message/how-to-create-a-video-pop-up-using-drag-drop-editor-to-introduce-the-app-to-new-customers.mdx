...
sidebarTitle: "How to Create a Video Pop-Up Using Drag & Drop Editor to Introduce the App to New Customers"
---
...
<img alt="1q.png"  src="/images/moengage_bb5d38.png"  />
...
2. Under **Inbound**, click **In-app**.  
    <img alt="In-app.png" src="/images/moengage_430e69.png" />   
...
5. In the **Trigger Criteria** section, select **On Custom event**.  
    <img alt="Screenshot 2024-07-28 at 1.47.44 AM.png" src="/images/moengage_ea88fb.png" />   
...
1. Select the template you want to show the user. On the **Start from scratch** tab on the template listing page, select the drag-and-drop editor option.  
    <img alt="Screenshot 2024-07-28 at 1.53.54 AM.png" src="/images/moengage_9c7e41.png" />
...
2. In the **Conversion Goals** section, add conversion goals that you would like to track.  
    <img alt="Screenshot 2024-07-26 at 7.00.51 PM.png" src="/images/moengage_a2d33b.png" />
...
4. In the **Delivery Controls** section, define the controls based on your requirements. For more information, refer to [Create In-App Campaign](https://help.moengage.com/hc/en-us/articles/206184196). Ensure the pop-up is only shown once to avoid repetition.  
    <img alt="image-20240121-054810.png" src="/images/moengage_a28233.png" />
5. Click **Publish**.
