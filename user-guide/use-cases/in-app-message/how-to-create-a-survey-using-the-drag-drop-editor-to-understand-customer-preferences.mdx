...
![Screenshot 2024-08-04 at 7.17.24 PM.png](/images/moengage_a8d1a0.png)
...
2. Under **Inbound**, click **In-app**.
   ![In-app.png](/images/moengage_73ba11.png)
...
5. In the **Trigger Criteria** section, select **On app open**.
   ![image-20240121-050504.png](/images/moengage_d1943f.png)
...
1. Access the drag-and-drop editor and click **Explore pre-built templates** from the banner.
   ![Screenshot 2024-08-04 at 7.10.37 PM.png](/images/moengage_0b10c7.png)
2. Design the survey:
   - Let’s select the **Drag and Drop - E-commerce 2** template for our use case.
     ![Screenshot 2024-08-04 at 7.12.08 PM.png](/images/moengage_a324f8.png)
...
3. Track results:
   ...
   - To track the click, select the button and click **\+ Add new attribute** on the right panel.
     ![Screenshot 2024-08-04 at 7.22.39 PM.png](/images/moengage_63091e.png)
   - Then click **Search Attributes** and select **Track event** from the **Action type** drop-down list.
     ![Screenshot 2024-08-04 at 7.23.18 PM.png](/images/moengage_bad001.png)
   - In the **Track Event** field:
     ...
     - For the Asian button, set the event as Asian\_clicked.
       ![Screenshot 2024-08-04 at 7.25.23 PM.png](/images/moengage_e7f06d.png)
...
4. In the **Delivery Controls** section, define the controls based on your requirements. For more information, refer to [Create In-App Campaign](/user-guide/campaigns-and-channels/in-app-message/create/create-in-app-campaign).
   ![image-20240121-054810.png](/images/moengage_a7a82b.png)
5. Click **Publish**.
