...
sidebarTitle: "How to Retarget Dropped-Off Customers"
---
...
<img alt="UC57-a.png"  src="/images/moengage_35055f.png"  />
...
- Events to track the action of a user adding the items to a cart and purchasing a product. In this example, we will name the event as "addedToCart” and “Product Purchased” respectively. To understand how to track events, refer to the [Developer Guide](https://developers.moengage.com/hc/en-us).
...
5. To add more events, click **+ Add Step** and select "Product Purchased" from the drop-down list.  
    <img alt="UC57-1.png" src="/images/moengage_1fbbd3.png" />
6. Click **+ OR** to add other events to each step. This can be helpful if you have multiple events for different platforms or different actions that are part of same step that leads to the end goal, as shown below:  
    <img alt="UC57-2.png" src="/images/moengage_086374.png" />   
...
7. In the **Filter Users** section, select **All users**because we want to perform this analysis on all users and not a specific segment of users.   
    <img alt="UC57-3.png" src="/images/moengage_72c330.png" />
8. In the **Funnel Options** section, enter the following details:
   ...
   The following images show an example of how you can define the options:  
    <img alt="UC57-4.png" src="/images/moengage_3c4f8b.png" />
9. Click **APPLY**. As expected, the chart shows the drop-offs in users who did the events from "Product Viewed" to "Product Purchased".  
    <img alt="UC57-5.png"  src="/images/moengage_5bfc16.png"  />
...
1. Click the "Step 3 Product Purchased" column (or the third column). The Create segment pop-up is displayed:  
    <img alt="UC57-6.png"  src="/images/moengage_898bba.png"  />
...
7. From the **Delivery type** drop-down list, select "One Time Push Campaign" because we want to send the push notification to users only once.  
    <img alt="UC57-7.png"  src="/images/moengage_cef686.png"  />
8. Click **Create**. We are taken to the Push campaign creation page.
9. Create a Push campaign. For instructions on creating a Push campaign, refer to [Create Push Campaigns](https://help.moengage.com/hc/en-us/articles/206541583-Create-Push-Campaigns#01GTB20D7XGNCKZ7HFRC0B30P4).
...
For high value products or products with longer conversion, we can use Flows to send multiple communications to the user across channels. We can further analyse user journeys using [User Paths](https://help.moengage.com/hc/en-us/articles/36048677165332) in MoEngage.