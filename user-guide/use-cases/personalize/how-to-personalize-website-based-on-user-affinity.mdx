...
sidebarTitle: "How to Personalize Website Based on User Affinity"
---
...
- Integration of the MoEngage Web SDK with your website to create a personalized web experience. For more information, refer to [Web Personalization](https://developers.moengage.com/hc/en-us/articles/10645116433812-Web-Personalisation-V2).
...
7. Search for the event "Product Searched" and then select **Predominantly** with Category as Fitness and then click **Add**. To know more about users affinity segments and the filters, refer [here](https://help.moengage.com/hc/en-us/articles/360058291252-Affinity-Segments).  **<img alt="image-20240120-183254.png" src="/images/moengage_d67c9d.png" />**
