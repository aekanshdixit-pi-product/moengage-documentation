...
description: "Build a watch-next recommendation engine for your OTT platform using MoEngage to grow user engagement, watch time, and content discovery."
---
...
- The tracked events above must be mapped to the concerned MoEngage catalog user actions. In this example, the custom event of starting content will be mapped to *Product Viewed*. For information, refer to [Map User Actions Settings](/user-guide/content/recommendations/prerequisites/map-user-actions-settings).
