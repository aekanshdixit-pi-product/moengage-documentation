...
description: "Cross-sell and upsell study material packages to students using MoEngage recommendations based on their enrolled courses and interests."
---
...
3. While defining the message, select the product set that is generated through the recommendation [that you defined](/user-guide/use-cases/recommendations/how-to-nudge-users-to-continue-watching-content). Enter “@” and search for "DemoRecommendations,“ the name of the recommendation that you built, in the Push Personalization pop-up.  
