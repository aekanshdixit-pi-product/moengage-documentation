...
![image-20231202-162532.png](/images/moengage_465bc4.png)

![image-20231202-162336.png](/images/moengage_e3680e.png)
...
2. At the top right corner, click **\+ Create recommendation**. It takes you to the first step "Select recommendation model".
   ![image-20231126-104436.png](/images/moengage_415bc9.png)
3. Select the **User Actions** model and click **Next**. It takes you to the second step "Create recommendation". Enter the following details:
   ...
   3. **Catalog**: Select the catalog on which the recommendation is going to be worked. In this example, select "Demo - ECommerce".
      ![image-20231126-112521.png](/images/moengage_4109ba.png)
...
2. Under **Outbound**, select **Push** \> **Event Triggered**.
   ![UC-61 Event triggered.png](/images/moengage_5af464.png)
...
3. Enter the following details:
   ...
   - **Campaign tags**: Select the required campaign tags.
     ![UC-61 campaign details.png](/images/moengage_27cd45.png)
...
5. To define the dynamic check mentioned above:
   ...
   6. Under THEN trigger the message, select **With Delay** and define the delay based on the requirement. This will be the maximum time the user will be evaluated to fulfill the conditions from the time the first condition was fulfilled.\
      ...
      ![image-20231128-162022.png](/images/moengage_ff4937.png)
6. In the **Target Audience** section, select **All users**.
   ![image-20231129-212852.png](/images/moengage_25cbab.png)
...
3. While defining the message, select the product set that is generated through the recommendation [that you defined](#Create-a-Recommendation). Enter “@” and search for “ProductViewed\_By\_Users”, the name of the recommendation that you built, in the Push Personalization pop-up. <img alt="image-20231126-112839.png" src="/images/moengage_d14127.png" />
...
1. In the **Send campaign** section, define when you want to start and end your campaign.
   ![3.png](/images/moengage_bfee38.png)
...
3. Define **Delivery controls** and **Advanced** settings based on your requirements. For more information, refer to [Create Push Campaigns](/user-guide/campaigns-and-channels/mobile-push/create/create-push-campaigns).
   ![4.png](/images/moengage_d042cc.png)
4. Click **Publish**.
