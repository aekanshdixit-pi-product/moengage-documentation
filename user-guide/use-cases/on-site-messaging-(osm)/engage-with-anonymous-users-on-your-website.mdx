...
description: "Target anonymous website visitors showing high intent with on-site messaging. Engage users who haven't logged in using real-time personalized prompts."
---
...
We will achieve this use case by [creating an OSM campaign](#h_01J1SQNZF1D2REJK368G3Y5V8C) to engage with anonymous users.

# Expected Result

When users visit the website, they will see the following pop-up message.

<img alt="Screenshot 2025-03-18 at 11.52.43 AM.png"  src="/images/moengage_64a427.png"  />

<Tip>
- Your website must be integrated with the MoEngage Web SDK. For more information, refer to [Web SDK](https://developers.moengage.com/hc/en-us/sections/360013507792-Web-SDK-Integration).
- Events to capture a user’s behavior must be available in MoEngage. To understand how to track events, refer to the [Developer Guide](https://developers.moengage.com/hc/en-us). In this example, we will use the events *Viewed Product* and *Purchase Completed*.
...
3. Under **Inbound**, click **On-site**.  
    <img alt="Screenshot 2025-04-29 at 2.14.36 PM.png"  src="/images/moengage_3f1631.png"  />   
...
5. In the **Target platforms** section, select **Web**.  
    <img alt="4.png"  src="/images/moengage_bd0f13.png"  />
...
7. In the **Select trigger time** section, click **After Delay** and set the delay to *5 seconds*. This ensures that when the users open the website the next time, the on-site message will be triggered after 5 seconds.  
    <img alt="Screenshot 2025-01-27 at 12.25.06 PM.png" src="/images/moengage_d1531e.png" />
8. In the **Select pages** section, click **All pages**.  
    <img alt="Screenshot 2025-01-27 at 12.26.16 PM.png" src="/images/moengage_a4a555.png" />
9. In the **Target Audience** section, define the audience as *users who have viewed products multiple times and not added to the cart in the last 10 days,* as shown below:  
    <img alt="2025-01-27_12-35-47 (1).gif" src="/images/moengage_1533fb.png" />   
   <Info>
...
2. Hover over the required template and click **Select Template**. You can also start from scratch by selecting **Blank Popup Template**.  
    <img alt="2025-01-27_12-46-02 (1).gif" src="/images/moengage_d59f8b.png" />
3. You can add personalized elements to your campaign. For example, you can personalize the product name instead of a generic word. Follow the steps shown in the GIF below. For more information, refer to [Personalize](/user-guide/personalize/overview/overview-personalize).  
    <img alt="2025-01-27_14-14-13 (1).gif" src="/images/moengage_889980.png" />
...
1. In the **Send campaign** section, define when you want to start and end your OSM campaign.  
    <img alt="11.png" src="/images/moengage_d33c31.png" />
...
5. In the **Local Delivery controls** section, define the controls based on your requirements. For more information, refer to [Create OSM Campaign](/user-guide/campaigns-and-channels/on-site-message/create/create-osm-campaign).  
    <img alt="12.png" src="/images/moengage_b713b3.png" />
6. Click **Publish**.
