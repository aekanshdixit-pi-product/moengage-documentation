...
We will achieve this use case by [creating an On-site Messaging (OSM) campaign](#Create-an-OSM-Campaign) to encourage users to complete their purchases when they try to exit from the payments page.
