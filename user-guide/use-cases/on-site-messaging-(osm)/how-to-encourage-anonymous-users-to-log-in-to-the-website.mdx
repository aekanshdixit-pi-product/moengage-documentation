...
description: "Encourage anonymous app users to log in with personalized on-site messaging prompts. Convert unknown visitors into identified users for better targeting."
---
...
5. In the **Local Delivery controls** section, define the controls based on your requirements. For more information, refer to [Create OSM Pro Campaign](/user-guide/campaigns-and-channels/on-site-message/create/create-osm-campaign). Configure the pop-up to be shown only once per user.  
