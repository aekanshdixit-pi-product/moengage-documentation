...
sidebarTitle: "Increase Newsletter Subscriptions"
---
...
9. In the **Target audience** section, we will define sports enthusiasts as users who predominantly read sports-related news.
   1. Select the **Filter users by** option and click the **User affinity** tab. For more information, refer to [Affinity Segments](https://help.moengage.com/hc/en-us/articles/360058291252).  
...
4. You can add personalized elements to your campaign. For example, you can greet the user with their first name instead of any generic word. Follow the steps shown in the GIF below. For more information, refer to [Personalize](https://help.moengage.com/hc/en-us/articles/12592564915604).  
...
5. In the **Local Delivery controls** section, define the controls based on your requirements. For more information, refer to [Create OSM Campaign](https://help.moengage.com/hc/en-us/articles/14111506452372).  
...
Now that we have published the campaign, we can track our CTR and conversions (if defined) to understand how well it is performing. For more information, refer to [Analyze Onisite Messaging Campaigns](https://help.moengage.com/hc/en-us/articles/360054475351-Campaign-Analytics-for-On-site-Messaging-Campaigns#h_01HGZD9X6F9A19KZWY1W5DQW85).