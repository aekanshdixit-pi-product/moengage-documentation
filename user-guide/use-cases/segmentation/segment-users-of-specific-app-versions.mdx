...
sidebarTitle: "Segment Users of Specific App Versions"
---
...
We will achieve this use case by [creating a segment](#h_01JP36ZSV5S45QYTYYK02GF1VV) to target users of the current App Version 8.3.1.

## Expected Result

You will get a segment of users who are using the App Version 8.3.1.

<img  src="/images/moengage_57c6a4.png"  />
...
1. On the left navigation menu in the MoEngage dashboard, click **Segments \> Create segment.** For more information on creating segments, refer [here](https://help.moengage.com/hc/en-us/articles/206169646-Create-Segments).
2. Click the Filter users by option and then click the **User behavior** tab.
3. Filter users who have executed the *App/Site Opened* event at least once in the last 90 days
4. Add attributes as *App Versions* and select the *App Version* *8.3.1* to target users using that specific app version.
5. Click **+ Create.**  
    <img src="/images/moengage_95e177.png" />
