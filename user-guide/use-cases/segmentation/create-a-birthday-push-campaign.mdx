...
1. [Verify the availability of data](#Verify-the-Availability-of-Data)
2. [Create a Push campaign](#Create-a-Push-Campaign)

# Expected Result

Users receive a push notification on their phones on their birthday:

![6usecase6.png](/images/moengage_5c4d72.png)
...
2. On the [User Profile](/user-guide/data/user-data/user-profile) page, check if the **Birthday** field has the birthday data.\
   ...
   ![birthday.png](/images/moengage_15da45.png)
   <Info>
...
3. Under **Outbound**, click **Push** \> **Periodic**.
   ![periodic.png](/images/moengage_2d8257.png)
...
4. Define your campaign with a name and tags. Enter the following details:
   ...
   3. **Campaign tags**: Select the required campaign tags.
      ![6usecase2.png](/images/moengage_2103c9.png)
5. In the **Target audience** section, define the audience for your campaign.
   ...
   4. In the filter condition, select _is today_. The _Yearly where the date_ _is today_ combination filters out the users whose birthday is today. So whenever this query is executed, you will get a list of users whose birthday is on that day.
      ![Birthday\_Segment.gif](/images/moengage_aaebe7.png)
6. In the **Target Platforms** section, select all three platforms (Android, iOS, and Web).
   ![6usecase3.png](/images/moengage_0aafe3.png)
...
1. Select the template that you would like to use. For example, select **Basic notification**.
   ![6usecase4.png](/images/moengage_1701b9.png)
...
4. Add the information for all the platforms. For more information, refer to [Create Push Campaign](/user-guide/campaigns-and-channels/mobile-push/create/create-push-campaigns).
   ![BdayPush.gif](/images/moengage_a336ae.png)
...
1. In the **Send campaign** section, do the following:
   ...
   2. Set up the start date, send time, AM/PM, and set the frequency as _Daily_.
      ![6usecase5.png](/images/moengage_48e7a1.png)
2. In the **Delivery controls** section, turn the **Ignore frequency capping** and **Ignore global minimum delay** toggles on.
   ![6usecase7.png](/images/moengage_c311bc.png)
3. In the **Advanced** section, under **Expiration settings**, set up the **Expire notifications after** and **Remove notifications from inbox after**field values.
   ![6usecase8.png](/images/moengage_b32404.png)
4. Click **Publish**.
