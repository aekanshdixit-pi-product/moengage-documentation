...
description: "Discover and segment web push subscribers in MoEngage by permission status, subscription date, page URL, and notification engagement metrics."
---
...
A popular use-case of the *Viewed Web Page* event is to send viewed/cart abandonment notifications to your subscribers and take them directly to the web page they dropped off from. For more information, refer to [Web Push Campaigns in 60 Minutes](/user-guide/campaigns-and-channels/web-push/getting-started-with-web-push/web-push-campaigns-within-60-minutes).
