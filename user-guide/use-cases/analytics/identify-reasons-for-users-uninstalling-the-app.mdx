...
description: "Understand why users uninstall your app and identify the key touchpoints leading to churn. Use MoEngage analytics to reduce uninstall rates effectively."
---
...
4. In the **Funnel Options** section:
   1. In the **Funnel Type** list, select *Funnel - Unique Users*. To learn more about the funnel types, refer to [Funnels](/user-guide/analyze/analytics/funnels/funnels-overview).
