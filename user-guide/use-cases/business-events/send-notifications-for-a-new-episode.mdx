...
2. [Create a business event](#Create-a-Business-Event)
3. [Create a Push campaign](#Create-a-Push-Campaign)
4. [Trigger the alert for a new episode](#Trigger-the-Alert-for-a-New-Episode)
...
1. Write the information above in the JSON format and send it to MoEngage through Postman: JSON
   ```text
   {
   "event_name": "ENT\_New\_Content\_Released",
   "event_attributes": [
   {
