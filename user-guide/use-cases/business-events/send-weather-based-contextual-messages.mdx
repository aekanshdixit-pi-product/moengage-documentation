...
description: "Trigger automated weather-based messages using MoEngage business events to deliver contextually relevant promotions tied to local weather conditions."
---
