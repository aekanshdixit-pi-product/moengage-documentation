...
2. [Create an Email campaign](#Create-an-Email-Campaign)
3. [Trigger the campaign by triggering the business event](#Trigger-Campaign-by-Triggering-Business-Events)
...
3. To verify if the event was successfully added:
   ...
   2. In the **Select Business Event** list, you can check for your event. You can see the _WeatherUpdate1_ event listed there. \\
      <Frame>
        ![Wether 2](/images/wether-2.png)
      </Frame>
...
4. From the **Select business event** list, select the _WeatherUpdate1_ event.\\
   <Frame>
     ![Weather 5](/images/weather-5.png)
   </Frame>
