...
1. [Create a business event](#Create-a-Business-Event)
2. [Create a Push campaign](#Create-a-Push-Campaign)
3. [Trigger the campaign by triggering the business event](#Trigger-the-Campaign-by-Triggering-the-Business-Event)
...
3. Under **Outbound**, click **Push** \> **Business Event Triggered**.
    <img src="/images/moengage_282b60.png" alt="BUSINESSPUSH.png" /> \
