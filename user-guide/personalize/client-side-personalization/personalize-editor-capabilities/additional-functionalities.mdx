...
You can use the default _auto_ property to define the selected element's size and position. In this case, the browser calculates the size and position of the element depending on the device in use.<img alt="auto.png" src="/images/moengage_ee95f9.png" style={{ width:"53%" }}/>
