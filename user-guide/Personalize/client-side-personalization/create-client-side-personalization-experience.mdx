...
sidebarTitle: "Create Client-side personalization experience"
---
...
8. Click *Add* at the bottom right corner of the screen to add the audience. <img alt="AddAudience.gif" src="/images/moengage_f0024d.png" />

### Control Group

Toggle the *Global control group* to exclude users in the global control group from the Experience. For more information, refer to [Control Groups.](https://help.moengage.com/hc/en-us/articles/360052829132-Control-Groups-)
...
<img alt="FilterConditions.png"  src="/images/moengage_6113f6.png"  />

<img alt="MultiplePages.gif"  src="/images/moengage_67cb25.png"  />
...
<img alt="Custom Attributes Personalize.gif"  src="/images/moengage_dbd359.png"  />
...
- - Check if the Web SDK is integrated.
  - Check if an experience has already been configured for the URL specified for personalization. A message is shown in the UI if an experience has already been added to the URL.
    ...
    <img alt="URLHasExperienceAlready.gif" src="/images/moengage_bda644.png" />

You can personalize the URL by clicking **Personalize URL** at the bottom right corner of the popup.

# Step 2: Content

In this step, you personalize the webpage using MoEngage's WYSIWYG editor. Refer [here](https://help.moengage.com/hc/en-us/sections/33615909444756-Personalize-Editor-Capabilities) for a deep-dive on the editor capabilities.
...
<img alt="Personalize AB Testing.gif" src="/images/moengage_818c99.png" />
...
| --- | --- |
| Field | Description |
| Variation | There are two options present by default:   1. Default Variation 2. Variation 1   You can add another variation by clicking the *+ Variation* at the lower left corner of the screen. Note: You can add up to 5 variations for each target audience. For more information, refer to [Dynamic multivariate testing](https://help.moengage.com/hc/en-us/articles/115000913866-Dynamic-Multivariate-Experiment). |
...
<img alt="DeliverySchedule.png" src="/images/moengage_07a60d.png" />
...
<img alt="ordersuccessful.png" src="/images/moengage_c0889a.png" />
...
<img alt="Trackrevenue.png" src="/images/moengage_7d674b.png" />
...
<img alt="AttributionWindow.png" src="/images/moengage_9cc194.png" />
