...
sidebarTitle: "Content Security Policy and impact on Personalization"
---
...
- **style-src 'self' 'unsafe-inline' fonts.googleapis.com**; allows stylesheets to be loaded from the same origin ('self'), allows inline styles ('unsafe-inline'), and allows stylesheets from [fonts.googleapis.com](http://fonts.googleapis.com).
- **img-src 'self' data**; allows images to be loaded from the same origin ('self') and allows data URLs.
- **font-src 'self' fonts.gstatic.com**; allows fonts to be loaded from the same origin ('self') and allows fonts from [fonts.gstatic.com](http://fonts.gstatic.com).
