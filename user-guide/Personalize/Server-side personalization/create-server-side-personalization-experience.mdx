...
sidebarTitle: "Create Server-side Personalization Experience"
---
...
1. [**Target Users**](#1): Specify the audience for your web experience.
2. [**Content**](#2): Specify the variation and personalized content for the selected users.
3. [**Schedule and goals**](#3): Specify a delivery schedule and conversion goals for the experience.
...
- **Experience tags** - Select the experience tags from the drop-down list. Tags help you add context to your experience. For example, you can add 'onboarding' as a tag for an experience created for onboarding users to your platform or app. For more information, refer to [Tags](https://help.moengage.com/hc/en-us/articles/360058057412-Campaign-Tags-).
...
2. **Segmentation criteria** - the segmentation filters that help you define your audience.
   ...
   For more information, refer to [Create Segments](https://help.moengage.com/hc/en-us/articles/206169646).
   ...
   For more information, refer to [User Affinity](https://help.moengage.com/hc/en-us/articles/360058291252-Affinity-Segments).
...
3. **In-session attributes** - allow you to group visitors based on specific conditions. You can add the following in-session attributes:
   ...
   | Field | Description |
   | --- | --- |
   | Query Parameter | The Query Parameter field enables the use of custom key-value pairs to identify and include users in a specific target audience. These key-value pairs act as an additional layer of targeting criteria, supplementing the segmentation rules already defined.  **For instance:** If your app supports content in multiple languages, such as English and Spanish, you can define a key called *language\_preference* with corresponding values: **en**: To target users who prefer content in English. **es**: To target users who prefer content in Spanish.  By leveraging this field, you can ensure that users are matched to the appropriate audience based on their preferences or attributes, providing them with a more personalized and contextually relevant experience. |
...
7. Click *Add* at the bottom right corner of the screen to add the audience. <img alt="AddAudience.gif" src="/images/moengage_be35d0.png" />
...
<img alt="Screenshot 2024-02-26 at 3.06.10 PM.png" src="/images/moengage_4ade9d.png" />
...
- [Catalogs](https://help.moengage.com/hc/en-us/articles/17456587985428-Catalogs)
...
- [Decision Policies](https://help.moengage.com/hc/en-us/articles/38697925717396-Decision-Policy)

Do the following:

1. You can personalize your content by pressing **@** anywhere within the text area as shown below.   
    <img alt="Personalize API payload personalization.gif" src="/images/moengage_569701.png" />
...
<img alt="DeliverySchedule.png" src="/images/moengage_85d471.png" />
...
<img alt="ordersuccessful.png" src="/images/moengage_dcf8c9.png" />
...
<img alt="Trackrevenue.png" src="/images/moengage_d5b026.png" />
...
<img alt="AttributionWindow.png" src="/images/moengage_0c1ec9.png" />
