...
1. - Order/Booking/Purchase confirmations and pertinent updates
...
1. 1. Build APIs for multiple channels
...
1. - send personalized Transactional Messages on multiple channels
   - add new channels
