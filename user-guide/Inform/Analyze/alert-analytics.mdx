...
5. **Delivery Failed**  
   This is the total number of requests for which the SMS notification has not been delivered. This information is passed on to the SMS vendor and can represent various reasons like the Recipient is unreachable, the Inbox full, and so on. For more information, refer to [Common SMS Errors](https://help.moengage.com/hc/en-us/articles/41052133057428-Analyze-SMS-Campaigns#01K4YHYDZAT668P7P9MKC598KK).
...
3. **Delivered**  
   This is the total number of emails that have been delivered to the user. This is only available for Alerts employing vendors SendGrid and Amazon SES. The percentage denotes the total number of emails delivered successfully for every request received. For more information, refer to [Common Email Errors](https://help.moengage.com/hc/en-us/articles/16242513761556-Email-Analytics-and-Info#h_01GQM0HNVSGKX28S9M2W8DCZ0T).
4. **Clicks**  
...
For more information, refer to [Email Channel Stats](https://help.moengage.com/hc/en-us/articles/16242513761556-Email-Analytics-and-Info).
...
6. **Delivery Failed**  
   This is the total number of requests for which the notifications have not been delivered due to errors in sending the messages to GCM/APNS. For more information, refer to [Common Push Errors](https://help.moengage.com/hc/en-us/articles/12598903874196-Push-Analytics-and-Info#h_01GQM0HNVSGKX28S9M2W8DCZ0T).
...
For more information, refer to [Push Channel Stats](https://help.moengage.com/hc/en-us/articles/12598903874196-Push-Analytics-and-Info).
...
4. **Read**This is the total number of WhatsApp messages read by the user.  
   For more information, refer to [WhatsApp Stats](https://help.moengage.com/hc/en-us/articles/5183700770324-Analyze-WhatsApp-Campaign).
5. **Clicks**  
