...
description: "Optimize the delay between trigger events and push delivery in event-triggered campaigns using AI-driven timing instead of static delay settings."
---
