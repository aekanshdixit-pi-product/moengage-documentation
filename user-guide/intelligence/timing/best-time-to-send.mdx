...
<table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '14px' }}>
  <thead>
    <tr>
      <th colSpan="3" style={{ padding: '12px', textAlign: 'center', border: '1px solid' }}>
  ...
  <tbody>
    <tr>
      <td rowSpan="8" style={{ width: '30%', padding: '16px', border: '1px solid', verticalAlign: 'top' }}>
        Of 100 users, the users whose BTS is available: <b>75</b>
      </td>
      <td colSpan="2" style={{ padding: '16px', border: '1px solid' }}>
        Number of users whose best time is within the BTS window (6:58 PM to 9:58 PM): <b>50</b>
      </td>
    </tr>
    <tr>
      <th style={{ padding: '12px', border: '1px solid', width: '35%', fontWeight: 'normal' }}>
    ...
    <tr>
      <th style={{ padding: '12px', border: '1px solid', fontWeight: 'normal' }}>
    ...
    <tr>
      <td style={{ padding: '16px', border: '1px solid', verticalAlign: 'top' }}>
        Of 100 users, the users whose BTS is not available: <b>25</b>
      </td>
      <td colSpan="2" style={{ padding: '16px', border: '1px solid', verticalAlign: 'top' }}>
