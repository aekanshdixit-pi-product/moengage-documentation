...
<table style={{ borderCollapse: 'collapse', width: '100%', fontSize: '14px', margin: '20px 0' }}>
  <thead>
    <tr>
      <th colSpan="3" style={{ border: '1px solid #e5e7eb', backgroundColor: '#eff6ff', padding: '12px', textAlign: 'center' }}>
  ...
  <tbody>
    <tr>
      <td rowSpan="8" style={{ border: '1px solid #e5e7eb', padding: '16px', verticalAlign: 'top', width: '30%' }}>
        Of 100 users, the users whose BTS is available: <b>75</b>
      </td>
      <td colSpan="2" style={{ border: '1px solid #e5e7eb', padding: '16px' }}>
        Number of users whose best time is within the BTS window (6:58 PM to 9:58 PM): <b>50</b>
      </td>
    </tr>
    <tr>
      <td style={{ border: '1px solid #e5e7eb', backgroundColor: '#eff6ff', padding: '12px', width: '35%' }}>
        <b>25 users have the best time as 7 PM</b>
      </td>
      <td style={{ border: '1px solid #e5e7eb', backgroundColor: '#eff6ff', padding: '12px', width: '35%' }}>
        <b>The campaign will be sent at 7 PM</b>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td style={{ border: '1px solid #e5e7eb', backgroundColor: '#eff6ff', padding: '12px' }}>
        <b>15 users have the best time before 7 PM</b>
      </td>
      <td style={{ border: '1px solid #e5e7eb', backgroundColor: '#eff6ff', padding: '12px' }}>
        <b>The campaign will be sent at 6:58 PM (start time)</b>
      </td>
    </tr>
    <tr>
      <td style={{ border: '1px solid #e5e7eb', padding: '12px' }}>
    ...
    <tr>
      ...
      <td colSpan="2" style={{ border: '1px solid #e5e7eb', padding: '16px', verticalAlign: 'top' }}>
