...
<img alt="mceclip0.png" src="/images/moengage_6754a7.png" />
...
<table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #E2E8F0', fontSize: '14px' }}>
  <thead>
    <tr>
      <th colSpan="3" style={{ backgroundColor: '#eff6ff', padding: '12px', textAlign: 'center', borderBottom: '1px solid #E2E8F0' }}>
        Total users in Segment: <b>100</b>
      </th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td rowSpan="8" style={{ width: '30%', padding: '16px', borderRight: '1px solid #E2E8F0', borderBottom: '1px solid #E2E8F0', verticalAlign: 'top' }}>
        Of 100 users, the users whose BTS is available: <b>75</b>
      </td>
      <td colSpan="2" style={{ padding: '16px', borderBottom: '1px solid #E2E8F0' }}>
        Number of users whose best time is within the BTS window (6:58 PM to 9:58 PM): <b>50</b>
      </td>
    </tr>
    <tr>
      <td style={{ backgroundColor: '#eff6ff', padding: '12px', borderRight: '1px solid #E2E8F0', borderBottom: '1px solid #E2E8F0', width: '35%' }}>
        <b>25</b> users have the best time as 7 PM
      </td>
      <td style={{ backgroundColor: '#eff6ff', padding: '12px', borderBottom: '1px solid #E2E8F0', width: '35%' }}>
        The campaign will be sent at 7 PM
      </td>
    </tr>
    <tr>
      <td style={{ padding: '12px', borderRight: '1px solid #E2E8F0', borderBottom: '1px solid #E2E8F0' }}>
        <b>15</b> users have the best time as 8 PM
      </td>
    ...
    <tr>
      <td style={{ padding: '12px', borderRight: '1px solid #E2E8F0', borderBottom: '1px solid #E2E8F0' }}>
        <b>10</b> users have the best time as 9 PM
      </td>
      <td style={{ padding: '12px', borderBottom: '1px solid #E2E8F0' }}>
    ...
    <tr>
      <td colSpan="2" style={{ padding: '16px', borderBottom: '1px solid #E2E8F0' }}>
        Number of users whose best time lies <b>outside</b> the BTS window (6:58 PM to 9:58 PM): <b>25</b><br/><br/>
        Depending on the option you choose under "If user’s best time is outside this time window"<br/>
        • If you choose "Send message at start time or end time", let us assume
      </td>
    </tr>
    <tr>
      <td style={{ backgroundColor: '#eff6ff', padding: '12px', borderRight: '1px solid #E2E8F0', borderBottom: '1px solid #E2E8F0' }}>
        15 users have the best time before 7 PM
      </td>
      <td style={{ backgroundColor: '#eff6ff', padding: '12px', borderBottom: '1px solid #E2E8F0' }}>
    ...
    <tr>
      <td style={{ padding: '16px', borderRight: '1px solid #E2E8F0', verticalAlign: 'top' }}>
        Of 100 users, the users whose BTS is not available: <b>25</b>
      </td>
      <td colSpan="2" style={{ padding: '16px', verticalAlign: 'top' }}>
        Depending on the option chosen under "if user's best time is not available"<br/><br/>
        • The campaign will be sent either at the campaign start time of 6:58 PM<br/>
        • At the app's best time. App's best time is explained in detail below<br/>
...
You can also segment the users based on their best time value. The BTS attribute is available in the **User Property** drop-down list, under the **Predictive Insights (Merlin AI)** section.
  ...
  <img alt="mceclip1.png" src="/images/moengage_707117.png" />
...
<Accordion title="1. what are the specific data points used to measure user engagement across different channels (email, push notifications, SMS)? For example, does this include metrics like open rates, click-through rates, or time spent on content?">
...
<Accordion title={`2.What are the specific data points (attributes or events) considered in the context while referring to "all outbound engagement with users"?`}>
...
<Accordion title="3. What are the SDK- events tracked in the BTS calculation?">
...
<Accordion title="4. How are the estimations for Best Time to Send and Most Preferred Channel calculated?">
...
<Accordion title="5. What validation methods are in place to ensure the accuracy and reliability of these estimations?">
...
<Accordion title="6. How do the models handle edge cases or anomalies in user data?">
