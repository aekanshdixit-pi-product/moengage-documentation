...
Assume that there were 100 users in the segment and distributed as explained below:

### Total users in Segment: 100

**1. Of 100 users, the users whose BTS is available: 75**

* **Number of users whose best time is within the BTS window (6:58 PM to 9:58 PM): 50**

    | User Distribution | Campaign Send Time |
    | ----------------- | ------------------ |
...
**2. Of 100 users, the users whose BTS is not available: 25**
