...
Ans. Campaign Uplift measures the impact of your message variations to drive conversion goal. Control Group performance serves as base-line to calculate the Uplift. You can check this in detail [here.](/user-guide/campaigns-and-channels/getting-started/introduction/control-groups)
