---
title: "Overview"
description: "Explore A/B and multivariate testing concepts in MoEngage, including split testing methods, control groups, and statistical significance."
---
...
If you only want to test whether _Android Push Notifications with images get better CTRs than the ones without_, you should create two variations with similar content with the only difference that you send out the image with one of the variations and not with the other.
...
For more information, refer to [Static User Distribution](/user-guide/intelligence/ab-testing/what-is-ab-or-multivariate-testing/manual-multivariate-experiment).
...
For more information, refer to [Dynamic User Distribution](/user-guide/intelligence/ab-testing/what-is-ab-or-multivariate-testing/dynamic-multivariate-experiment).
...
- [Manual User Distribution](/user-guide/intelligence/ab-testing/what-is-ab-or-multivariate-testing/manual-multivariate-experiment)
- [Dynamic User Distribution](/user-guide/intelligence/ab-testing/what-is-ab-or-multivariate-testing/dynamic-multivariate-experiment)
- [Perform User Distribution Manually in Campaigns](/user-guide/intelligence/ab-testing/create-multivariate-testing/perform-user-distribution-manually)
- [Perform User Distribution Dynamically in Campaigns](/user-guide/intelligence/ab-testing/create-multivariate-testing/perform-user-distribution-dynamically-using-merlin-ai)
...
- [Analyze Variation Campaigns](/user-guide/intelligence/ab-testing/analyze-multivariate-testing/analyze-multivariate-experiments)
