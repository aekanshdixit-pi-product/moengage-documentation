...
The Decisioning Agent Analytics page provides a centralized view to evaluate your AI Agent’s performance across multiple campaigns. It measures the "Incremental Value" of AI by comparing a Treatment Group (AI-optimized) against a Control Group (baseline).
