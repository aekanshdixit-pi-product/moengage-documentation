...
Revenue Tracking is an optional feature associated with the primary conversion goal of an offering. For information about enabling revenue tracking, refer to [Revenue Tracking](/user-guide/settings/advanced-settings/campaign-attribution-settings).
