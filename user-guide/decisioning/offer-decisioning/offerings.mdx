...
Assign [attributes](/hc/en-us/articles/48238775389716) to your offering so it can be scored by the Custom Formula ranking strategy in a Decision Policy. You can assign up to 5 attributes per offering.
...
If no attributes are available in the dropdown, you must first configure them in **Settings** \> **Offer Decisioning** \> **Offering Attributes**. For more information, refer to [Offering Attributes](https://help.moengage.com/hc/en-us/articles/48238775389716-Offering-Attributes).
