...
You can view the uplift percentage in the tabular view of Conversion Goals performance. For more information, refer to [Uplift in Campaigns](/user-guide/campaigns-and-channels/getting-started/introduction/control-groups). <img alt="conversion performance.png" src="/images/moengage_3b467d.png" />
