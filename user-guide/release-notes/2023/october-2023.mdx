...
Localization support has been added for the email channel with this release. You can add locale variations to your email campaigns and analyze the performance of these variations in campaign analytics. For more information, refer to [Variation Performance](/user-guide/campaigns-and-channels/email/analyze/email-analytics-and-info).
