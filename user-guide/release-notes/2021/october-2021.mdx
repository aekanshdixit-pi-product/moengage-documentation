...
For more information, refer to [Dynamic Multivariate Testing for Email](/user-guide/intelligence/ab-testing/what-is-ab-or-multivariate-testing/dynamic-multivariate-experiment).
