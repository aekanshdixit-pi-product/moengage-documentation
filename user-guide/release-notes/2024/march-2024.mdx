...
For more information, refer to [In-session attributes](/user-guide/campaigns-and-channels/on-site-message/create/create-osm-campaign).
...
For more information, refer to [Trigger Criteria](/user-guide/campaigns-and-channels/in-app-message/create/create-in-app-campaign).
