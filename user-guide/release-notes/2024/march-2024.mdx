...
In this release, MoEngage introduces Template Groups. You can create template groups by passing the `locale`, `variant`, and `group\_id` parameters in the Create Email Template API. For more information, refer to [Create Email Template API](https://www.moengage.com/docs/api/email-templates/create-email-template-v2).
