...
For more information, refer to [Add Forms to your In-App Campaign](/user-guide/campaigns-and-channels/in-app-message/templates/drag-and-drop-editor/add-forms-to-your-in-app-campaign) and [Form Inputs](/user-guide/campaigns-and-channels/in-app-message/analyze/analyze-in-app-campaigns).
