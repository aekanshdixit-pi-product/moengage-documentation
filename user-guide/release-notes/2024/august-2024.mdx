...
For more information, refer to [Generate Email Subject Line and Preview Text with Merlin AI](/user-guide/intelligence/merlin-ai/merlin-ai-copywriter/generate-email-subject-line-and-preview-text-with-merlin-ai).
...
For more information, refer to [Global Exit Criteria](/user-guide/flows-cross-channel-messaging/create/create-flows/create-a-flow).
