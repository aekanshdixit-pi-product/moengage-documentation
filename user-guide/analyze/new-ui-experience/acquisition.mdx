---
title: "Acquisition"
description: "Evaluate user acquisition campaigns in the updated MoEngage UI — view attribution data for publishers, campaigns, and lifetime value metrics."
---
...
To access the Acquisition page, perform the following steps:

1. On the sidebar menu in MoEngage, hover over the **Analyze** menu item <img alt="Screenshot 2025-06-13 at 5.55.10 PM.png"   src="/images/moengage_276c9b.png"   /> . The **Analyze** menu appears.
2. Click **Acquisition**.  
    <img alt="Screenshot 2025-06-18 at 12.33.05 PM.png"  src="/images/moengage_82a8f1.png"  />   
   The Acquisition page is displayed. <img alt="aquisition page.png" src="/images/moengage_c8f798.png"  />
