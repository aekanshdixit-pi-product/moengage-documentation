...
description: "How MoEngage tracks app uninstalls using silent push notifications and real-time FCM-based tracking, with setup steps for Android and iOS."
---
...
<img
  alt="UninstallTracking_REvampedUI.png"
  src="/images/moengage_fb2b48.png"
  style={{ width:"55%" }}
/>
