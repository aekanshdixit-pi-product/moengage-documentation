---
title: "My Studio"
description: "Save and organize your MoEngage analyses in My Studio — retrieve saved reports, resume interrupted work, and streamline your analytics workflow."
---
...
<iframe src="https://www.loom.com/embed/9d764d37e2c04feba905d47cc993321d" title="Loom video player" frameborder="0" className="w-full aspect-video rounded-xl" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />
...
2. Click **Analyse** and then select **My Studio**.
   <img
     alt="my studio.png"
     src="/images/moengage_4f3bab.png"
     style={{ width:"34%" }}
   />
3. Once you enter the My Studio dashboard, you'll see all your saved analyses with the following details:
   ...
   ![analysis.gif](/images/moengage_798511.png)
...
2. Under **Analyse**, select the **Users** type of analysis.
   <img
     alt="users.png"
     src="/images/moengage_2bf37b.png"
     style={{ width:"31%" }}
   />
...
6. Navigate to **My Studio** on your MoEngage dashboard to view the newly saved analysis.
   ![demo analysis.png](/images/moengage_601fe9.png)
...
2. Click the vertical ellipsis (...) next to the analysis name.
   ![Screenshot 2025-04-22 at 4.24.17 PM.png](/images/moengage_b9a6d1.png)
3. Select **Share** from the list. The **Share** settings window will appear.
   ![Screenshot 2025-04-22 at 4.25.31 PM.png](/images/moengage_623a12.png)
4. Configure the sharing settings. For more information, refer to [Configuring Sharing Settings](/user-guide/analyze/dashboards/my-studio#configuring-sharing-settings) below.
   ![2025-04-22\_16-40-59.png](/images/moengage_8fcaf6.png)
...
![Screenshot 2025-04-22 at 4.42.05 PM.png](/images/moengage_242e3a.png)
...
1. Click the **Copy Link** button to copy the unique, secure shareable link to your clipboard.
   ![2025-04-22\_16-38-24.png](/images/moengage_0dac0f.png)
2. Set Edit or View permissions for general access. For more information, refer to [Understanding Permissions](/user-guide/analyze/dashboards/my-studio#understanding-permissions) below.
...
2. From the **Access type** list, select the desired permission level (**View** or **Edit**) for the specified user(s).
   ![00000000.gif](/images/moengage_e4bee6.png)
3. Click **Share**.
...
![Screenshot 2025-03-17 at 3.59.01 PM.png](/images/moengage_6cb1ff.png)
...
While performing an analysis, you can access your in-progress analyses. Click the **Recents** button in the upper-right corner to display a list of all analyses you have recently worked on. Drafts are identified by this <img alt="Screenshot 2025-06-04 at 4.32.53 PM.png" src="/images/DRAFT-2.png" style={{ display:"inline" }} /> icon located next to the analysis name.

![2025-03-17\_17-27-11 (1).gif](/images/moengage_1b4825.png)
...
![2025-03-17\_16-09-04 (1).gif](/images/moengage_64ab42.png)

# View, Edit, or Delete Analysis

![2025-03-17\_16-19-22 (1).gif](/images/moengage_ee467b.png)
...
<img
  src="/images/moengage_7ff2aa.png"
  alt="save as new analysis.png"
  style={{ width:"37%" }}
/>
...
<Warning>
  ...
  ![new name.png](/images/moengage_5b42e5.png)
</Warning>
