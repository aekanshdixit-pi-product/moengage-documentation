...
You can add the following filters to your event:
   ...
   - Split events - You can use the **Split by** option to compare the selected attribute with another from the drop-down. To learn more, see [Comparing Properties](https://help.moengage.com/hc/en-us/articles/18129193565204-Compare-Mode-in-Analytics).  
...
4. Filter the users to whom this analysis may apply. The Behavior analysis is performed on all users having access to the workspace by default. You can also segment users using the **Filter by users** option.  
   For more information, refer [here](https://help.moengage.com/hc/en-us/articles/206169646-Create-Segments#01G2PMG9GWY99TNEV1TZP0N596).  
