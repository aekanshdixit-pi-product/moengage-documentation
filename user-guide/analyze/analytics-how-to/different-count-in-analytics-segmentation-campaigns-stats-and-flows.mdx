...
description: "Learn why user counts differ between MoEngage Analytics, Segmentation, Campaign stats, and Flows, and how each module calculates them."
---
...
**Note:** In Funnel analysis, Funnel - Unique User analysis with *Holding attribute constant* on campaign id attribute across all steps, provide unique converted user for each campaign for the selected granularity. Read more about it [here](/user-guide/analyze/analytics/funnels/advanced-funnel-analysis).
