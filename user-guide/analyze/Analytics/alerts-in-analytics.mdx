...
sidebarTitle: "Alerts in Analytics"
---
...
2. In the **Events & Filters** section, click the dropdown and then select **App/Site Opened**.  
    <img alt="app open.gif"  src="/images/moengage_e9fb32.png"  />
...
You can add the following filters to your event:
   ...
   - Add multiple attributes - You can add multiple attributes to your event by selecting the **AND** or **OR** logical operators. The analysis will execute all the attributes and then display the result to you.  
      <img alt="Events&amp;Filters.png" src="/images/moengage_8afaf4.png" />
   - Split events - You can use the **Split by** option to compare the selected attribute with another from the drop-down. To learn more, see [Comparing Properties](https://help.moengage.com/hc/en-us/articles/18129193565204).  
      <img alt="split by.png"  src="/images/moengage_b6f8fb.png"  />
   - Add multiple events - You can use the **+ Add Event** button to add a maximum of 10 events to your analysis. The analysis will execute all the events and display the result to you.  
      <img alt="compare two events.png" src="/images/moengage_336524.png" />
3. Filter the users to whom this analysis may apply. The Behavior analysis is performed on all users having access to the workspace by default. You can also segment users using the **Filter by users** option.  
   To learn more, see [Filter Users](https://help.moengage.com/hc/en-us/articles/33214017936532).  
    <img alt="FilterUsers.png" src="/images/moengage_ef1920.png" />
...
2. Select your analysis from the list of **Saved analysis**.  
    <img alt="saved analysis.png" src="/images/moengage_16e02b.png" />
...
4. Click **Set alert** to create a new alert for the selected analysis.  
    <img alt="create alert.gif" src="/images/moengage_240bb4.png"  />
...
After successfully setting up an alert, you will receive an email when the specified conditions are met. The email will include a visualization and details about the alert. It will inform you about the change in the metric, the percentage change, and the timestamp of when this data was evaluated.  
 <img alt="New_alert.png" src="/images/moengage_40d756.png" />
...
1. Click the Settings <img alt="settings.png"  src="/images/moengage_001f49.png"  /> on the left sidebar of your MoEngage dashboard.
2. Scroll down to **Reports and Alerts** and then select **Alert management** from the dropdown.  
    <img alt="reports alerts.png"  src="/images/moengage_7ffde7.png"  />
3. Select the **Analytics alerts** tab and then search for the alert that you want to view or manage.  
   ...
   - Use the **Subscribed by** dropdown to filter the alert based on the alert recipients.  
      <img alt="analytics alerts.png" src="/images/moengage_ff18d6.png" />
4. Once you locate your alert, click the verticle ellipsis <img alt="verticle ellipsis.png"  src="/images/moengage_8c9ee8.png"  /> under the **Actions** column at the right end of the table.
5. You can take the following actions:
   ...
   - **Delete**: An alert that is deleted will be permanently removed.  
      <img alt="unsubscribe.png"  src="/images/moengage_fddee1.png"  />
