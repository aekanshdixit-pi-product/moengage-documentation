...
User analysis follows a similar workflow to other analyses. For a basic overview of performing an analysis, refer [here](https://help.moengage.com/hc/en-us/articles/33114992690324).

We will begin with performing User Analysis in the next section.

# Next Step

- [Analysis](https://help.moengage.com/hc/en-us/articles/33185107111188-Analysis)