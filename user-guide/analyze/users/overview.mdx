...
<Tip>
Before you start creating email campaigns, make sure you have configured [email settings](/user-guide/campaigns-and-channels/getting-started-with-email/configure-email-channel).
</Tip>
...
4. Click one of the following campaign delivery types:
   ...
   For more information about delivery types, refer to [Delivery Types.](/user-guide/campaigns-and-channels/introduction/delivery-types-moengage-channels)
...
- **Teams**: If your organization has teams enabled, select a team in the drop-down list. For more information, refer to [Teams in MoEngage](/user-guide/settings/team-management/teams-in-moengage).
...
- **Campaign tags**: Campaign tags are used to provide context about the campaigns and describe the nature of the campaign or the campaign's central theme. Select campaign tags from the drop-down list. You can select a maximum of five tags. For more information, refer to [Campaign Tags](/user-guide/campaigns-and-channels/introduction/campaign-tags).
- **Campaign Content Type**: There are two types of campaigns that you can send using MoEngage, and they are promotional and transactional. For more information, refer to [Promotional Campaigns vs. Transactional Campaigns](/user-guide/campaigns-and-channels/getting-started-with-email/promotional-campaigns-vs-transactional-campaigns).  
   **<img alt="CreateEmail_CampaignDetails.png" src="/images/moengage_bf81bb.png" />**
- **Subscription Categories**: Subscription categories are a means to help users choose the type of communication they receive from your brand. They can be configured in the Email Channel settings. For more information, refer to [subscription categories](/user-guide/campaigns-and-channels/getting-started-with-email/configure-subscription-categories).  
...
Event-triggered campaigns allow you to send personalized messages triggered by different user action events. For example, you can remind users about the item they added to the cart but have not purchased. For more information on creating such campaigns, refer to [Create an Event-Triggered Campaign](/user-guide/campaigns-and-channels/event/create-an-event-triggered-campaign).
...
- **Exclude Users**: Select this checkbox to define the filter criteria for users to be excluded from the campaign. For more information, refer to [Preference Management](/user-guide/campaigns-and-channels/getting-started-with-mobile-push/preference-management-for-push-notifications).
...
|  |  |
| --- | --- |
| In the **Control groups** section:   - Turn the **Global control group** toggle on to not send the campaign to all the users in the control group - Turn the **Campaign control group** toggle on to not send the particular campaign to the control group.   For more information, refer to [Control Group](/user-guide/campaigns-and-channels/introduction/control-groups). | <img alt="mceclip10.png" src="/images/moengage_2d75fd.png" /> |
...
- **Deep linking Domain**: Deep linking your domain allows for a smoother and more direct user experience. Deep linking allows an app to be accessed and launched from a URL. For more information, refer to [Configure Deeplinking Domain](/user-guide/campaigns-and-channels/getting-started-with-email/configure-a-deep-linking-domain).

Type "@" and select among the list of user attributes. You will also need to select a fallback mechanism that applies when a personalization attribute is missing for a user. *[Read more about personalizing emails here.](/user-guide/campaigns-and-channels/create/personalize-email-content)*
...
You can attach one or more files as part of the message in the email campaigns. For more information, refer to [Add File Attachments to Email](/user-guide/campaigns-and-channels/create/add-file-attachments-to-email).

### Gmail annotation

Gmail annotations help customers conveniently view and engage with your promotions from their inboxes. For more information, refer to [Gmail Annotations](/user-guide/campaigns-and-channels/create/gmail-annotations).
...
While selecting a "from" email address, you can see the current reputation of each domain. For more information, refer to [Domain Reputation](/user-guide/campaigns-and-channels/domain-reputation/domain-reputation-in-moengage).

#### Other options

There are additional options to:

- Personalize [*URLs*](/user-guide/campaigns-and-channels/create/personalize-email-content) & [images](/user-guide/campaigns-and-channels/create/personalize-email-content)
- [Preview your template in different environments and devices](/user-guide/campaigns-and-channels/create/inbox-previews)
- [Check for potential Spam Folder landing](/user-guide/campaigns-and-channels/create/inbox-previews#spam-checker-0-1)
- See Email Tips
...
Do not forget to insert an unsubscribe link in your email template. Read more about the unsubscribe tracking mechanism [here](/user-guide/campaigns-and-channels/create/track-email-unsubscribes).
...
- [Delivery Controls](/user-guide/campaigns-and-channels/create/create-an-email-campaign): Choose the advanced delivery control options such as throttling, frequency capping, and expiration settings for the notification.
...
- **Ignore frequency capping**: Enable this toggle to ignore the frequency capping limit for this Email campaign. For more information, refer to [Frequency Capping](/user-guide/settings/delivery-controls/frequency-capping).
...
Select the Throttle limit in the **Request limit** section. For more information, refer to [Throtlling](/user-guide/settings/delivery-controls/throttling).
...
|  |  |
| --- | --- |
| - **Minimum delay between two messages**: Set the minimum time gap between two messages received by the same user. - **Ignore DND settings**: Enable this toggle to ignore the DND settings. - **Ignore frequency capping**: Enable this toggle to ignore the frequency capping limit for this Connector campaign. For more information, refer to [Frequency Capping](/user-guide/settings/delivery-controls/frequency-capping). - **Count for the frequency capping**: Enable this toggle if you want this connector to be counted for the frequency capping limit. | <img alt="deivery controls 2.png" src="/images/moengage_06c03b.png" /> |
...
If you have successfully created the campaign, you will be taken to the Analytics page. For more information, refer to [Email Campaign Analytics](/user-guide/campaigns-and-channels/email/email-analytics-and-info).
