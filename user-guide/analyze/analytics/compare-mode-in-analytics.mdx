...
<Frame>
  ![Retention Chart](/images/retention-chart.png)
</Frame>

**_Note: Time comparison visualization is not present on Area and Pie charts._**
...
_You can select up to 5 different segments for comparison at the moment._
...
**_Note: Segment comparison visualization is not present on Area and Pie charts._**
...
#### **Important Note:** _Currently, both Time comparison and segment comparison cannot be performed together._
