...
Ensure that you have configured the Uninstall Settings for your app for the uninstall analytics to be available. For more information, refer to [Uninstall Settings](/user-guide/analyze/faqs-analyze/uninstall-tracking).
