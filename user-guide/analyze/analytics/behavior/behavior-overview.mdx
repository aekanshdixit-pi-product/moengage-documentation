...
Getting a Behavior chart follows a workflow similar to other analyses. For a basic overview of performing an analysis, refer [here](/user-guide/settings/account/security/overview).
