...
**Step 1**: [Create Analysis](#1)

**Step 2**: [Create a new Alert](#2)
...
3. Click **Apply** to view the analysis chart and then select your chart type and related granularity.\
   ...
   - Bar chart
   - Column chart\
     To learn more, see [Alert Subscription Details](#3).
...
1. Click the Settings icon on the left sidebar of your MoEngage dashboard.
...
4. Once you locate your alert, click the verticle ellipsis icon under the **Actions** column at the right end of the table.
