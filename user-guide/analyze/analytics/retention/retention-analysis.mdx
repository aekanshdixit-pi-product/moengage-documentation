...
By default, you can perform behavior analysis on all users. However, you can also query for a group of users filtered using **User property**, **User behavior**, **User affinity**, or **Custom segments**. Filtering users is similar to creating a segment. For more information, refer to [Create Segment](/user-guide/segment/segment-operations/create-segments).
