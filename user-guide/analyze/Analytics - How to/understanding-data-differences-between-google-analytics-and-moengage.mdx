...
sidebarTitle: "Understanding Data Differences between Google Analytics and MoEngage"
---
...
1. 1. - **Bot Traffic** - Bot traffic comes to your website from search engine crawlers, price-tracing websites, and others trackers. If this traffic is not blocked from MoEngage tracking, it creates unnecessary extra users.
