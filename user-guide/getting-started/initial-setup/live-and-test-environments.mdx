...
- Developers must specifically mark certain users as test users before they can create campaigns or run any segmentation queries in the Live environment. For more information, refer to  [Test Users in LIVE Environment](/user-guide/getting-started/initial-setup/live-and-test-environments).
