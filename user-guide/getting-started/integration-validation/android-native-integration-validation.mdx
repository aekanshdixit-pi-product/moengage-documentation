...
| Status | Condition | Next Action |
| --- | --- | --- |
| Failed | small app icon is not configured. | Add *NotificationConfig* during SDK initialization and include a small icon. For more information, refer to [Push Configuration](/developer-guide/android-sdk/push/basic/push-configuration). |
...
| Status | Condition | Next Action |
| --- | --- | --- |
| Failed | Large app icon is not configured. | Add *NotificationConfig* during SDK initialization and include a large icon in the parameter. For more information, refer to [Push Configuration.](/developer-guide/android-sdk/push/basic/push-configuration) |
