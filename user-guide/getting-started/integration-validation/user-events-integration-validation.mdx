...
description: "Validate that user events, event attributes, and data types are tracked correctly in MoEngage. Check event tracking from app activity to your dashboard."
---
...
- Number attributes should have operators like equal to, greater than, in between, etc
  ...
  <Frame>
    ![Segmentation User Attributes](/images/Segmentation_UserAttributes.png)
  </Frame>
