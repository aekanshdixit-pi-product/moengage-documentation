...
description: "Step-by-step guide to validate Android push notification integration with MoEngage SDK. Verify push token generation and test notification delivery."
---
...
- Test the notification from the test option at the 2nd stage of creation.
  ![AndroidTest.png](/images/moengage_6561be.png)
...
![NotificationRedirection\_Android.png](/images/moengage_6b3732.png)
...
<img
  alt="Navigate_to_screen_Android.png"
  src="/images/moengage_ee4077.png"
  style={{ width:"49%" }}
/>
...
<img
  alt="Deeplinkling_Android.png"
  src="/images/moengage_873216.png"
  style={{ width:"58%" }}
/>
...
<img
  alt="Richlanding_Android.png"
  src="/images/moengage_80aa31.png"
  style={{ width:"55%" }}
/>
...
- Once the campaign is sent out, the campaign stats should show the impressions and clicks.
  ![Download1 1](/images/download1-1.png)
...
1. If tokens are not generated correctly, the reachable user base will be less than the actual users. To fix the Token issue, please check the [Android](/developer-guide/android-sdk/push/basic/push-configuration) docs.
2. Incorrect Redirection will lead to confusion/miss in opportunities
3. If the clicks and impressions are not recorded, we cannot understand the impact of the campaign. To fix the Impression or click tracking-related issue, please check the [Android](/developer-guide/android-sdk/push/basic/push-configuration) docs.