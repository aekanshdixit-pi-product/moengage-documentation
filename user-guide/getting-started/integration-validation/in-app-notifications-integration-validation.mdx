...
sidebarTitle: "In-App Notifications Integration Validation"
---
...
If InApp is not working, targeting users will not be possible other than through the push channel. To fix this InApp-related issue, please check the [Android](https://developers.moengage.com/hc/en-us/articles/4403652537492-In-App-NATIV) and [iOS](https://developers.moengage.com/hc/en-us/articles/4404155127828-In-App-NATIV-SDK-Version-6-0-0-and-above-) docs.