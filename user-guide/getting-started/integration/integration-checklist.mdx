...
You should integrate Transactional APIs to enable push for server events from your server. *[Read more about Transactional APIs in our docs here](https://developers.moengage.com/hc/en-us/articles/4404548252820-Push-API)*.

**Enable Data APIs**

In case you want to pass additional data about your users to MoEngage, you should get Server Server Communication integration implemented. *[Read more about Data APIs in our docs here](https://developers.moengage.com/hc/en-us/articles/4404674776724-Data-API)*.
