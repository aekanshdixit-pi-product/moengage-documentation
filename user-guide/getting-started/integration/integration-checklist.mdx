...
You should integrate Transactional APIs to enable push for server events from your server. *[Read more about Transactional APIs in our docs here](/api/push/push-overview)*.

**Enable Data APIs**

In case you want to pass additional data about your users to MoEngage, you should get Server Server Communication integration implemented. *[Read more about Data APIs in our docs here](/api/data/data-overview)*.
