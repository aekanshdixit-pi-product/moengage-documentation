...
As a marketer, you can create users and their devices using the [Bulk Import API](/api/bulk/bulk-import-users-and-events) of MoEngage. You can then assign a custom user attribute with a corresponding value to indicate users who should be notified about the app version upgrade.   
