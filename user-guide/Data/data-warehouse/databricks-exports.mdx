...
sidebarTitle: "Databricks Exports"
---
...
- If your system requires IP whitelisting, you must whitelist MoEngage IPs. For more information, refer [here](https://help.moengage.com/hc/en-us/articles/35329024618772-A-Guide-to-MoEngage-IP-Whitelisting-Mechanism#h_01JNGJBH0HCJAVHHP9MZZ8AYWM).
...
If not done already, you need to set up a MoEngage \<\> Databricks integration for your account. For more information, refer to the [Databricks Integration](#moengage-vizard-0-1) help doc.
...
GRANT USE SCHEMA, CREATE TABLE ON SCHEMA ``.`` TO ``;
```

Remember to change the following values:

- `` - The name of your catalog.
- `` - The name of your database or schema.
...
2. On the App Marketplace page, search for **Databricks**. __PROTECTED_2__
...
`moe\_events\_\<table\_creation\_timestamp` .
