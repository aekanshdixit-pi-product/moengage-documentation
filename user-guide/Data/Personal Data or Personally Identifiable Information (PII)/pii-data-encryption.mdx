...
sidebarTitle: "PII Data Encryption"
---
...
You can enable data encryption for all user and event attributes, except for a list of reserved, non-encryptable attributes. For more information, refer to the [list of reserved attributes for which data encryption is not supported](#h_01GRXGZ2GEMG9BBNBW65T52WT7).
...
Perform the following steps to encrypt user attributes:  
 <img alt="encrypt_user attributes.gif" src="/images/moengage_ef083b.png" />
...
<img alt="event attribute_encrypt.gif" src="/images/moengage_159a3b.png" />
...
<img alt="UserPopup.png" src="/images/moengage_f4fb42.png" />
...
<img alt="UserProfile_PIIEncryption.png" src="/images/moengage_93f737.png" />
...
<img alt="PIi_Data_Encryption_ActivityInfo.png" src="/images/moengage_434ced.png" />
...
**<img alt="RecentEvents.png" src="/images/moengage_d86d83.png" />**
...
<img alt="TestUser.png" src="/images/moengage_05c181.png" />

## Value Suggestions

Visibility of encrypted [value suggestions](https://help.moengage.com/hc/en-us/articles/360001062103-Value-Suggestions) on the Segmentation and Analytics page depends on your role. For roles lacking encryption access, these suggestions are disabled. However, roles with encryption permissions can see the encrypted values behind the encrypted suggestions.
...
<img alt="SegmentationFilters.png" src="/images/moengage_6a9f19.png" />
...
**<img alt="SegmentationFilters_CampaignScreens.png" src="/images/moengage_624bdc.png" />**
...
Yes. For more information, refer to [PII Masking](https://help.moengage.com/hc/en-us/articles/5902573446804).
