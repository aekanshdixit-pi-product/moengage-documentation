...
sidebarTitle: "PII Tokenized Sending"
---
...
For more information about MoEngage's data privacy compliance, refer to [GDPR Compliance](https://help.moengage.com/hc/en-us/articles/360000878126-GDPR) and [PII Masking](https://help.moengage.com/hc/en-us/articles/5902573446804).
...
- MoEngage uses dynamic IPs for sending messages, if you want to use static IPs refer to [this](https://help.moengage.com/hc/en-us/articles/35329024618772) doc to know more.
...
Email Settings SMS, MMS & RCS Settings WhatsApp Settings
...
- **OAuth 2.0 Authentication**: To secure your PII API with OAuth 2.0, enable the **OAuth** toggle. A dropdown menu appears. Select a pre-configured OAuth setting. To learn how to create and manage OAuth settings, refer to [Authorization Configuration with OAuth 2.0](https://help.moengage.com/hc/en-us/articles/23949234646292).
...
- **Parameters:** Type or paste the relevant "URL parameters", "Headers", and/or "Body" details for the API as key-value pairs. You can personalize the URL parameters and request headers by typing @ in the placeholders while entering the key-value pairs. <img alt="singlesss.png" src="/images/moengage_b6c890.png" />

By selecting bulk, you can fetch a maximum of 500 user attributes in a single request, significantly reducing the number of requests made to collect each customer data individually. <img alt="BULKKKKK.png"  src="/images/moengage_f147de.png"  />

1. Enter the batch size of your request.
2. **API configuration**
   - **Method:** Only the POST method is supported in bulk.
   - **Enable OAuth** : To secure your PII API with OAuth 2.0, enable the OAuth toggle. A dropdown menu appears. Select a pre-configured OAuth setting. To learn how to create and manage OAuth settings, refer to [Authorization Configuration with OAuth 2.0](https://help.moengage.com/hc/en-us/articles/23949234646292).
...
1. - **Request URL:** Type or paste the "Request URL" of the API.
...
4. In the **Email/Mobile Number field in API response** list, select the response key that contains the customer's email or mobile number (for example, `Email\_ID`).
5. Click **Save** to finalize the configuration.  
    <img src="/images/moengage_ceb13c.png" />
...
<img alt="PII_TS_Flow.png" src="/images/moengage_0dc235.png" />
...
<img alt="PII_API_Error.png" src="/images/moengage_59915b.png" />
...
Yes, for more information, refer [here](https://help.moengage.com/hc/en-us/articles/5902573446804).

</Accordion>
<Accordion title="Does MoEngage rm support PII tokenized sending?">
