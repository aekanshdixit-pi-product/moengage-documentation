...
sidebarTitle: "Why Are Location Values Not Updated on the User Profile?"
---

## Problem

Location details such as **City**, **State**, and **Country** passed through Server-to-Server API (S2S API) or Amazon Simple Storage Service (S3) imports are not updated on the user profile in the MoEngage dashboard. <img alt="s3 import.png" src="/images/moengage_88018b.png" />
