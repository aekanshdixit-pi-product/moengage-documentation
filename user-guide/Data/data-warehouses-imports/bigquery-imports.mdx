...
Importing datetype attributes requires additional steps. For more information, refer [here](https://help.moengage.com/hc/en-us/articles/31354584806548-Importing-Datetype-attributes).
...
- If your security policies require you to whitelist our IPs, you can refer to [here](https://help.moengage.com/hc/en-us/articles/35329024618772-A-Guide-to-MoEngage-IP-Whitelisting-Mechanism).
- Support for [Object Data Type](https://help.moengage.com/hc/en-us/articles/29787626775828-Support-for-Object-Data-Type) needs to be enabled for your account (optional).
</Tip>
...
2. Click **+ Import** in the upper-right corner and select **Users** or **Events** to create a new import.  
    <img src="/images/moengage_588dda.png" />
3. Click the **Google** **BigQuery** tile.
4. Click **Continue**.  
    <img src="/images/moengage_ffbdab.png" />
...
<img  src="/images/moengage_899d35.png"  />

Based on the type of import selected, your next steps might vary:

User Imports Events Imports

You can select whether to import registered users, anonymous users, or both. In the Select **user type** section, select **Registered users** or **Anonymous users**. Both user types require different file names. For more information, refer to [Naming Conventions](https://help.moengage.com/hc/en-us/articles/12246167449236-Overview#h_01GK4C4XDBQ18GNTRXBD47RD43).  
 <img src="/images/moengage_d33d5c.png" />
...
2. In the **Event name** box, type a unique name for your event. By default, your display name will be the same as the event name.  
    <img alt="CreateNewEvent.png"  src="/images/moengage_606b17.png"  />
...
4. In the **Table/View** list, select the table/view to import data from.  
    <img src="/images/moengage_1f2b5a.png" />
...
<img  src="/images/moengage_4ed8b4.png"  />
...
<img src="/images/moengage_d8ed36.png" />
...
1. Click **+ Create attribute** available in the **Select attribute** list. The **Create new attribute** dialog box is displayed.  
    <img alt="CreateNewAttribute.png"  src="/images/moengage_0403e5.png"  />
2. In the **Attribute name** box, type a name for your attribute.
3. In the **Data type** list, select a data type. You can edit these and existing attributes from the [Data Management](https://help.moengage.com/hc/en-us/articles/31633492991124-Overview-Data-Management#h_01JBXZ3694DQ3RZHNKMSRSPJQY) page.   
   <Info>
...
Optionally, you can auto-map these columns by uploading a [Manifest file](https://help.moengage.com/hc/en-us/articles/12246167449236-Overview#h_01GKNQTM9XVHZE2Z17YZEM88VA). To upload a manifest file:

1. Click the **Upload mapping** file in the upper-right of the mapping table.  
    <img  src="/images/moengage_de013e.png"  />
2. On the **Upload mapping** dialog box, upload your manifest file.  
    <img  src="/images/moengage_efcab2.png"  />
3. Click **Done**.

### Manifest File Functionality

- **Add Manifest (File Selection)**: For every import, you can download a sample manifest file from the MoEngage UI to use as a reference template and to view the [expected conventions](https://help.moengage.com/hc/en-us/articles/12246167449236-Overview-Imports#h_01GKNQTM9XVHZE2Z17YZEM88VA). Select the file you want to upload as a manifest file.
...
- If a column exists in the table but the mapping is missing from the manifest file, MoEngage keeps the mapping blank for you to configure manually.  
   <img src="/images/moengage_83a1b8.png" />
...
<img  src="/images/moengage_5bc0f7.png"  />

You can also create new Object attributes by clicking **Create new attribute** in the **Select attribute** list under the **Map attribute** column. <img src="/images/moengage_e4879f.png" />

<img  src="/images/moengage_7f5c31.png"  />
...
1. Turn the **Save as a custom segment** toggle on to save your imported users in a custom segment and send tailored campaigns to the same.  
    <img  src="/images/moengage_4bbb0f.png"  />
...
<img  src="/images/moengage_f49c46.png"  />
...
2. In the **Select email id** list, select the email ID. You can select up to 10 emails to send the status emails to.  
    <img alt="ImportStatus.png"  src="/images/moengage_877e05.png"  />   
...
<img src="/images/moengage_18495b.png" />
