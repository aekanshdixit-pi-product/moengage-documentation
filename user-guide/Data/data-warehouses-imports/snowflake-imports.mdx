...
sidebarTitle: "Snowflake Imports"
---
...
Importing Datetype attributes requires additional steps. You learn more about this in our [dedicated guide](https://help.moengage.com/hc/en-us/articles/31354584806548-Importing-Datetype-attributes).
...
You can set up Snowflake Imports from the MoEngage Dashboard > **Data** > **Data imports**.

__PROTECTED_5__

Clicking **+ Import** allows you to select your source. Click on Snowflake to create a new import for either Users (Registered/Anonymous can be picked in the next step) or Events.
...
You can either select an existing event or create a new one. If you have multiple events stored in a single table, MoEngage will look at the "Event Name" column to determine matching rows to import. The value of the "Event Name" column will be determined by the event you pick. Some of these events might have different Display Names and Event Names. You can always go to the __PROTECTED_29__ page and view the Event Information. For example, the event "App/Site Opened" should have the value of the "Event Name" column as `MOE\_APP\_OPENED`:
...
To get started, select a Snowflake connection to use for this Import. If you have not already created a Snowflake connection, you can click on the "+ Add connection"  option at the end of the dropdown and you will be taken to the App Marketplace to set it up. You can learn more about how to connect your Snowflake warehouse to MoEngage __PROTECTED_31__.

Once you have selected your Snowflake connection, you will be required to select the schema and table to import from. If there is an error loading your schemas, ensure you have given MoEngage sufficient permissions as __PROTECTED_32__.
...
| Anonymous ID | You need to mark a column from your table (email, mobile number, etc.) as an identifier of these users. |
| Updated at | MoEngage will use this column to determine which rows have been added/updated since the last sync. You need to ensure that this timestamp (date + time) is in UTC Timezone. The column type for this should be `TIMESTAMP\_NTZ`.    For the full list of supported datetime formats, refer to this __PROTECTED_36__. |
...
<img alt="CreateNewAttribute.png"  src="/images/moengage_57ff13.png"  />

Give your attribute a name and select its Data type. You can edit this as well as existing attributes from the [Data Management](https://help.moengage.com/hc/en-us/articles/31633492991124-Overview-Data-Management#h_01JBXZ3694DQ3RZHNKMSRSPJQY) page. Do note that any new attributes you create now will only be available in your app after the first successful import.

### Manifest Files

Optionally, you can choose to auto-map these columns by uploading a [manifest file](https://help.moengage.com/hc/en-us/articles/12246167449236-Overview#h_01GKNQTM9XVHZE2Z17YZEM88VA).
...
- If a column exists in the table but the mapping is missing from the manifest file, MoEngage keeps the mapping blank for you to configure manually.  
   <img src="/images/moengage_03be6c.png" />

### Support for Object Data Type

<Info>
Support for [Object Data Type](https://help.moengage.com/hc/en-us/articles/29787626775828-Support-for-Object-Data-Type) needs to be enabled for your account.
</Info>
...
<img  src="/images/moengage_2a1bba.png"  />
...
<img  src="/images/moengage_821de8.png"  />

### Sending Import Notifications

<img alt="ImportStatus.png"  src="/images/moengage_03bc95.png"  />
...
<img src="/images/moengage_bbd25f.png" />
