...
sidebarTitle: "Android Advertising ID Tracking"
---
...
With Android SDK version 12.2.01 released in April 2022, we have added the required APIs and support for enabling tracking of the specified identifiers only after the user’s consent. For more information, refer to [Enabling Advertising ID tracking](https://developers.moengage.com/hc/en-us/articles/6046152370452-Enable-Advertising-Identifier-Tracking).
