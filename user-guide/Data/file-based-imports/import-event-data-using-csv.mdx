...
sidebarTitle: "Import Event Data Using CSV"
---
...
2. Navigate to **Data** \> **Data Imports**.  
    <img alt="data imports 2.png" src="/images/moengage_53bcc6.png" />
3. On the **Data Imports** page, under the **Event** tab, click **Import** \>**Events**.  
    <img alt="EVENTS .png" src="/images/moengage_10d6ee.png" />
4. On the **Import Events** dialog box, click **Upload CSV.** You can also import events using [SFTP](https://help.moengage.com/hc/en-us/articles/12241329478676-SFTP-Imports) and [S3](https://help.moengage.com/hc/en-us/articles/10170540879380-S3-Imports).
5. Click **Continue.  
    <img alt="Import event 3.png" src="/images/moengage_4cb084.png" />**
...
When you upload an event CSV file, the column represents the event attributes.
   ...
   <img alt="file import 4.png" src="/images/moengage_9680db.png" />
...
5. Click **Next**. This takes you to the next step.  
    <img alt="Screenshot 2024-10-08 at 1.04.20 PM.png" src="/images/moengage_bd8c65.png" />
...
While mapping the **Event time**, make sure to select the date, time format and time zone.  
 <img alt="required mapping.png" src="/images/moengage_f762b8.png" />
...
1. You can either select the event attributes of MoEngage from the *Select attribute* drop-down or click **Create new attribute**, if the attribute is not listed in the drop-down.  
    <img alt="create new attribute.png" src="/images/moengage_fcb9f8.png" />   
   1. On the **Create new attribute** dialog box, enter the **Attribute name**, **Data type** and click **Create**.  
       <img alt="Screenshot 2024-10-08 at 2.56.15 PM.png" src="/images/moengage_5be458.png" />
...
3. Select the **Skip column**if you want to skip any columns from mapping. Note that the mandatory fields already mapped are disabled under **Map Columns**.  
    <img alt="Map columns.png" src="/images/moengage_880ee9.png" />
...
After the event data is imported to MoEngage, you can send the import status to 10 email ids. Select the **Email id** from the drop down to which you want to send the status and click **Next**.  
 <img alt="send import status.png" src="/images/moengage_7f3be5.png" />
...
- **As soon as possible**: The file will start importing as soon as you click **Schedule Import**.  
   <img alt="Screenshot 2024-10-08 at 3.06.00 PM.png" src="/images/moengage_5aaa4f.png" />
- **At specific date and time**: You can choose to run the import based on your selected **Start date** and **Start time**. You can also select the **Time zone**.  
   <img alt="Screenshot 2024-10-08 at 3.07.29 PM.png" src="/images/moengage_82b24c.png" />

After scheduling, click **Schedule Import**. The event data now gets imported to MoEngage.

# View Imported Event Data

The imported event data gets listed under **Data** \> **Data Imports** \>**Events**. Click **Actions** ( <img alt="ellipsis.png"  src="/images/moengage_939e0d.png"  /> ) to **View** or **Duplicate** the event data.   
 <img alt="view duplicate.png" src="/images/moengage_d85a1f.png" />

- Click **View** to view the imported event details. Click **Actions** ( <img alt="ellipsis.png"  src="/images/moengage_939e0d.png"  /> ) to **Export file** to your email id**.**  
   <img alt="Import details.png" src="/images/moengage_b4cc3a.png" />
...
| Date Time | Any date time value. The supported formats are covered in the [next table](https://help.moengage.com/hc/en-us/articles/12246167449236-Overview-Imports#h_01GJN38YMYS8MSDG2PGX67FRC3).Example of acceptable values are 2019/02/22 17:54:14.933 | "type": "datetime" |
...
- The supported data types are array double (numeric) and array string. You can select these data types in the list under the **Map column to attribute** column of the **Map columns** section while executing **Step 2: Import configuration and action.  
   <img  src="/images/moengage_1e1325.png"  />**
...
- Array Typecasting: If an array has elements [“1” | 2 | “abc”] of multiple datatypes and the defined datatype is Array Double, then the final array ingested in MoEngage is [ 1, 2 ]. In this case, “abc” was a string that cannot be transformed into Double and hence not ingested into MoEngage in the final array. For more information on typecasting in MoEngage, refer [here](https://help.moengage.com/hc/en-us/articles/31633492991124-Overview-Data-Management#h_01H9QV0Z5B4DK7VEN9PPR1AD3G).
