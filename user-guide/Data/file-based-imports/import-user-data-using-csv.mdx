...
sidebarTitle: "Import User Data Using CSV"
---
...
<img alt="USERIMPORTS.png" src="/images/moengage_aba40c.png" />
...
<img alt="CreateImport.png" src="/images/moengage_467fa4.png" />
...
<img alt="CreateIMport_Step2.png" src="/images/moengage_2396dd.png" />
...
<img alt="CreateIMport_Step_2.png" src="/images/moengage_1d918b.png" />
...
<img alt="CreateIMport_Step_2_1.png" src="/images/moengage_f2d79a.png" />
...
<img alt="Screen_Shot_2017-04-05_at_3.01.27_PM.png" src="/images/moengage_52f9ae.png" />
...
<img alt="SaveFileSegment.png" src="/images/moengage_02bc37.png" />
...
<img alt="Step3.png" src="/images/moengage_5d0711.png" />
...
- The supported data types are array double (numeric) and array string. You can select these data types in the list under the **Map column to attribute** column of the **Map columns** section while executing **Step 2: Import configuration and action.  
   <img  src="/images/moengage_494750.png"  />**
- All the elements in the array have to be homogenous, which means they must be either integer or string. If they are not homogenous, MoEngage tries to typecast (transform) the element and then store the data. Following is the example of an array in a CSV field: [1|2|3]   
   <img  src="/images/moengage_8e250a.png"  />
- Array Typecasting: If an array has elements [“1” | 2 | “abc”] of multiple datatypes and the defined datatype is Array Integer, then the final array ingested in MoEngage is [ 1, 2 ]. In this case, “abc” was a string that cannot be transformed into an integer and hence not ingested into MoEngage in the final array. For more information on typecasting in MoEngage, refer [here](https://help.moengage.com/hc/en-us/articles/31633492991124-Overview-Data-Management#h_01H9QV0Z5B4DK7VEN9PPR1AD3G).
