...
sidebarTitle: "How To Generate an Auth Token for the Data API?"
---
...
1. **Input required**:
   ...
   To find the Workspace ID and API key, go to **Settings** \> **APIs** in the MoEngage dashboard. <img alt="Auth token.png" src="/images/moengage_bedf6e.png" />
