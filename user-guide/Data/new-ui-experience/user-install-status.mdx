...
sidebarTitle: "User Install Status"
---
...
- By setting up [Install/Uninstall/Reinstall tracking](https://help.moengage.com/hc/en-us/articles/360051732232-Install-Uninstall-Reinstall-Integration-Validation#h_01HP6K7SRS22WP3YYQNNDN3378) through SDK integration
- By observing when silent push messages, sent to users' devices, return a signal from Firebase Cloud Messaging (FCM) or Apple Push Notification Service (APNs) indicating whether the app is installed or not. Note that a silent push notification is not supported in Apple devices any longer. You can [activate this tracking](https://help.moengage.com/hc/en-us/articles/360043026012-Uninstall-Tracking#h_01HJ0V9N39T3V43KDPFNBDRP4Q) from the dashboard settings page.
