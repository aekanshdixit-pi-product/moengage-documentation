...
Refer to the [File Imports help doc](https://help.moengage.com/hc/en-us/articles/12246167449236-Overview) to understand the supported file types, naming conventions, file structure, etc. Once you are ready with the files, you need to place them inside an SFTP folder.
...
Choose which one you want to import. Both registered users import and anonymous users import expect different file names. Refer to the [Naming Conventions](https://help.moengage.com/hc/en-us/articles/12246167449236-Overview#h_01GK4C4XDBQ18GNTRXBD47RD43) section for more information.
...
In the above example, "App/Site Opened" is the Display Name of the chosen event and its Event Name is `MOE\_APP\_OPENED`, so the file names should begin with `MOE\_APP\_OPENED\_`. Refer to the [Naming Conventions](https://help.moengage.com/hc/en-us/articles/12246167449236-Overview#h_01GK4C4XDBQ18GNTRXBD47RD43) section for more information.
