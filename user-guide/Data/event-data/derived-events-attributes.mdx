...
sidebarTitle: "Derived Events & Attributes"
---
...
Know more about [List of derived User attributes here](https://help.moengage.com/hc/en-us/articles/17152954613908-Derived-User-Atributes).
...
| Push Preference Changed iOS | Tracked when iOS device push preference is changed. It has a modified status.  **Note**: This event is deprecated. It was used to track when a user unsubscribes to Push notifications.   - Subscribed to push event with platform attribute as iOS - Unsubscribed to push event with platform attribute as iOS | iOS |
...
<Info>
- Some MoEngage-tracked events or system events (e.g., App/Site opened) have device information tracked as [event attributes](https://help.moengage.com/hc/en-us/articles/207836953-Derived-Events-Attributes#h_01HMRWM2G0TSGFSGSNF5GDQM5F). Such event attributes are available for analysis and segmentation.
- [Device attributes](#Device-Info-Tracked:) tracked by MoEngage SDKs are not available for analysis and segmentation.
</Info>
