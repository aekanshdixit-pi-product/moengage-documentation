...
sidebarTitle: "Event Time and Received Time"
---
...
Event Time is the time on the device when the event was performed. Event Time is displayed in the User Profile. For more information, refer to [User Profile](https://help.moengage.com/hc/en-us/articles/360044285511).  
  
For events that are not generated at the device ([MoEngage generated events](https://help.moengage.com/hc/en-us/articles/207836953)) or events that don't have device time ([Data API events](https://developers.moengage.com/hc/en-us/articles/4413174104852)), the event time is recorded in the User Timezone. If it is unavailable, then the App timezone is shown. If neither is available, then UTC time is taken as the Event Time.
...
For events that are not generated at the device ([MoEngage generated events](https://help.moengage.com/hc/en-us/articles/207836953) and [Data API events](https://developers.moengage.com/hc/en-us/articles/4413174104852)) the Received Time is the App time zone in the user profile.

All Segmentation and Analytics queries use Received Time for the event time range selection.

In [User Profile](https://help.moengage.com/hc/en-us/articles/360044285511) for all events, there is Event Time (time at which the event is performed) and Event Received time (time at which the event is received at MoEngage).
