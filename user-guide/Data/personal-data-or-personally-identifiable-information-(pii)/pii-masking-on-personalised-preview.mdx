...
sidebarTitle: "PII Masking on Personalised Preview"
---
...
<img alt="MaskPII1.png" src="/images/moengage_f54f57.png" />

With this feature, you can mask PII fields in the user profile as well as in the personalized content.

<img alt="image (13).png" src="/images/moengage_cef6af.png" /> With this update, any user or event attribute marked for masking also appears masked in personalization content. This applies to all channels that support personalization preview, ensuring masked values are consistently protected across the platform.
...
1. On the **Content API**page, under the **Actions** column, click the ellipsis icon and then select **Edit**. For more information on creating personalized campaigns using content APIs, refer to [Content APIs](https://help.moengage.com/hc/en-us/articles/115003622346-Content-APIs#01H7YH45YQ2P1DN16FE2ZKBQ59).  
    <img alt="PIImasking2.png" src="/images/moengage_58feba.png" />
...
3. In the Select fields to mask list, select the fields you want to mask. For example, in the following image, we have selected coord. lon, coord.lat, and click **Done**.  
    <img alt="image (17).png" src="/images/moengage_b2dbc5.png" />
4. Upon using this content API for personalizing content, the values of the selected fields in the previous step are masked.  
    <img alt="image (18).png" src="/images/moengage_fa4138.png" />
