...
For more information, refer to the [API Key Dashboard](https://help.moengage.com/hc/en-us/articles/28332074311060-API-Key-Dashboard).
...
For more information, refer to [WhatsApp Templates](https://help.moengage.com/hc/en-us/articles/4951072814100-WhatsApp-Templates).
...
For more information, refer to [Frequency Capping.](https://help.moengage.com/hc/en-us/articles/15919660670356-Frequency-capping#h_01HKVB22J94S5H2PDX5FCQS16V)
...
For more information, refer to [Teams Management 2.0 for Push](https://help.moengage.com/hc/en-us/articles/30310276466964-Teams-2-0-in-MoEngage#h_01J7JKVR61CAQMV5CXXKT8YB41)
...
For more information, refer to [Personalized Preview](https://developers.moengage.com/hc/en-us/articles/31553277679892-Personalized-Preview#h_01JB1FXG69W2X49ESKT8JEP68Q).
...
For more information, refer to [Stats API](https://developers.moengage.com/hc/en-us/articles/32895300259732-Stats-API#01GQRA6BGSEZA2F6DR6NA2BBDA).
...
For more information, refer to [Countdown Timer](https://help.moengage.com/hc/en-us/articles/33647366123412-Adding-Widgets).
...
For more information, refer to [Split URL testing](https://help.moengage.com/hc/en-us/articles/34278200126228).
...
For more information, refer to [Personalization of Content](https://help.moengage.com/hc/en-us/sections/33615909444756-Personalize-Editor-Capabilities).

# Track Device API

MoEngage has now introduced Device API. With this API, you can add or update devices and device properties in MoEngage. For more information, refer to [Track Device](https://developers.moengage.com/hc/en-us/articles/31285296671252-Track-Device).

# Sorting on Charts

You can now sort charts in Analytics. Sorting is available across User Analysis, Behavior, and Session and Source.

For more information, refer to [Sorting](https://help.moengage.com/hc/en-us/articles/33114992690324-Overview#h_01JJ95KP5JE5T10NNKNH88CG2E).
...
For more information, refer to [Shepa AI-Based Dynamic Traffic Allocation](https://help.moengage.com/hc/en-us/articles/11621615057300-Create-Client-side-personalization-experience#h_01HKVGF1WQKPB6HEX6F1HFM322).

# Set Up Imports from SFTP

All SFTP connections are now added directly to the App marketplace, and an SFTP connection can be reused for all SFTP Imports. For more information, refer to [Set Up Imports from SFTP](https://help.moengage.com/hc/en-us/articles/12241329478676-SFTP-Imports#h_01HDR27GJTYMRJZCMQKQMACDF0).

# S3 Exports PGP Encryption

MoEngage now supports exporting encrypted files and has added support for PGP Encryption. For more information, refer to [Enable S3 Exports on the MoEngage App Marketplace](https://help.moengage.com/hc/en-us/articles/8098260902548/live_preview/01JH5PJFWW0YQYVCT44HNCTY4Q#01G9KRK38MEG08WD2C11XNAFB9).