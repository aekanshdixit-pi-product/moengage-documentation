...
sidebarTitle: "Aggregation Operations"
---
...
Aggregation facilitates growth teams to aggregate an [event attribute](https://help.moengage.com/hc/en-us/articles/207836953-Derived-Events-Attributes#events-user-activity-0-0) by using operations such as sum, average, min, max, and median. The aggregation operator on an event attribute combined with the [numeric filters](https://help.moengage.com/hc/en-us/articles/360046335412-Filters-in-segmentation#numeric-filters-0-4) helps users write sophisticated queries and extract deeper customer segments.
