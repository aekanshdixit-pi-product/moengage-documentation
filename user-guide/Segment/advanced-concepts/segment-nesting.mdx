...
For better understanding, let’s say A, B, C, and D represent the ‘segment blocks’, which are events & user attributes with all their filters. For example, A can be ‘users who are male’, B can be ‘users who added to cart: wallet in the last 3 days, and so on. You can always create segments like A AND B AND C AND D and A OR B OR C OR D by combining segment blocks using AND/OR operators.  
 ...
 <img alt="AND" src="/images/moengage_d8b3c5.png" />
...
<img alt="Nested" src="/images/moengage_45067a.png" />
...
<img  src="/images/moengage_7c97d1.png"  />
...
<img  src="/images/moengage_30c9a3.png"  />
...
<img  src="/images/moengage_318a3a.png"  />
...
<img  src="/images/moengage_af3958.png"  />
...
<img  src="/images/moengage_a565a3.png"  />
...
Let’s say, Segment cs\_level\_1 = Created a custom segment of level 1 using an attribute (Has executed Allowed web Push Subscription atleast 1 time in the last 3 days)

<img  src="/images/moengage_a8be6c.png"  />

Segment cs\_level\_2 = Created a level 2 custom segment by adding custom segment cs\_level\_1 in the query

Level 2 = 1 level of cs\_level\_1 + 1 level of nesting (as per rule mentioned in the beginning)

<img  src="/images/moengage_f84742.png"  />

Cs\_level\_3 = Created a level 3 custom segment by adding custom segment cs\_level\_2 in the query

Level 3 = 2 level of cs\_level\_2 + 1 level of nesting (as per rule mentioned in the beginning)

<img  src="/images/moengage_544fc4.png"  />
...
<img  src="/images/moengage_e6868b.png"  />
...
<img  src="/images/moengage_ba0667.png"  />
...
<Info>
[File Segments](https://help.moengage.com/hc/en-us/articles/207606916-File-Segments) are not counted towards the nesting Limits.
</Info>
