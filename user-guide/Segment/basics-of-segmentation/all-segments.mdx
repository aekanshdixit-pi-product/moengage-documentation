...
<img alt="Teams_AllSegments.png" src="/images/moengage_8ff2ee.png" />
...
<img alt="All_segments_2.gif" src="/images/moengage_1bf5b4.png" />
...
File Segments archived beyond 30 days from the date of archival will not be listed on this page as they have expired. [Learn more about file segments here.](https://help.moengage.com/hc/en-us/articles/207606916-File-Segments) Within 30 days of archival, you can unarchive the file segments from this page.
...
| Edit | - For Filter segments, the Edit option will open the Create Segments page will the filters of the segment pre-populated. These filters can be edited and the new query can be saved as a new custom segment. - For File segments, the Edit option can be used to add, remove or replace users in an existing file segment. [Learn more about file segments here.](https://help.moengage.com/hc/en-us/articles/207606916-File-Segments) |
| Duplicate | - For filter segments, the Duplicate option will open the Create Segments page with the filters of the segment pre-populated. These filters can be edited and the new query can be saved as a new custom segment. - File segments cannot be duplicated. This is because they represent a static list of users from an uploaded file and are not defined by editable rules. Duplicating a segment is useful for copying and then modifying its rules, but since a file segment has no rules, this action isn't applicable. To reuse the same list, you can simply use the original segment. |
...
<img alt="All_segments_3.gif" src="/images/moengage_1bd92e.png" />
...
<img alt="All_Segments_4.png" src="/images/moengage_b08c31.png" />
...
<img alt="All_Segments_5.png" src="/images/moengage_c7b03b.png" />
...
You can sync and send customer segments created on MoEngage to any other platform in your tech stack. For more information, refer to [Outbound Segment Sync](https://help.moengage.com/hc/en-us/articles/13003920120212).