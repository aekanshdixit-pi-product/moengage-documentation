...
description: "Turn natural-language marketing prompts into ready-to-deploy customer journeys with Merlin AI Flows Assist, built into the MoEngage canvas editor."
---
...
For more information on creating a flow using AI Assist, refer to [Create a Flow Using AI Assist](/user-guide/flows-cross-channel-messaging/create/create-flows/create-a-flow-using-ai-assist).