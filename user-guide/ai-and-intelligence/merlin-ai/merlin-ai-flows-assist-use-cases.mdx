...
<Info>
  ...
  **Flow behavior:**
  ...
  - **Step 1 — one hour after add to cart:** Send a push notification.
...
<Info>
  ...
  **Flow behavior:**
  ...
  - **T+5 days:** Initial wait to allow for shipping and unboxing.
...
<Info>
  ...
  **Flow behavior:**
  ...
  - **T+24 hours:** Check for **KYC Completed**. If not completed, send an email describing benefits after completion (for example higher limits, full product access).
