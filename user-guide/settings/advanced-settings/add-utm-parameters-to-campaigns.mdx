...
description: "Add UTM parameters to your MoEngage campaigns to track traffic sources, user engagement, and campaign performance in analytics platforms."
---
...
1. Ensure that the general UTM parameters are turned on at **Settings** \> **App** \> **UTM tracking**. <img src="/images/moengage_34bf4f.png" alt="10 - general to email.png" />
2. In the email template editor, go to the **UTM parameters** section. <img src="/images/moengage_19bf8e.png" alt="7 - email.png" />
3. Click the accordion to expand the parameters.
   ...
   ![8 - email 2.png](/images/moengage_6fa7c6.png)
...
5. Enable or disable individual parameters. You cannot disable the _utm\_source_ and _utm\_medium_ parameters. <img src="/images/moengage_248449.png" alt="12 - email disabled.png" />
6. Click **\+ Create custom parameter** to add a custom UTM parameter as a key-value pair.
7. Click the delete icon for the custom parameter that is no longer required. You can delete custom UTM parameters that are carried over from the general settings. <img src="/images/moengage_c8dbef.png" alt="11 - email custom.png" />
8. Turn off the **UTM parameters** toggle to disable the usage of UTM parameters in the current campaign. In that case, MoEngage does not insert UTM parameters in the links used in the current campaign. <img src="/images/moengage_0910bf.png" alt="12 - disabled at email.png" />
...
1. Ensure that the general UTM parameters are turned on at **Settings** \> **App** \> **UTM tracking**. For example: <img src="/images/moengage_34bf4f.png" alt="10 - general to email.png" />
2. In the canvas of the flow, click **\+**.
3. On the **Add Stage** page, select the **Actions** \>  **Messaging** \> **Email**. <img src="/images/moengage_718802.png" alt="Addstageflows.gif" />
4. Hover over **Email** and click the **Edit** icon.
5. In the email template editor, go to the **UTM parameters** section. <img src="/images/moengage_e06d27.png" alt="14 - flow.png" />
...
For a detailed guide on each of these actions, refer to steps 4-7 in the [Configure UTM Parameters for Campaigns](/user-guide/settings/advanced-settings/add-utm-parameters-to-campaigns#feature-support-matrix) section above.
