...
- Monitor the event and user attribute usage proactively, thereby complying with your workspace's [Data Tracking Policies](/user-guide/data/key-concepts/data-tracking-policies). When you set up usage alerts, you are notified based on your event and user attribute usage.
...
<Info>
You can also create the usage alert using the **Create Alert** option on the **Alert Management** page. While creating, make sure to select the **Create Alerts On** as **Events and User Attribute Usage**. For more information, refer to [Create Alert](/user-guide/settings/reports-and-alerts/alert-management/getting-started/create-an-alert).
</Info>
