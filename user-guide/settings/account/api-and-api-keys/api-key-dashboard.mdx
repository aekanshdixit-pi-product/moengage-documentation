...
2. Click **\+ Create new key**.
   ...
   ![create new key.png](/images/moengage_a5e237.png)
3. In the **Create new key** page, enter the following details:
   ...
   2. In the **Select APIs for access** check box list, select the APIs you want to access using this key.
      ...
      ![Screenshot 2024-09-25 at 12.41.17 PM.png](/images/moengage_685ea1.png)
1. Click **Save**. After saving, this key is listed under **Active** **API keys**.

   <Info>
     The **API Access** is **Full** if all listed APIs can be accessed using this key; otherwise, it is **Partial**.
   </Info>
2. Click **View archived keys** to view the list of archived keys.
1. On the **API Keys** page, clicking <img alt="333.png" src="/images/moengage_b6aff6.png" />for each API key displays the following options:

   ![multi key.png](/images/moengage_b6852d.png)
...
- Click **Export audit logs** to receive the audit log report in your email. You can download the report from the email. <Icon icon="ellipsis-vertical" />
