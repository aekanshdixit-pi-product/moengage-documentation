...
|  | Create, manage and publish | Yes | Yes | Enabled: No / Disabled: Yes | No | No |
...
| **Alert Manager - OOTB** | View | Yes | Yes | Yes | Yes | Yes |
...
| **Alert Manager - Custom** | View | Yes | Yes | Yes | Yes | Yes |
...
| User Profile Management | <br />Create and manage | Can delete a user or edit their permissions. |