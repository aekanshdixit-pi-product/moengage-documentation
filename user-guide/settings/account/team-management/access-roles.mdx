...
| Create, manage and publish | Yes | Yes | If [approval flow](/user-guide/settings/account/team-management/campaign-approval-workflow) is enabled - No  If [approval flow](/user-guide/settings/account/team-management/campaign-approval-workflow) is disabled - Yes | No | No |
...
| Teams [(know more)](/user-guide/settings/account/team-management/teams-in-moengage) | View | Yes | Yes | Yes | No | No |
...
| Create and manage | Can create new campaigns, and edit/update existing campaigns; but cannot publish the campaign.  If you are using [campaign approval flow](/user-guide/settings/account/team-management/campaign-approval-workflow) - the user with the permission can only send the campaign for approval. |
| Create, manage, and publish | Can create new campaigns, edit/update existing campaigns, and also publish the campaign.  If you are using [campaign approval flow](/user-guide/settings/account/team-management/campaign-approval-workflow) - the user with the permission can approve/reject the campaign. |
...
| Teams [(know more)](/user-guide/settings/account/team-management/teams-in-moengage) | View | Can view all teams and their members |
