...
- \[cite\_start\]**Custom roles**: User-defined roles that you can configure with specific permission sets based on your organization's requirements.
