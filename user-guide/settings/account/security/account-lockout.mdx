...
description: "Learn how MoEngage account lockout works after suspicious login attempts, including wait times and admin steps to unblock user accounts."
---

_Account Lockout_ is a security feature that locks your MoEngage account when your login attempts seem suspicious. This helps you prevent attacks that might allow unauthorized entities to access an account.
