...
<Tabs>
  ...
  <Tab title="Azure">
    ...
    5. Copy the **Base Connector URL** and save it (to use in [Step 3](/user-guide/settings/account/security/system-for-cross-domain-identity-management-scim#step-3-configure-provisioning-credentials-in-azure)).
