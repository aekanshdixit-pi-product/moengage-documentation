...
<Tabs>
  <Tab title="Okta">
    ...
    4. Turn the **Enable SCIM Provisioning** toggle on. <img src="/images/moengage_db66a7.png" />
    5. Copy the **Base Connector URL** to use in [Step 4](/user-guide/settings/account/security/system-for-cross-domain-identity-management-scim#step-4-configure-scim-on-okta).
    ...
    8. Click **Generate Access Token**.
       ...
       - **Note**: Copy the token immediately; it is only shown once. <img src="/images/moengage_51c118.png" />
    9. Click **Okay**. <img src="/images/moengage_de3c06.png" />
  ...
  <Tab title="Azure">
    ...
    2. On the **Security** page, click the **Login** tab.
    3. Click **Single Sign On (SSO) only**.
    4. Under **Single Sign On (SSO) only**, turn the **Enable SCIM Provisioning** toggle on. <img src="/images/moengage_3ab29c.png" />
    ...
    8. Click **Generate Access Token**. <img src="/images/moengage_5974c0.png" /> The **generated access token** is displayed.\
       **Note**: You can view the access token only once; ensure to copy it.
    9. Click **Okay**. <img src="/images/moengage_882217.png" />
