...
<Tabs>
  ...
  <Tab title="Azure">
    ...
    3. Click **Single Sign On (SSO) only**.
    4. Scroll to the **Automate user provisioning** section.
    5. Turn the **Automate user provisioning** toggle on. <img src="/images/moengage_3ab29c.png" />\
       The **Configure provisioning method** dialog box appears.
    6. Click **SCIM configuration** as your configuration type.
    ...
    10. Click **Save**.\
        The **Save your configuration** dialog box appears, prompting you to confirm your configuration.
    11. Click **Confirm**.\
        The **Successfully generated SCIM token** message and the **Generate access token** dialog box appear. **Note**: Copy the token immediately; it is only shown once. <img src="/images/moengage_5974c0.png" />
