...
In [Step 3](/user-guide/campaigns-and-channels/email/create/create-an-email-campaign) (Schedule and Goals) of campaign creation for any channel (including In-App and On-Site Messaging), you can configure the delivery controls for your frequency capping.
