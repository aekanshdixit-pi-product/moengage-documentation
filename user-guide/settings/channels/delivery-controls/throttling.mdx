...
[BTS](/user-guide/intelligence/timing/best-time-to-send)  uses a prescriptive time slot to send communications to increase user interaction. BTS determines this by analyzing Push, SMS & RCS, and Email campaigns individually, predicting the optimal time slot from the (0-24 hour) bucket. In BTS, throttling takes precedence over the number of communications that should be sent in a particular time slot.
