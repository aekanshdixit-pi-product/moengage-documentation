...
description: "Set a minimum time gap between campaign deliveries in MoEngage to prevent users from receiving multiple notifications in quick succession."
---
...
![MinDelay.png](/images/moengage_303b81.png)