...
3. Once you enable DND settings for a channel, the following fields are enabled:
   - **Do not disturb timing (User’s time zone)** - You can specify the time interval in the user's time zone - the starting time for the DND interval and the ending time for the same in the _From_ and _To_ fields.
     ![image (8).png](/images/moengage_5eb235.png)
   - **Action for messages generated during DND** -
     ...
     ![dnd 2.png](/images/moengage_f66385.png)
     | Action | Description |
     | --- | --- |
...
These DND Settings are applicable to the campaigns created inside a MoEngage Flow as well. Read more about how it works [here](/user-guide/flows-cross-channel-messaging/create/configure-flows/frequency-capping-fc-and-do-not-disturb-dnd-for-flows).