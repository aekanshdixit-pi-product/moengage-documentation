...
sidebarTitle: "Item Attribute Model"
---
...
<Tip>
Before you proceed, you must add a catalog. For more information, refer to [Catalogs](https://help.moengage.com/hc/en-us/articles/17456587985428-Catalogs).
</Tip>
...
2. Click **Create Recommendation**. The Create recommendation page is displayed. <img src="/images/moengage_915ab9.png" />
3. Select the **Item attributes** model and click **Next**. <img src="/images/moengage_e27706.png" />
...
7. Now, you can set up either generic rules or targeted rules.
   - To create a generic rule, choose the relevant item attribute in the **Item where** drop-down list and choose the **Custom Value** option. <img src="/images/moengage_3025ff.png" />
   ...
   - You can also create a combination of generic and targeted rules. <img src="/images/moengage_55d1a3.png" />
8. Turn the **Filter items by user actions** toggle on to add filtering criteria and control which items to recommend to their customers. These filters are applied to the results of the core recommendation further. You will see two types of filters for user actions:  
    <img alt="user action filter.png" src="/images/moengage_032c9b.png" />   
...
9. In the **Sort the filtered items** section, sort the recommendation results by any numeric attribute. For example, price.
10. Click **Save**. The recommendations listing is created with an 'Active' state on the recommendations listing page.