...
sidebarTitle: "Overview - Basic Recommendations"
---
...
The user action recommendations can be generated can be generated based on the event data from the past 30 days, for the event(s) configuration in [user action mapping](https://help.moengage.com/hc/en-us/articles/17459183026196-Map-User-Actions-Settings).
