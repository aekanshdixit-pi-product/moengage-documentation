...
sidebarTitle: "Landing Page Templates"
---
...
2. On the **Advanced** tab, in the **User Attribute** list, select a user attribute. The inputs are stored in the user attribute mapped in the template.
...
For more information on personalizing a landing page, refer to [Personalize](https://help.moengage.com/hc/en-us/articles/32059361335956-Personalize-Landing-Page).
...
After you load the template of your choice, you can customize elements like text fields, style the images, embed links to the buttons, and capture user attributes. For more information on customizing these elements, refer to the [Landing Page Editor](https://help.moengage.com/hc/en-us/articles/32059423774740-Landing-Page-Editor).