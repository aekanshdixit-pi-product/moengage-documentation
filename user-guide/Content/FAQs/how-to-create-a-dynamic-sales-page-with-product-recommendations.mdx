...
sidebarTitle: "How to Create a Dynamic Sales Page with Product Recommendations"
---
...
1. [Step 1: Create a Product Catalog](#h_01JQRA54GGM4559P252CH07QBF)
2. [Step 2: Create a Recommendation](#h_01JQRA5EQRRCJT97TNB7F69EA0)
3. [Step 3: Create the Landing Page](#h_01JQRA5QZ38C2899QC79VSYHZB)
...
1. On the left navigation menu in the MoEngage dashboard, click **Content**, and then click **Catalogs**.  
    <img alt="Screenshot 2025-04-16 at 1.01.33 PM.png" src="/images/moengage_9e9888.png" />
2. On the Catalogs page, click **Create Catalog**.  
    <img alt="2025-04-16_13-04-14.png" src="/images/moengage_b3d954.png" />
3. In the Catalog name box, type a name for the catalog to identify it, and click **Submit**.  
    <img alt="Screenshot 2025-04-16 at 1.05.57 PM.png" src="/images/moengage_e25b3e.png" />
4. Prepare a CSV file with the following columns: title (the product's name), image\_link (the URL of the product image), and link (the URL that leads to the product's checkout page, such as *https://www.example.com/productA/checkouts*). An example feed might look like the following image:  
    <img alt="Screenshot 2025-04-16 at 12.59.28 PM.png" src="/images/moengage_398368.png" />
5. On the **Catalogs** page, click the newly created catalog.  
    <img alt="2025-04-16_13-10-20.png" src="/images/moengage_7abe26.png" />
6. Click **Add Feed**. The **Create feed** pop-up window appears.  
    <img alt="Screenshot 2025-04-16 at 1.11.55 PM.png" src="/images/moengage_ed1e19.png" />
7. Upload the CSV file from your computer and click **Submit**. For information on using URL upload, refer to [Creating a Catalog](https://help.moengage.com/hc/en-us/articles/17456587985428).  
    <img alt="2025-04-16_13-16-49.png" src="/images/moengage_e24691.png" />
8. After a successful upload, your item feed will look something like this.  
    <img alt="Screenshot 2025-04-16 at 1.19.44 PM.png" src="/images/moengage_54208f.png" />
...
3. In the **Select recommendation model** section, we will use **Item attributes** type. You can learn more about recommendations [here](https://help.moengage.com/hc/en-us/articles/17653486610324).  
    <img alt="Screenshot 2025-04-16 at 1.23.32 PM.png" src="/images/moengage_bf1dbb.png" />
4. Click **Next**.
5. Enter a name and description for your recommendation.
6. In the **Catalog** list, select the catalog created in [Step 1](#h_01JQRA54GGM4559P252CH07QBF).  
    <img alt="2025-04-16_13-34-00 (1).gif" src="/images/moengage_a2f2e8.png" />
7. Set the filter as shown below:  
    <img alt="Screenshot 2025-04-16 at 1.44.42 PM.png" src="/images/moengage_38fb52.png" />   
   This will ensure all the products are shown when this recommendation is used. For more information on using filters, refer [here](https://help.moengage.com/hc/en-us/articles/17520210176916-Item-Attribute-Model#01HRYD8FX3YJ4G0DWK7V0FY2JE).
8. Click **Create**.
...
4. In the **Content** section, click **Blank Template**.  
    <img alt="Screenshot 2025-04-16 at 1.58.03 PM.png" src="/images/moengage_dfa159.png" />
5. Add the desired text and images to your page. For more information, refer to [Landing Page Editor](https://help.moengage.com/hc/en-us/articles/32059423774740).
...
7. Within the embed element, click the first icon in the settings bar and paste the following HTML code, replacing YOUR\_RECOMMENDATION\_NAME with your recommendation name (for example, *LP\_test*):  
   ...
   <img alt="2025-04-16_14-08-54 (1).gif" src="/images/moengage_13f511.png" />
...
10. Configure the URL and settings for your landing page. For more information, refer to [Create a Landing Page](https://help.moengage.com/hc/en-us/articles/32026262347028).
11. Click **Publish** to publish your landing page. The page will appear as shown below.  
     <img alt="Screenshot 2025-04-16 at 2.23.30 PM.png" src="/images/moengage_7daa3c.png" />
