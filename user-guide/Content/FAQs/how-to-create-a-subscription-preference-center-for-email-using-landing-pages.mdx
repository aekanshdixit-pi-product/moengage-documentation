...
sidebarTitle: "How to Create a Subscription Preference Center for Email Using Landing Pages"
---
...
5. If a required user attribute does not exist, create a new one by following the steps outlined in [Import User Data Using CSV](https://help.moengage.com/hc/en-us/articles/19192630201620-Import-User-Data-Using-CSV#h_01HB83FB354B1V8VQA9AZF3AQY).
6. Configure any additional form settings as needed.
7. Configure the URL and settings of your landing page. For more information, refer [here](https://help.moengage.com/hc/en-us/articles/32026262347028-Create-a-Landing-Page#h_01JCFX0SVP3ESEAP94M12CYSF6).
...
For more information on creating a connector campaign, refer [here](https://help.moengage.com/hc/en-us/articles/214247906-Create-a-Connector-Campaign).
...
7. In the **Content** section, follow the steps below:  
   ...
   4. Under **Body type**, select **Raw** and provide the JSON payload to update user preferences.  
      ...
      ```
   5. Click **Next**.
8. Define the **Schedule and Goals** of the campaign as desired. For more information, refer [here](https://help.moengage.com/hc/en-us/articles/214247906-Create-a-Connector-Campaign#01FXMQ4NVQR1FZDSVFC5YTTYGC).
