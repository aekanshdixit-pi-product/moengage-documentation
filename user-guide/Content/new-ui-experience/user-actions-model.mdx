...
2. Click **Recommendations**.   
    <img  src="/images/moengage_100d91.png"  />   
...
8. Choose the relevant user actions based on your use case from the **Item where user performed** drop-down list and define the activity date range. For example, Added to wishlist performed in the last 7 days. You can also exclude certain types of interacted items.  
    <img src="/images/moengage_c4b894.png"  />
...
10. In the **Sort the filtered items** section, sort the recommendation results by any numeric attribute. For example, price.  
     <img src="/images/moengage_576be6.png"  />
