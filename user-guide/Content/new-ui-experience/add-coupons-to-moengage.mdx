...
7. Under **Select Coupon file**, upload the CSV file containing coupons from your system. After the coupon list is created, you can add more files. Your CSV file must have a header with *Coupon Code*. You can also [download a sample file](https://webpush-manifest-files-staging.s3.amazonaws.com/Coupon+Sample+File/Sample_Coupon_File.csv) to see the format.
...
2. On the Add Coupons dialog box, attach a coupon file. Upload the CSV file containing coupons from your system. Your CSV file must have a header with *Coupon Code*. You can also [download a sample file](https://webpush-manifest-files-staging.s3.amazonaws.com/Coupon+Sample+File/Sample_Coupon_File.csv) to see the format.
...
MoEngage does not verify the redemption of coupon codes. You can generate the audit report of the coupon list used by different campaigns. For more information, refer to a [sample usage report](https://drive.google.com/file/d/16C_X649yxzhw8tEhaX28HRDvpmNwx2ky/view?usp=drivesdk).
