...
sidebarTitle: "Bring Users Back with Exit Intent Communications"
---
...
We will achieve this use case by [creating an On-site Messaging (OSM) campaign](#h_01HRZS8XFGYWN9KZPS82B9YNQK) to encourage users to complete their purchases when they try to exit from the payments page.

# Expected Result

When users visit the website, they will see a pop-up message.

<img alt="1.png"  src="/images/moengage_baf5d5.png"  />
...
3. Under **Inbound**, click **On-site**.  
    <img alt="Screenshot 2025-04-29 at 2.14.36 PM.png"  src="/images/moengage_c1569f.png"  />   
...
6. In the **Trigger Criteria** section, click the **On Exit Intent** card. This will ensure that the campaign is displayed to your users when they attempt to leave the page. For more information on defining exit intent, refer to [Exit Intent Technology](https://help.moengage.com/hc/en-us/articles/360043881431).  
    <img alt="3.png" src="/images/moengage_ebc220.png" />
7. In the **Select pages** section, you will define where you would want to display the campaign. Select **Specific pages** to display the campaign on specific pages of your website and define the condition as shown below.  
    <img alt="4.png" src="/images/moengage_b8e140.png" />   
...
1. On the **Prebuilt and saved templates** tab, use the search box to search with the keyword *pop-up* to find the pop-up templates.
2. Select the desired template from the **Templates** section. Alternatively, you can start from scratch and build your own template by selecting **Blank Popup Template** in the **Start from scratch** tab.  
    <img alt="Screenshot 2025-03-10 at 10.50.45 AM.png" src="/images/moengage_e9450d.png" />
3. After the template loads, you can edit it and define the OSM according to your requirements. Click the **+** icon on the left to add new elements to your campaign.  
    <img alt="6.png" src="/images/moengage_2ed6f9.png" />
...
1. In the **Send campaign** section, define when you want to start and end your OSM campaign.  
    <img alt="7.png" src="/images/moengage_f11983.png" />
...
5. In the **Local Delivery controls** section, define the controls based on your requirements. For more information, refer to [Create OSM Campaign](https://help.moengage.com/hc/en-us/articles/14111506452372).  
    <img alt="8.png" src="/images/moengage_ef0f2e.png" />
6. Click **Publish**.
...
Now that we have published the campaign, we can track its CTR and conversions (if defined) to understand its performance. For more information, refer to [Analyze On-site Messaging Campaigns](https://help.moengage.com/hc/en-us/articles/360054475351-Campaign-Analytics-for-On-site-Messaging-Campaigns#h_01HGZD9X6F9A19KZWY1W5DQW85).