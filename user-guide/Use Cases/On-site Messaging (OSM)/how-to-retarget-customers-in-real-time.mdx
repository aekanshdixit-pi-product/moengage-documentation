...
sidebarTitle: "How to Retarget Customers in Real Time"
---
...
<Tip>
Integration of the MoEngage Web SDK with your website. For more information, refer to the [Developer Guide](https://developers.moengage.com/hc/en-us).
</Tip>
...
2. Under **Inbound**, click **On-site**.  
    <img alt="2.png"  src="/images/moengage_683341.png"  />   
...
7. In the **Select pages** section, select the **All pages** option.  
    <img alt="1.png" src="/images/moengage_2b55f1.png" />
8. In the **Target Audience** section, filter the users by **User Property** and define the attribute as "Mobile Number (Standard) does not exist".  
    <img alt="14.png" src="/images/moengage_7934db.png" />
...
2. In the **Popup templates** section, hover your mouse on the **Popup: Lead Gen 1** template and click **Select Template**.  
    <img alt="13.png" src="/images/moengage_7f6489.png" />
...
7. On the **Advanced** tab, you can make sure to save the input value to the profile that gets created at MoEngage by selecting the “Attribute” where you would like to store the input value. This will help you engage with them in the future.  
    <img alt="9.png"  src="/images/moengage_53b29d.png"  />
8. To handle cases where the User Attribute Sync with segmentation is delayed, add the following Jinja to check whether the mobile number is populated.
   ```
   {% if UserAttribute['Mobile Number (Standard)']|length != 0 %} MOE\_NOT\_SEND {% endif %}
   ```
...
1. In the **Send campaign** section, define when you want to start and end your OSM campaign.  
    <img alt="11.png" src="/images/moengage_d5adb2.png" />
...
5. In the **Local Delivery controls** section, define the controls based on your requirements. For more information, refer to [Create OSM Pro Campaign](https://help.moengage.com/hc/en-us/articles/14111506452372).  
    <img alt="12.png" src="/images/moengage_34ab06.png" />
6. Click **Publish**.
...
3. Specify the time range for the event and add the campaign ID of your OSM campaign to see the number of users who have submitted a response to the campaign, as shown below:  
    <img alt="Segmentation.gif" src="/images/moengage_e01c37.png" />
...
- If the user attribute check fails in the Content section, the On-Site message will be dropped for the specific user.  
  To learn more, see [OSM Pro Templates](https://help.moengage.com/hc/en-us/articles/14909758696084-OSM-Pro-Templates#h_01GY6RCNESEJ8ZF4EVNP5BQXBT).
