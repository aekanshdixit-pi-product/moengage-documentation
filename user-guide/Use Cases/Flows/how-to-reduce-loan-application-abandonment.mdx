...
sidebarTitle: "How to Reduce Loan Application Abandonment"
---
...
7. Add as many action campaigns you want, from WhatsApp to Push, OSM or In-App based on your preference, to nudge the user for both getting their feedback and sending a message. Make sure to have some gap between any two communications to avoid spamming the user by using a Wait stage, especially in the Yes path of your “Has done events”. For more information, refer to [Add Controls to Flow](https://help.moengage.com/hc/en-us/articles/5663624694420-Add-Controls-to-Flow).
8. Click **Publish**.
