...
sidebarTitle: "How to Nudge Your Guests to Extend Their Stay"
---
...
#### <img alt="10.png"  src="/images/moengage_6ea0aa.png"  />

#### Users receive an Email message to extend their stay: <img alt="11.png"  src="/images/moengage_87d9ec.png"  />
...
4. Under the **Conversion goal** section, turn the **Exit on conversion** toggle on to exit users who convert by doing the event "Booking Extended". This is your primary conversion goal, which triggers when a user extends their stay at the hotel.  
    <img alt="1.png" src="/images/moengage_69e268.png" />
...
6. In the **IF user** section, select the event “Booked Room”, which gets triggered when a user books a room at the hotel.  
   ...
   John, a user of your platform booked a room in Hotel A from Dec 26–30 and in Hotel B from Dec 31 to Jan 3. On or before Dec 24, if he cancels his reservation in Hotel B and if the flow has checks only on the "Booked Room" and "Booking Extended" events, John will not enter the flow and thus will not get any nudges to extend the stay because you would have received the "Booked Room" and "Booking Extended" events.  
    <img alt="2.png" src="/images/moengage_053576.png" />
...
9. Turn the **Limit user entry into this flow** toggle on to define the maximum time a user can enter the flow. Defining such limits helps you control users from re-entering the flow repeatedly and thus avoid spamming them too much, which in turn provides a better user experience.  
    <img alt="5.png" src="/images/moengage_ed169d.png" />
...
11. In the **Audience** section, select **All users**. For a user to be eligible to enter an event-triggered flow, they must be part of the target audience before they do the required event.  
     <img alt="6.png" src="/images/moengage_09f0b0.png" />
...
1. Click the **+** icon. A drawer is displayed from where you can choose an action campaign from the range of options under **Actions** including Push, Email, SMS, or WhatsApp to send a message.   
    <img alt="7.png" src="/images/moengage_fb9ce8.png" />
2. If you have additional information about the users such as their name and gender, use the same to personalize the message while editing your action campaign. Also, including the details about the hotel booked such as the room type and image helps making the message more contextual and thereby increasing the chance of making the user feel connected and extend their stay. For more information, refer to [Personalization in Flows](https://help.moengage.com/hc/en-us/articles/115005552086).
...
4. Turn the **Keep evaluating for the next** toggle on to define the maximum time to wait for the user to execute the event. For our use case, select 1 hour.  
    <img alt="8.png" src="/images/moengage_168643.png" />
5. In the "No" path, you can check if the user clicked the previous message and based on that you can send further reminders. To do the same, you can click the **+** icon and then you will see different condition options under **Conditions** based on the action campaign used above. In case of Push and Emails, you will have the **Has clicked push notification** and **Has clicked email message** options respectively. You can select them.  
    <img alt="9.png" src="/images/moengage_b8311b.png" />
...
- Now that we have published the Flow, we can [analyze](https://help.moengage.com/hc/en-us/articles/20492596514708) how well our campaign is performing.
...
- We can also understand how many extended their stay because of our campaign. Create a segmentation on the “Flow Trip Conversion” event by mentioning the “Flow ID”. For more information, refer to [Conversion Tracking and Attribution in Flows](https://help.moengage.com/hc/en-us/articles/360038353852).