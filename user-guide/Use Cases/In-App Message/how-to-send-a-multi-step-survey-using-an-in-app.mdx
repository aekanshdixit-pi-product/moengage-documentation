...
sidebarTitle: "How to Send a Multi-Step Survey Using an In-App"
---
...
<img alt="ezgif.com-video-to-gif-converted.gif"  src="/images/moengage_a4d112.png"  />
...
2. Under **Inbound**, click **In-app**.  
    <img alt="In-app.png" src="/images/moengage_5b0eab.png" />   
...
5. In the **Trigger Criteria** section, select **On custom event**. Target users who clicked a pop-up offer (in-app clicked) but did not add any product to the cart within 15 minutes. It can be configured as shown below:  
    <img alt="3 on event.png" src="/images/moengage_782c47.png" />
...
1. Select the template you want to show the user. Select the **Survey** check box from the filters on the left side of the template listing page. Select the **Survey Popup - Multi Screen** template. You can customize it on the **Template Settings** page.  
    <img alt="Screenshot 2024-07-26 at 11.03.57 PM.png" src="/images/moengage_a867d8.png" />
2. Configure the survey steps:  
   ...
   - **Page 6: Thank you screen**
     ...
     These pages are already defined in the multi-page survey template. You can also change them according to your use case. For more information on configuring this HTML template, refer [here](https://help.moengage.com/hc/en-us/articles/4405363286292-HTML-In-App-Templates#h_01HHKG3821DWXKMFERJY55Y2DC).  
      <img alt="image-20240726-174057.png" src="/images/moengage_4f6c86.png" />   
      <img alt="ezgif.com-video-to-gif-converted.gif"  src="/images/moengage_a4d112.png"  />
...
4. In the **Delivery Controls** section, define the controls based on your requirements. For more information, refer to [Create In-App Campaign](https://help.moengage.com/hc/en-us/articles/206184196).  <img alt="image-20240121-054810.png" src="/images/moengage_d99cf8.png" />
5. Click **Publish**.
...
2. Filter based on the *response submitted* event as shown below:  
    <img alt="Screenshot 2024-07-26 at 11.15.22 PM.png" src="/images/moengage_95e4f5.png" />
...
Now that we have published the campaign, we can track its CTR and conversions (if defined) to understand its performance. For more information, refer to [In-App Campaign Analytics](https://help.moengage.com/hc/en-us/articles/360052454472).