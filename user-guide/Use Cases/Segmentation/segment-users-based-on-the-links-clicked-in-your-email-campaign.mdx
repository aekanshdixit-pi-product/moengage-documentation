...
sidebarTitle: "Segment Users Based on the Links Clicked in Your Email Campaign"
---
 ...
 **<img  src="/images/moengage_24bae6.png"  />**

<Tip>
- Email partner must be configured. For more information on configuring an email partner, refer [here](https://help.moengage.com/hc/en-us/articles/360059172811-Configure-Email-Channel).
- An email campaign with a feedback survey must be conducted. For more information on creating an Email campaign, refer [here](https://help.moengage.com/hc/en-us/articles/360059171891).  
   <img alt="att_2_for_4061496363.png" src="/images/moengage_af8d31.png" />
- Here, Good is associated with http://www.example.com/good. Similarly, OK and Bad are associated with different links, which will be unique identifiers.
...
- An event must be available in MoEngage to track the user action of engaging with the email. In this example, we will use the *Email Clicked* event. To understand how to track events, refer to the [Developer Guide](https://developers.moengage.com/hc/en-us).
</Tip>

# Create a Segment Based on User Response

1. On the left navigation menu in the MoEngage dashboard, click **Segments**, and then click **Create segment**. For more information on creating segments, refer [here](https://help.moengage.com/hc/en-us/articles/206169646-Create-Segments).  
    <img alt="att_1_for_4061496363.png"  src="/images/moengage_52790e.png"  />
...
3. To segment users, select those who have clicked the email. The following image shows a sample segment to track users who clicked your email:  
    <img alt="att_4_for_4061496363.png" src="/images/moengage_854f00.png" />
...
1. 1. On the left navigation menu in the MoEngage dashboard, click **Engage** and then select **Campaigns**.
