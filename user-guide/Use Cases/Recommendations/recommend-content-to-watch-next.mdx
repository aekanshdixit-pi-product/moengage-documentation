...
sidebarTitle: "Recommend Content to Watch Next"
---
...
- [Create a recommendation](#h_01HKCZMQH8ZSCW6SXM4CJ2NEJ4)
- [Create a Push Campaign](#h_01HN0HKXW0SA6A6K8N46G1J5GA)

# Expected Result

Users receive a push notification with recommendations of what to watch next on their phones: 

<img alt="1.png"  src="/images/moengage_68c3b4.png"  />   
  
 <img alt="14.png"  src="/images/moengage_32913a.png"  />

<Tip>
- Events must be available in MoEngage to track the action of a user watching content and each action’s related information, such as the genre, title, type, progress, rating, and platform. To understand how to track events, refer to the [Developer Guide](https://developers.moengage.com/hc/en-us).
- The tracked events above must be mapped to the concerned MoEngage catalog user actions. In this example, the custom event of starting content will be mapped to *Product Viewed*. For information, refer to [Map User Actions Settings](https://help.moengage.com/hc/en-us/articles/17459183026196).
...
1. On the left navigation menu in the MoEngage dashboard, click **Content** and then click **Recommendations.** For more information, refer to [Creating User Action Recommendations](https://help.moengage.com/hc/en-us/articles/17558854011924-User-Actions-Model#h_01HDNVE5AGE3QZ03RNCQ5DMDPW).
...
5. Enter the following details:  <img src="/images/moengage_dbeeaa.png" />
   ...
   3. **Catalog**: Select the catalog to which the recommendation is to be applied. In this example, we will select *Recommendations Demo Catalog*.  
       <img  src="/images/moengage_ca1b77.png"  />
...
2. Under **Outbound**, select **Push** \> **Periodic**.
   ...
   <img src="/images/moengage_4c0c28.png" />
...
5. On the **User behavior** tab, select *users who have not watched content in the last 1 day.*  
    <img alt="7.png" src="/images/moengage_f6add1.png" />
6. In the **Target Platforms** section, select **Android**.  
    <img alt="8.png" src="/images/moengage_9e9b70.png" />
7. Click **Next**.
...
1. Select the template that you would like to use. For our example, select **Basic notification**.  
    <img  src="/images/moengage_710bcb.png"  />
...
3. While defining the message, select the product set generated through the recommendation [you defined](#h_01HKCZMQH8ZSCW6SXM4CJ2NEJ4).
   ...
   2. Search for *WhatNextToWatch*, which is the name of the recommendation you built.   
       <img alt="10.png" src="/images/moengage_c08d85.png" />
   3. Click **Done**.   
      The following JINJA code is inserted in the Message field:  
       <img alt="11.png" src="/images/moengage_a73b60.png" />
   4. Edit the code to run a loop through each content and list down the first suggestion because the highly confident suggestions come first from the Recommendation engine. The higher the confidence, the higher the content will be in the list. The final JINJA code looks as follows:
      ...
      In line 2, the loop does only one iteration using “[0:1]” in the query. If you want to suggest the top 3, you can change the same to “[0:3]” and so on. The {{product.product\_name}} element in line 3 prints the name of the suggested content. For more information, refer to [Jinja Templating Language](https://help.moengage.com/hc/en-us/articles/115002757783).
   5. Enter the following code to get the image of the recommended watch:
      ...
      In Line 3, {{product.image\_url}} provides the link to the image of the concerned title of the suggested content.
4. Add a deep link to the push notification, mentioning the URL that will directly take users to your app's mentioned title or suggestion list. This reduces the possibility of a user dropping off before finding the suggested content.  
    <img alt="12.png" src="/images/moengage_5b62f3.png" />
...
1. In the **Send campaign** section, define when you want to start and end your campaign.  
    <img src="/images/moengage_278628.png" />
