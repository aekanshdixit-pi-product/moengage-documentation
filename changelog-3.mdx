...
<Info>
* You can now get notified whenever MoEngage releases a new version of the Unity SDK. For more information, refer to [Subscribe to MoEngage SDK Releases](https://developers.moengage.com/hc/en-us/articles/25961611872788).
...
* iOS
	+ Added support for tracking custom boolean attributes in two formats: ***0/1*** and ***TRUE/FALSE*** Refer to the [documentation](https://developers.moengage.com/hc/en-us/articles/4404440336148-Tracking-User-Attributes#h_01J4RHZ6CNAAX7T8Z941S34KQF) for more information.
...
* iOS
	+ Updated the MoEngage-iOS-SDK dependency to **9.17.0** and above. Refer [here](https://developers.moengage.com/hc/en-us/articles/4404198236564-Changelog#01HS8FGNBB50KZ0QAT847A34N3) for more information.
...
* Android
	+ Native SDK updated to support `11.4.00` and above. Refer to [Release Notes](https://developers.moengage.com/hc/en-us/articles/4403896795540-Changelog#11-4-00-31-08-2021--0-5) for more details.
* iOS
