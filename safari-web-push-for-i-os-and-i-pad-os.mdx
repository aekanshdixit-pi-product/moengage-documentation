...
Ensure that you follow our standard [web push integration guide](https://developers.moengage.com/hc/en-us/articles/360060819792-Configure-and-Integrate-Web-Push). The following steps are required to support web push notifications on Safari for iOS and iPadOS.
...
To enable web push notifications for iOS and iPadOS, import the MoEngage service worker and place it in the root file. This step is the same as that of the normal web push notifications integration. For more information, refer to the [Service worker integration document.](https://developers.moengage.com/hc/en-us/articles/360060819792-Configure-and-Integrate-Web-Push)
...
![Addtohomescreen](/images/Addtohomescreen.png)
...
This can be configured using the MoEngage dashboard. For more information, refer to [opt-in management](https://help.moengage.com/hc/en-us/articles/210224063-Configure-Web-Push-Settings#configure-web-push-opt-in-0-4).

| |
| --- |

![Optin Image](/images/Optin_image.png)

| | |
| --- | --- |

![Optin Image2](/images/Optin_image2.png)
...
- Send yourself a [push notification](https://help.moengage.com/hc/en-us/articles/210223973-Create-Web-Push-Campaign) and validate whether it is working as expected.