...
<Info>
Updating to Core 8.0.0 changes custom boolean user attribute tracking on iOS from **1/0** to **TRUE/FALSE**. You can configure the preferred format. Refer to the [documentation](/developer-guide/react-native-sdk/data-tracking/Tracking-User-Attributes#Custom-Boolean-User-Attribute) for details.
</Info>
