...
| Catalog Version | Modules | Dependencies |
| :--- | :--- | :--- |
| [6.1.1](https://github.com/moengage/android-dependency-catalog/releases/tag/v6.1.1) | • <span style={{ color: '#008767', fontWeight: 'bold' }}>moe-android-sdk: 14.04.01</span><br/>• <span style={{ color: '#008767', fontWeight: 'bold' }}>cards-core: 3.2.1</span><br/>• <span style={{ color: '#008767', fontWeight: 'bold' }}>cards-ui: 3.2.1</span><br/>• inapp: 9.5.0<br/>• geofence: 5.1.0<br/>• pushkit: 6.2.0<br/>• inbox-core: 4.2.0<br/>• inbox-ui: 4.2.0<br/>• realtime-trigger: 4.2.0<br/>• pushAmp: 6.2.0<br/>• richNotification: 6.3.0 | AGP: 8.7.3<br/>Kotlin: 1.9.23<br/>Compile SDK: 35<br/>Gradle: 8.9 |
