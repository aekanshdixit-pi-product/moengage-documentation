...
For more info on SDK Initialization, refer to the following [doc](/hc/en-us/articles/4403905438228).

# Analytics Module Changes

## Track Event:

We have Introduced `MOProperties` class to track all the event attributes. And hence we have deprecated the earlier methods and included `trackEvent:withProperties:` to track events. Refer to this [link](/hc/en-us/articles/4403922636308) for more info.
...
We have added a couple of additional methods to track date user attributes in the SDK, more info in this [doc](/hc/en-us/articles/4403905883796) :
...
- We have added support for **Context-based InApps** wherein we can tag InApps and show InApps based on the current context set on the SDK. Refer to this [link](/hc/en-us/articles/4404155127828) for more info.
...
- [InApp APIs for SDK version 6.0.0 and above](/hc/en-us/articles/4404155127828)
