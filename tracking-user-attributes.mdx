...
For SDK versions below 9.23.0 refer to [this document](/developer-guide/ios-sdk/sdk-integration/basic/sdk-initialization).
...
_Note_: This method is a replacement for the deprecated **_setUniqueId()_**. If you are using \*\*\*setUniqueId() \*\*\*in your application, consider replacing it with **_identifyUser()_**
