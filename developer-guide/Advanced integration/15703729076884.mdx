...
Before updating your SDK code, you must delegate a subdomain to MoEngage. Please refer to our [DNS Delegation Help Documentation](https://help.moengage.com/hc/en-us/articles/45199793953300-Custom-Proxy-Sub-Domains) for the step-by-step process on picking a domain and configuring NS records.
</Info>
...
importScripts("https://cdn.yoursubdomain.yourdomain.com/release/your_data_center/versions/2/serviceworker_cdn.min.latest.js");
```
...
<script src="https://cdn.yoursubdomain.yourdomain.com/release/your_data_center/versions/2/moe_webSdk_webp.min.latest.js?app_id=YOUR_WORKSPACE_ID&customProxyDomain=yoursubdomain.yourdomain.com"></script>
```
...
For Web SDK integration support, please feel free to reach out to [our support team](https://help.moengage.com/hc/en-us/articles/19708702327572-Raise-a-Support-Ticket-Through-MoEngage-Dashboard).
