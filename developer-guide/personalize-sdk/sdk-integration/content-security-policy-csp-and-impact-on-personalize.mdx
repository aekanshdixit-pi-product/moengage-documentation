---
title: "Content Security Policy (CSP) and Impact on Personalize"
description: "Learn how to configure CSP to work seamlessly with MoEngage Personalize."
---
...
```html HTML wrap
<head>
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' [www.example.com](https://www.example.com); style-src 'self' 'unsafe-inline' fonts.googleapis.com; img-src 'self' data:; font-src 'self' fonts.gstatic.com;">
</head>
```
