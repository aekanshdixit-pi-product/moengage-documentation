...
<Warning>
Make sure you are calling **initialize()** method of the plugin to receive these callbacks. Refer [Initialise Capacitor Component](https://developers.moengage.com/hc/en-us/articles/4417377582100-SDK-Integration#integrate-native-platforms-0-1) for more info.
</Warning>
