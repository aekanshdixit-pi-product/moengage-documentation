...
* iOS
	+ Added support for tracking custom boolean attributes in two formats: ***0/1*** and ***TRUE/FALSE*** Refer to the [documentation](https://developers.moengage.com/hc/en-us/articles/4404424678036-Tracking-User-Attributes#h_01J4R65FT0DPAVJ834N7XG4ZTS) for more information.
