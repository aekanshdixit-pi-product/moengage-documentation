...
- Enhancements
  - Support for provisional Push API - `registerForProvisionalPush()`
  - Support for fetching multiple self-handled In-Apps - `getSelfHandledInApps()`
  - Added support for a logout complete callback to manage post-session cleanup.
...
- iOS
  - Support for iOS SDK version **_9.16.1_** and above. Refer to [release notes](/developer-guide/release-notes/ios-sdk/2024#8th-April-2024) for more details.

## Geofence 1.6.0

- iOS
  - MoEngageGeofence SDK dependency updated to **_5.15.0_** and above.Refer to [release notes](/developer-guide/release-notes/ios-sdk/2024#8th-April-2024) for more details
