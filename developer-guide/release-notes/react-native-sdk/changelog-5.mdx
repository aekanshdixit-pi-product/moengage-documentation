...
| --- | --- |
| core: 12.6.0   <br />cards: 6.3.0  <br /> geofence: 7.3.0  <br /> inbox: 6.3.0 | <ul><li>**Android** <ul><li>AGP: 8.13.2</li><li>Kotlin: 1.9.23</li><li>Compile SDK Version: 35</li><li>Gradle Version: 8.13</li></ul></li><li>**iOS** <ul><li>iOS deployment target: 13</li><li>tvOS deployment target: 13</li></ul></li></ul> |
...
- iOS
  - **_MoEngagePluginGeofence_** version updated to __4.2.2__\*\*
...
- iOS
  - **_MoEngagePluginInbox_** version updated to __4.2.2__\*\*
...
- Android
  - Support for Native Android SDK version **_13.00.00_**_ and above_, refer to the [release notes](/developer-guide/release-notes/android-sdk/2024/#27th-February-2024) for more details.
- iOS
