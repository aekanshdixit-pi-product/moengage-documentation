...
- Added support for tracking clicks in email. This feature is enabled automatically upon upgrading to this SDK version.
...
- Fixed the order of event tracking for the `Offering Clicked` event.
