...
- Added support for tracking clicks in emails sent from the MoEngage Platform. This feature is enabled automatically upon upgrading to this SDK version. For more information, refer [here](/user-guide/campaigns-and-channels/email/gett[…]ed-with-email/configure-a-deep-linking-domain).
