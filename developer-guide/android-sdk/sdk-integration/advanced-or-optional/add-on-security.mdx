...
Integration using BOM is the recommended way of integration; refer to the [Install Using BOM](/hc/en-us/articles/44622788607892) document to configure if not done already. Once you have configured the BOM, add the dependency in the ***app/build.gradle*** file as shown below.
...
<Frame>
  <img src="/guide-media/01JG0WKD6C7V8DVH25J95QFKEP" alt="Dashboard API Keys Screen" />
</Frame>
