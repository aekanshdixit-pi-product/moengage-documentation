...
Refer to this [link](https://www.moengage.com/docs/user-guide/campaigns-and-channels/in-app-message/create/preview-in-app-template-in-your-phone) to read more about how to create and test in-apps.
