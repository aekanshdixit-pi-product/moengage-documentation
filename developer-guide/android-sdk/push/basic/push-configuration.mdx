...
Use the [_configureNotificationMetaData()_](https://moengage.github.io/android-api-reference/core/com.moengage.core/[android-jvm]-mo-engage/-builder/configure-notification-meta-data.html) to transfer the configuration to the SDK.
