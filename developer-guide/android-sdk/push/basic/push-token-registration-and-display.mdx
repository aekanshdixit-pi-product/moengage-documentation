...
First, we will look at the integration steps needed if **MoEngage SDK** handles Push token registration and display. Refer to [this section](/android-sdk/push/basic/push-token-registration-and-display#Pass-the-Push-Token-To-MoEngage-SDK) for the integration steps required if **the app** handles push token registration and receives the notification payload.
