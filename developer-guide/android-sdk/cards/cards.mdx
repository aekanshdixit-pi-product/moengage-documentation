...
dependencies {
    ...
    // Required if you use the SDK-provided CardActivity or CardFragment, covered later on this page.
...
The SDK uses [Glide](https://bumptech.github.io/glide/) to load images and GIFs. Add Glide to your application if you don't already use it. Use **4.16.0** or higher to stay consistent with the version used by the [in-app module](/developer-guide/android-sdk/in-app-messages/in-app-nativ#prerequisites).
