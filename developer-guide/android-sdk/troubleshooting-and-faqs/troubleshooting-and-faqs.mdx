...
No. The initialization API takes approximately 1–5 milliseconds on average. Refer to the [SDK Performance](/developer-guide/android-sdk/performance/sdk-performance) document for per-device benchmarks.
