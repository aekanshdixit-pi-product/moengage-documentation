...
Starting Android 14, you need to get explicit alarm permission from the customer, read more about it [here](https://www.moengage.com/docs/developer-guide/android-sdk/push/optional/push-templates#timer-with-progress-bar).
