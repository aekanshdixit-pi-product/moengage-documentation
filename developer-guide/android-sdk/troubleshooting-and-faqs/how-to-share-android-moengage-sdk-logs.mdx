...
Use the following API to enable MoEngage SDK logs globally at runtime without rebuilding the application or modifying initialization code. This activates comprehensive logging across all SDK components and active workspace instances.
...
<Warning>
  Call this method before any SDK initialization to capture all logs from startup. Remove it before pushing the app to production.
</Warning>
