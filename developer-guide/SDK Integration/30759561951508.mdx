...
| custom | Any other trait that you want to target for personalization.    **Example**Personalize all pages that display **White, Medium**-size Polo T-shirts for **Men   OR**Personalize checkout page only when the cart value is $500 or above and cart discount is 0 and cart contains atleast 2 items. | **custom**: {   color: "White",   size: "M",   gender: "Male"   }   **OR**   **custom**: {   cartAmount: "750",   cartDiscount: "0",   cartQuantity: "4"   } |
