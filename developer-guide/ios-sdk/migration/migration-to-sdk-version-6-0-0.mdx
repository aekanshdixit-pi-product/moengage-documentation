---
title: "Migration to SDK 6.0.0"
description: "Migration guide for upgrading to MoEngage iOS SDK version 6.0.0."
sidebarTitle: "SDK 6.0.0"
---
...
- We have added support for **Context-based InApps** wherein we can tag InApps and show InApps based on the current context set on the SDK. Refer to this [link](/developer-guide/ios-sdk/in-app-messages/in-app-native) for more info.
...
- [InApp APIs for SDK version 6.0.0 and above](/developer-guide/ios-sdk/in-app-messages/in-app-native)
