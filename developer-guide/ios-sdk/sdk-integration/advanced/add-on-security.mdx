...
![Screenshot_2023-03-30_at_12.21.36_PM.png](15320359672468)
2. Specify the Keychain group name
![Screenshot_2023-03-30_at_12.23.06_PM.png](15320349011604)
...
![Screenshot_2023-03-30_at_12.24.23_PM.png](15320388302356)
...
MoEngageSDKConfig* sdkConfig = [[MoEngageSDKConfig alloc] initWithAppID:@"YOUR Workspace ID"];        sdkConfig.storageConfig = [[MoEngageStorageConfig alloc] initWithEncryptionConfig: [[MoEngageStorageEncryptionConfig alloc] initWithIsEncryptionEnabled:true]];
