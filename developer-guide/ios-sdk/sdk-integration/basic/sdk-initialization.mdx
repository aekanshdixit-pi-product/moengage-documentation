...
<Warning>
  ...
  - If you set _any_ portfolio attribute during SDK initialization without passing a valid `projectID`, the application will crash. If you are using portfolio attributes, you must provide the `projectConfig`.
