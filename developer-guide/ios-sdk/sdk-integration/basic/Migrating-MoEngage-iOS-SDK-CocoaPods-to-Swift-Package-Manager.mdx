...
3. Enter the corresponding URL to install the package:
   * **For SDK versions 9.23.0 and above:** `https://github.com/moengage/apple-sdk.git`
   * **For other SDK versions:** `https://github.com/moengage/MoEngage-iOS-SDK.git`
