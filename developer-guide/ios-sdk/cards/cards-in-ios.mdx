---
title: "Cards"
description: "Integrate the MoEngage Cards module for app inbox and newsfeed campaigns."
---
...
![Cards inbox UI on iOS](/images/cardsinios1.png)
...
MoEngageSDKCards.sharedInstance.getCardsViewController(withUIConfiguration: uiConfig, withCardsViewControllerDelegate: self, forAppID: "YOUR Workspace ID") { cardsController in
    self.cardsController = cardsController
}
```
...
![Customized cards inbox UI](/images/cardsinios2.png)
...
![Empty inbox default UI](/images/customizeemptyinbox.jpeg)
