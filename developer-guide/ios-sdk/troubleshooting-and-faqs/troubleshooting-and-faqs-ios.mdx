...
description: "Common issues and solutions for the MoEngage iOS SDK integration."
...
- Make sure **handleInAppMessage** method is called wherever In-App is displayed - [link](/developer-guide/ios-sdk/in-app-messages/in-app-native)
- In-App only came once and can’t see/test it again. Then it might be a case where inApp to be shown may not pass a set of rules which we have kept in SDK to make sure the user experience isn't hindered. Refer the [link](/developer-guide/ios-sdk/in-app-messages/in-app-native) to know about these rules.
