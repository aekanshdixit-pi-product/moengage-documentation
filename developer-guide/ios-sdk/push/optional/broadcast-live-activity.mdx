...
description: "Send Live Activity updates to all users via broadcast push notifications."
---
...
<Check>
  **Success/Developer Info**
  ...
  Your server should store the returned channel_id, MoEngage metadata, and make it available to your mobile app. Your app will need this data to initiate the Live Activity locally.
</Check>
