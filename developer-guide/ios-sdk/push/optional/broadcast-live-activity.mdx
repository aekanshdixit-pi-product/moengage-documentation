...
<Warning>
  Starting a Live Activity before the MoEngage SDK has fully initialized triggers an exception and causes your app to crash. Ensure the SDK is initialized before calling any Live Activity tracking methods.
</Warning>
