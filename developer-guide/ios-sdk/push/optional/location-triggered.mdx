...
1. On the simulator:
	* You can simulate location as shown below.  
	![607cac9-W6pm9CraSnyt95y5dYs0_iOS_geofence_simulator.png](4404024244628)
	* Simulate the location for which you have created the campaign on the dashboard.  
	If you get the respective call back (the delegate methods in MoEngageGeofenceHandler), you are good to go. On simulator, you will not receive push notifications.
2. On the device:
	* You can simulate location for real device from the bar above the console as shown below:  
	![6320d0b-DiSRKNLTCGaPPeKpbdL6_iOS_geofence_location.png](4404024244244)
