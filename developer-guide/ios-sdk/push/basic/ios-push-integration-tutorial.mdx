...
<AccordionGroup>
  ...
  <Accordion title="Why does the app crash when receiving a Rich Push Notification?">
    This crash occurs if a rich push notification payload is received by the device, but the MoEngage RichNotification extension has not been integrated into your iOS project. Verify that your Notification Service Extension is properly set up.
  </Accordion>
</AccordionGroup>