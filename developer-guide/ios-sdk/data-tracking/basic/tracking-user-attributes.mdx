...
<Warning>
  **Note**
  ...
  - For more information on supported data types and data tracking policies, please refer to [Data Tracking Policies](https://www.moengage.com/docs/user-guide/data/key-concepts/data-tracking-policies#supported-datatypes).
</Warning>
