...
<Info>
  **Prerequisites**
  ...
  - Multiple projects must be configured in your MoEngage workspace. For more information, contact your MoEngage account manager.
</Info>

In a multi-project workspace, user attributes can be tracked either at the project level (scoped to a specific project) or at the portfolio level (shared across all projects in the workspace).
