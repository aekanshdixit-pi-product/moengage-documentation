...
description: "Handle custom deeplink and navigation actions from in-app message clicks."
---
...
Refer to the [doc](/developer-guide/ios-sdk/in-app-messages/in-app-native#non-intrusive-nudges) for callback methods.
