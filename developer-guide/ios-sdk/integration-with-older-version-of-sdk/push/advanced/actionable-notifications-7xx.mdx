---
title: "Actionable Notifications 7.x.x"
description: ""
---
...
MoEngage recommended not to change the actions grouped in a category across the app versions, as it will lead to user seeing different actions for same category across different app versions.
</Info>
