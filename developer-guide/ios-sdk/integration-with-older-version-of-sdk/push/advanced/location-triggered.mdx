---
title: "Location triggered (legacy)"
description: "Geofence-based notifications for older SDK versions."
sidebarTitle: "Location (legacy)"
---
...
1. On the simulator:
	* You can simulate location as shown below.  
	![607cac9-W6pm9CraSnyt95y5dYs0_iOS_geofence_simulator.png](19218271392020)
...
2. On the device:
	...
	* You can simulate location for real device from the bar above the console as shown below:  
	![6320d0b-DiSRKNLTCGaPPeKpbdL6_iOS_geofence_location.png](19218271393684)
