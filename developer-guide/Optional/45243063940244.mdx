...
Start a live activity for a user using the Inform API. For more information, refer [here](https://developers.moengage.com/hc/en-us/articles/38536918351380).
...
Update the transactional activity status using a push notification targeted at the activity's push token. Updates must be performed exclusively via the Inform API. For more information, refer to the [Inform API](https://developers.moengage.com/hc/en-us/articles/10699624590868-Inform-API).
...
For more information, refer to the [Inform API](https://developers.moengage.com/hc/en-us/articles/10699624590868-Inform-API).
