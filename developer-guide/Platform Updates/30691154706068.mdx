...
After building a release APK for each flavour, publish them both to the Play Store, and the device will update with the most appropriate version for that device. Read more about [multiple APK support in the Play Store](https://developer.android.com/google/play/publishing/multiple-apks).
