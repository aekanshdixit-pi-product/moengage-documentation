...
* Android
	+ Support for the MoEngage SDK BOM version [1.5.1](https://developers.moengage.com/hc/en-us/articles/44954767963284-2026#h_01KFD9D3PY3AF03HPJP19XYNZ0)
* iOS
...
* iOS
	+ Added support for tracking custom boolean attributes in two formats: ***0/1*** and ***TRUE/FALSE*** Refer to the [documentation](https://developers.moengage.com/hc/en-us/articles/4404313711124-Tracking-User-Attributes#h_01J4RAY2R4YDNB3X6JRVRD3FKX) for more information.
...
* Android
	+ Native SDK Updated to support version **13.00.00** and above. Refer to the [Release Notes](https://developers.moengage.com/hc/en-us/articles/4403896795540-Changelog) for behavior changes.
	+ Add support for AGP **8.2.2** and above
	+ **Note:**Use minimum Native Inapp version [8.1.1](https://developers.moengage.com/hc/en-us/articles/4403896795540-Changelog#h_01HSFNBZR5AVPP8MZ3HX0K90DS). There is a known issue regarding in-app rendering in Flutter in InApp versions **8.0.0** & **8.1.0.**
* IOS
...
* Native SDK updated to support version `6.0.2` and above. Refer to the [Release Notes](https://developers.moengage.com/hc/en-us/articles/4403896795540-Android-SDK-Consolidated-Release-Notes) for behavior changes.
