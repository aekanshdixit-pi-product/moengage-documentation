...
For general cases, you would just be passing the event-name and event-attributes JSON and in this case you can skip the other params. A method for this case would be like - moengage.trackEvent(Response\_Submitted,{"response1":"johndoe@gmail.com","response2":"approved"})
</Info>
