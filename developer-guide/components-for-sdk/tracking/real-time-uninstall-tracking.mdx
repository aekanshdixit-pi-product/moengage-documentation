...
Cloud Functions for Firebase is a serverless framework that programmatically provides responses to events triggered by Firebase features and HTTPS requests. For more information, refer to [Cloud Functions for Firebase](https://firebase.google.com/docs/functions).[Placeholder_Link]
...
<Check>
  ...
  To deploy Cloud Functions to the runtime environment, your project must be on the [Firebase pricing plan](https://firebase.google.com/pricing).[Placeholder_Link]
</Check>

## Set up a common identifier

Ensure your app has integrated Firebase Analytics SDK. For more information, refer to [Get started with Google Analytics](https://firebase.google.com/docs/analytics/get-started).[Placeholder_Link]
...
1. Navigate to [Firebase Console](https://console.firebase.google.com/) [Placeholder_Link] and select the Firebase project integrated with the app.
...
After the conversion event is set up, use the [Cloud Function for Firebase](https://firebase.google.com/docs/functions/get-started) [Placeholder_Link] to create a function and send the **app_remove** event to MoEngage.

To create and publish a cloud function using Node JS, follow these steps:

1. Install [Node.js](https://nodejs.org/en/) [Placeholder_Link]and [npm](https://www.npmjs.com/).[Placeholder_Link]\
