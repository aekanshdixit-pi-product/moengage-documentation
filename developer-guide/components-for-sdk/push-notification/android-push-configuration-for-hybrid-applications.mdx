...
Use the [_configureNotificationMetaData()_](https://moengage.github.io/android-api-reference/core/com.moengage.core/%5Bandroid-jvm%5D-mo-engage/-builder/index.html) to transfer the configuration to the SDK.
