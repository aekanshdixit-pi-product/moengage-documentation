---
title: "iOS SDK Initialization 8.2.0 and Above"
description: ""
---
...
* Call any one of the below-given initialization methods in **application:didFinishLaunchingWithOptions:** method. The method accepts the **MoEngageSDKConfig** instance as its parameter. Refer [doc](https://developers.moengage.com/hc/en-us/articles/4403905438228) for more info on all the properties which can be configured using **MoEngageSDKConfig**.
