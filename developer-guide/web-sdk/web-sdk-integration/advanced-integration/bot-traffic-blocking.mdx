...
<CodeGroup>
```javascript Default Blocked Bot List
...
To block additional bots, you can update the key `bots_list: ["bot_name"]` key during [integration](https://developers.moengage.com/hc/en-us/articles/360060713252-Web-SDK-Integration#01H8XHVYJZHY8Z7869YDF2CKJJ).  
