...
Before configuring the nonce, ensure MoEngage domains are whitelisted in your CSP header (for example, script-src, connect-src, and img-src). For more information, refer to [Web SDK Integration](https://developers.moengage.com/hc/en-us/articles/360060713252-Web-SDK-Integration#h_01KD2BMMKRQPB8W4GBQCHDVPRX).
</Note>
...
Update the script below with your specific Data Center value and app_id. For more information, refer to [Web Personalization](https://developers.moengage.com/hc/en-us/articles/10645116433812-Web-Personalization-V2).
</Info>

<Tabs>
  <Tab title="WebP Script">
    ```html wrap
