...
3. Replace the value of sdkVersion with the version of Web SDK you intend to use. It is recommended to use the format x (major)
4. Replace "DC" with the data center form the above table
5. If you have [_Portfolio_](https://help.moengage.com/hc/en-us/articles/40394603054100-Portfolio) enabled for your workspace, you need to pass the `projectId` key and the projectID of you project as value.
...
- if you have [_Portfolio_](https://help.moengage.com/hc/en-us/articles/40394603054100-Portfolio) enabled for your workspace, you need to pass the `projectId` key.
