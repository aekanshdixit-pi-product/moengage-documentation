...
The MoEngage Assist Chrome extension is a dedicated debugging tool designed to help developers and marketers monitor and troubleshoot their MoEngage Web SDK implementation. Install and configure the extension to seamlessly validate and debug your Web SDK integration directly from your browser.
...
<Tabs>
  ...
  <Tab title="User">
    ...
    **Warning:** Manually clearing local storage will reset the MoEngage SDK session and break event tracking. Always utilize the destroySession() method before clearing localStorage.
  </Tab>
</Tabs>
