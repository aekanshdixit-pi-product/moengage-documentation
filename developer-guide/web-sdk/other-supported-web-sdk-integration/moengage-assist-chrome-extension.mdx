...
<Tabs>
  ...
  <Tab title="User">
    ...
    <Warning>
      Manually clearing local storage  resets the MoEngage SDK session and break event tracking. Always utilize the destroySession() method before clearing localStorage.
    </Warning>
