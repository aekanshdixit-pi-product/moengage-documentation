...
| Serviceworker custom path | The path of your service worker file. Read more about setting up Push notifications support [here](https://developers.moengage.com/hc/en-us/articles/360060819792-Configure-and-Integrate-Web-Push). |
| Is Onsite-Messaging disabled? | On-site Messaging Campaigns allow you to show personalized pop-ups and non-intrusive banners on your website.   Web SDK integration for On-site Messaging will automatically start working on all the pages where the web SDK is integrated.       If you want to disable Onsite-Messaging for this website, check this option. Read more about how to configure Onsite-Messaging [here](https://developers.moengage.com/hc/en-us/articles/360061573232-Configure-and-Integrate-On-site-Messaging). |
| Is SPA enabled? | If your website is a Single Page Application (SPA), select this option. Read more about how MoEngage handles SPAs [here](https://developers.moengage.com/hc/en-us/articles/360062008652-Single-Page-App-SPA-Support). |
| Keep SDK disabled? | If selected, SDK is disabled during initialization. For more information, refer [here](https://developers.moengage.com/hc/en-us/articles/37903063575060-Web-SDK-Opt-out). |
| Enable Web Personalization | Web Personalization is used to personalize the website experience for each user. Select this option if you want to leverage our Web Personalization capabilities. Read more about Web Personalization [here](https://developers.moengage.com/hc/en-us/articles/360062008891-Configure-and-Integrate-Web-Personalization). |
| Cards Config (in JSON) | If you want to personalize cards, paste the JSON config in here. Read more about how to customise cards according to your needs [here](https://developers.moengage.com/hc/en-us/articles/9526886582292-Cards). |
**Step 2 (Optional): Enabling Web Push notification**

Optionally, if you want to be able to send push through the Google Tag Manager, first follow the [push integration](https://developers.moengage.com/hc/en-us/sections/360013507812-Web-Push) guidelines and place serviceworker file at the root directory of your project.

**Step 3: Triggering**

After configuring the tag, trigger it at every page view of your site:

![Screenshot](17395395773588)
...
[Read more](https://developers.moengage.com/hc/en-us/articles/360061114832-Web-SDK-User-Attributes-Tracking#update-user-0-5) about how updating the User ID of a user works in MoEngage.
...
[Read more](https://developers.moengage.com/hc/en-us/articles/360061114832-Web-SDK-User-Attributes-Tracking#pre-defined-attributes-0-0) about updating the standard attributes of a user in MoEngage.

## Enable SDK

You can use this tag to enable the SDK. For more information, refer [here](https://developers.moengage.com/hc/en-us/articles/37903063575060-Web-SDK-Opt-out).

![Screenshot 2025-05-28 at 3.57.23 PM.png](37972257779348)
...
You can use this tag to disable the SDK. For more information, refer [here](https://developers.moengage.com/hc/en-us/articles/37903063575060-Web-SDK-Opt-out).

![Screenshot 2025-05-28 at 3.58.29 PM.png](37972257781012)
...
You can use this track to enable data tracking. For more information, refer [here](https://developers.moengage.com/hc/en-us/articles/45070778963348-Configure-Data-opt-out-in-Web-SDK#h_01KD2BMMKKHZJH215ZTYGRZ0R0).

![Screenshot 2026-01-12 at 1.45.01 PM.png](45205694594324)
| **Property** | **Value** |
| --- | --- |
| Tag type | Enable Data Tracking |
## Disable Data Tracking

You can use this track to disable data tracking. For more information, refer [here](https://developers.moengage.com/hc/en-us/articles/45070778963348-Configure-Data-opt-out-in-Web-SDK#h_01KD2BMMKFWQKG1GFVXZJQAFPY).

![Screenshot 2026-01-12 at 1.45.18 PM.png](45205678853652)
| **Property** | **Value** |
| --- | --- |
...
You can also forward the events captured on your GTM server to MoEngage without writing any code on your website. Read more about how to set up the integration with GTM Server and MoEngage on our [help docs](https://partners.moengage.com/hc/en-us/articles/18795331766676-Google-Tag-Manager-GTM).

# Handle Ad Blockers (Custom Proxy Domain)

To ensure ad blockers do not interrupt MoEngage SDK traffic, you can route requests through a custom proxy domain. For more information, refer to [Handle Ad Blockers](https://developers.moengage.com/hc/en-us/articles/15703729076884). Follow these steps to update your GTM configuration.
...
![Screenshot 2026-01-23 at 6.23.17 PM.png](45700795950612)
...
![Screenshot 2026-01-23 at 6.27.24 PM.png](45700782764436)
