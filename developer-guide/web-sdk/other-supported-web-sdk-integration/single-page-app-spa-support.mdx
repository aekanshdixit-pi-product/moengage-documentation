...
In order to get the `MOE_PAGE_VIEWED` event tracked on every route change, pass `enableSPA: true` while [initializing](https://developers.moengage.com/hc/en-us/articles/360060713252-Web-SDK-Integration#01H8XHVYJZHY8Z7869YDF2CKJJ)
