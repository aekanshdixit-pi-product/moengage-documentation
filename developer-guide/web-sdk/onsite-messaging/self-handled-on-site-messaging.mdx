...
description: "Receive on-site messaging campaign data as JSON and build custom UI for your website."
---
...
<Check>
  You must use the MoEngage Web SDK version _2.55.0_ or later.
</Check>
...
### _Moengage.onsite.getSelfHandledOSM(callbackFunction)_
...
The _data_ object passed to the tracking methods is not the entire `fullCampaignData` object. You must construct a new, specific object for tracking.
