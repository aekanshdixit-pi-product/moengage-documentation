...
For information, refer to [Configure Web Push settings](https://help.moengage.com/hc/en-us/articles/210224063-Configure-Web-Push-Settings).
...
1. 1. Ensure that the settings for Self Handled Opt-in are selected on the MoEngage app.
   ...
   1. Set the **display** style attribute of the parent div to **none**.
...
| main_class  | string (class name of the soft ask HTML)   Do not forget to set the **style-display** of your**main_class** to **none** initially. |
...
After you configure the opt-in and the user visits your website, there is a prompt for opt-in permission requests. If the user accepts the opt-in request, the reachability icon for web push is green in color on the MoEngage user profile page. For more information, refer to [User Reachability](https://help.moengage.com/hc/en-us/articles/360045962992-User-Reachability).
...
You have three Push Opt-In options. For more information, refer to [Configure Web Push Settings](https://help.moengage.com/hc/en-us/articles/210224063-Configure-Web-Push-Settings).

## I wish to customize Notification permission opt-in banner or nudge.

You can customize the time (after which to show banner or nudge), Text, Fonts & Font-size. For more information, refer to [Configure Web Push Settings](https://help.moengage.com/hc/en-us/articles/210224063-Configure-Web-Push-Settings).
