...
<Warning>
If the user [log in](https://developers.moengage.com/hc/en-us/articles/360061114832-Web-SDK-User-Attributes-Tracking#h_01H9GQTH6RMC9P0Q73G9P54CJ0) in and [log out](https://developers.moengage.com/hc/en-us/articles/360061114832-Web-SDK-User-Attributes-Tracking#h_01H9GQTH6RA39A8PZTXTXBTA1S) is not handled correctly, user data may get corrupted.
</Warning>
...
For SDK versions below 2.52.2 refer to [this document](https://developers.moengage.com/hc/en-us/articles/35723849692948-Setting-Unique-Id-for-SDK-versions-below-2-52-2).

<Info>
Please ensure that you are using the latest [integration script](https://developers.moengage.com/hc/en-us/articles/360060713252-Web-SDK-Integration#01H8XHVYJZHY8Z7869YDF2CKJJ) before using the below MoEngage methods.
</Info>
