...
Integration using BOM  is the recommended way of integration; refer to the Install Using BOM document [Placeholder_Link]. Once you have configured the BOM add the dependency in the _app/build.gradle_ file as shown below
