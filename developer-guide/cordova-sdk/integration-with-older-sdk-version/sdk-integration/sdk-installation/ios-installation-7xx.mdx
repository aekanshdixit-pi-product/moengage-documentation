...
Here, after adding the plugin just go to the `ios` folder in `platforms` and run `pod install` command to integrate our `MoEPluginBase`:
...
![3fba9f4-047c04a-e794e94-Screen_Shot_2018-06-29_at_14.41.54.png](18922840809492)
...
![5b26c5e-6bd2243-ec9ab96-Screen_Shot_2018-08-28_at_14.28.47.png](18922824629652)
