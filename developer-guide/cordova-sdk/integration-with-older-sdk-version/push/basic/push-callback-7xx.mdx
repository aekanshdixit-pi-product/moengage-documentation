...
In the case of iOS, you would always receive the key-value pairs with respect to clicked action in `clickedAction` key. Refer to this [link](https://developers.moengage.com/hc/en-us/articles/4564174542228) for knowing the iOS notification payload structure.
