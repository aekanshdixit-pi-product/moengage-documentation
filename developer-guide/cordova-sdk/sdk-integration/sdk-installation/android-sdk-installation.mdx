...
Replace \*\*\<bomVersion\>`** with the latest BOM version.`. For more info on integration using BOM, refer [here](https://developers.moengage.com/hc/en-us/articles/44622788607892-Installing-BOM). [Placeholder_Link]
