...
<Check>
Make sure you have created APNS certificate and uploaded it to MoEngage dashboard as mentioned in [APNS Certificate/ PEM file](https://developers.moengage.com/hc/en-us/articles/4403944011028) before testing push notification.
</Check>
...
![0ab5e70-Screenshot_2019-06-05_at_15.02.38.png](4564082050836)
...
![0f30c27-Screenshot_2019-01-10_at_14.36.57.png](4564082177172)
...
let sdkConfig = MOSDKConfig.init(appID: "MoEngage Workspace ID")
...
![2350517-Screenshot_2019-10-09_at_19.30.54.png](4564088173204)
...
For testing the flow with silent pushes refer to this [link](https://developers.moengage.com/hc/en-us/articles/4403442558228-Push-Display-Handled-by-Application#01H8KP6QT4EKJQRAGTXPNBVVJ3).
</Info>
...
![f89973a-Screenshot_2019-01-10_at_16.25.11.png](4564088422036)

Set the name of the extension target and the programing language which you want to use:![46006f3-Screenshot_2019-01-10_at_16.30.18.png](4564149991828)
...
Then make sure that the Push Notifications Capability is enabled for the Notification Service Extension created:![b578a57-Screenshot_2019-01-10_at_16.27.09.png](4564158389780)
...
![d31ec1d-Screenshot_2019-01-10_at_17.20.43.png](4564088865684)
...
* Add `MORichNotification` to embedded binaries in the App target, and is linked in your Notification Service Extension target.
</Info>
...
![0ba5256-Screenshot_2019-06-05_at_18.38.34.png](4564150384788)
...
HTTP URLs are not supported in iOS 9, unless explicitly specified in the plist. You will have to include **App Transport Security Settings** Dictionary in your Info.plist and inside this set **Allow Arbitrary Loads** to **YES**.
</Warning>
