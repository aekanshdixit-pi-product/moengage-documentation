...
This document outlines the new methods available in the MoEngage iOS SDK to report impressions and clicks for offerings fetched using the [MoEngage Personalize API](https://developers.moengage.com/hc/en-us/articles/24787922896276-Personalize-API##offering). These methods are currently available only for the **iOS SDK**.
...
Ensure your MoEngage workspace is enabled to utilize the Personalize API. Refer to [this article](https://help.moengage.com/hc/en-us/articles/24644175705236-Create-Server-side-Personalization-offering "null") for details on setting up Personalize API offerings.
