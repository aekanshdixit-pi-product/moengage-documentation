...
4. Once the MoEngage SDK is loaded, perform the **Product view** and **Add to Cart** events to check if MoEngage is successfully tracking data in your app settings.                                                     ![](24266972313492) 
...
5. While the **Product view** and **Add to Cart** events are being tracked properly, ensure to check if the cart token user attribute is getting set or not.![Screenshot 2024-03-04 at 5.01.08 PM.png](24266975925780)

The integration will be active and should function as intended if the above mentioned checklist is completed.

For more information, see [FAQs](https://developers.moengage.com/hc/en-us/articles/23720870020884).
