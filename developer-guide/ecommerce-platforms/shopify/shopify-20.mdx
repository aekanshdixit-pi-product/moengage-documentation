...
3. Navigate to the **Integrate** tab, and then click **Install MoEngage app on your Shopify** **store**. Use the MoEngage listing in the Shopify App Marketplace to add the app to your store.
   <Frame>
     ![Install Shopify (1)](/images/InstallShopify-\(1\).gif)
   </Frame>
...
4. Click **Save configuration**. <img src="/images/InstallShopify3.png" alt="SuccessMsd.png" />
...
2. On the **Configuration** tab, turn the **Enable web personalization** **on your store** toggle on. <img src="/images/InstallShopify4.png" alt="Settings (1).png" />

# Next Steps

Now that your integration is successful, you can sync data about your past orders and start tracking events.

1. [Events and User Data Tracking](https://www.moengage.com/docs/developer-guide/ecommerce-platforms/shopify/events-and-user-data-tracking)
2. [Sync User Data](https://www.moengage.com/docs/developer-guide/ecommerce-platforms/shopify/user-data-sync)
3. [Steps to Validate Integration](https://www.moengage.com/docs/developer-guide/ecommerce-platforms/shopify/validate-integration)
4. [FAQs](https://www.moengage.com/docs/developer-guide/ecommerce-platforms/shopify/faqs)