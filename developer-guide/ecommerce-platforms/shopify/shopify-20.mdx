...
3. Navigate to the **Integrate** tab, and then click **Install MoEngage app on your Shopify** **store**. Use the MoEngage listing in the Shopify App Marketplace to add the app to your store.\
   <Frame>
     <img src="/guide-media/01H7ZAM10041H1XS9QM3A6XR4P" alt="InstallShopify.gif" />
   </Frame>
...
4. Click **Save configuration**. <img src="/guide-media/01H94EMD06V84TBQRRE0KAXTA3" alt="SuccessMsd.png" />
...
2. On the **Configuration** tab, turn the **Enable web personalization** **on your store** toggle on. <img src="/guide-media/01HQQ7MFM1KE2PKDQHWBMX92VF" alt="Settings (1).png" />
