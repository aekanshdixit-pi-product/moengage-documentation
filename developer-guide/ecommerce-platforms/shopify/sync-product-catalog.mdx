...
You can sync your store's existing product catalog. to MoEngage and use it to generate personalized [Recommendations](https://help.moengage.com/hc/en-us/articles/16292685447444-Overview).[Placeholder_Link]
...
| Created_at      | Date and time ([ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601)) [Placeholder_Link]when the item was first added to your catalog.                                                                                                                                                                                        |
| Updated_at      | Date and time ([ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601)) [Placeholder_Link]when the item was last updated.                                                                                                                                                                                                       |
