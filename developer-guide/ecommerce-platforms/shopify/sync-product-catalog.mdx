...
| **Status**                   | The current product state:<br /><br />- **Active**: The product is ready to sell and is available to customers.<br />- **Archived**: The product is no longer sold and is unavailable to customers.<br />- **Draft**: The product is not ready to sell. Duplicated and unarchived products are set to draft by default. | Product status        |
