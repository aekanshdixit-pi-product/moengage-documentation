...
<AccordionGroup>
  <Accordion title="Android Configuration Details">
    ...
    |              | `com_moengage_core_data_center`                       | Integer  | Default: `1`. For more info, refer to [Data Center values](#data-center-values).                |
...
<AccordionGroup>
  <Accordion title="iOS Configuration Details">
    ...
    |              | `DataCenter`                         | Integer          | Mandatory. Default: `1`. Refer to [Data Center values](#data-center-values). |
