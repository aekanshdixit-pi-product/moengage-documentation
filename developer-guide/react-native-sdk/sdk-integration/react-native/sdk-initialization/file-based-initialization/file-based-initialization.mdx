...
<AccordionGroup>
  <Accordion title="iOS Configuration Details">
    ...
    |              | `DataCenter`                         | Integer          | Mandatory. Default: `1`. Refer to [Data Center values](/developer-guide/react-native-sdk/sdk-integration/react-native/sdk-initialization/file-based-initialization/file-based-initialization). |
