...
<Steps>
  ...
  <Step title="Configure Parameters">
    ...
    - [Android](/developer-guide/react-native-sdk/sdk-integration/react-native/sdk-initialization/file-based-initialization/file-based-initialization)
    - [iOS](/developer-guide/react-native-sdk/sdk-integration/react-native/sdk-initialization/file-based-initialization/file-based-initialization)
  </Step>
  <Step title="Generate">
...
<AccordionGroup>
  <Accordion title="Android Configuration Details">
    ...
    |              | `com_moengage_core_data_center`                       | Integer  | Default: `1`. For more info, refer to [Data Center values](/developer-guide/react-native-sdk/sdk-integration/react-native/sdk-initialization/file-based-initialization/file-based-initialization). |
...
<Warning>
  **Troubleshooting** If the XML file is missing or the `com_moengage_core_workspace_id` is empty, the SDK will throw a `ConfigurationMismatchError`.
</Warning>
...
<Steps>
  <Step title="Create the file">
    Create a file named `moengage.xml`.

    <Info>
      **File-Based vs Code-Based Init:**
      ...
      - **Code-Based Init:** Calling `MoEInitializer.initialize(context, moEngage.Builder)` will initialize the SDK using the parameters provided, ignoring the XML file.
    </Info>
  </Step>
  <Step title="Place the file">
    Place it in `android/app/src/main/res/values/`.
  </Step>
  <Step title="Add Content">
    Add your configuration file content generated in the Initialization Website.
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="iOS Configuration Details">
    ...
    |              | `DataCenter`                         | Integer          | Mandatory. Default: `1`. Refer to [Data Center values](/developer-guide/react-native-sdk/sdk-integration/react-native/sdk-initialization/file-based-initialization/file-based-initialization)1. |
...
<Steps>
  ...
  <Step title="Configure">
    Add the configuration keys generated on the Initialization Website.
  </Step>
</Steps>
...
<Warning>
  **Warning** Make sure you are setting the Push/InApp callback listeners **before** calling `initialize()`.
</Warning>
