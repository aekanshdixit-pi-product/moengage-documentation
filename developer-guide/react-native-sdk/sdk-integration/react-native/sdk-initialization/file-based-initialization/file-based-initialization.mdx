...
File-based initialization keeps your App ID and SDK configuration in native config files, separate from your application code.
...
- Your MoEngage App ID from the dashboard.
...
<AccordionGroup>
  <Accordion title="iOS configuration details">
    ...
    |              | `DataCenter`                         | Integer          | Mandatory. Default: `1`. Refer to [Data center values](/developer-guide/react-native-sdk/sdk-integration/react-native/sdk-initialization/file-based-initialization/file-based-initialization#data-center-values).|
