...
Descriptive information about a user that enhances their profile - Used for segmentation, personalisation, and analytics - Examples: name, age, gender, preferences, purchase history - Set using dedicated methods like **_setUserFirstName()_** or **_setUserAttribute()_** - Help create personalised user experiences 
