...
description: "Set a unique user ID for login and logout in React Native SDK versions below 11.2.0."
---
...
Use the method **_setAlias()_** to update the user attribute unique id instead of \*setUniqueId()\*with a different value. Using the method **_setUniqueId()_** with a new value creates unintended users in MoEngage.
