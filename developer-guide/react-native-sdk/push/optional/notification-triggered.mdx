...
<Warning>
  Make sure to configure [AppGroup ID in App Target](/developer-guide/ios-sdk/sdk-integration/basic/sdk-initialization) and Set up [Notification Service Extension](/developer-guide/ios-sdk/push/basic/ios-push-integration-tutorial) in your iOS Project, for the SDK to save the received notifications.
</Warning>
