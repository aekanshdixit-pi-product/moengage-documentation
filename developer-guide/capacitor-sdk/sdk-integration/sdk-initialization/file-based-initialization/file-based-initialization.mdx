...
<Info>
  Starting with the \[PLACEHOLDER\] versions, the MoEngage Capacitor SDK supports file-based initialization.
</Info>
...
Place the generated file in your Capacitor Android project at `android/app/src/main/res/values/`.
...
Import the `MoEngage` Capacitor plugin in your project's main entry file (e.g., `app.component.ts` or `index.ts/js`) and call the **initialize()** method as shown below:
