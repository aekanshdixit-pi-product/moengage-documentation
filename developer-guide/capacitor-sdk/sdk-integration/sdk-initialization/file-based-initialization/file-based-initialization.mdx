...
<Info>
  Starting with v6.0.0.0, the MoEngage Capacitor SDK supports file-based initialization.
</Info>
...
This approach outlines how you can use the form-based interface to generate a validated code snippet for initialization and access module-specific configurations.

<Info>
  Alternatively, the SDK can be initialized manually. If you require this approach, please refer to the guide on [Framework Initialization](/developer-guide/capacitor-sdk/sdk-integration/sdk-initialization/framework-initialization).
</Info>
...
\[PLACEHOLDER: Insert XML snippet generated from the MoEngage portal here\]
...
Ensure your `MainApplication.java` triggers the default initialization so the SDK reads from the `moengage.xml` file.
...
import UIKit
import Capacitor
// [PLACEHOLDER: Verify exact MoEngage imports for your setup, e.g., import MoEngageSDK, import CapacitorMoengageCore]
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Initialize MoEngage using the default instance setup
        // [PLACEHOLDER: Verify if initializeDefaultInstance() requires a config object passed in for your specific use case]
...
Import the MoEngage Core plugin in your project's main entry file (e.g., `app.component.ts`, `main.ts`, or `index.ts/js`) and call the initialization method.
