...
![ab8683f-71c6364-f93ec45-vlcsnap-2016-11-08-16h16m41s386.png](18959728838676)
...
<Warning>
The callbacks must be registered before inapps are displayed either via show methods or triggered events. Make sure you are calling `initialize()` the method of the plugin after you set up these callbacks. Refer [doc](https://developers.moengage.com/hc/en-us/articles/4404205878676) for more info.
</Warning>
