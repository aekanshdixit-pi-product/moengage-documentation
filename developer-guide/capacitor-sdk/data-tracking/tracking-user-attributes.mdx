...
In case the application is registering for push token it should pass the new push token to MoEngage SDK after user logout. For more information about passing push tokens, refer to [Push Configuration for Android SDK](https://developers.moengage.com/hc/en-us/articles/360061216011). [Placeholder_Link]
