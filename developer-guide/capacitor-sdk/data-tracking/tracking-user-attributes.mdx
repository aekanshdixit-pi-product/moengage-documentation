...
If your application registers for push tokens, pass the new push token to the MoEngage SDK after the user logs out. For more information, refer to [Push Configuration for Android SDK](/developer-guide/android-sdk/push/basic/push-configuration).

#### Logout callback listener

Clearing user data and resetting the SDK state is an asynchronous process on Android and iOS. Wait for the SDK to complete logout before navigating the user away or clearing your app's local state.
