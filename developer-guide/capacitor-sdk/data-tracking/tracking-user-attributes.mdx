...
- This method is a replacement for the deprecated **_setUniqueId()_**. If you are using **_setUniqueId()_** in your application, consider replacing it with **_identifyUser()_**
- The following values are not allowed in the identifier field: "unknown", "guest", "null", "0", "1", "true", "false", "user\_attribute\_unique\_id", "(empty)", "na", "n/a", "", "dummy\_seller\_code", "user\_id", "id", "customer\_id", "uid", "userid", "none", "-2", "-1", "2".
