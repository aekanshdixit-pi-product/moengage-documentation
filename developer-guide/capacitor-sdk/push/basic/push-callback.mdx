...
<Warning>
  Make sure you are calling **initialize()** method of the plugin to receive these callbacks. Refer [Initialise Capacitor Component](https://developers.moengage.com/hc/en-us/articles/4417377582100-SDK-Integration#integrate-native-platforms-0-1) [Placeholder_Link] for more info.
</Warning>
...
In the case of iOS, you would always receive the key-value pairs with respect to clicked action in `clickedAction` property. Refer to this [Notification Payload](https://developers.moengage.com/hc/en-us/articles/23448115571732-Custom-Notification-Handling#h_01H92ZQDWJWX6615STBKN7NRYJ) [Placeholder_Link] for knowing the iOS notification payload structure.