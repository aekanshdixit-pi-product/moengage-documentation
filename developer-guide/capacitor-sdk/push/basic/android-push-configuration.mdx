...
<Tabs>
  <Tab title="Let MoEngage handle Push(Recommended)">
    **Add messaging service**\
    You must add the messaging service to the Manifest file for MoEngage SDK to show the notifications. Refer to this document [here](/developer-guide/android-sdk/push/basic/push-token-registration-and-display#push-token-registration-and-display-by-moengage-sdk). k
