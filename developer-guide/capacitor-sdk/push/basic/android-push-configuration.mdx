...
<Tabs>
  ...
  <Tab title="You handle Push via Capacitor (Not Recommended)">
    ...
    - [Pass the Push Token To MoEngage SDK](/developer-guide/capacitor-sdk/push/basic/android-push-configuration)
    - [Pass the Push payload to the MoEngage SDK](/developer-guide/capacitor-sdk/push/basic/android-push-configuration)
