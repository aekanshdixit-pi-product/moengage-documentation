...
<Tabs>
  ...
  <Tab title="You handle Push via Capacitor (Not Recommended)">
    ...
    - [Pass the Push Token To MoEngage SDK](/developer-guide/capacitor-sdk/push/basic/android-push-configuration#passing-push-token) jj
    - [Pass the Push payload to the MoEngage SDK](/developer-guide/capacitor-sdk/push/basic/android-push-configuration#passing-push-token) jjj
    - [Callbacks and customizations](/developer-guide/react-native-sdk/push/basic/android-push-configuration#passing-push-token) jjjj
  </Tab>
  <Tab title="Tab">
