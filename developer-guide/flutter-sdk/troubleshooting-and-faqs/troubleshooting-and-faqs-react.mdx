---
title: "Troubleshooting and FAQs - React"
description: ""
---
...
MoEngage callbacks must be registered in your app.js or app.ts, and after setting them up, you must call the MoEngage Plugin's initialize () method. Read more about [it here](https://developers.moengage.com/hc/en-us/articles/7778383683732-Push-Callback#h_01H18VJ9JQDS1ZSN18P1AHY96A)
...
Refer to [this documentation](https://developers.moengage.com/hc/en-us/articles/4404257042452-InApp-NATIV#h_01H9677QPM37XA96NWBFN69FDT) to set up inapp callbacks. Additionally, you must register the callbacks in your application's app.js or app.ts, and after setting them up, you must call the MoEngage Plugin's initialize () method.
