...
| Code Language | Existing Code                                                                                                          | Replace with                                                                                                |
| ------------- | ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| Swift         | <code>MoEngageInitializer.sharedInstance.initializeDefaultInstance(sdkConfig, launchOptions: launchOptions)   </code>  | <code>import moengage_flutter_ios MoEngageInitializer.sharedInstance.initializeDefaultInstance()   </code>  |
| Objective-C   | <code>[[MoEngageInitializer sharedInstance] initializeDefaultInstance:sdkConfig launchOptions:launchOptions];  </code> | <code>@import moengage_flutter_ios; [MoEngageInitializer.sharedInstance initializeDefaultInstance]; </code> |
