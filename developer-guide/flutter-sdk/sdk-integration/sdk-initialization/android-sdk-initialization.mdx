...
Get the APP ID from the Settings Page _Dashboard --\> Settings --\> App --\> Genera_l on the MoEngage dashboard and initialize the MoEngage SDK in the **_Application_** class's **_onCreate()_**.
