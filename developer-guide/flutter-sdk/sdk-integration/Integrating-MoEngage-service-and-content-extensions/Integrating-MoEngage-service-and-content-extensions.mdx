...
To migrate from an existing manual implementation to the integrator tool, refer [here](/developer-guide/flutter-sdk/sdk-integration/sdk-initialization/file-based-initialization/migration-and-precedence).
