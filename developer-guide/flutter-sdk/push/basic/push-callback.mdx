...
In the case of iOS, you would always receive the key-value pairs for clicked action in the **clickedAction** property. Refer to this [link](https://developers.moengage.com/hc/en-us/articles/23448115571732-Custom-Notification-Handling#h_01H92ZQDWJWX6615STBKN7NRYJ) to knowing the iOS notification payload structure.
...
<Info>
    **Initialization Restriction**: File-based initialization is not supported when using this configuration.
</Info>
