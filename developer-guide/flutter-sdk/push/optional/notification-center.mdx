...
Note: This plugin is dependent on **moengage_flutter** plugin. Make sure you have installed the **moengage_flutter** plugin as well. Refer to the [doc](/developer-guide/flutter-sdk/sdk-integration/sdk-installation/framework-dependency) for the same.
