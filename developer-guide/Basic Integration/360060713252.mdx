...
2. Configure the values based on your application requirements. Refer to the [Configuration Parameters](#h_01KC5VD65H5EY6YPTC3DP98EKG) table below for detailed descriptions of each field.
...
| MoEngage Data Center | Specifies the data center associated with the dashboard URL. Refer [here](https://developers.moengage.com/hc/en-us/articles/8489937322004-Data-Center) for more details. |
