...
This document outlines the new methods available in the MoEngage Android SDK to report impressions and clicks for Offerings fetched using the [MoEngage Personalize API](https://developers.moengage.com/hc/en-us/articles/24787922896276-Personalize-API##experience). 
