...
You can enable JWT authentication during [SDK initialization](https://developers.moengage.com/hc/en-us/articles/4401984811796) by configuring the ***NetworkAuthorizationConfig*** property on the ***MoEngage.Builder*** object.
