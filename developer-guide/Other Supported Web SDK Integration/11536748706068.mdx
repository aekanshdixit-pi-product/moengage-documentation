...
For a complete technical reference, check out our [Javascript Documentation](https://developers.moengage.com/hc/en-us/articles/360060713252-Web-SDK-Integration) or our sample apps for [LG TV](https://github.com/moengage/webSDK-sample/tree/master/lg-web-os)  and [Samsung TV](https://github.com/moengage/webSDK-sample/tree/master/samsung-tizen-os/samsungTizenOs) to see the Web SDK running on a TV.

<Check>
1. Do not add the serviceworker.js file, as Push Notification does not work here.
2. Pass `disable_web_push: true` to the initialization config., so that the SDK does not initialize the Push Notification module. More details are available [here.](https://developers.moengage.com/hc/en-us/articles/360060819792-Configure-and-Integrate-Web-Push#rename-service-worker)
3. Pass `disableCookies: true` to disable the usage of any cookies
</Check>

## Supported Features

* [Data Tracking](https://developers.moengage.com/hc/en-us/sections/360013606731-Data-Tracking)
* [On-site Messaging](https://help.moengage.com/hc/en-us/articles/25289365657620-Create-OSM-Pro-Campaign-for-TV)
