...
For SDK versions below 2.52.2 refer to [this document][Placeholder_Link].

<Note>
  Please ensure that you are using the latest [integration script][Placeholder_Link] before using the below MoEngage methods.
</Note>
...
4. For more information on supported data types and data tracking policies, please refer to [Data Tracking Policies][Placeholder_Link].
...
For more information about the default attributes collected by MoEngage SDK, refer to [Web SDK Data Collection][Placeholder_Link].
