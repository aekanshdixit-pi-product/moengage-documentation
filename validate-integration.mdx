...
5. While the **Product view** and **Add to Cart** events are being tracked properly, ensure to check if the cart token user attribute is getting set or not.![Screenshot 2024-03-04 at 5.01.08PM.png](24266975925780)
