...
If you have not yet set up attributes, navigate to **Settings** \> **Offering Decisioning** \> **Offering Attributes** and create at least one attribute before proceeding. Refer to the [Create offering attributes](/hc/en-us/articles/48418160010900) guide for instructions.
...
- To configure the Offering Attributes used by this strategy, refer to [Offering Attributes](https://help.moengage.com/hc/en-us/articles/48238775389716-Offering-Attributes).
- To learn how to create a Decision Policy, refer to [Decision Policy](https://help.moengage.com/hc/en-us/articles/38697925717396-Decision-Policy).
- To assign Offering Attributes to your offerings, refer to [Offerings](https://help.moengage.com/hc/en-us/articles/38661119123732-Offerings).