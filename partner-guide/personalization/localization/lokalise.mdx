...
1. In the MoEngage UI, on step 2 (Campaign Content) of campaign creation, type `@` in any text field (headline, body, or CTA). For more information, see [Content APIs](https://www.moengage.com/docs/user-guide/campaigns-and-channels/getting-started/campaign-content/content-apis).
