...
Here, you must send language data in your API calls with the property name `user_language`.
...
To use the user imports, perform the following steps:
...
4. Complete the import process. For more information, see [Import User Data Using CSV](https://help.moengage.com/hc/en-us/articles/19192630201620-Import-User-Data-Using-CSV).
...
5. Click **Save** to complete the setup.
   ...
   ![MoEngage Add content API dialog with the Lokalise URL and user_language attribute mapped](/images/partner_31453674918036.png)
...
You can use the [MoEngage Templating Language](https://help.moengage.com/hc/en-us/articles/115002757783-MoEngage-Templating-Language-JINJA-#content-api-0-3) to manipulate how translations are displayed or to create fallback logic:
