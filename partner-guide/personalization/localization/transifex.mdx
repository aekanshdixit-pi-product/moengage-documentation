...
Use MoEngage [Content APIs](/user-guide/campaigns-and-channels/getting-started/campaign-content/content-apis) to add Transifex as one of your data sources. You can add multiple APIs from Transifex at the same time for each use case.
