---
title: "Radar"
description: "Use Radar's geofencing, geocoding, and Geo APIs with MoEngage to trigger location-based campaigns, sync user attributes and events, and display nearby places in real time."
keywords: ["radar", "geofencing", "location platform", "trip tracking", "geo apis", "moengage integration"]
---
...
The MoEngage and Radar integration uses location-based data to enhance your marketing campaigns. With this integration, you can:
...
The following table shows how Radar events map to MoEngage events:
...
The tables below describe the property payload Radar sends for each event.

<Note>
  Geofence, place, and region events all include shared **regional context properties** (`country_code`, `country_name`, `state_code`, `state_name`, `dma_code`, `dma_name`, `postal_code`) when Regions is enabled on the Radar project. See [Regional context properties](#regional-context-properties) at the end of this section for the full list.
</Note>
...
##### [Radar] Country Entered / [Radar] Country Exited
...
##### [Radar] State Entered / [Radar] State Exited
...
##### [Radar] DMA Entered / [Radar] DMA Exited
...
##### [Radar] Started Trip / [Radar] Updated Trip / [Radar] Approaching Trip Destination / [Radar] Arrived at Trip Destination / [Radar] Stopped Trip
...
##### [Radar] Beacon Entered / [Radar] Beacon Exited
...
If Regions is enabled on your Radar project, the following properties are added to geofence and place events (entered, exited, and dwelled):
...
For more information about Content APIs, see [Content APIs](/user-guide/campaigns-and-channels/getting-started/campaign-content/content-apis#01H7YH45YQTJCR366AA75AYMH9).
...
3. Use the [MoEngage Templating Language](/user-guide/campaigns-and-channels/getting-started/message-personalization/jinja-templating-language#content-api-0-3) to parse the API response and include the content in your campaign. The Jinja snippet below iterates through the list of places and prints their names:
