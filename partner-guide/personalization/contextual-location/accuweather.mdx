---
title: "AccuWeather"
description: "Use AccuWeather APIs through MoEngage's templating language to enrich and personalize campaigns with location-aware weather data."
keywords: ["accuweather", "weather forecast", "location personalization", "jinja", "contextual marketing", "moengage integration"]
---
...
5. Print the output in the template or use [Personalized Previews](/user-guide/campaigns-and-channels/getting-started/message-personalization/personalized-preview) to preview.
