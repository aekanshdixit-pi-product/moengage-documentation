...
5\. You can print the output in the template or use the [Personalized Previews](/user-guide/campaigns-and-channels/getting-started/message-personalization/personalized-preview) to preview.   
