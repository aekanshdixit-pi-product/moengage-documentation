...
1. Navigate to _Settings \> API keys._ If you don’t already have an API key, create a new one.
...
**Note:** - The example Content Delivery API URL uses only one of Contentful’s available endpoints.
