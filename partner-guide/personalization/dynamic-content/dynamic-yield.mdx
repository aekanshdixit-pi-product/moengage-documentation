...
| Field | Description |
| --- | --- |
| cuid_type | Set the user ID type in accordance with how you [identified your users](https://support.dynamicyield.com/hc/en-us/articles/360034332473-Identifying-Users-#identifying-users-via-events-0-1) (such as by email address). cuid |
