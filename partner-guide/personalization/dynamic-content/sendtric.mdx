---
title: "Sendtric"
description: "Integrate MoEngage with Sendtric to add countdown timers to emails that contain time-sensitive products, sales, or events."
---

# Introduction

[Sendtric](https://www.sendtric.com/) provides countdown timers that help to email maximise conversions, generate more sales, and inject urgency into your landing pages, emails and marketing touch points. o
...
1. Go to the Sendtric dashboard and create your countdown timer. Refer to the [document here to know more](https://blog.sendtric.com/2018/10/18/beginners-guide-to-email-countdown-timers/) on creating countdown timers on sendtric:\
   <img src="/images/partner_23503961439380.png" alt="Screenshot 2024-02-07 at 12.51.34 AM.png" />
