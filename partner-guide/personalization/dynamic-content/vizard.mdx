---
title: "Vizard"
description: "Use Vizard's dynamic image templates inside MoEngage campaigns either as direct image URLs or as personalized URLs powered by Content APIs."
keywords: ["vizard", "dynamic images", "personalized images", "magic image", "content api", "moengage integration"]
---
...
You can now use this Content API in your campaigns. To learn more, refer to [Content APIs](/user-guide/campaigns-and-channels/getting-started/campaign-content/content-apis#step-2-using-content-apis-to-create-personalized-campaigns-0-3).
