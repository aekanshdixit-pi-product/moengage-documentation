---
title: "Whilter AI"
description: "Integrate Whilter AI with MoEngage to generate and deliver personalized media in real-time."
---
...
1. Sign in to the Whilter AI platform. <img src="/guide-media/01KJCATS9GN05HVSAFH82344ZR" alt="Whilter Sign In Dashboard" />
2. Navigate to the **Campaign Creation** page:
   1. On the left navigation, click **Campaign**.
   2. Click **\+ Create** or select an existing campaign (for example, axis-genz). <img src="/guide-media/01KJYY5VWBGNPAAPQHFQ1G69PK" alt="Create Campaign Option" />
3. Configure Media Parts:
   ...
   4. Map the dynamic fields:
      ...
      3. Click the Eye <img src="/guide-media/01KJ7Q4Y14DXEQ4EH8YSBEW3VV" alt="Preview Icon" /> icon (optional) to preview the asset. <img src="/guide-media/01KJCAW82TA9T92FDS777836P0" alt="Preview Asset Layers" />
...
![Campaign Setup Screenshot](/guide-media/01KJB4AAG4DDMKNC3RZQEZN9WT)
...
1. In the **OAuth details** step, enter the following:
   ...
   - **Body type**: Click **Raw** and in the body section, configure the body for your requests. <img src="/guide-media/01KJB61X070A4B6GM6M3XP3FXX" alt="OAuth Body Configuration" />
...
6. Click **Save**. <img src="/guide-media/01KJB6EVVE56R01HA8V17HD8ZG" alt="Save Configuration Screenshot" />
   The setting status is shown as **Active**. For more information, refer to [Authorization Configuration with OAuth 2.0](https://help.moengage.com/hc/en-us/articles/23949234646292-Authorization-Configuration-with-OAuth-2-0).
...
3. On the All campaigns page, in the upper-right corner, click **\+ Create campaign**. <img src="/guide-media/01HWVQ4BHS4PV3RX2D6108SYH7" alt="Create Campaign Step 1" />
   Alternatively, click Create **New** \> **Campaign**. The Campaign page is displayed. <img src="/guide-media/01HWVQ4V51VX15CYPV17J6K32T" alt="Create Campaign Step 2" />
4. Under **Connectors**, click **Custom** and select one of the following campaign delivery types:
   1. One Time
   2. Periodic
   3. Event Triggered
   4. Business Event Triggered
      For more information, refer to [Delivery Types](https://help.moengage.com/hc/en-us/articles/360058616131-Delivery-Types). The Connector creation page is displayed. <img src="/guide-media/01K76678MB97P1Z8WGRQWYZ487" alt="Connector Creation Page" />
...
5. In the body section, define the parameters required by the Whilter AI template using the following payload structure:
   ...
   ![JSON Body Payload Configuration](/guide-media/01KJC9FYN8NQ0C07R5VWP2BM9H)
6. Now, preview your request. The campaign is now ready to be tested and sent. You can test the connector configuration using the Test functionality available in the second step of campaign creation. <img src="https://moengage.zendesk.com/guide-media/01GW7CPY1HVBA02FC0H4ZWF8RV" alt="Test Result Screenshot" />
