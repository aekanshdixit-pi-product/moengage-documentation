...
6. Click **Save**. <img src="/images/partner_46651404053012.png" alt="Save Configuration Screenshot" /> The setting status is shown as **Active**. For more information, refer to [Authorization Configuration with OAuth 2.0](/user-guide/settings/advanced-settings/authorization-configuration-with-oauth-20#h_01HR16WG2MHMC9BFDAVCTPDTX3)
...
4. Under **Connectors** , click **Custom** and select one of the following campaign delivery types:
   ...
   2. Periodic
   3. Event Triggered
   4. Business Event Triggered For more information, refer to [Delivery Types](/user-guide/campaigns-and-channels/getting-started/introduction/moengage-channels). The Connector creation page is displayed. <img src="/images/partner_46651420360340.png" alt="Connector Creation Page" />
...
| **Custom Header: Authorization** | Select the OAuth configuration that you created in Step 2. |
