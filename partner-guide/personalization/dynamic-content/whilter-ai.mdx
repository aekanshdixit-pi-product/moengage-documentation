...
2. **Access token** : Click the key that contains the token (for example, access\_token).
...
2. Ensure your target audience is filtered to include users who have the personalized URL set (for example, whilter\_video\_url is set).
