---
title: "Whilter AI"
description: "Integrate Whilter AI with MoEngage to generate and deliver personalized video and image content in real-time."
---
...
1. Sign in to the Whilter AI platform. ![Whilter AI sign-in page](/images/partner_46664893095700.png)
2. Navigate to the **Campaign Creation** page:
   1. On the left navigation, click **Campaign**.
   2. Click **+ Create** or select an existing campaign (for example, axis-genz). ![Campaign creation page](/images/partner_46902300658324.png)
3. Configure Media Parts:
   ...
   4. Map the dynamic fields:
      ...
      3. Click the Eye ![Preview Icon](/images/partner_46651420346260.png) icon (optional) to preview the asset. ![Media parts configuration](/images/partner_46664884994068.png)
...
1. In the **OAuth details** step, enter the following:
   ...
   - **API URL** : Enter [https://api.whilter.ai/getToken/token](https://api.whilter.ai/getToken/token).
   - **Method** : Click **POST**.
...
6. Click **Save**. ![Save Configuration Screenshot](/images/partner_46651404053012.png) The setting status is shown as **Active**. For more information, refer to [Authorization Configuration with OAuth 2.0](https://www.moengage.com/docs/user-guide/settings/advanced-settings/authorization-configuration-with-oauth-20).
...
3. On the All campaigns page, in the upper-right corner, click **+ Create campaign**. ![Create Campaign Step 1](/images/partner_46651404054164.png) Alternatively, click **Create New** > **Campaign**. The Campaign page is displayed. ![Create Campaign Step 2](/images/partner_46651404056596.png)
4. Under **Connectors** , click **Custom** and select one of the following campaign delivery types:
   1. One Time
   2. Periodic
   3. Event Triggered
   4. Business Event Triggered. For more information, refer to [Delivery Types](https://www.moengage.com/docs/user-guide/campaigns-and-channels/getting-started/introduction/delivery-types-moengage-channels). The Connector creation page is displayed. ![Connector Creation Page](/images/partner_46651420360340.png)
5. In step 2 of the campaign, provide the following information:

| Field | Value |
| --- | --- |
| **Method** | **POST** |
| **URL** | [https://api.whilter.ai/video/request](https://api.whilter.ai/video/request) |
| **Custom Header: Content-Type** | application/json |
| **Custom Header: Authorization** | Select the OAuth configuration that you created in [Step 2](/partner-guide/personalization/dynamic-content/whilter-ai#step-2-set-up-moengage-authorization).|

6. In the body section, define the parameters required by the Whilter AI template using the following payload structure:
...
![Connector campaign body configuration](/images/partner_46664321277844.png)

7. Now, preview your request. The campaign is now ready to be tested and sent. You can test the connector configuration using the Test functionality available in the second step of campaign creation. ![Test Result Screenshot](/images/partner_46651404059540.png)
...
3. In the campaign editor, use MoEngage personalization syntax (@ or {{UserAttribute}}) to insert the attribute you mapped in [Step 2](/partner-guide/personalization/dynamic-content/whilter-ai#step-2-set-up-moengage-authorization).
