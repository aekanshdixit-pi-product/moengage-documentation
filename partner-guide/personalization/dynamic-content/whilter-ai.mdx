...
1. Sign in to the Whilter AI platform.
   ![Whilter Sign In Dashboard](/guide-media/01KJCATS9GN05HVSAFH82344ZR)
2. Navigate to the **Campaign Creation** page:
   ...
   2. Click **+ Create** or select an existing campaign (for example, axis-genz).
      ![Create Campaign Option](/guide-media/01KJYY5VWBGNPAAPQHFQ1G69PK)
3. Configure Media Parts:
   ...
   4. Map the dynamic fields:
      ...
      3. Click the Eye ![Preview Icon](/guide-media/01KJ7Q4Y14DXEQ4EH8YSBEW3VV) icon (optional) to preview the asset.
         ![Preview Asset Layers](/guide-media/01KJCAW82TA9T92FDS777836P0)
...
1. In the **OAuth details** step, enter the following:
   ...
   * **Body type**: Click **Raw** and in the body section, configure the body for your requests.
     ![OAuth Body Configuration](/guide-media/01KJB61X070A4B6GM6M3XP3FXX)
...
6. Click **Save**.
   ![Save Configuration Screenshot](/guide-media/01KJB6EVVE56R01HA8V17HD8ZG)
...
3. On the All campaigns page, in the upper-right corner, click **+ Create campaign**.
   ![Create Campaign Step 1](/guide-media/01HWVQ4BHS4PV3RX2D6108SYH7)
   
   Alternatively, click Create **New** > **Campaign**. The Campaign page is displayed.
   ![Create Campaign Step 2](/guide-media/01HWVQ4V51VX15CYPV17J6K32T)
4. Under **Connectors**, click **Custom** and select one of the following campaign delivery types:
   ...
   4. Business Event Triggered
      ...
      ![Connector Creation Page](/guide-media/01K76678MB97P1Z8WGRQWYZ487)
...
6. Now, preview your request. The campaign is now ready to be tested and sent. You can test the connector configuration using the Test functionality available in the second step of campaign creation.
   ![Test Result Screenshot](https://moengage.zendesk.com/guide-media/01GW7CPY1HVBA02FC0H4ZWF8RV)
