...
|      5. In step 2 of the campaign, provide the following information:  Field | Value
...
| info |  **Information** You can use the Whilter URL as the **src** attribute value in an img tag or embed it as a link for playback in a web browser.
