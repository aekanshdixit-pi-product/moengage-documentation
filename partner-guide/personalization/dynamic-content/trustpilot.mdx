...
| Headers | Enable OAuth toggle and select trustpilot. And Select Auth Prefix as Basic ![Screenshot 2025-02-14 at 5.07.12 PM.png](/images/partner_34808375054484.png) |
...
If you want to use product reviews from TrustPilot in your campaigns, you can use [MoEngage Content API](/user-guide/campaigns-and-channels/getting-started/campaign-content/content-apis#01H7YH45YQKMEKBVT7Z637BN6B) to make a call to [Trustpilot’s Get product reviews summary endpoint](https://documentation-apidocumentation.trustpilot.com/product-reviews-api#get-product-reviews).
