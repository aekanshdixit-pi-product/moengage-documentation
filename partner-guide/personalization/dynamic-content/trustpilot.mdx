...
</Info>To integrate with TrustPilot, use the [optilyz API](https://www.optilyz.com/doc/api/) to send recipient data to the MoEngage connectors.
...
![Screenshot 2025-02-14 at 4.55.33 PM.png](/images/partner_34808335347220.png)
     4. API URL: [https://api.trustpilot.com/v1/oauth/oauth-business-users-for-applications/accesstoken](https://api.trustpilot.com/v1/oauth/oauth-business-users-for-applications/accesstoken)
     5. Method: Post 
     6. Headers:  
...
![Screenshot 2025-02-14 at 5.07.12 PM.png](/images/partner_34808375054484.png)  
...
If you want to use product reviews from TrustPilot in your campaigns, you can use [MoEngage Content API](https://help.moengage.com/hc/en-us/articles/115003622346-Content-APIs#01H7YH45YQKMEKBVT7Z637BN6B) to make a call to [Trustpilot’s Get product reviews summary endpoint](https://documentation-apidocumentation.trustpilot.com/product-reviews-api#get-product-reviews).
