...
1. Navigate to **Settings** -\> **Advanced settings** -\> **Content API**. Click **\+ Add content API** at the top right corner of the Content API screen.<img src="/images/partner_21979648411668.png" alt="ContentAPI_Navogation.png" />
2. Add your Certona API to the endpoint URL. <img src="/images/partner_10170418355732.png" alt="Screenshot_2022-10-18_at_3.33.26_PM.png" />\
