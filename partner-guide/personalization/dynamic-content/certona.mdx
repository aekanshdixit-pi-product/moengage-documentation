---
title: "Certona"
description: "Integrate MoEngage with Certona to leverage machine learning product recommendations in your campaigns via Content APIs."
---
...
Ensure that you have a Certona account and access to the Certona REST API endpoint. This endpoint is used directly in your MoEngage Content APIs to pull recommended content based on user ID.
</Info>
...
1. Navigate to **Settings** -> **Advanced settings** -> **Content API**. Click **+ Add content API** at the top right corner of the Content API screen.
   <img src="/images/partner_21979648411668.png" alt="ContentAPI_Navogation.png" />
2. Add your Certona API to the endpoint URL. 
   <img src="/images/partner_10170418355732.png" alt="Screenshot_2022-10-18_at_3.33.26_PM.png" />
...
3. You can use [MoEngage Templating Language](https://www.moengage.com/docs/user-guide/campaigns-and-channels/getting-started/message-personalization/jinja-templating-language) to parse through the API response and use the content in your campaigns.
   <img src="/images/partner_10170418825108.png" alt="Screenshot_2022-10-18_at_3.41.01_PM.png" />
