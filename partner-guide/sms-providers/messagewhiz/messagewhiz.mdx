...
| **Service provider name** | This field identifies the service provider you are configuring on the MoEngage dashboard and has to be unique. Type the name of the service provider here. Enter MessageWhiz. **Sender name**** |
