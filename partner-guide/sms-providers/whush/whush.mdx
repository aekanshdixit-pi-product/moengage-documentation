...
| **Body Typex** | Enter the following code:<br />curl --location '[https://api.whush.io/api/v1/one2One](https://api.whush.io/api/v1/one2One)' \\--header 'Content-Type: application/json' \\--header 'apikey: A2D31FB9BA1C7E1356FF' \\--data '{"credentials": {"password": "apimo","user": "apimo"},"options": {},"unicode": "false","from": "CRDHAT","shortMessages": \[{"recipient": "Number","corelationId": "0e6503aa-1ac7-4a0c-9819-beb69cfdedca","message": "Template"}\]}' |
