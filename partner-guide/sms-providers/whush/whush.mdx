...
|   4. Add the following details in step 2 "Sender Details":  Field | Description
...
| --- | --- |  
| **API URL** |  This field contains information about the URL that should be used to send an API request to the sender. You can get this information from the API documentation of the sender. Enter the API Endpoint of the sender here. The API URL for Whush is: https://whush.pludous.com/whush-send-sms  
...
| **Body Type** |  Enter the following code:
  ...
  8. You can configure delivery tracking after creating the sender in the MoEngage Dashboard. For  
information about Delivery Tracking, refer to [Delivery Tracking for Custom Connectors](https://help.moengage.com/hc/en-us/articles/360061107691#h_01H9K8CAQGXAZV2PTQK9VS520F).
