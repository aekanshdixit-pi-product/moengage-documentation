...
| **API URL** | Select the **GET** or **POST** option depending on which HTTP Endpoint you have from TIL. <br />Now, enter the TIL SMS Push Endpoint (GET/POST) with respective credentials/details: <ul><li>GET API:</li><li>POST API:</li></ul> |
