...
| **API URL** | Select the **GET** or **POST** option depending on which HTTP Endpoint you have from TIL. <br />Now, enter the TIL SMS Push Endpoint (GET/POST) with respective credentials/details: Select the **GET** or **POST** option depending on which HTTP Endpoint you have from TIL. <br />Now, enter the TIL SMS Push Endpoint (GET/POST) with respective credentials/details: <ul><li>GET API: <ul><li>Endpoint:</li><li>Key-value pair: Enter your keys and values.</li></ul></li><li>POST API: <ul><li>Endpoint: [https://bsms.timesapi.in/ct/api/v1/message](https://bsms.timesapi.in/ct/api/v1/message)</li><li>Enter the JSON payload structure supported by the POST Endpoint.</li></ul></li></ul> |
