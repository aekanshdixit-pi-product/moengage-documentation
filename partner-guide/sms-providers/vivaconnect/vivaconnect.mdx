...
| **Headers** | Add the Request Headers to be passed to the API as Key-Value pairs using this option. You can get this information from the API Documentation of the Sender. Add the Authorization Header. \* Content-Type: application/json \* apikey: `{{Workspace\_ID or APP\_ID}}` |
| **Body Type** | Choose the Body Type as **JSON** and add the following details:<br />`{`<br />`"msg_type": 2,`<br />c<br />d |
