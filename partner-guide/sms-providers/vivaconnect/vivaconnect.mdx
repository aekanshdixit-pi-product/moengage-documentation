...
| **Headers** | Add the Request Headers to be passed to the API as Key-Value pairs using this option. You can get this information from the API Documentation of the Sender. Add the Authorization Header. <ul><li>Content-Type: application/json</li><li>apikey: `{{Workspace\_ID or APP\_ID}}`</li></ul> |
