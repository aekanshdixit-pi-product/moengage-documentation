...
| **Body Type** | Choose the Body Type as **JSON** and add the following details:<br />{ "messages":\[ { "destinations":\[{"to":"Moesms\_destination"}\], "from":"RAPIDA", "text":"Moesms\_message", "intermediateReport":"True", "notifyContentType":"application/json", "notifyUrl":"YourMoEngageAccountURL" }\] }<br />Change the values of Sender\_ID and YourMoEngageAccountURL based on your Route Mobile and MoEngage accounts. |
...
8. You can map the attributes of the delivery tracking response manually or automatically.<img src="/images/partner_21974346518036.png" alt="Infobip_NewUI_PG_DT.png" />
