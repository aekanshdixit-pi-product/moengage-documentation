...
| **Service provider name** | This field identifies the service provider you are configuring on the MoEngage dashboard and must be unique. Type the service provider's name here. Enter D7Messaging. **Sender name**** |
| ** | This field identifies the readable sender name that can be used while creating a campaign or alert. |
| **Sender type** | The sender type can either be **Promotional** or **Transactional**. * Select Promotional when you plan to use the sender to send information about your brand, promote deals, or engage with users. * Select the sender type as Transactional for sending alerts about transactions, OTPs, security information, or any information that can be classified as transactional in nature. |
...
| **Content-Type** | application/JSON ![Image 10-10-24 at 3.17 PM \(1\).jpeg](/images/partner_31131241335444.png) |
