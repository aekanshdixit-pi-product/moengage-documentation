...
|   5. Configure the Webhook by adding the following details:  Field | Description
...
| **Headers** |  Add the request headers to be passed to the API as key-value pairs using this option. Make sure to include the following in the request header:
     * Content-Type as the key and application/json as  
the value
     * Authorization as the key and YOUR_API_KEY  
as provided by NexG.  
