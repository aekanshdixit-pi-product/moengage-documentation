...
| **Body Type** | Choose the Body Type as **JSON** and add the following details:<br/><br/><code>&#123;<br/>&nbsp;&nbsp;"messages": [<br/>&nbsp;&nbsp;&nbsp;&nbsp;&#123;<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"text": "Moesms_message",<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"dest": [Moesms_destination],<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"send": "SENDER_ID"<br/>&nbsp;&nbsp;&nbsp;&nbsp;&#125;<br/>&nbsp;&nbsp;],<br/>&nbsp;&nbsp;"key": "API_KEY",<br/>&nbsp;&nbsp;"ver": "1.0"<br/>&#125;</code><br/><br/>Change value for these keys:<br/>&bull; SENDER_ID and API_KEY - Set as per the Karix account credentials<br/>(If the API key has '=' at the end, add the '=' in the Key Value Pair section explicitly) |
...
![Karix_NewUI_PG_DT.png](/images/partner_21971032567828.png)
