...
4. Add the following details:
   ...
   | API URL | <ol><li>Select the **POST** option depending on which HTTP endpoint you have from TIL.</li><li>Enter the Dove Soft SMS Push endpoint (GET/POST) with respective credentials/details:</li></ol> |
