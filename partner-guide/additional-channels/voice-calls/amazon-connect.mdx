...
| library_add_check |  **Prerequisites** To set up the integration, ensure you have the following:
...
To create or modify the contact flow, perform the following steps:
  ...
  3. Click **Create contact flow** or edit an existing flow.![](/images/partner_42986479976212.png)
  4. Add the following blocks to your flow:
     ...
     3. Configure [Attributes](https://docs.aws.amazon.com/connect/latest/adminguide/connect-contact-attributes.html).  
![](/images/partner_42986510350612.png)
  5. Invoke the AWS Lambda Function Block: 
     ...
     3. Leave **Function input parameters** empty (the function will receive all contact data automatically).![](/images/partner_42986479976596.png)
  6. Connect the flow.
