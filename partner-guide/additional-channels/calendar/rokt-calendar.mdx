...
- Add Webhook URL as:
  [https://api.roktcalendar.com/v1/subscriptionevent/&#123;&#123;accountCode&#125;&#125](https://api.roktcalendar.com/v1/subscriptionevent/&#123;&#123;accountCode&#125;&#125);
...
- Select the method as POST
- Add Webhook URL as:
  [https://api.roktcalendar.com/v1/subscriptionevent/&#123;&#123;accountCode&#125;&#125;/update](https://api.roktcalendar.com/v1/subscriptionevent/&#123;&#123;accountCode&#125;&#125;/update)
- In Headers, add
  - Authorisation
    Basic base64encode(app_id:app_secret)
  - Content-Type:
