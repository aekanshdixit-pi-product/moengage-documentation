...
- Add Webhook URL as: `[https://api.roktcalendar.com/v1/subscriptionevent/{{accountCode}}]``(https://api.roktcalendar.com/v1/subscriptionevent/{{accountCode}});`
...
- Select the method as POST
- Add Webhook URL as: [https://api.roktcalendar.com/v1/subscriptionevent/](https://api.roktcalendar.com/v1/subscriptionevent/{{accountCode}}/update){{accountCode}}[/update](https://api.roktcalendar.com/v1/subscriptionevent/{{accountCode}}/update)
- In Headers, add
  - Authorisation Basic base64encode(app\_id:app\_secret)
  - Content-Type: application/json
- In the Body, you need to define the segment details. Use the following example to help structure your payload and enter your desired fields.
