...
6. Click **Connect**. You are taken to the Microsoft login page to authorize the account.
7. Log in using an account with Administrator privileges to grant MoEngage the necessary permissions to establish the connection.
