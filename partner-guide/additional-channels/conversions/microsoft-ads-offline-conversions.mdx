...
description: "Sync MoEngage events with Microsoft Advertising to attribute offline actions—such as in-store purchases and phone orders—to your ad campaigns."
---
...
<Info>
  **Prerequisites**
  ...
  Microsoft Advertising Offline Conversions is part of the Connected Channels add-on. Contact your dedicated MoEngage customer success manager (CSM) to enable it for your account.
</Info>
...
6. Click **Connect**. <img src="/images/microsoft1.png" alt="Microsoft1" /> \
   You are taken to the Microsoft login page to authorize the account.
7. Log in using an account with Administrator privileges to grant MoEngage the necessary permissions to establish the connection. <img src="/images/microsoft2.png" alt="Microsoft2" />
8. Once authenticated, you will be automatically redirected back to the MoEngage dashboard.
...
4. In the **Content** step of the campaign creation, map the MoEngage attributes to the following fields:
...
![Microsoft3](/images/microsoft3.png)
