...
# Integration<Info>
**Prerequisites**
1\. Ensure you have access to your PFL dashboard. 2\. Ensure that you have your PFL Webhook key and your PFL URL. If you dont have these, schedule an installation call with your PFL customer success manager. They can provide API keys for each PFL store from which you'll place orders.
</Info>To integrate with PFL, use the PFL APIs to send recipient data via MoEngage connectors.
...
![Screenshot_2022-02-21_at_10.48.46_PM.png](/images/partner_23502530346900.png)
...
![Screen_Shot_2022-02-22_at_11.12.42_AM.png](/images/partner_23502530348564.png)
