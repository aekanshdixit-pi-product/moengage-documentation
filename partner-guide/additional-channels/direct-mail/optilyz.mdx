...
| --- | --- |
| Method | POST |
| Webhook URL | [https://www.optilyz.com/api/v2/automations/&lt;OPTILYZ\_AUTOMATION\_ID&gt;/recipient](https://www.optilyz.com/api/v2/automations/&lt;OPTILYZ_AUTOMATION_ID&gt;/recipient) |
| URL params | -- |
...
| Key | Value |  |
| --- | --- | --- |
| Authorization | `{{` '\<OPTILYZ\_API\_KEY\>:' | base64\_encode `}}` |
