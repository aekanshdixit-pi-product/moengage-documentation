...
<Tabs>
  <Tab title="Update contact in Regal">
    `{ "userId": "", //Optional "traits": { "phone": "", "email": "", "firstName": "", "lastName": "", "optIn": [ { "channel": "voice", "source": "", "subscribed": true }, { "channel": "sms", "source": "", "subscribed": true } ], "custom1": "", "custom2": "" }, "eventSource": "MoEngage" }`
  </Tab>
