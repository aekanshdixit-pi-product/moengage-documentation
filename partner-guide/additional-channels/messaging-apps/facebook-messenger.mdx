...
| library_add_check |  **Prerequisites** Acknowledge the following before proceeding with integration:
...
| --- | --- |  
| Facebook Messenger page |  [https://www.facebook.com/pages/create](https://www.facebook.com/pages/create)  
...
| Facebook Messenger app |  [https://developers.facebook.com/apps](https://developers.facebook.com/apps)  
