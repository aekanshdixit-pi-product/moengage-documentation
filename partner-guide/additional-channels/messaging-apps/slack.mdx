...
3. On the Slack api page, click **Create an App**.\
   <img src="/images/partner_42946256996628.png" />
4. On the **Create an app** window, click **From scratch**.\
   <img src="/images/partner_42946257000084.png" />
5. On the **Name app & choose workspace** dialog box, enter the following details:
   ...
   3. Click **Create App**.\
      <img src="/images/partner_42946257002772.png" />
6. On the **Display Information** page, enter the following details:
   ...
   4. Background color
   5. Long description\
      <img src="/images/partner_42946257002900.png" />
...
2. Select the app name that you created in the previous step from the list.\
   <img src="/images/partner_42946257003156.png" alt="webhook0.png" />
...
5. Scroll down and click **Request to Add New Webhook**.\
   <img src="/images/partner_42946312120724.png" alt="webhooksfinal.png" />
...
1. On the left navigation menu of your MoEngage UI, select App marketplace. Alternatively, on the Create alert page, click \+ Add alert destination in the **Send Alerts On** list.\
   <img src="/images/partner_42946312120980.png" alt="slackkkkkkk.png" />
2. On the App marketplace page, click **Alert Management** , and then select **Slack**.\
   <img src="/images/partner_42946312121620.png" alt="slack2.png" />
3. On the Slack page, click the **Integrate** tab.\
   <img src="/images/partner_42946257005972.png" alt="slackintegrate.png" />
...
5. Click **Connect**.\
   <img src="/images/partner_42946257006612.png" alt="slackkk3.png" />
6. After the connection is defined, you can now select the defined new destination from the **Send Alerts On** list while creating an alert on the [Alert management](/user-guide/settings/reports-and-alerts/alert-management/getting-started/create-an-alert) page. You can select _Email_ , _Slack,_ or both.\
   <img src="/images/partner_42946257006996.png" alt="dashboard4.png" />
7. After adding the destinations, you can view the defined alert destinations on the [Alert management](/user-guide/settings/reports-and-alerts/alert-management/getting-started/create-an-alert) page.\
   <img src="/images/partner_42946257007252.png" alt="slackemailfinal.png" />
