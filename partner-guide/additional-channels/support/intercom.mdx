...
2. In the **Request Body** section, paste the following JSON. This will search for a contact using their email or external ID.
   ...
   ```
3. Click **Next step** to proceed to the **Test response** tab to test the connection by providing sample values for your payload. Click **Next step** to proceed to the **Test response** tab to test the connection by providing sample values for your payload. <img src="/images/partner_41456256508692.png" /> **Note**: Ensure Intercom is successfully connected to MoEngage before you use the connector in a live workflow.
