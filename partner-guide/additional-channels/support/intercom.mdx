...
| --- | --- |
| **Method** | **POST** |
| **URL** | Enter the dedicated Webhook URL provided by MoEngage in the following format: [https://api-0X.moengage.com/v1/partner/intercom/{events/users}/?configName={config\_name}](https://api-0X.moengage.com/v1/partner/intercom/{events/users}/?configName={config_name}) |
