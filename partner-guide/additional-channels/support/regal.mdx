...
<Tabs>
  ...
  <Tab title="Create custom event">
    { "userId": "{{UserAttribute\['ID'\]}}", "name": "Course Purchased", "properties": { "course\_title": "{{EventAttribute\['Title'\]}}", "course\_amount": "{{EventAttribute\['Amount'\]}}", "course\_start": "{{EventAttribute\['Start date'\]}}" }, "eventSource": "MoEngage" }
  </Tab>
</Tabs>
