...
</Info>The Regal Voice API is designed as a single Custom Events endpoint that lets you creates a contact, update a contact or add a custom event to a contact’s profile.
