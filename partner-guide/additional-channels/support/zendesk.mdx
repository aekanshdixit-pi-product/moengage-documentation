...
4. On the Webhooks page, click **Create webhook** in the upper-right corner.\
   <img src="/images/partner_42220201148436.png" />
...
6. Click **Next**.\
   <img src="/images/partner_42220212646548.png" />
...
1. On the **Create webhook** page, under the **Add details** section, provide the following details:
   ...
   5. In the **Request format**\* list, click **JSON**.\
      <img src="/images/partner_42220212647444.png" />
...
<img src="/images/partner_42220201150996.png" /> 
...
4. Click **Send test**.\
   <img src="/images/partner_42220212650260.png" />
...
7. In the **Value** list, click the Webhook that you created in Step 3.\
   <img src="/images/partner_42220212654868.png" />
8. In the request body box, add the appropriate JSON payload.\
   <img src="/images/partner_42220201163668.png" />
...
"updated_at": "{{ticket.created_at | date:'%Y-%m-%d %H:%M:%S'}}", "user_attributes": { //create your k-v pairs here } }     
```
...
3. On the All campaigns page, in the upper-right corner, click **\+ Create campaign**.\
   ...
   <img src="/images/partner_42220212656148.png" alt="2.png" />
4. Under **Connectors** , click **Custom** and select one of the following campaign delivery types:
   ...
   - Business Event Triggered\
     ...
     <img src="/images/partner_42220201166484.png" />
5. In step 2 of the campaign, provide the following information:
   ...
   3. In the **Headers** section, add the following key-value pairs:
      1. **Authorization** : Basic {{ '\<email\_address\>/token:\<api\_token\>' | base64\_encode }}.
      2. **Content-Type** : Application/json.\
         <img src="/images/partner_7424845082900.png" alt="Screenshot_2022-06-30_at_7.28.12_AM.png" />
...
<img src="/images/partner_42220212657812.png" alt="Screen_Shot_2022-02-22_at_11.12.42_AM.png" />
