...
On the Limechat Dashboard, copy the account id from your URL ![Untitled 3-05d8344c2466545cc7fffb7c16d7e204.png](/images/partner_27700893924244.png)
...
On the Limechat Dashboard, 
  ...
  3. ![Untitled 6-36b4dcfcc94044d3e979a877ba97a266.png](/images/partner_27700932085012.png)
  4. Scroll down to the bottom of this page and copy the Access Token ![Untitled 7-98ddd32b3e5bb2e9a6d5e9ad0dbd3909.png](/images/partner_27700893927572.png)
...
1\. Navigate to Create Campaign >> Connectors >> Custom and choose delivery type most suitable to your needs ![Screenshot_2022-02-21_at_10.48.46_PM.png](/images/partner_27700893928596.png)
...
2\. On step 2 of the campaign 
  ...
  * Add Webhook URL as : 
        ...
        [https://app.limechat.ai/api/v1/accounts/&#123;](https://app.limechat.ai/api/v1/accounts/%60)account_id&#125;/store_notifications/create_notification_limekit/
...
3\. At this point, your campaign should be ready to test and send. You can also test your connector configuration using the Test functionality available on Step 2 of Create Connector Campaign. ![Screen_Shot_2022-02-22_at_11.12.42_AM.png](/images/partner_27700932088596.png)
...
| --- | --- |  
| Webhook |  The MoEngage Endpoint provided to you by your Customer Success Manager.  
Headers**  
**

|  Provide the following headers: | Header(s) | 

| Value <br/>- |--- <br/>- Content-Type |

| application/json <br/>- Authorization  |  Get your Basic Token by going to any online [Basic Auth Header Generator](https://www.debugbear.com/basic-auth-header-generator) tool. Enter your Workspace ID as username and Data API Key as password. Your final token should look like this (MoEngage Dashboard >> Settings >> APIs): `Basic Qk5CR1NNNUR4eHh4eHhWQ1hSRFJEWTdSOlFsWHVoTHVaeHh4eHh4QWQrQnBYUEotNw==` <br/>- ### Step 3: See the events in MoEngage <br/>- Once the webhook is set up in Limechat, you should be able to see these events in your MoEngage dashboard. <br/>- #### Supported events <br/>- Event |
...
| lc_button_clicked | Notify a Button Interaction. <br/>- Opt Out | 

| lc_user_wa_opt_out | |

 Notify when a user opts out from a brand.  
Conversational & Contact Tag by agents

| lc_tag_added_by_agent | Link clicks will only work if LimeChat shortens them. <br/>- Opt In | 

| lc_user_wa_opt_in | |

 Notify when a user opts in from a brand
