...
| info |  **Information** You can choose Kwickchat (GoKwik) from the left pane if you have already added Kwikchat (GoKwik) to your connector list.  
...
| X-api-key | 
     ...
     * You can find your API token by [Logging in to your Kwikchat(Gokwik)](https://app.tellephant.com/) account and navigating to **Integrations** **> API**.  
![API token.png](/images/partner_25025446748692.png)  
  5. Click **Save**.
...
| info |  **Note** The URL in the image above is a sample URL. Copy the exact URL from your MoEngage dashboard and update it on the Kwikchat (Gokwik) dashboard.
