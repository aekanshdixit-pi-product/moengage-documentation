...
![Salla My Apps page](/images/partner_44496806792468.png)
...
### 3.1 Retrieve MoEngage Credentials
  ...
  1. Log in to the [MoEngage Dashboard](https://app.moengage.com).
...
| warning |  **Disable Debug Mode Before Production** When Debug Logs is enabled, data flows to the MoEngage Test Environment. You MUST disable this before going live to ensure data flows to your production workspace.
...
| check_circle |  **Integration Complete** Your Salla store is now integrated with MoEngage and tracking customer events in real-time across web and mobile. You can now create campaigns and engage your customers.
...
| Page Viewed, Product Viewed, Product List Viewed, Product List Filtered, Products Searched | Web, Mobile <br/>- Cart & Checkout** | 

| Product Added to Cart, Product Added, Product Removed, Cart Viewed, Cart Updated, Checkout Started | |

 Web, Mobile  
**Order**

| Order Placed, Order Completed | Web, Mobile <br/>- User** | 

| Signed Up, Signed In, Signed Out, User Profile Updated, Market Selected | |

 Web, Mobile  
**Wishlist**

| Product Added to Wishlist, Product Removed from Wishlist | Web, Mobile <br/>- Coupon** | 

| Coupon Entered, Coupon Applied, Coupon Denied, Coupon Removed | |
...
After integration is active, create campaigns using these guides:
  ...
  * **Web Push Notifications** : [Create Web Push Campaign](https://help.moengage.com/hc/en-us/articles/210223973-Create-Web-Push-Campaign)
  * **On-Site Messaging (OSM)** : [Create OSM Campaign](https://help.moengage.com/hc/en-us/articles/14111506452372-Create-OSM-Campaign)
  * **Web Personalization** : [Create a Web Personalization Campaign](https://help.moengage.com/hc/en-us/articles/360016569831-Create-a-Web-Personalization-Campaign)
