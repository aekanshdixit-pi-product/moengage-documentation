...
|  Address submitted |  This event is tracked when a user submits their address and contact details. <br/>- Checkout Event | 
...
|  Order Completed |  This event is tracked when a user successfully completes a purchase. <br/>- User Profile Event | 
...
</Info>## Step 1: Get Your MoEngage API Credentials
...
|      3. **Data Center** : Find your data center code from your dashboard's URL. The following table describes the data center name and URL:  Data Center Name | Dashboard URL
...
For more information, refer [here](https://help.moengage.com/hc/en-us/articles/360057030512-Data-Centers-in-MoEngage#01G5DQVXGT2KZMXTJPF77QPJ25).
...
To configure the integration in Shopflow, perform the following steps:
  ...
  3. In the **Re-marketing** section, locate **MoEngage** in the list and click **Click to setup** to open the configuration panel.  
![](/images/partner_41270993462164.png)  

  4. Enter the details that you copied in the [Get Your MoEngage API Credentials](https://help.moengage.com/hc/en-us/articles/41235880529812#h_01JTFF5S83KCHAHHN0QJARWJBN).
...
| info |  **Information** Shopflo sends data instantly, but there may be a short delay before it appears in your MoEngage UI.
