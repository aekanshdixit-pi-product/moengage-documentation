---
title: "Set up MoEngage app on Salesforce"
description: "Install the MoEngage managed package from Salesforce AppExchange, assign permission sets, and create a connected app for bi-directional Salesforce and MoEngage integration."
keywords: ["salesforce", "appexchange", "managed package", "connected app", "permission sets", "moengage app", "oauth"]
---
...
| --- | --- |
| **MoEngage Admin Permission** | Assign to users who will create and manage the syncs. No additional permissions are required for admin users. Provides access to: managing MoEngage Connections within Salesforce, managing syncs and mappings, accessing the Sync Queue and using Manual Retry, and managing the *Delete Processed Sync* scheduler. |
| **MoEngage User Permission** | Assign to users who will interact with the synced objects (for example, Leads, Contacts) by creating or updating them. Provides access to: package custom objects and fields, custom settings and metadata, and Apex class access. |
...
<Frame>
<img src="/images/partner_41649939572628.png" alt="Custom settings configuration page in Salesforce showing six MoEngage app configuration values" />
</Frame>
</Step>
</Steps>
...
<Frame>
<img src="/images/partner_30688827310612.png" alt="Salesforce gear icon menu with Setup highlighted" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688853320724.png" alt="Salesforce Setup search showing My Domain in the results" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688853321620.png" alt="Salesforce My Domain settings page showing the current domain URL" />
</Frame>
</Step>
</Steps>
...
<Frame>
<img src="/images/partner_30688853322388.png" alt="Salesforce Setup search showing App Manager in the results" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688827316628.png" alt="Salesforce App Manager with the New Connected App button highlighted" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688853322900.png" alt="Salesforce New Connected App form with basic information fields" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688853323540.png" alt="Salesforce Connected App OAuth scopes configuration with the api scope selected" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688853324948.png" alt="Salesforce App Manager dropdown menu with the View option for the connected app" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688827319188.png" alt="Manage Consumer Details button in the OAuth settings section of a Salesforce connected app" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688827319572.png" alt="Salesforce consumer details page with Copy buttons for Consumer Key and Consumer Secret" />
</Frame>
</Step>
</Steps>
...
<Frame>
<img src="/images/partner_30688853329684.png" alt="Salesforce Setup search showing Users in the results" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688853330196.png" alt="Salesforce user list with a user selected for permission assignment" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688853330964.png" alt="User detail page in Salesforce with Permission Set Assignments link visible" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688853331220.png" alt="Permission Set Assignments section with Edit Assignments button highlighted" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688853331988.png" alt="Permission set picker with MoEngage Sync Configuration Permission added to enabled permissions" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_30688827324180.png" alt="Salesforce error message indicating a missing MoEngage permission set assignment" />
</Frame>
</Warning>
</Step>
</Steps>
