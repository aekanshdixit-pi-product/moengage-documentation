...
* Follow the steps [mentioned here](/partner-guide/message-orchestration/crm/salesforce-crm-native/setup-moengage-app-on-salesforce) to install and setup the MoEngage app from Salesforce app-exchange.
</Info>
...
<Info>
You can change the above default values for your Salesforce organisation by configuring it in [Custom Settings](/partner-guide/message-orchestration/crm/salesforce-crm-native/setup-moengage-app-on-salesforce#h_01K60V21ZADHXCRG0GX7QHNBX8).
</Info>
</Accordion>
