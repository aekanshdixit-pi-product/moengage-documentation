...
description: "Stream MoEngage campaign engagement events to Microsoft Dynamics 365 Sales using Power Automate to enrich Lead, Contact, and Opportunity records in real time."
keywords: ["microsoft dynamics 365", "d365 sales", "moengage streams", "power automate", "campaign events", "outbound integration"]
---
...
<Frame>
<img src="/images/partner_43270355308564.png" alt="Power Automate trigger selection screen with the HTTP request trigger highlighted" />
</Frame>
</Step>
</Steps>
...
<Frame>
<img src="/images/partner_43270361460244.png" alt="Power Automate HTTP request trigger configuration with Request Body JSON Schema field visible" />
</Frame>
...
<Frame>
<img src="/images/partner_43270355310100.png" alt="Power Automate Apply to each loop configured with the events array as input" />
</Frame>
</Step>
</Steps>
...
| --- | --- | --- |
| **Event Name** | Click the field, then click **/** and select from the dynamic content list | Select **event_name** from the dynamic content picker |

<Frame>
<img src="/images/partner_43271000194580.png" alt="Power Automate Dataverse action with the Event Name field mapped to event_name from dynamic content" />
</Frame>
...
<Frame>
<img src="/images/partner_43270361463188.png" alt="Power Automate expression editor with the Unix-to-DateTime conversion formula" />
</Frame>
...
<Frame>
<img src="/images/partner_43270976890900.png" alt="MoEngage Events table in D365 showing a new event record with mapped data and Lead lookup" />
</Frame>
</Step>
</Steps>
