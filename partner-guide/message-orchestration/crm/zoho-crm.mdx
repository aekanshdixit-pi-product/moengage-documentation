...
To get a dedicated endpoint for your integration, please contact the MoEngage Support team. In your request, you must specify the common identifier used to link user profiles between MoEngage and the partner platform. To set up a workflow rule, perform the following steps:

![Image of Create New Rule dialog box](/images/partner_40830764971668.png)
...
![Image of Next button](/images/partner_40830749827348.png)

Now, configure the trigger.

![Image of Next button](/images/partner_40830764972948.png)
...
![Image of CONDITION block](/images/partner_40833954277524.png)

To configure a Webhook action, perform the following steps: The **Webhook** dialog box appears.
...
| --- | --- |
| Method | **POST** |
| URL | Enter the dedicated Webhook URL provided by MoEngage in the following format: [https://api-0X.moengage.com/v1/partner/zoho-crm/](https://api-0X.moengage.com/v1/partner/zoho-crm/{events/user}/?configName={config_name}){events/user}[/?configName=](https://api-0X.moengage.com/v1/partner/zoho-crm/{events/user}/?configName={config_name}){config_name}. |
| Custom Headers |  |
| Header(s) |  |
| --- | --- |
