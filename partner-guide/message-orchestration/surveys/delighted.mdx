---
title: "Delighted"
description: "Learn how to integrate Delighted with MoEngage to trigger real-time, actionable customer feedback surveys. Automatically send surveys and add users to Autopilot based on user events and actions in your app or website."
---
...
1. Navigate to Create Campaign >> Connectors >> Custom and choose the delivery type most suitable to your needs. For this example, we will select "Event Triggered" and select the event as "Purchased".
   ![](/images/partner_20264613012372.png)
...
- Headers
  - `Authorization`: Use an online tool to create your basic auth with your `Delighted API Key` as a username and keeping your password as blank:
    ![](/images/partner_20264654903572.png)
    In the above example, the value of this header would be `Basic PGRlbGlnaHRlZF9hcGlfa2V5Pjo=`
