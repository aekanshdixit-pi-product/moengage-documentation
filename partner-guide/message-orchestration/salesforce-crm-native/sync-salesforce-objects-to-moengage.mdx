...
| --- | --- |  
| Status |  Status of the Historic Sync. If this is `Processing`, the data sync is in progress. When this is `Completed` it means that all the records have been sent to MoEngage for processing.  
...
arrow_drop_down **Activating Sync Queue Views**
...
arrow_drop_down **Steps to reschedule the Delete Job**
...
| info |  **Note** You can change the above default values for your Salesforce organisation by configuring it in [Custom Settings](https://partners.moengage.com/hc/en-us/articles/30688853335444-Setup-MoEngage-App-on-Salesforce#h_01K60V21ZADHXCRG0GX7QHNBX8).

| --- | --- |  
  
# Frequently Asked Questions

arrow_drop_down **Can I apply filters on my data sync?**
...
arrow_drop_down **How do I enable real-time syncs?**
