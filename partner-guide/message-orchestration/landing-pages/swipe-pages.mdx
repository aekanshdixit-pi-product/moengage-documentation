...
<Steps>
<Step title="Add a global webhook">
Click **Add Global Webhooks**.

<Frame>
<img src="/images/partner_32487524491668.png" alt="Swipe Pages dashboard with the Add Global Webhooks button highlighted" />
</Frame>
</Step>
...
<Frame>
<img src="/images/partner_32487524496404.png" alt="Webhook details form in Swipe Pages with name, endpoint URL, method, and event configured" />
</Frame>
</Step>
...
Select the pages tied to the selected domain.
</Step>

<Step title="Map the form fields">
Map the Swipe Pages form fields to the appropriate webhook fields. Select the fields you want to send to MoEngage.
...
<Frame>
<img src="/images/partner_32487544888980.png" alt="Field mapping screen in Swipe Pages with form fields mapped to MoEngage keys" />
</Frame>
</Step>

<Step title="Configure miscellaneous options">
...
<Frame>
<img src="/images/partner_32487544891284.png" alt="Authorization header configuration in Swipe Pages with the Basic auth token entered" />
</Frame>
...
<Frame>
<img src="/images/partner_32487524508180.png" alt="Swipe Pages webhook test screen with the Run a test button highlighted" />
</Frame>
