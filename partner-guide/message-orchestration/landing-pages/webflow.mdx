...
2. In Site Settings, scroll down to the **Overview** section to find your Site ID.
   ![Webflow Site Settings Overview section showing the Site ID field](https://fdr-prod-docs-files-public.s3.amazonaws.com/https://webflow-prod.docs.buildwithfern.com/2024-11-25T21:05:46.734Z/assets/images/7bbb258-Screenshot_2024-07-29_at_2.49.21_PM.png)

#### Create an API key

1. Navigate to **Site** \> **Apps and Integration**.
2. Scroll down to the **API access** section.
   ![Webflow Apps and Integration page with the API access section visible](/images/partner_32485612507284.png)
3. Click **Generate Key**.
4. Provide a name for the key and add the relevant permissions.
   ![Webflow API key creation form with name and permission scopes configured](/images/partner_32485628871060.png)
