...
| Event type | `event_type` | Type of the event (e.g., gift or loyalty for check-ins, etc.) |
...
| User-Agent | For details, see [User Agent](https://developers.partech.com/docs/dev-portal-online-ordering/ZG9jOjQ0OTU0NzY3-user-agent). | Punchh/OnlineOrder/1.0/Web/BrowserVersion/OS_Type |
