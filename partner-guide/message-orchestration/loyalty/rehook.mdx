...
1. Navigate to Create Campaign \>\> Connectors \>\> Custom and choose the delivery type most suitable to your needs. For this example, we will select "Event Triggered" and select the event as "Purchased".
   <img src="/images/partner_20174965334164.png" />
...
- Headers
  - `Authorization`: Use an online tool to create your basic auth with your `API Key` as a username and your `Secret Key` as a password:
    <img src="/images/partner_20174943398804.png" />\
...
[https://api.rehook.ai/campaigns/reward-progress/&#123;&#123;UserAttribute\['Customer](https://api.rehook.ai/campaigns/reward-progress/&#123;&#123;UserAttribute['Customer) ID'\]}}
...
<img src="/images/partner_20174943398804.png" />\
In the above example, the value of this header would be `Basic dG9rZW46c2VjcmV0` 3. `Content-Type`: `application/json` 2. Click on "Save" and then "Done" once you see a successful response. 3. Note - You can also test your APIs. To test your APIs, from the Content API's action menu, click on "Test". You can your API response and validate it.
