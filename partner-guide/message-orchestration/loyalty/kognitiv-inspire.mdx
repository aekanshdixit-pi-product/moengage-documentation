...
| --- | --- |
| Method | POST |
| Webhook URL | `https://api-0X.moengage.com/v1/event/&lt;Workspace_ID&gt;`<br />The 'X' in the API Endpoint URL refers to the MoEngage Data Center (DC). MoEngage hosts each customer in a different DC. You can find your DC number (value of X) and replace the value of 'X' in the URL by referring to the DC and API endpoint mapping [here](/user-guide/data/key-concepts/data-centers-in-moengage). K |
