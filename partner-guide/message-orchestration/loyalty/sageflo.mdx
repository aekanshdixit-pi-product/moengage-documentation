...
Perform the following steps:
  ...
  1. Navigate to **Settings** -> **Advanced settings** -> **Content API**. Click **\+ Add content API** at the top right corner of the Content API screen.![ContentAPI_Navogation.png](/images/partner_26221652141332.png)
...
In a similar way, Sageflo allows you to add pre-determined prefixes and suffixes to your generated coupon codes:
    ...
    https://coupons-app.sageflo.com/coupon/&lt;CLIENTNAME&gt;/pools/&lt;CLIENTPOOL&gt;?auth=&lt;AUTHCODE&gt;&email=&#123;&#123;UserAttribute['Emaill
      (Standard)']&#125;&#125;&campid=&#123;&#123;EventAttribute['Campaign ID']&#125;&#125;&prefix=ABC
...
If you're also using the count parameter, you must include the same number of prefixes, separated by commas, or you'll get an error. For example:
    ...
    https://coupons-app.sageflo.com/coupon/&lt;CLIENTNAME&gt;/pools/&lt;CLIENTPOOL&gt;?auth=&lt;AUTHCODE&gt;&email=&#123;&#123;UserAttribute['Emaill
      (Standard)']&#125;&#125;&campid=&#123;&#123;EventAttribute['Campaign ID']&#125;&#125;&count=3&prefix=ABC,CDE,EFG

Similarly, for suffixes:
    
    
    https://coupons-app.sageflo.com/coupon/&lt;CLIENTNAME&gt;/pools/&lt;CLIENTPOOL&gt;?auth=&lt;AUTHCODE&gt;&email=&#123;&#123;UserAttribute['Emaill
      (Standard)']&#125;&#125;&campid=&#123;&#123;EventAttribute['Campaign ID']&#125;&#125;&suffix=XYZ
