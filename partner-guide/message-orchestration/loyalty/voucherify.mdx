...
</Info>## Step 1: Prepare a Voucherify campaign to engage inactive customers
...
On your MoEngage account, navigate to Settings → App → APIs → Content API tab and click the ‘Add’ button.
  ...
  3. In the _Parameters_ tab: 
     ...
     2. Add a _customer_ parameter and fill in the MoEngage field that should be used as the customer’s source_id field in Voucherify. In this case, the customer’s email is used as source_id. You can learn more about MoEngage users’ attributes [here](https://help.moengage.com/hc/en-us/articles/207836953-Derived-Events-Attributes#tracked-standard-attribute-0-15).



![](/images/partner_15879310627732.png)
...
![](/images/partner_15879301166612.png)

     2. Set `Content-Type` header to `application/json`.  
  
![](/images/partner_15879333346580.png)
...
![](/images/partner_15879370756884.png)
...
![](/images/partner_15879396555924.png)

  2. Prepare the email content. Using the templating language Jinja you can insert e.g. customer name into the content and call the Content API endpoint created in step 2, parse its response, and display the desired information to the customer. You can find out more about using Jinja in MoEngage [in this article](https://help.moengage.com/hc/en-us/articles/115002757783-MoEngage-Templating-Language-JINJA-). 
...
![](/images/partner_15879477980180.png)

  3. You can preview how the message will look to a particular customer after you click the preview button in the template editor, [in the personalised mode](https://help.moengage.com/hc/en-us/articles/30958544839828-Personalized-Preview) or you can test it by sending an email using the _Test Campaign_ field below the template editor.



![](/images/partner_15879480332180.png)
...
![](/images/partner_15879482764436.png)
...
![](/images/partner_15879531262868.png)

And see generated codes on your Voucherify campaign dashboard:

![](/images/partner_15879535034516.png)
...
![](/images/partner_15879519884692.png)
