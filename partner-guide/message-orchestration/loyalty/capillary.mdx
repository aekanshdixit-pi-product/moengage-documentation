...
</Info>## Display customer rewards in MoEngage Campaigns
...
### Step 1: Set up a MoEngage Content API
  ...
  1. Navigate to **Settings** > **Advanced settings** > **Content API**. Click **\+ Add content API** at the top right corner of the Content API screen.![ContentAPI_Navogation.png](/images/partner_21979873442068.png)
  2. Add your Capillary API to the endpoint URL. Depending on your use case, the endpoint will change. 



![](/images/partner_19899981002644.png)
...
Under Headers, add the following:
  ...
  1.      1. `Authorization`: Use an online tool to create your basic auth with `username` as a username and your MD5 hash of your `password` as a password:  
![](/images/partner_19899891659924.png)  
