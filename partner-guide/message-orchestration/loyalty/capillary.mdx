...
1. Navigate to **Settings** > **Advanced settings** > **Content API**. Click **+ Add content API** at the top right corner of the Content API screen.
   ![ContentAPI_Navogation.png](/images/partner_21979873442068.png)
...
5. Note - You can also test your APIs. To test your APIs, from the Content API's action menu, click on "Test". You can test your API response and validate it.
