...
- Parameters\
  ...
  <Note>
    ...
    - Include an appropriate field to map theexternalUserId field to. The example in the screenshot above uses the driver\_id, though your field will likely be different. This ID will be available in eduMe reports, allowing you to correlate them with your systems
  </Note>
