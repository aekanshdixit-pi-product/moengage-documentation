...
|  Setup MoEngage custom activity in SFMC |  [Click here](/partner-guide/message-orchestration/marketing-cloud/salesforce-marketing-cloud-sfmc/setup-moengage-activity). <br/>- 2. | 

| Use MoEngage Push Campaign in Journey Builder  | |

  [Click here](/partner-guide/message-orchestration/marketing-cloud/salesforce-marketing-cloud-sfmc/create-moengage-push-campaign-activity).  
3.

|  Use MoEngage Event destination in Journey Builder  |  [Click here](/partner-guide/message-orchestration/marketing-cloud/salesforce-marketing-cloud-sfmc/create-moengage-event-activity). <br/>- 4. | 

| Sync users and attributes from data extension into MoEngage | |

  [Click here](/partner-guide/message-orchestration/marketing-cloud/salesforce-marketing-cloud-sfmc/sync-users-from-sfmc-to-moengage).
