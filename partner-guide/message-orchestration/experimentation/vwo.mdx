...
To analyze the results of your experiments in MoEngage, you need to setup the data tracking for MoEngage as mentioned in the [document here.](https://www.moengage.com/docs/developer-guide/web-sdk/web-sdk-integration/basic-integration/web-sdk-integration) 
...
You can now start sending your VWO experiment data to MoEngage at the campaign level. <img src="https://help.vwo.com/hc/article_attachments/5859491532697/Integrate_with_Third-party_apps.png" alt="Integrate_with_Third-party_apps.png" />
...
3. Specify the number of visits that you want to track for the visitors that landed on your website and the period during which the visit(s) took place.<img src="https://help.vwo.com/hc/article_attachments/5859501221273/Tracked_User_Events.png" alt="Tracked_User_Events.png" /> \
