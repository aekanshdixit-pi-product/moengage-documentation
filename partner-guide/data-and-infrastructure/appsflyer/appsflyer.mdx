...
| info |  **Information** We've revamped our dashboard settings UI. Acquisition Settings are available in **Settings** -> **Analytics and Data** -> **Acquisition tracking.** For more information, refer to [Summary of Changes - Settings UI Revamp](https://help.moengage.com/hc/en-us/articles/21980082482324).
...
| --- | --- |  
| Workspace ID |  The Workspace ID of your MoEngage account is available in the following navigations in the revamped and old UIs:
...
| info |  **Note** Third-party Acquisition Data from partners is calculated every two hours and aggregated data on the Acquisition dashboard is refreshed every six hours.
