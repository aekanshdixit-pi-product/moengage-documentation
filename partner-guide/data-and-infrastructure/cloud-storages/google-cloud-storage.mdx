...
1. From the sidebar, open **Service Accounts**.
   ...
   <Frame>
   <img src="/images/partner_12062501879700.png" alt="Service Accounts home in the IAM & Admin console" />
   </Frame>
...
4. Click **Create and continue**.
   ...
   <Frame>
   <img src="/images/partner_12062703174548.png" alt="Creating a new service account in Google Cloud" />
   </Frame>

5. Add the role **Basic > Browser** to this service account.

   <Frame>
   <img src="/images/partner_12062802345876.png" alt="Assigning the Basic > Browser role to the service account" />
   </Frame>
...
9. Go to the **Keys** tab, click **Add Key**, and then select **Create new key**.
   ...
   <Frame>
   <img src="/images/partner_12062893736724.png" alt="Add Key option on the service account Keys tab" />
   </Frame>

10. Select the **Key Type** as **JSON**, and then click **Create**.

    <Frame>
    <img src="/images/partner_12062926508052.png" alt="Selecting JSON as the key type when creating a service account key" />
    </Frame>
...
1. On your service account details page, copy the email of your service account.
   ...
   <Frame>
   <img src="/images/partner_12063141549076.png" alt="Service account email on the details page" />
   </Frame>
...
3. Under the **Permissions** tab, click **Grant Access**.
   ...
   <Frame>
   <img src="/images/partner_12063166880276.png" alt="Grant Access option on the bucket Permissions tab" />
   </Frame>
...
5. Assign the role **Cloud Storage > Storage Admin**.
   ...
   <Frame>
   <img src="/images/partner_12063216822036.png" alt="Assigning the Storage Admin role to the service account" />
   </Frame>
...
1. In your GCP console, go to **APIs & Services**, and then click **+ Enable APIs and Services**.
   ...
   <Frame>
   <img src="/images/partner_12063295895828.png" alt="Enable APIs and Services option in GCP console" />
   </Frame>
...
3. Click **Enable** to enable it.
   ...
   <Frame>
   <img src="/images/partner_12063394282388.png" alt="Enabling the Cloud Storage API in GCP" />
   </Frame>
...
3. Go to the **Integrate** tab, and click **+ Add Integration**.
   ...
   <Frame>
   <img src="/images/partner_12063471722644.png" alt="Add Integration option on the Google Cloud Storage Integrate tab" />
   </Frame>
...
8. Select which events you want to export. By default, each event is exported with standard attributes.
   ...
   <Frame>
   <img src="/images/partner_12064408178068.png" alt="Configuring the GCS integration on the MoEngage App Marketplace" />
   </Frame>
...
<Frame>
<img src="/images/partner_12064664073364.png" alt="Verifying that exported files are present in the GCS bucket" />
</Frame>
...
For a list of supported events and attributes, refer to our [Data Export Glossary](/user-guide/data/exports/events/data-export-glossary).
