...
<AccordionGroup>
  <Accordion title="Cross-account role (Recommended) — supports both imports and exports">
    ...
    - **MoEngage Role ARN**: The only MoEngage identity your role trusts. Use the ARN for your data center.
    - **External ID**: A value unique to your workspace, in the format `moe-external-xxxxxxxxxx` (for example, `moe-external-f82a6992-9c75-5d4c-f985-a0c3b8f3bcf2`).

    <Info>
      **Where to find these values**

      In MoEngage, go to **Amazon S3** \> **Integrations** \> **Add Connection**. The **MoEngage Role ARN** and your workspace's **External ID** appear on the **Add Connection** form (see [Step 3: Connect Amazon S3 on the App Marketplace](#step-3-connect-amazon-s3-on-the-app-marketplace)). Copy them before you configure AWS.
    </Info>
