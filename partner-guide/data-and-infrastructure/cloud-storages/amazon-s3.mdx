...
<AccordionGroup>
  <Accordion title="Cross account role (Preferred) — supports both imports and exports">
    ...
    - **MoEngage AWS Account ID**: The MoEngage account that your role trusts.
    ...
    ![Add Connection form highlighting the MoEngage AWS Account ID and MoEngage External ID fields](/images/s3-add-connection-form.png)
    ...
    **Create the cross account role**
    ...
    4. In the **Custom trust policy** editor, paste the following trust policy (replace the placeholders first), and then click **Next**. The trust policy defines who may assume your role.
