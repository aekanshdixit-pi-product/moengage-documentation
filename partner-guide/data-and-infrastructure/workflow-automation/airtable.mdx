---
title: "Airtable"
description: "Learn how to integrate MoEngage with Airtable to automatically forward user and event data into your Airtable databases using Connector Campaigns."
---
...
![CreateCampaign_RightNav.png](/images/partner_22022827372052.png)
     2. Click **Create New** > **Campaign**.  
The Create Campaign page is displayed.  
![CreateCampaignLeftNav.png](/images/partner_22022813215892.png)
...
![airtable-url-breakdown.png](/images/partner_15197578625300.png)
  11. Define the following headers: 
     1. `Authorization`: `Bearer <TOKEN_YOU_COPIED_EARLIER>`
     2. `Content-Type`: `application/json`
  12. Choose the "Body Type" as raw and paste the following:  
