...
![webhooksfinallllll.png](/images/partner_43421536761876.png)
  6. After the connection is defined, you can select the defined new destination from the **Send Alerts On** list while creating an alert on the [Alert management](/user-guide/settings/reports-and-alerts/alert-management/getting-started/create-an-alert) page.  
