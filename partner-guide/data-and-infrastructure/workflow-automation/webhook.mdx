---
title: "Webhook"
description: "Receive real-time MoEngage alert notifications via HTTP POST webhooks with detailed JSON payloads for monitoring and automation."
keywords: ["webhook", "alerts", "real-time notifications", "HTTP POST", "MoEngage integration", "automation"]
---
