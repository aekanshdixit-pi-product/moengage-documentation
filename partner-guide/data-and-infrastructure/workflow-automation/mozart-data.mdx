...
* You need a Mozart Data account for this integration.
  * You will need to enable [Snowflake Exports](https://help.moengage.com/hc/en-us/articles/18603435928212-Snowflake-Exports) for your account.
  * You will need to enable [Snowflake Imports](https://help.moengage.com/hc/en-us/articles/18324470276884-Snowflake-Imports) for your account.
</Info>
...
You can send Campaign Interaction Data of your users from MoEngage to your Snowflake tables using [Snowflake Exports](https://help.moengage.com/hc/en-us/articles/18603435928212-Snowflake-Exports).

## Sending data from Mozart Data to MoEngage

Using Mozart Data, you can perform various transformations on your data, as well as link more BI tools and data sources to Mozart Data, combining it for a more holistic view. Once ready, you can import this data using [Snowflake Imports](https://help.moengage.com/hc/en-us/articles/18324470276884-Snowflake-Imports) to MoEngage. Currently, we support importing Users as well as Events.
