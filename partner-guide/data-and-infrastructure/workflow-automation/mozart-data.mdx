...
* You need a Mozart Data account for this integration.
  * You will need to enable [Snowflake Exports](/user-guide/data/exports/events/data-warehouse/snowflake-exports) for your account.
  * You will need to enable [Snowflake Imports](/user-guide/data/imports/data-warehouses-imports/snowflake-imports) for your account.
</Info>
...
You can send Campaign Interaction Data of your users from MoEngage to your Snowflake tables using [Snowflake Exports](/user-guide/data/exports/events/data-warehouse/snowflake-exports).

## Sending data from Mozart Data to MoEngage

Using Mozart Data, you can perform various transformations on your data, as well as link more BI tools and data sources to Mozart Data, combining it for a more holistic view. Once ready, you can import this data using [Snowflake Imports](/user-guide/data/imports/data-warehouses-imports/snowflake-imports) to MoEngage. Currently, we support importing Users as well as Events.
