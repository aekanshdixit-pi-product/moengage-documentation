...
| Base URL | The URL of your MoEngage REST API Host. For more information about your REST API URL, please refer to [Data centers in MoEngage](/user-guide/data/key-concepts/data-centers-in-moengage). Example: https://api-01.moengage.com |
