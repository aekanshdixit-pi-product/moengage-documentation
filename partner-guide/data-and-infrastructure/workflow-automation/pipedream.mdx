...
![Trigger-Step2.png](/images/partner_9580666060692.png)
  ...
  3. Event Data => `Full HTTP Request`  
...
![CreateCampaign_RightNav.png](/images/partner_22017108045972.png)
     2. Click **Create New** > **Campaign**.  
The Create Campaign page is displayed.  
![CreateCampaignLeftNav.png](/images/partner_22017108047124.png)
...
![Action-Step2.png](/images/partner_9581319258644.png)
  ...
  8. Once you are satisfied with the configuration, you can choose to test this step or the entire workflow.



![Action-Step3.png](/images/partner_9581344713876.png)

  9. Once the insert is successful, you can then deploy this workflow. It will insert new rows to Google Sheets each time a user performs your selected event in MoEngage.
...
Using MoEngage's [Data APIs](https://developers.moengage.com/hc/en-us/articles/4404674776724-Overview), you can:
...
In order to make use of Data APIs in Pipedream, you need to add the "HTTP / Webhook" step. You can choose to send GET or POST Requests depending on the type of call supported in MoEngage. Data API is a collection of the following APIs:
  ...
  * [User API](https://developers.moengage.com/hc/en-us/articles/4413167462804)
  * [Event API](https://developers.moengage.com/hc/en-us/articles/4413174104852)
...
| Data API Key | The Data API key of your MoEngage account is available at **Settings - > Account -> APIs -> API keys **>**Data** API settings. Data Center Name |
| Check your MoEngage URL: `https://dashboard-OX.moengage.com` Based on the dashboard value &#123;‘DC-01’ | ‘DC-02’ | ‘DC-03’ |

 ‘DC-04’&#125;, set the correct input in the data center name on the Pipedream dashboard. [Know more](https://help.moengage.com/hc/en-us/articles/360057030512-Data-Centers-in-MoEngage).  
...
![Action-Webhook-Step-3.png](/images/partner_9582166157844.png)
  ...
  8. Copy and paste the following payload from the [User API](https://developers.moengage.com/hc/en-us/articles/4413167462804) docs:
