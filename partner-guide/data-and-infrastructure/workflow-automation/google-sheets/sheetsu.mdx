---
title: "Sheetsu"
description: "Integrate Sheetsu with MoEngage to read Google Sheets data through Content APIs in campaigns and write back to sheets using Connector Campaigns."
keywords: ["sheetsu", "google sheets", "content api", "connector campaign", "moengage integration"]
---
...
2. Add your Sheetsu name and API URL.
   ...
   **API URL**
   ...
   Enter the following URL. Please note that *your Sheetsu API URL* should be the same as copied from the previous step.
