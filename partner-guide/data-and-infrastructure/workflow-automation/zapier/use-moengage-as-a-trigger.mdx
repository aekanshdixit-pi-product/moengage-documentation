...
With MoEngage's [Connector Campaigns](/user-guide/inform/connectors/connector-campaigns/about-connector-campaigns), you can use MoEngage to trigger your Zapier workflows for multitude of purposes.
...
The use case takes advantage of MoEngage [Connector Campaigns](/user-guide/inform/connectors/connector-campaigns/about-connector-campaigns). For this tutorial, we will pick up Use Case #1: Post Slack message for each uninstall in MoEngage. On your [Zapier Dashboard](https://zapier.com/app/dashboard), click on "+ Create Zap" on the top-left corner.
...
4. For the campaign delivery types, choose "Event-Triggered".
   - For more information about delivery types, refer to [Delivery Types](/user-guide/inform/key-concepts/delivery-types).
