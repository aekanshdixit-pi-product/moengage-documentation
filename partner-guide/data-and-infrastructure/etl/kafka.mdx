...
<Info>
**Flexible Schema** You can add custom fields to the `user_attributes` and `event_attributes` objects. MoEngage automatically captures and stores these fields. Only `customer_id`, `updated_at`, and `event_attributes.event_name` are mandatory.
</Info>
