...
| info |  **Information** The mParticle integration does not currently support [Unified Identity (Identity Resolution)](https://help.moengage.com/hc/en-us/articles/24050999467284-Unified-Identity-Identity-Resolution) or [Portfolio](https://help.moengage.com/hc/en-us/articles/40394603054100-Portfolio).
...
| warning |  Important  Server-to-server integration does not support features such as In-Apps, Cards, or Push notifications. You need integrate with MoEngage SDKs if you are using these channels.
