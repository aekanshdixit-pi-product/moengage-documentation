...
| info |  **Information** The Twilio Segment integration does not currently support [Unified Identity (Identity Resolution)](https://help.moengage.com/hc/en-us/articles/24050999467284-Unified-Identity-Identity-Resolution) or [Portfolio](https://help.moengage.com/hc/en-us/articles/40394603054100-Portfolio).

| --- | --- |  
  
  
With MoEngage Destination on Twilio Segment, you can forward your Users, Events, and Audiences ([Twilio Segment Engage](https://partners.moengage.com/hc/en-us/articles/5873974672148-Segment-Engage#connection-settings)) data to MoEngage and run personalized campaigns targeting them. If you’re a new MoEngage customer, you can relay historical data to MoEngage using [Twilio Segment replays](https://partners.moengage.com/hc/en-us/articles/5873974672148-Segment-Engage#connection-settings).
...
| --- | --- |  
Side-by-side  
| (Device mode) |  Preferred mode of integration Device mode uses Segment’s SDK to send data directly to MoEngage. This allows access to deeper features and more comprehensive usage of MoEngage.  
Server-to-server  
| (Cloud mode) | Cloud mode forwards data from Segment servers directly to MoEngage Data APIs. Cloud mode is generally recommended for sending offline data to MoEngage.   
...
Destination Frameworks > _Integration Modes v_

| MoEngage Classic  | MoEngage Actions <br/>- |-
...
| Recommended  | N/A <br/>- _Cloud Mode_ | 

| To be deprecated by Dec 2025  | |
...
![](/images/partner_38197516346388.png)
...
![](/images/partner_38197516350996.png)
...
| info |  **Information** It is preferred to use MoEngage (Actions) for Cloud Mode.
...
| Segment SDK | MoEngage SDK <br /> ---\|-

| --\|--- <br /> Preferred \|

| [Analytics Swift](https://github.com/segmentio/analytics-swift) \| [MoEngage Segment Swift](https://partners.moengage.com/hc/en-us/articles/12783066457236) <br /> Legacy \|

| [Analytics iOS](https://github.com/segmentio/analytics-ios) \| [MoEngage Segment iOS](https://partners.moengage.com/hc/en-us/articles/12783066457236) | <br/>- ### Android <br/>- The MoEngage SDK you need to use will depend on which Segment SDK you use: |

| Segment SDK | MoEngage SDK <br /> ---\|-

| --\|--- <br /> Preferred \|

| [Analytics Kotlin](https://github.com/segmentio/analytics-kotlin) \| [MoEngage Segment Kotlin](https://partners.moengage.com/hc/en-us/articles/13554404768404) <br /> Legacy \|

| [Analytics Android](https://github.com/segmentio/analytics-android) \| [MoEngage Segment Android](https://partners.moengage.com/hc/en-us/articles/4409143474964) | |


  
### Web

To complete the side-by-side integration, please refer to the detailed instructions for [Segment Web](https://partners.moengage.com/hc/en-us/articles/4409143477012).

### React Native

To complete the side-by-side integration, please refer to the detailed instructions for [Segment React Native](https://partners.moengage.com/hc/en-us/sections/15979246131092-React-Native-Device-Mode).
...
**Note** : Select your preferred setup method. Optional: If you previously integrated with MoEngage, you can copy the settings from a previous destination.
  2. Click **Save**.   
![](/images/partner_38197516359572.png)
...
| Endpoint region | This is your MoEngage data center. For more information, refer [here](https://help.moengage.com/hc/en-us/articles/360057030512-Data-Centers-in-MoEngage?_gl=1*t7lqc6*_gcl_au*MTAwMzI3NjY5OS4xNzQzMDY2NTg5LjUzMTczNzcxMS4xNzQ3MjkyOTU1LjE3NDcyOTI5NTQ.*FPAU*MTAwMzI3NjY5OS4xNzQzMDY2NTg5*_ga*MjEzNDM1ODE1LjE2OTcxOTUzMzE.*_ga_SEBHW7YTZ7*czE3NDcyODE3MTIkbzI3JGcxJHQxNzQ3MjkzOTUxJGozNyRsMCRoMA..).  
  4. Turn the **Enable** **Destination** toggle on and then click **Save** **Changes**.  
![](/images/partner_38197516367636.png)
...
| info |  **Information** MoEngage (Actions) supports importing both Registered and anonymous users via Cloud Mode. Make sure to pass at least one of the User IDs or anonymous IDs.

| --- | --- |  
  
  1. Click the **Mappings** tab and then click **\+ New Mapping**.
  2. In the **Add mapping** section, under **ACTIONS** , select **Identify User**.   
![](/images/partner_38197516374676.png)
  ...
  6. Scroll to the end of the page to optionally test your connection.  
![](/images/partner_38197516377620.png)
...
To add the Track Event action, perform the following steps:
  ...
  1. Click the **Mappings** tab and then click **+** **New Mapping**.
  2. In the **Add mapping** section, under **ACTIONS** , select **Track Event**.  
![](/images/partner_38197578373268.png)
  3. Define the event triggers based on your requirements, or retain the default condition provided by MoEngage.
  4. Click **Test Event**. The segment attempts to fetch a recent event that matches your trigger conditions.
  5. In the **Define mappings** step, MoEngage provides preset values for all mappings.
  6. Scroll to the end of the page to optionally test your connection.  
![](/images/partner_38197516386836.png)
  7. After the configuration, click **Save**.  
**Note** : Ensure these values remain unchanged.

| info |  **Information** After the **Identify User** and **Track Event** mappings, the **Enabled** toggle is turned on. If not, enable them by turning the toggle in the **Status** column. ![](/images/partner_38197578376084.png)
...
| warning |  **Warning** **Segment's Analytics.js 2.0 Required** MoEngage (Actions) Destination requires features found in Segment's Analytics.js 2.0. If you are using Web actions and have connected MoEngage (Actions) Destination to a JavaScript Source, upgrade your Analytics.js (provided by Segment) to ensure compatibility.
...
![Step9.png](/images/partner_9122484700436.png)
...
Using Segment Engage, you can create segments of users based on data you have already collected across various sources and sync them to MoEngage. For more information, refer to how to set up and sync [Segment Personas and Computed Traits](https://partners.moengage.com/hc/en-us/articles/5873974672148-Segment-Personas).
