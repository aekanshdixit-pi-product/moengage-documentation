---
title: "Apsalar"
description: "Send install acquisition data from Apsalar to MoEngage to enrich marketing automation campaigns with publisher and campaign attribution."
keywords: ["Apsalar", "Singular", "install acquisition", "attribution", "MoEngage integration"]
---
...
| Field | Description |
| --- | --- |
| MoEngage Data Center | Select one of the following depending on the MoEngage Data Center you have signed up with: `DC-01`, `DC-02`, or `DC-03`. You can refer to [this article](/user-guide/data/key-concepts/data-centers-in-moengage) for more details on identifying your MoEngage data center. |
