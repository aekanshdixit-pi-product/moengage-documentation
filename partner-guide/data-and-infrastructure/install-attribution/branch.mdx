...
| appAttributionKey | Available on MoEngage dashboard by navigating to **Settings _- > _Analytics _- > _Acquisition tracking**.**_  
_**  
  
# Frequently Asked Questions

arrow_drop_down **Can I see the install data from Facebook in MoEngage?**
