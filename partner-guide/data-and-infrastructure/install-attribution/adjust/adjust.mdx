...
| Region | Region of your MoEngage data cluster. [Read more](/user-guide/data/key-concepts/data-centers-in-moengage) |
...
The MoEngage × Adjust Integration also sends events from Adjust to MoEngage. To leverage MoEngage capabilities like push notifications, in-apps would require some additional integration. [Read here for the advanced integration with Adjust CDP. ](/partner-guide/data-and-infrastructure/install-attribution/adjust/adjust-cdp)
