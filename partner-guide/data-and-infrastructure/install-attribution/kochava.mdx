...
| --- | --- | --- |
| Data Center Endpoint | Your [MoEngage Data Cluster](/user-guide/data/key-concepts/data-centers-in-moengage). | 1/2/3/4 |
| Workspace ID | Workspace ID of your MoEngage account. You can find this by navigating to **Settings \> Account \> API \> Workspace ID (earlier app id)**. | -- |
