...
To export data from MoEngage to BigQuery, you must connect MoEngage to your Google Cloud project. Ensure you have the necessary administrative privileges within your project and that the service account credentials remain valid:
  ...
  * **To perform exports** : The service account requires the BigQuery Data Editor role to read and write data to your BigQuery tables. For more information, refer to the [BigQuery Exports](/user-guide/data/exports/events/data-warehouse/bigquery-exports#h_01HBE3RK9RSSYM5Y45DCJNAJ68).
...
BigQuery is available in our Warehouse Segments. For more information, refer to [Warehouse Segments](/user-guide/segment/segment-operations/warehouse-segments#h_01J1CFANAANTHBDK1PJV9J2QV7).

## Import Users and Events from BigQuery into MoEngage

To set up MoEngage × BigQuery imports for your account, refer to the [BigQuery Imports guide](/user-guide/data/imports/data-warehouses-imports/bigquery-imports).

## Export Events from MoEngage to BigQuery

You can export events from MoEngage to your BigQuery tables. To set up an export, refer to the [BigQuery Exports guide](/user-guide/data/exports/events/data-warehouse/bigquery-exports#introduction-0-0).
