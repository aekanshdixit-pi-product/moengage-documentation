...
<AccordionGroup>
  <Accordion title="Method 1: Service Principal with OAuth (Recommended)">
    ...
    **Generate an OAuth Secret for the Service Principal**
    ...
    3. Click **Generate secret**. <img src="/images/Auth1.png" alt="Auth1" />
       {/* Image placeholder: Generate secret button in Databricks service principals Secrets tab */}
    ...
    5. Click **Generate**. <img src="/images/Auth2.png" alt="Auth2" />
       {/* Image placeholder: Generate OAuth secret dialog with Lifetime field */}
       <Info>
       ...
       {/* Image placeholder: Generated client_id and client_secret confirmation screen */}
  ...
  <Accordion title="Method 2: Personal Access Token (PAT)">
    ...
    **Generate the Token**
    ...
    - **Service-principal token via the Databricks CLI:** Run the following command in your terminal:
      ```shellscript Databricks CLI Token Creation
