---
title: "Databricks"
description: "Sync user attributes and events from your Databricks warehouse directly to MoEngage on a recurring schedule to power campaigns and segmentation."
keywords: ["Databricks", "data warehouse", "user sync", "event sync", "MoEngage integration", "data warehouse imports"]
---
...
<Tab title="Create a PAT for a user (optional)">
...
To connect Databricks on the App marketplace, perform the following steps:
     ...
     5. Enter the following details:
        ...
        ![Databricks connection form](/images/partner_35794647020948.png)
