...
Databricks is now available in our Warehouse Segments. For more information, refer to [Warehouse Segments](/user-guide/segment/segment-operations/warehouse-segments#h_01J1CFANAANTHBDK1PJV9J2QV7).

## Import Users and Events from Databricks into MoEngage

For more information on setting up MoEngage × Databricks imports for your account, refer to [Databricks Imports guide](/user-guide/data/imports/data-warehouses-imports/databricks-imports#01H7YM656E45T6HK5WCZWW4WGM).

## Export Events from MoEngage to Databricks

You can export events from MoEngage to your Databricks tables. To set up an export, read our [Databricks Exports](/user-guide/data/exports/events/data-warehouse/databricks-exports) guide.
