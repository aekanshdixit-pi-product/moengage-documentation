...
description: "Forward MoEngage user engagement and campaign events to RudderStack as a source for routing to data warehouses and analytics destinations."
keywords: ["RudderStack", "MoEngage Source", "event streaming", "CDP", "Streams", "data forwarding"]
---
