...
description: "Integrate the mParticle Android Kit for MoEngage to enable device-mode SDK forwarding of users, events, push tokens, and screen views."
keywords: ["mParticle Android Kit", "Android SDK", "device mode", "push token", "MoEngage SDK", "kit integration"]
---
...
Check the[ MoEngage Push integration doc](https://developers.moengage.com/hc/en-us/sections/360013606771-Push) to configure the FCM with MoEngage SDK or if you want to handle it independently.
