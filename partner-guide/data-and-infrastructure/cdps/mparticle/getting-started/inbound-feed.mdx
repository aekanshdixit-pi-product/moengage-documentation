---
title: "Inbound (Feed)"
description: "Forward MoEngage campaign interaction data to mParticle's CDP as inbound events to power downstream activation and analytics."
keywords: ["mParticle", "inbound feed", "campaign interaction events", "CDP", "MoEngage Streams", "data forwarding"]
---
...
| Events | Select the event(s) you want to forward to mParticle. [Here is the complete list of events](/user-guide/data/exports/events/data-export-glossary#Events-Exported) that MoEngage can send to mParticle. |
