...
<Info>
The Twilio Segment integration does not currently support [Unified Identity (Identity Resolution)](/user-guide/data/user-data/unified-identity-identity-resolution) or [Portfolio](/user-guide/settings/account/portfolio/portfolio).
</Info>
...
| [Analytics Swift](https://github.com/segmentio/analytics-swift) \| [MoEngage Segment Swift](/partner-guide/data-and-infrastructure/cdps/twillio-segment/device-mode-integration/ios-swift-device-mode) <br /> Legacy \|

| [Analytics iOS](https://github.com/segmentio/analytics-ios) \| [MoEngage Segment iOS](/partner-guide/data-and-infrastructure/cdps/twillio-segment/device-mode-integration/ios-swift-device-mode) | <br/>- ### Android <br/>- The MoEngage SDK you need to use will depend on which Segment SDK you use: |

| Segment SDK | MoEngage SDK <br /> ---\|-

| --\|--- <br /> Preferred \|

| [Analytics Kotlin](https://github.com/segmentio/analytics-kotlin) \| [MoEngage Segment Kotlin](/partner-guide/data-and-infrastructure/cdps/twillio-segment/device-mode-integration/android-kotlin-device-mode) <br /> Legacy \|

| [Analytics Android](https://github.com/segmentio/analytics-android) \| [MoEngage Segment Android](/partner-guide/data-and-infrastructure/cdps/twillio-segment/device-mode-integration/android-device-mode) | |
...
| Endpoint region | This is your MoEngage data center. For more information, refer [here](/user-guide/data/key-concepts/data-centers-in-moengage). |
