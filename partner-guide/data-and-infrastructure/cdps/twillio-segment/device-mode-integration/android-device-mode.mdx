...
description: "Integrate the MoEngage Android Device Mode SDK with Twilio Segment to enable push notifications, in-app messaging, and rich user tracking."
keywords: ["Twilio Segment", "Android", "device mode", "MoEngage SDK", "push notifications", "in-app messaging"]
---
...
After adding the dependency, you must register the integration with Twilio Segment SDK. To do this, import the MoEngage  
integration:
...
This will send the event to MoEngage with the associated properties. Tracking events is essential and will help you create Twilio segments for engaging users.
