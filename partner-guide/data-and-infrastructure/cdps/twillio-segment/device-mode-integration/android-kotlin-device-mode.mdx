...
description: "Integrate the MoEngage Kotlin Segment Destination SDK on Android to enable push notifications, in-app messaging, and rich user tracking via Twilio Segment."
keywords: ["Twilio Segment", "Android Kotlin", "device mode", "MoEngage SDK", "push notifications", "Kotlin destination"]
---
