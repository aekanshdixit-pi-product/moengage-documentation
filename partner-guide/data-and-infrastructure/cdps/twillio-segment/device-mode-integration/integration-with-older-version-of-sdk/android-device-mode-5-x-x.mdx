...
description: "Legacy integration guide for connecting MoEngage Android SDK 5.x.x with Twilio Segment in device mode for push notifications and in-app messaging."
keywords: ["Twilio Segment", "Android SDK 5.x.x", "legacy integration", "device mode", "MoEngage SDK"]
---
