...
description: "Legacy integration guide for connecting MoEngage iOS SDK 6.x.x with Twilio Segment in device mode for push notifications and in-app messaging."
keywords: ["Twilio Segment", "iOS SDK 6.x.x", "legacy integration", "device mode", "MoEngage SDK", "Segment-MoEngage"]
---
...
<Warning>
  Please make sure to set the Data Center/ Region for MoEngage SDK separately in your AppDelegate's `application:didFinishLaunchingWithOptions` method. Refer [doc](https://developers.moengage.com/hc/en-us/articles/4562614612628) for more info.
</Warning>
...
![64351a3-Screen_Shot_2018-09-20_at_11.25.31.png](/images/partner_27904757056532.png)
...
<Warning>
  Please note that [**AppDelegate Swizzling**](https://developers.moengage.com/hc/en-us/articles/4564174542228) does not work reliably with Segment Integration because of delay in initializing the SDK by Segment, therefore make sure to call the MoEngage SDK methods for all Push related callbacks.
</Warning>
...
For more info on this refer the following [link](https://developers.moengage.com/hc/en-us/articles/4562585347220).
