...
<Warning>
This SDK built on top of [analytics-ios](https://github.com/segmentio/analytics-ios) will no longer receive updates. We recommend you use the [MoEngage- Twilio Segment-Swift](https://github.com/moengage/MoEngage-Segment-Swift) SDK built on top of [analytics-swift](https://github.com/segmentio/analytics-swift). Refer to the [MoEngage- Twilio Segment-Swift documentation](/partner-guide/data-and-infrastructure/cdps/twillio-segment/device-mode-integration/ios-swift-device-mode) for more details.
</Warning>
...
<Warning>
Please make sure to set the Data Center/ Region for MoEngage SDK separately in your AppDelegate's `application:didFinishLaunchingWithOptions` method. Refer [doc](https://developers.moengage.com/hc/en-us/articles/4403910162452-Data-Center) for more info.
</Warning>
<Warning>
