...
description: "Integrate the legacy MoEngage iOS Segment SDK with Twilio Segment to enable push notifications, in-app messaging, and rich user tracking."
keywords: ["Twilio Segment", "iOS", "device mode", "MoEngage SDK", "push notifications", "Segment-MoEngage"]
---
