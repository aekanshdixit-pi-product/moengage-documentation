---
title: "BlueConic"
description: "Sync user data from BlueConic to MoEngage in real time using a custom plugin to power lifecycle campaigns and segmentation."
keywords: ["BlueConic", "CDP", "user sync", "real-time data", "MoEngage integration", "plugin"]
---
