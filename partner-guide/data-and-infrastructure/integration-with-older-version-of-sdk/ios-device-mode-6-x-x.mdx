...
| warning |  **Data Redirection** Please make sure to set the Data Center/ Region for MoEngage SDK separately in your AppDelegate's `application:didFinishLaunchingWithOptions` method. Refer [doc](https://developers.moengage.com/hc/en-us/articles/4562614612628) for more info.

| --- | --- |  
  
| warning |  **Important** Don't miss to add **[config use:[SEGMoEngageIntegrationFactory instance]]** while setting up Segment SDK. **Unless this is done data will not be sent to MoEngage**.
...
| info |  **Segment Docs** For more info on using **Segment for iOS** refer to [Developer Docs](https://segment.com/docs/sources/mobile/ios/) provided by Segment.
