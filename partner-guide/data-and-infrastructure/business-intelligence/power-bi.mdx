...
Power BI also supports cloud storage like Amazon S3 and Google Cloud Storage. Additional transformation might be necessary because you can import data directly from these files. To understand the schema of these files, please refer to our [Data Exports Glossary](https://help.moengage.com/hc/en-us/articles/15975781928468-Data-Export-Glossary).
