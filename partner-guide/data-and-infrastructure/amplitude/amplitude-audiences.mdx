...
## Enabling Amplitude and MoEngage Integration for your account.
  ...
  3. To enable the data export integration from MoEngage to Amplitude, please contact your MoEngage customer success manager (CSM) or the MoEngage Support team[ ](mailto:support@moengage.com)with a few details mentioned in Exporting Campaign Data from MoEngage to Amplitude.
...
![Screen_Shot_2020-06-24_at_9.10.00_AM.png](/images/partner_6391038683284.png)
...
![Screen_Shot_2020-07-01_at_6.10.44_PM.png](/images/partner_6391025308308.png)
  3. Log in to your MoEngage Dashboard and navigate to Settings to get the Workspace ID and Secret Key.

| info |  **Information** Acquisition Settings are available in **Settings** -> **Analytics** -> **Acquisition tracking**.

| --- | --- |  
  
     1. Navigate to **Settings** -> **Account** -> **APIs**.
     2. Click on the copy icon to copy the Workspace ID. 
     3. Click**** on the copy icon in the **Data** tile in the **API Keys** section to copy the Secret Key.

![Settings_APIs_RevampedUI.png](/images/partner_22181763389844.png)
...
| **Note** : Ensure your cohort name do not start with a period (.) and must not contain the following restricted characters: |, *, ?, \, :, &lt;, &gt;, =, $, "  
...
![Screen_Shot_2020-06-24_at_9.33.05_AM.png](/images/partner_6391046166932.png)  
The Sync your cohort to MoEngage pop-up is displayed.  
  
![Amplitude.png](/images/partner_11619075291796.png)
...
| warning |  **Note** Users in your Amplitude cohort attempted to map with unique user profiles in MoEngage. If MoEngage systems do not have that user profile, the user is not mapped and not added to the cohort/segment.  
...
![Screen_Shot_2020-06-24_at_9.41.22_AM.png](/images/partner_6391019524756.png)

The custom segment is used in any MoEngage campaigns to send personalized messages to the users under this segment.

# Exporting Campaign Data from MoEngage to Amplitude<Info>
**Prerequisites**
Exports to Amplitude make use of MoEngage Streams, which is an add-on.
</Info>To setup exports to Amplitude, go to MoEngage Dashboard >> App Marketplace. Search for Amplitude and go to the Integrate tab.

![marketplace.png](/images/partner_13910721832212.png)

  1. Click on "+ Add Integration".
  2. Fill up the form: Amplitude API Key - This is available on your Amplitude Account -> Settings -> ProjectName -> General -> API Key as shown below -   
![amplitudesettins.png](/images/partner_6391019543316.png)  
...
The following MoEngage source-specific documents for setting unique user id in MoEngage:
  ...
  * [Android](https://developers.moengage.com/hc/en-us/articles/4402050979860-Tracking-User-Attributes#user-login-and-logout-0-0)
  * [iOS](https://developers.moengage.com/hc/en-us/articles/4403905883796-Tracking-User-Attributes#user-login-logout-0-0)
  * [Web](https://developers.moengage.com/hc/en-us/articles/360061114832-Web-SDK-User-Attributes-Tracking#user-login-and-logout-0-2)
  * [Data API (Server-side integration)](https://developers.moengage.com/hc/en-us/articles/4404674776724-Data-API)



| info |  Information Ensure that you are setting the same value for User Id in amplitude and Unique User Id in MoEngage.
...
| Event Code | Type (Reference Only) | 
...
| MOE_CARD_CAMPAIGN _DELIVERED | Delivery |
...
| MOE_EMAIL_HARD_BOUNCE | Delivery |
...
| MOE_EMAIL_SOFT_BOUNCE | Delivery | 
...
| Email | Tracked when our system finds an email is hard bounced. Typically happens when an email address doesn't exist. <br/>- Email Unsubscribed |

| MOE_EMAIL_UNSUBSCRIBE | Interaction |
...
| In-App | Tracked when a user clicks In-App message on an Android device. <br/>- In-App Closed Android |
...
| In-App | Tracked when an In-App message is shown to the user on an iOS device. <br/>- In-App Clicked iOS |
...
|  iOS_IN_APP_CLOSE _CLICKED | Interaction | 

| In-App | Tracked when a user dismisses an In-App message by clicking on the close button on an iOS device. <br/>- Mobile In-App Shown |
...
| Push | Tracked when a user receives a notification on an iOS device. <br/>- Notification Received iOS |
...
|  NOTIFICATION_CLICKED _IOS_MOE | Interaction | 
...
| MOE_ONSITE_MESSAGE _SHOWN | Interaction |
...
|  MOE_WEBP_MESSAGE _SHOWN | Interaction | 
...
|  MOE_USER_REMOVED_ FROM_CONTROL_GROUP | Delivery | 

| All Campaigns | Tracked when a user is removed from a control group <br/>- User Removed From Campaign Due to Control Group |

| MOE_CAMPAIGN_USER _REMOVED_DUE_TO _CONTROL_GROUP | Delivery |

| All Campaigns | |

 Tracked when au ser is removed from a campaign due to the user being a part of the control group  
  
| warning |  **Points to remember for events sent to Amplitude**
