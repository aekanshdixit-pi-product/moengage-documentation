...
| Geography |  Location of the user, latitude and longitude (- lat,lng).  
...
| warning |  **Limitation** Only Connector action - Add/Modify User Information is supported by Tealium.
