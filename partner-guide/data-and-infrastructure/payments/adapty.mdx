...
![](/images/partner_45241748673940.png)
...
To configure the Webhook in Adapty, perform the following steps:
  ...
  3. Scroll to the **Server** section and click **webhooks**.![](/images/partner_45241247781140.png)
...
| Authorization Value | Paste the Basic Auth token generated in step 1 (for example: Basic Qk5CR1NNNUR4eHh4…). ![](/images/partner_45240276198804.png) |
...
![](/images/partner_45240223306516.png)
...
To verify data in MoEngage, perform the following steps:
  ...
  3. In the **Search Users** search box, locate a test user by using one of the following identifiers:
     * Customer ID
     * Email address
     * Phone number ![](/images/partner_45241650283540.png)
...
![](/images/partner_45241719936532.png)
