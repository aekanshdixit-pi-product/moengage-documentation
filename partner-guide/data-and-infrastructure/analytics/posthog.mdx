---
title: "PostHog"
description: "Forward MoEngage events and users to PostHog using Connector Campaigns to perform holistic product analytics across funnels, heatmaps, and session recordings."
keywords: ["PostHog", "product analytics", "Connector Campaigns", "MoEngage integration", "event forwarding"]
---
