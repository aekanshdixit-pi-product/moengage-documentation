...
- Trigger MoEngage journeys, campaigns, and automated flows directly from Behamics events such as _rage_click_detected_ or _accidental_add_to_cart_.
...
3. In the **API keys** section, copy the API key on the **Data** tile.\
   <img src="/guide-media/01K0KH9Z1BEK7Y4MEG4MZK5Z3K" alt="MoEngage API keys page showing the Data tile in the API keys section" width="643" />
...
<img src="/guide-media/01KKRE1HNXRAKHGPVDMFB69V1Q" alt="Basic Auth Header Generator tool showing the generated authorization token" />
...
<img src="/guide-media/01KKRE0PW25CA4PFDV3R9Y23D0" alt="Example Behamics payload showing the event structure and user attributes" />
