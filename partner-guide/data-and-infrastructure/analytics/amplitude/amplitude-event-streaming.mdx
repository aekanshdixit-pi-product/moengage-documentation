...
description: "Stream Amplitude events and user properties to MoEngage to enrich segmentation, personalize campaigns, and track conversion across the funnel."
keywords: ["Amplitude", "event streaming", "behavioral analytics", "MoEngage Streams", "segmentation"]
---
