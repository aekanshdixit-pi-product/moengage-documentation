...
description: "Sync Amplitude cohorts to MoEngage and stream MoEngage campaign events back to Amplitude for richer behavioral analytics and targeted engagement."
keywords: ["Amplitude", "cohort sync", "behavioral analytics", "MoEngage Streams", "audience integration"]
---
...
1. Log in to Amplitude and Navigate to Sources and Destinations.\
   ![Amplitude Sources and Destinations page](/images/partner_6391038683284.png)
2. On the Sources & Destinations Page, go to Destinations and click on Add Destination -> MoEngage. On doing this, you will see a pop-up with the following details:\
   ![Add MoEngage as a destination popup in Amplitude](/images/partner_6391025308308.png)
3. Log in to your MoEngage Dashboard and navigate to Settings to get the Workspace ID and Secret Key.
   ...
   ![MoEngage Settings APIs page showing Workspace ID and Data API key](/images/partner_22181763389844.png)
...
1. Open a cohort in Amplitude that you want to sync with MoEngage and click "Sync To" -> Select MoEngage.\
   ![Amplitude cohort sync to MoEngage option](/images/partner_6391046166932.png)\
   The **Sync your cohort to MoEngage** pop-up is displayed.\
   ![Sync your cohort to MoEngage popup with sync options](/images/partner_11619075291796.png)
...
2. Fill up the form: Amplitude API Key - This is available on your Amplitude Account > Settings > ProjectName > General > API Key as shown below:\
   ![Amplitude project settings page showing the API Key](/images/partner_6391019543316.png)
