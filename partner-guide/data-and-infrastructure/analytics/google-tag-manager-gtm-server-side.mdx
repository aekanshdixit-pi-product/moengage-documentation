...
description: "Forward events from your GTM server-side container to MoEngage using the MoEngage GTM template, with no website code required."
keywords: ["Google Tag Manager", "GTM", "server side", "tag manager", "MoEngage integration", "event forwarding"]
---
