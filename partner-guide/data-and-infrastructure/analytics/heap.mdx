...
|   1. Under **Basic Configuration** , in the **Heap Webhook** section, provide the following details: Heap Webhook Section | Description
...
| info | You can sync customer information along with the event, if needed, by using the keys in the user profiles table.   
