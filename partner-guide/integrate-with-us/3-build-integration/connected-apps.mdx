...
<CardGroup cols={2}>
  ...
  <img src="images/Untitled-presentation-2.png" alt="Connected Channels Diagram" style={{ marginTop: '20px', borderRadius: '8px' }} />
</div>
  </Card>
  ...
  <img src="images/connected-2.png" alt="Connected Sources Diagram" style={{ marginTop: '20px', borderRadius: '8px' }} />
</div>
  </Card>
</CardGroup>
