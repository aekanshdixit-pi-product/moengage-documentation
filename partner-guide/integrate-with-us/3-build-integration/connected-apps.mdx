...
**💡 Helpful context:** Familiarize yourself with how [Connector Campaigns](/user-guide/campaigns-and-channels/connectors/create/create-a-connector-campaign) work in MoEngage. Connected Apps closely follows this user journey. You can also browse existing [Connected Channels](/user-guide/campaigns-and-channels/connected-apps/getting-started-with-connected-apps/overview#h_01JVKYB2V23T3TPVVCPNKZ7RCH) to see integrations built on this platform.
