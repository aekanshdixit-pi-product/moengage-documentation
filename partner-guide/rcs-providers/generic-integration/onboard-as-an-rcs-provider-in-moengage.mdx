...
| An array of objects having messages to be sent, which can be a bulk or a single object. The maximum limit is 50 characters. \
...
| String to be reverted to MoEngage in every callback. This helps with reconciliation. \
- fallback\_order | Required |
...
| This field denotes the object containing the RCS message and contains keys specific to RCS and the type of RCS message. For more information, refer to rcs. \
- sms | Optional  |
...
| This field denotes the agent ID registered for sending the RCS message. \
- rcs\["template\_id"\] | Optional |

| String | |

This field is present only for messages sent to an Indian mobile number.\
rcs\["message\_content"\]

| Required | Object |

| This field denotes the entire RCS template content. \
- ### sms \
...
| This field contains all the dynamic parts of the message for vendors who do not use resolved text. They can use dynamic parameters. \
...
| This field denotes the resolved title. This is for vendors who do not support dynamic parameters can use this to do a string match. \
...
| This field denotes the text to be shown as a reply. \
- postback\_data | Required |
...
| This field denotes the URL specified for redirection. \
...
| This field denotes the latitude of the location. \
- longitude | Required |
...
| This field denotes the label text for the location. \
...
| This field denotes the start time of the calendar event in the timestamp format. \
- end\_time | Required |
...
| This field denotes the title of the calendar event. \
- description | Optional |
...
| Success or Failure | This response is returned when the request is processed successfully or when the request fails. \
- 4XX |
...
| Unknown errors | This response is returned when the system runs into an unexpected error. \
...
| This field denotes the callback status. \
- callback\_data | Required |
...
| This field denotes the timestamp in epoch format. \
- error\_message | Optional |
