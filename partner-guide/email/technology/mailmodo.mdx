...
**Step 3:** Select your [Rest API Host](https://help.moengage.com/hc/en-us/articles/360057030512-Data-Centers-in-MoEngage#list-of-data-centers-0-0) from the drop-down
...
Use the connector campaigns to send email campaigns from MoEngage. For more information, refer to [Connector Campaigns](https://help.moengage.com/hc/en-us/articles/214247906-Create-Connector-Campaign).
...
| warning |  Sending Requirement Add Hard Bounce, Spam, and Unsubscribe criteria in Segmentation of the campaign creation manually to ensure your domain reputation is intact.
...
# Analyze Campaign Data in MoEngage
  ...
  1. For more information about the analysis of campaigns, refer to [Analyze emails in MoEngage](https://help.moengage.com/hc/en-us/articles/16242513761556-Email-Analytics-and-Info).

  2. Export the response data from Mailmodo and use the exported data in MoEngage [Data APIs](https://developers.moengage.com/hc/en-us/articles/4404674776724-Data-API "https://docs.moengage.com/docs/data-import-apis").
