...
1. 1. If you do not have a MoEngage account, click _Sign up now_. You will be directed to the account creation page for MoEngage. Skip to step 3 if you have a MoEngage account already.
...
1. Enable the MoEngage-Shopify app to embed on your Shopify Store. To do so:
   1. 1. Navigate to Theme Settings. (add link)
...
![InitializationSettings (2).png](18782410324756)
