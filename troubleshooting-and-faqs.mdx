...
*   Make sure that the [SDK initialization](/hc/en-us/articles/4403905438228) is done properly. Check if the App ID provided in the initialization method is correct.
...
*   Make sure you have implemented user unique ID tracking properly. Please set [**User Attribute Unique ID**](/hc/en-us/articles/4403905883796) **unique** to your users that are logged, don't hardcode this value.
*   Make sure [resetUser](/hc/en-us/articles/4403905883796) method is called on the logout feature of the App so that SDK can differentiate between the users.
...
*   Refer this [link](/hc/en-us/articles/4403944011028) and verify uploaded APNS pem file is valid.
...
*   Set Build Configuration correctly and test in the correct environment. Refer [link](/hc/en-us/articles/4403905438228-SDK-Initialisation#test-live-environment-0-3) for more info.
...
*   Make sure **handleInAppMessage** method is called wherever In-App is displayed - [link](/hc/en-us/articles/4404155127828-In-App-NATIV-SDK-Version-6-0-0-and-above-#how-to-show-in-app-message--0-1)
*   In-App only came once and can’t see/test it again. Then it might be a case where inApp to be shown may not pass a set of rules which we have kept in SDK to make sure the user experience isn't hindered. Refer the [link](/hc/en-us/articles/4404155127828-In-App-NATIV-SDK-Version-6-0-0-and-above-#in-app-messaging-rules-0-13) to know about these rules.
