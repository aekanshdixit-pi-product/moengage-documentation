...
For information, refer to [Configure Web Push settings][Placeholder_Link].
...
After you configure the opt-in and the user visits your website, there is a prompt for opt-in permission requests. If the user accepts the opt-in request, the reachability icon for web push is green in color on the MoEngage user profile page. For more information, refer to [User Reachability][Placeholder_Link].
...
You have three Push Opt-In options. For more information, refer to [Configure Web Push Settings][Placeholder_Link].

## I wish to customize Notification permission opt-in banner or nudge.

You can customize the time (after which to show banner or nudge), Text, Fonts & Font-size. For more information, refer to [Configure Web Push Settings][Placeholder_Link].
