...
- [Get Campaign Stats](/api/stats/get-campaign-stats) - Retrieve real-time performance metrics (clicks, impressions, conversions) at a platform level.
- [Download Campaign Report](/api/campaign-reports/download-campaign-report) - Directly download campaign data files for specified date ranges.
