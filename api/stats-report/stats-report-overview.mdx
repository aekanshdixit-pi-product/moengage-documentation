...
- [Get Campaign Stats](https://moengage.mintlify.app/api/stats/get-campaign-stats) - Retrieve real-time performance metrics (clicks, impressions, conversions) at a platform level.
- [Download Campaign Report](https://moengage.mintlify.app/api/campaign-reports/download-campaign-report) - Directly download campaign data files for specified date ranges.
