...
<Note>
  Live Activities can only be managed for push campaigns created with the **BROADCAST_LIVE_ACTIVITY** delivery type via the [Create Push Campaigns API](https://developers.moengage.com/hc/en-us/articles/38466364097044-Create-Push-Campaigns). These campaigns cannot be created through the MoEngage UI.
</Note>
