...
- [Create File Segment](https://moengage.mintlify.app/api-reference/custom-segments--file/create-file-segment)
- [Add Users to File Segment](https://moengage.mintlify.app/api-reference/custom-segments--file/add-users-to-file-segment)
- [Remove Users from File Segment](https://moengage.mintlify.app/api-reference/custom-segments--file/remove-users-from-file-segment)
- [Replace Users in File Segment](https://moengage.mintlify.app/api-reference/custom-segments--file/replace-users-from-file-segment)

### Segment Lifecycle (v2)

- [Archive Custom Segment](https://moengage.mintlify.app/api-reference/custom-segments--lifecycle/archive-custom-segment)
- [Unarchive Custom Segment](https://moengage.mintlify.app/api-reference/custom-segments--lifecycle/unarchive-custom-segment)

### Filter Segments (v3)

- [List Custom Segments](https://moengage.mintlify.app/api-reference/custom-segments--filters/list-custom-segments)
- [Create Filter Segment](https://moengage.mintlify.app/api-reference/custom-segments--filters/create-filter-segment)
- [Get Custom Segment by ID](https://moengage.mintlify.app/api-reference/custom-segments--filters/get-custom-segment-by-id)
- [Update Filter Segment](https://moengage.mintlify.app/api-reference/custom-segments--filters/update-filter-segment)
