...
- [Archive Segment](/api/segments--lifecycle/archive-segment): Archives an existing segment (File or Filter).
- [Unarchive Segment](/api/segments--lifecycle/unarchive-segment): Unarchives an existing segment, making it active again.
