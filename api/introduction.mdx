...
<Tip>
You can also quickly copy the MCP server URL or install command from any page on the MoEngage documentation site using the contextual menu at the top of the page.
</Tip>
