...
<Note>
  **Documentation Beta**: We are still refining the new API docs. While exploring them, you may encounter minor inaccuracies, broken links, formatting errors, or incomplete sections. We appreciate your patience as we finalize the content.

  The [legacy site ](https://developers.moengage.com/hc/en-us/categories/4404541620756-API)remains available during this transition. Refer to it if you need to cross-verify any information.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Catalog" icon="box" href="/api/catalog/catalog-overview">
  ...
  <Card title="Custom Segments" icon="users" href="/api/custom-segments/custom-segments-overview">
...
3. Copy your **Workspace ID** and the relevant **API Key**.
   ...
   Authentication can be performed using a client like Postman as follows:
