...
- [Fetch Cards](https://moengage.mintlify.app/api-reference/cards/fetch-cards-for-user)
- [Delete Cards](https://moengage.mintlify.app/api-reference/cards/delete-cards-for-user)
