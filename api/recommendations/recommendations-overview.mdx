...
- [Fetch Recommendation Metadata](/api/recommendations/fetch-recommendation-metadata) - Get configuration details, status, and logic.
- [Fetch Recommendation Results](/api/recommendations/fetch-recommendation-results) - Retrieve personalized items for a user.
