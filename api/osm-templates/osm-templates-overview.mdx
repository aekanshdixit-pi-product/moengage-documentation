...
The MoEngage On-Site Messaging (OSM) Template API allows you to manage your web and app-site messaging templates. You can use this API to upload custom HTML templates created outside the MoEngage ecosystem, making them available for your OSM campaigns. 
...
The OSM Template API is a collection of the following endpoints:
