...
Business Events API is a collection of the following endpoints:

- [Create Business Event](/api/business-events/create-business-event) - Define the schema and attributes for a new event.
- [Trigger Business Event](/api/business-events/trigger-business-event) - Fire an event to initiate associated campaigns.
