...
- [Create Business Event](https://moengage.mintlify.app/api-reference/business-events/create-business-event) - Define the schema and attributes for a new event.
- [Trigger Business Event](https://moengage.mintlify.app/api-reference/business-events/trigger-business-event) - Fire an event to initiate associated campaigns.
- [Search Business Events](https://moengage.mintlify.app/api-reference/business-events/search-business-events) - Retrieve details of existing events using IDs or names.
