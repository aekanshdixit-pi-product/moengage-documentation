...
- [Create a New Catalog](/api/catalog/create-a-new-catalog): Creates a new catalog with a unique name.
- [Add Catalog Attributes](/api/catalog/add-catalog-attributes): Adds new attributes to the catalog.
- [Ingest Items into the Catalog](/api/items/ingest-items-into-the-catalog): Ingests items into an existing catalog.
- [Update Existing Items](/api/items/update-existing-items-in-a-catalog): Updates items with new attribute values.
- [Delete Existing Items](/api/items/delete-existing-items): Deletes existing items in a given catalog.
- [Get Item Details](api/items/get-item-details): Retrieve item attribute details.
...
<AccordionGroup>
  ...
  <Accordion title="Can I change the data type of an attribute once an API catalog is created?">
    No, the data type cannot be changed once an attribute has been defined in the catalog. You can add a new attribute to the catalog using the [Add new catalog attribute API](/api-reference/catalog/add-catalog-attributes) with a different data type as needed.
  </Accordion>
</AccordionGroup>
