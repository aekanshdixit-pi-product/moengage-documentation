...
- [Create a New Catalog](https://moengage.mintlify.app/api/catalog/create-a-new-catalog)
- [Add Catalog Attributes](https://moengage.mintlify.app/api/catalog/add-catalog-attributes)
- [Ingest Items into the Catalog](https://moengage.mintlify.app/api/items/ingest-items-into-the-catalog)
- [Update Existing Items](https://moengage.mintlify.app/api/items/update-existing-items-in-a-catalog)
- [Delete Existing Items](https://moengage.mintlify.app/api/items/delete-existing-items)
