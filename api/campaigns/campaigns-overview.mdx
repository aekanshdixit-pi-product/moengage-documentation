...
- [Create Campaign](/api/create-campaigns/create-campaign)
- [Update Campaign](/api/update-campaigns/update-campaign)
- [Change Campaign Status](/api/update-campaigns/change-campaign-status)
- [Search Campaigns](/api/get-campaign-details/search-campaigns)
- [Get Campaign Meta](/api/get-campaign-details/get-campaign-meta)
- [Get Child Campaigns](/api/get-campaign-details/get-child-campaigns)
- [Test Campaign](/api/test-campaigns/test-campaign)
- [Personalized Preview](/api/test-campaigns/personalized-preview)
