...
<AccordionGroup>
  ...
  <Accordion title="What timezone should I use for the scheduling start time when creating a campaign via the API?">
     You can specify the scheduling start time in either UTC or your Workspace's local timezone. This prevents campaigns from triggering at the wrong time.
  </Accordion>
