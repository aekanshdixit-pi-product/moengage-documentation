...
The segment ID and name are visible in the MoEngage dashboard under **Segments**. For full segment construction details, refer to [Create Custom Segment](https://developers.moengage.com/hc/en-us/articles/13277936457748).
...
The full FAQ on per-state restrictions is at [Update Campaign](/api/v5/update-campaigns/update-campaign).
