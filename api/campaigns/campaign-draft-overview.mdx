...
* [Update Global Control Group](/api/v5/global-control-group/update-global-control-group): Adds or removes users from the Global Control Group in bulk via a CSV file.
