...
description: "The MoEngage Push Templates API allows you to create, update, and search for push notification templates programmatically for Android and iOS platforms. Use these endpoints to manage your template library efficiently and integrate it into your automated workflows."
---
