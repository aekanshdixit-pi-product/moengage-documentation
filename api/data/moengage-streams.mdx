---
title: "Streams"
description: "Streams enable you to forward events, such as user actions and campaign interaction events, available in MoEngage to a predefined API endpoint in near real-time."
icon: "webhook"
---
...
For more information on when the campaign events and attributes are tracked, refer to [this article](/hc/en-us/articles/15975781928468).
...
Businesses with multiple apps can do cross-app analysis to unlock higher LTV, provide opportunities for cross-selling, and increase brand loyalty.
