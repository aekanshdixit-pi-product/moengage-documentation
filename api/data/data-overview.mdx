---
title: "Data Overview"
description: "Data APIs are used to send user properties and events from your servers to MoEngage servers."
---

## Data API Endpoints

Data API is a collection of the following API endpoints:

- [Track User](/api/user/track-user)
- [Get User](/api/user/get-user)
- [Merge User](/api/user/merge-users)
- [Delete User](/api/user/delete-users-in-bulk)
- [Create Event](/api/event/create-event)
- [Track Device](/api/device/track-device)
- [Device Opt-out](/api/device/device-opt-out)
- [MoEngage Streams](/api/webhooks/moengage-streams-webhook)
- [Bulk Import](/api/bulk/bulk-import-users-and-events)
- [Trigger File Imports](/api/file-import/trigger-file-imports)
- [Import Details](/api/file-import/import-details)
- [Import File Run History](/api/file-import/import-file-run-history)
- [Install Tracking](/api/tracking/track-app-install)
- [Test connection](/api/utilities/test-api-connection)
