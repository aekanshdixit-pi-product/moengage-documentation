...
Data APIs support [IP whitelisting](/user-guide/settings/account/security/ip-whitelisting-in-moengage). Contact the MoEngage Support Team to whitelist your IP addresses. After configuration, MoEngage exclusively ingests API payloads originating from these whitelisted IPs.
</Note>
