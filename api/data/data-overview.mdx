---
title: "Data Overview"
description: "Sending events and user details from your servers to the MoEngage servers using the MoEngage Data APIs. "
---
...
- [Track User](https://moengage.mintlify.app/api-reference/user/track-user)
- [Get User](https://moengage.mintlify.app/api-reference/user/get-user)
- [Merge User](https://moengage.mintlify.app/api-reference/user/merge-users)
- [Delete User](https://moengage.mintlify.app/api-reference/user/delete-users-in-bulk)
- [Create Event](https://moengage.mintlify.app/api-reference/event/create-event)
- [Track Device](https://moengage.mintlify.app/api-reference/device/track-device)
- [Device Opt-out](https://moengage.mintlify.app/api-reference/device/device-opt-out)
- [MoEngage Streams](https://moengage.mintlify.app/api-reference/webhooks/moengage-streams-webhook)
- [Bulk Import](https://moengage.mintlify.app/api-reference/bulk/bulk-import-users-and-events)
- [Trigger File Imports](https://moengage.mintlify.app/api-reference/file-import/trigger-file-imports)
- [Import Details](https://moengage.mintlify.app/api-reference/file-import/import-details)
- [Import File Run History](https://moengage.mintlify.app/api-reference/file-import/import-file-run-history)
- [Install Tracking](https://moengage.mintlify.app/api-reference/tracking/track-app-install)
- [Test connection](https://moengage.mintlify.app/api-reference/utilities/test-api-connection)
- S3 Data Import
