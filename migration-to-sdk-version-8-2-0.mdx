...
App Group ID for App target was earlier set using `setAppGroupID:`, which is no longer supported. Make use of the MOSDKConfig to configure the same in the latest SDK versions(Refer to the [link](/hc/en-us/articles/4403905438228) for more info)
...
For more information on tracking user attributes methods, refer to this [doc](/hc/en-us/articles/4403905883796).
