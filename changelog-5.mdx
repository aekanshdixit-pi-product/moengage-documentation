...
* iOS
	+ Added support for tracking custom boolean attributes in two formats: ***0/1*** and ***TRUE/FALSE*** Refer to the [documentation](https://developers.moengage.com/hc/en-us/articles/4404254395924-Tracking-User-Attributes#h_01J4R65FT0DPAVJ834N7XG4ZTS) for more information.
...
* iOS
	+ Updated the dependency to MoEngage-iOS-SDK ***9.17.0,*** refer to [release notes](https://developers.moengage.com/hc/en-us/articles/4404198236564-Changelog#01HS8FGNBB50KZ0QAT847A34N3) for more details.
