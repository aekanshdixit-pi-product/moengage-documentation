...
<div style={{ border: '1px solid #E8E8E8', padding: '16px', borderRadius: '8px', marginBottom: '20px' }}>
  <strong style={{ fontSize: '1.1em', display: 'block', marginBottom: '12px' }}>Module Status Legend</strong>
  <ul style={{ margin: '8px 0 0 20px', padding: '0', listStyle: 'none' }}>
    <li>
      <span style={{ color: '#008767', fontWeight: 'bold' }}>■ Updated:</span> Module version has been updated in this release.
    </li>
    <li>
      <span>■ Unchanged:</span> Module remains on the previous version.
    </li>
    <li>
