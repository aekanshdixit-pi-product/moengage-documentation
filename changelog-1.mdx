...
- Shopify: Fix regarding saving cart_token in storage.
...
- Web Personalisation: Remove the default cluster target to dc_1.
...
- SDK: Adding new events and device attributes for Push Subscription events.
- SDK: JSON object support for trigger evaluator.
- Web Personalisation: Remove default cluster target to dc_1.
...
- Core: New Data centers DC_5 and DC_100 added
