...
- [Report Experience Events](/api/experiences/report-experience-events): Tracks impressions (`SHOWN`) and user interactions (`CLICKED`) for accurate campaign reporting.
