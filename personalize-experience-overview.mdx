---
title: "Personalize Experience Overview"
...
- [Fetch Experience](/api/personalize/fetch-experience): Evaluates targeting rules and returns the personalized payload (variations) for a user.
- [Fetch Experience Metadata](/api/personalize/fetch-metadata): Retrieves a list of all currently Active, Scheduled, or Paused experiences.

### Events

- [Report Experience Events](/api/personalize/report-events): Tracks impressions (`SHOWN`) and user interactions (`CLICKED`) for accurate campaign reporting.

## FAQs

### Experience Management

<Accordion title="Can I fetch multiple experiences in a single call?" icon="layer-group">
...
<Accordion title="How does MoEngage identify users via API?" icon="user-check">
...
<Accordion title="When should I regenerate my API Secret?" icon="shield-halved">
...
<Accordion title="Is it better to report events via API or SDK?" icon="chart-line">
...
<Accordion title="How do I track clicks on specific page elements?" icon="mouse-pointer">
...
Test these personalization endpoints quickly by importing our Postman collection: [**View in Postman**](https://www.postman.com/moengage-dev/api-docs/collection/)