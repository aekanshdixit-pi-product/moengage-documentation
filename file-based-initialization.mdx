...
<Warning>
**Warning**
The key `IsSdkAutoInitialisationEnabled` uses the British spelling ('s'). Ensure you use the exact key name, or initialization will fail.
</Warning>
...
<Warning>
**Warning**
Make sure you are setting the Push/InApp callback listeners **before** calling `initialize()`.
</Warning>
