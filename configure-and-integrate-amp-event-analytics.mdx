...
If any user attribute is configured as an identity for your account, then track it as part of [login][Placeholder_Link] instead of simply tracking it as a user attribute as it is shown in this section. Refer to [this document][Placeholder_Link] to learn more.
</Warning>
...
[Previous way of logging-in users][Placeholder_Link] has been changed. The below method follows the User Identity Resolution feature of MoEngage. [Learn More][Placeholder_Link].
...
If the user log in and log out is not handled correctly, user data may get corrupted. Refer [this section][Placeholder_Link] for more details.
</Warning>
