...
Ensure that you [configure the web push notifications settings](https://help.moengage.com/hc/en-us/articles/210224063-Configure-Web-Push-Settings?_gl=1*xitcbq*_ga*MTU4NTM0MzI0NS4xNzI3MTcwMzYy*_ga_SEBHW7YTZ7*czE3NzE4MjEwNDEkbzE1NiRnMSR0MTc3MTgzMTEyMSRqNTQkbDAkaDA.) since enabling the Web Push module is a mandatory pre-requisite.
...
If you wish to change the serviceworker.js file name depending on the browser or environment, use the following [initialization](/developer-guide/web-sdk/web-sdk-integration/basic-integration/web-sdk-integration) block:
...
You can also set an arbitrary scope by passing in an additional parameter `swScope` when [initializing](/developer-guide/web-sdk/web-sdk-integration/basic-integration/web-sdk-integration).
...
If you are not able to place the serviceworker.js file at the root of your app but still want it to be available throughout the app, then you have to pass `*swScope*` as in the following snippet when [initializing](/developer-guide/web-sdk/web-sdk-integration/basic-integration/web-sdk-integration):
...
Pass `disable_web_push: true` to the [initialization](/developer-guide/web-sdk/web-sdk-integration/basic-integration/web-sdk-integration) config to disable the Web Push Notification module:
...
![image-20221212-082616.png](12847727276436)
...
Or you can install the MoEngage Chrome Extension to see it easily. For more information, refer to [MoEngage Chrome Extension](/developer-guide/web-sdk/integration-validation/web-push-notifications-integration-validation).
...
![webpush_badge_icon_info.svg](9291717194260)
