...
For more information, refer to [Web SDK Integration][Placeholder_Link].

Ensure that you [configure the web push notifications settings][Placeholder_Link] since enabling the Web Push module is a mandatory pre-requisite.
