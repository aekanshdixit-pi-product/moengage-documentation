...
## Geofence 3.0.0
* ***startGeofenceMonitoring()*** and ***stopGeofenceMonitoring()*** APIs are introduced to control Geofence better. Refer to the [integration documentation](/hc/en-us/articles/4403443036564) for more details.
...
## Push Amp Plus 6.0.0
* Mi SDK update to Version 5.x.x, refer to the [Configuring Xiaomi Push](/hc/en-us/articles/4403466194708) and update the integration.
...
* Starting from SDK version 12.0.00 following features are not integrated by default when adding moe-android-sdk as a dependency. If you are using these features refer to their respective integration document and update the dependencies.
  ...
  * [Push Amplification](/hc/en-us/articles/4650416409876)
  * [Device Trigger](/hc/en-us/articles/4649815712532)
...
## InApp 6.0.0
* InApp feature is no longer part of the Core SDK. InApp SDK needs to be added separately, refer to the [InApp](/hc/en-us/articles/4403652537492) documentation for more details.
...
* The Push Amplification feature is no longer part of the Core SDK. Push Amplification SDK needs to be added separately, refer to the [Push Amplification](/hc/en-us/articles/4650416409876) documentation for more details.

## Device Trigger 2.0.0
* The Device Trigger feature is no longer part of the Core SDK. Device Trigger SDK needs to be added separately, refer to the [Device Trigger](/hc/en-us/articles/4649815712532) documentation for more details.

## Cards
* The current artifact i.e. **com.moengage:cards** is deprecated instead use **com.moengage:cards-ui**. Refer to the integration document for [Cards](/hc/en-us/articles/4403794226452) for more details.
...
* Starting SDK version `11.0.00` Geofence is not included when `moe-android-sdk` is added in the application. Refer to the [GeoFence Push](/hc/en-us/articles/4403443036564) documentation.
...
* InApp is no longer shown via Activity lifecycle callbacks. To show in-app `showInApp()` should be called in the Activity or Fragment. Refer to the [In-App NATIV](/hc/en-us/articles/4403652537492) documentation.
* Source and Target Compatibility Updated to Java 8.
* Updated hosts used by the SDK. Refer to the [Network Security Configuration](https://developers.moengage.com/hc/en-us/articles/4408876754068-Network-Security-Configuration) documentation.
...
* Refer to the [Updating to 11.x.xx](/hc/en-us/articles/4403899650196) for more details.
...
* Breaking change in integration. Refer to [Migrating to Push Amp+ 2.0.00](/hc/en-us/articles/4403899208724).
* Requires Core version `10.3.00` or above.
...
* Refer to [Migration to 10.x.xx](/hc/en-us/articles/4403898796052).
...
* GDPR Compliance. Refer to [GDPR Compliance documentation](/hc/en-us/articles/4403894239892).
...
* Modular SDK. features are pluggable. Refer to [migration documentation](https://developers.moengage.com/hc/en-us/articles/4403887649556-Migrating-to-7-x-xx).
