...
<Info>
* You can now get notified whenever MoEngage releases a new version of the Flutter SDK. For more information, refer to [Subscribe to MoEngage SDK Releases](developer-guide/release-notes/subscribe-to-mo-engage-sdk-releases/subscribe-to-mo-engage-sdk-releases).
