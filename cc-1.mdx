...
<Info>
  **Information**
  ...
  CocoaPods is being deprecated. MoEngage recommends using Swift Package Manager for all new integrations. For more info on CocoaPods, refer to [CocoaPods Integration Guide](/developer-guide/ios-sdk/sdk-integration/basic/sdk-integration-integration-through-cocoa-pods).
</Info>
